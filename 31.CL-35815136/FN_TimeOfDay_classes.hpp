...
namespace SDK
{
	...
	public:
		...
		void SetReflectionQualityMPC(); // Flags: Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void SetGlobalIlluminationMPC(); // Flags: Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		...
		void DisableLightAndFog(bool Enable); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void ReceiveBeginPlay(); // Flags: Event|Protected|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void Update Scalabilty Settings(); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void DebugScalabilitySettings(); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void ExecuteUbergraph_TODM_Disabled(int32_t EntryPoint); // Flags: Final, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
	...
	public:
		...
		TEnumAsByte<ETimelineDirection> New_Storm_Timeline__Direction_5E5E494B489306ED044096A143F228CF; // 0x1018(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1019(0x7) UNKNOWN PROPERTY
		...
		TEnumAsByte<ETimelineDirection> FlashLightning__Direction_FA5447C54EBAE729F521C3B243BEC285; // 0x1034(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x1035(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x7]; // 0x1079(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x5]; // 0x1093(0x5) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x7]; // 0x10C1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x7]; // 0x1259(0x7) UNKNOWN PROPERTY
		...
		void EmptyTransform(FTransform& Transform); // Flags: Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void SetHeavySSAO(); // Flags: Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void UserConstructionScript(); // Flags: Event|Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void FlashLightning__FinishedFunc(); // Flags: BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void FlashLightning__UpdateFunc(); // Flags: BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void New Storm Timeline__FinishedFunc(); // Flags: BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void New Storm Timeline__UpdateFunc(); // Flags: BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void New Storm Timeline__FireOffRain__EventFunc(); // Flags: BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void StartStorm(); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void OnStormStart(); // Flags: BlueprintCosmetic|Event|Public|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void OnStormEnd(); // Flags: BlueprintCosmetic|Event|Public|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void LightningStrike(); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void ReceiveBeginPlay(); // Flags: Event|Protected|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void DisableLightAndFog(bool Enable); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void EnableHDRRendering(); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void UpdateSSAO(); // Flags: BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void ExecuteUbergraph_MASTER_TODM(int32_t EntryPoint); // Flags: Final|HasDefaults, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
