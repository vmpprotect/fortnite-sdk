...
namespace SDK
{
	...
	public:
		...
		TArray<FJunoWorldGameplayProperty> GameplayProperties; // 0x30(0x10)
	...
	public:
		...
		TArray<bool> CanDefaultBeChangedPerMode; // 0x20(0x10)
		TArray<bool> CanChangePostCreation; // 0x30(0x10)
		TArray<int32_t> DefaultOptionPerMode; // 0x40(0x10)
		FGameplayTag DefaultWhenMissing; // 0x50(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x54(0x4) UNKNOWN PROPERTY
		TArray<FJunoWorldSettingOptionRow> Options; // 0x58(0x10)
