...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_6[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x7]; // 0x79(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray BehaviorDefinitions; // 0xC0(0x10)
		TArray DefinitionData; // 0xD0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr ObjectActorClass; // 0x0(0x20)
		FSoftObjectPath ObjectMeshPath; // 0x20(0x18)
		TWeakObjectPtr UserActorClass; // 0x38(0x20)
		TWeakObjectPtr UserValidationFilterClass; // 0x58(0x20)
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xB]; // 0x1(0xB) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xF]; // 0x1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray CollectionEntries; // 0x38(0x10)
		TMap RegisteredIdToObjectMap; // 0x48(0x50)
		TArray Definitions; // 0x98(0x10)
	...
	public:
		...
		unsigned char UnknownData03_6[0x30]; // 0x38(0x30) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x5]; // 0xA3(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr OwnerComponent; // 0x48(0x8)
		unsigned char UnknownData03_6[0x10]; // 0x50(0x10) UNKNOWN PROPERTY
		FTransform Transform; // 0x60(0x60)
		FGameplayTagContainer Tags; // 0xC0(0x20)
		unsigned char UnknownData04_6[0x28]; // 0xE0(0x28) UNKNOWN PROPERTY
		FSmartObjectHandle RegisteredHandle; // 0x108(0x8)
		FInstancedStruct SpatialEntryData; // 0x110(0x10)
		uint16_t DisableFlags; // 0x120(0x2)
		unsigned char UnknownData05_7[0xE]; // 0x122(0xE) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte TraceChannel; // 0x1(0x1)
		unsigned char UnknownData02_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
		TArray ObjectTypes; // 0x8(0x10)
	...
	{
	public:
		TWeakObjectPtr UserActor; // 0x0(0x8)
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
