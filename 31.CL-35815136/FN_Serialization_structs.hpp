...
namespace SDK
{
	...
	public:
		...
		char uint8; // 0x10(0x1)
		unsigned char UnknownData01_6[0x1]; // 0x11(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr<UClass*> SoftClass; // 0x18(0x20)
		UObject* RawObject; // 0x38(0x8)
		UObject* WrappedObject; // 0x40(0x8)
		TWeakObjectPtr<UMetaData*> WeakObject; // 0x48(0x8)
		TWeakObjectPtr<UMetaData*> SoftObject; // 0x50(0x20)
	...
	public:
		...
		unsigned char UnknownData02_7[0xC]; // 0xC4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x8]; // 0x128(0x8) UNKNOWN PROPERTY
		...
		TArray<FVector> VectorArray; // 0x2B0(0x10)
		TMap<FString, FVector> StrToVec; // 0x2C0(0x50)
		TSet<FVector> VectorSet; // 0x310(0x50)
	};
	...
	public:
		...
		TArray<FVector3f> VectorArray; // 0x168(0x10)
		TMap<FString, FVector3f> StrToVec; // 0x178(0x50)
		TSet<FVector3f> VectorSet; // 0x1C8(0x50)
	...
	public:
		...
		TArray<char> ByteArray; // 0x8(0x10)
	...
	{
	public:
		TArray<int32_t> Int32Array; // 0x0(0x10)
	...
	{
	public:
		TMap<int32_t, FString> IntToStr; // 0x0(0x50)
	...
	{
	public:
		unsigned char UnknownData00_2[0x210]; // 0x0(0x210) UNKNOWN PROPERTY
	};
