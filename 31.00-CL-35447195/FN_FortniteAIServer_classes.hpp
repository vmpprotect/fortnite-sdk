...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData03_3[0x20]; // 0x1A0(0x20) UNKNOWN PROPERTY
		FScalableFloat MaxApproaches; // 0x1C0(0x28)
		unsigned char UnknownData04_6[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
		FFortNearbyActorsPerceptionConfiguration PerceptionConfiguration; // 0x1F0(0xD0)
		FName EnableKeyName; // 0x2C0(0x4)
		unsigned char UnknownData05_7[0xC]; // 0x2C4(0xC) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData07_3[0x50]; // 0x1A0(0x50) UNKNOWN PROPERTY
		...
		TArray GEsToApplyOnFallbackBehaviorTrigger; // 0x2F0(0x10)
		TArray GEsToApplyOnCannotDamageBehaviorTrigger; // 0x300(0x10)
		FName HarvestTargetKeyName; // 0x310(0x4)
		unsigned char UnknownData08_6[0x4]; // 0x314(0x4) UNKNOWN PROPERTY
		FName HarvestTargetHitPointKeyName; // 0x318(0x4)
		unsigned char UnknownData09_6[0x4]; // 0x31C(0x4) UNKNOWN PROPERTY
		FName HarvestDestinationKeyName; // 0x320(0x4)
		unsigned char UnknownData10_6[0x4]; // 0x324(0x4) UNKNOWN PROPERTY
		FName FallbackBehaviorKeyName; // 0x328(0x4)
		unsigned char UnknownData11_6[0x4]; // 0x32C(0x4) UNKNOWN PROPERTY
		FName CannotDamageKeyName; // 0x330(0x4)
		unsigned char UnknownData12_6[0x4]; // 0x334(0x4) UNKNOWN PROPERTY
		FName WeaponTriggerMeleeKeyName; // 0x338(0x4)
		unsigned char UnknownData13_7[0x4]; // 0x33C(0x4) UNKNOWN PROPERTY
		...
		void HandleUnconverted(AFortPawn UnconvertedPawn, EUnconvertReason UnconvertReason); // Flags: Final|Native|Protected 0x7FF4149C06F8
		void HandleConverted(AFortPawn InstigatorPawn, AFortPawn ConvertedPawn); // Flags: Final|Native|Protected 0x7FF4149C0618
	};
	...
	{
	public:
		unsigned char UnknownData03_3[0x70]; // 0x1A0(0x70) UNKNOWN PROPERTY
		...
		TEnumAsByte FindAwayLocationFromPawnRunMode; // 0x290(0x1)
		unsigned char UnknownData04_6[0x7]; // 0x291(0x7) UNKNOWN PROPERTY
		UEnvQuery FindAwayLocationFromBoxQueryTemplate; // 0x298(0x8)
		TEnumAsByte FindAwayLocationFromBoxRunMode; // 0x2A0(0x1)
		unsigned char UnknownData05_7[0x7]; // 0x2A1(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x8]; // 0x1B0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x2]; // 0x1E6(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x10]; // 0x230(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x1]; // 0x1C7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x10]; // 0x1E8(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData04_3[0x10]; // 0x188(0x10) UNKNOWN PROPERTY
		TArray EQSs; // 0x198(0x10)
		...
		unsigned char UnknownData05_6[0x30]; // 0x258(0x30) UNKNOWN PROPERTY
		UFortAICombatTokenConsumerComponent CachedTokenConsumerComponent; // 0x288(0x8)
		TWeakObjectPtr CachedTokenProviderComponent; // 0x290(0x8)
		...
		unsigned char UnknownData06_6[0x1]; // 0x29F(0x1) UNKNOWN PROPERTY
		float PositionAcquiredFromQueryTimestamp; // 0x2A0(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x2A4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x78(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		TEnumAsByte MovementStyle; // 0x70(0x1)
	...
	{
	public:
		TArray EquippedItemTagAssociationDatas; // 0x70(0x10)
	...
	public:
		...
		unsigned char UnknownData08_6[0x4]; // 0x8C(0x4) UNKNOWN PROPERTY
		FName WeaponTriggerMeleeKeyName; // 0x90(0x4)
		unsigned char UnknownData09_6[0x4]; // 0x94(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x8]; // 0x68(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TArray InjectionTagsKeys; // 0x70(0x10)
	...
	{
	public:
		TArray InjectionSupportingBehaviors; // 0x38(0x10)
	...
	{
	public:
		TArray InjectedBehaviors; // 0x38(0x10)
	...
	public:
		...
		void HandleTimeOfDayPhaseChange(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation); // Flags: Final|Native|Private 0x7FF4149C07D8
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xC0]; // 0x150(0xC0) UNKNOWN PROPERTY
	...
	{
	public:
		TArray AIEvaluatorList; // 0x28(0x10)
	...
	public:
		...
		TEnumAsByte MoveUrgency; // 0x98(0x1)
	...
	public:
		...
		unsigned char UnknownData03_5[0x3]; // 0xCD(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray DistanceComparisons; // 0x168(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x192(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x181(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x4]; // 0x1D4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_5[0x3]; // 0x6D(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0x92(0x6) UNKNOWN PROPERTY
		...
		TArray DistanceChecks; // 0xC0(0x10)
	...
	public:
		...
		unsigned char UnknownData03_6[0x7]; // 0x159(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_5[0x3]; // 0x16D(0x3) UNKNOWN PROPERTY
		FBlackboardKeySelector AcceptableRadiusKey; // 0x170(0x28)
		bool bDeimosFlavor : 1; // 0x198:0(0x1)
		unsigned char UnknownData05_7[0x7]; // 0x199(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		void SetQueryTemplate(UEnvQuery InPrevisQueryTemplate); // Flags: Final|Native|Public|BlueprintCallable 0x7FF4149C0998
		void PrepForPrevis(); // Flags: Event|Public|BlueprintEvent 0x7FF4149C08B8
	};
	...
	public:
		...
		TArray FloorPatternsToIgnore; // 0x1A8(0x10)
	...
	public:
		...
		unsigned char UnknownData01_5[0x7]; // 0xC1(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_5[0x7]; // 0x101(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr CurvesAroundLineAsset; // 0x100(0x20)
	...
	public:
		...
		unsigned char UnknownData04_5[0x2]; // 0x1CA(0x2) UNKNOWN PROPERTY
		TEnumAsByte PathDistanceFilterOperator; // 0x1CC(0x1)
		unsigned char UnknownData05_6[0x3]; // 0x1CD(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte NavMeshToUse; // 0x88(0x1)
	...
	public:
		...
		unsigned char UnknownData01_6[0x6]; // 0xFA(0x6) UNKNOWN PROPERTY
	...
	public:
		UClass GenerateAround; // 0x88(0x8)
		TWeakObjectPtr CurvesAroundLineAsset; // 0x90(0x20)
	...
	public:
		...
		unsigned char UnknownData01_5[0x7]; // 0x1F9(0x7) UNKNOWN PROPERTY
		TArray AssignmentIDs; // 0x200(0x10)
		TArray ProhibitedAssignmentIDs; // 0x210(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x7]; // 0x201(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x1F9(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray TagQueriesPerDifficulty; // 0x1F8(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x27A(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte TestMode; // 0x278(0x1)
		unsigned char UnknownData03_7[0x7]; // 0x279(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x269(0x7) UNKNOWN PROPERTY
		UClass DistanceTo; // 0x270(0x8)
		TEnumAsByte ScreeningTestMode; // 0x278(0x1)
		TEnumAsByte TestMode; // 0x279(0x1)
		unsigned char UnknownData03_6[0x6]; // 0x27A(0x6) UNKNOWN PROPERTY
		TArray GoalDistanceDataRanges; // 0x280(0x10)
	...
	public:
		...
		unsigned char UnknownData03_7[0x2]; // 0x2BE(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x7]; // 0x269(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x3]; // 0x26D(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_5[0x3]; // 0x1F9(0x3) UNKNOWN PROPERTY
		int32_t ExtentXY; // 0x1FC(0x4)
		int32_t ExtentZ; // 0x200(0x4)
		unsigned char UnknownData03_7[0x4]; // 0x204(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x7]; // 0x1F9(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x6]; // 0x272(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x7]; // 0x2E9(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0x239(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		TArray ActorClassesToIgnoreInTrace; // 0x208(0x10)
	...
	public:
		...
		TMap AdditionalSenseScores; // 0x3B8(0x50)
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x269(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x231(0x3) UNKNOWN PROPERTY
		float AcceptanceAngleTowardNextCenter; // 0x234(0x4)
		TArray ExclusionSafeZoneIndex; // 0x238(0x10)
	...
	public:
		...
		unsigned char UnknownData03_7[0x8]; // 0x110(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x58]; // 0x1B0(0x58) UNKNOWN PROPERTY
		...
		void OnAssignedPerksChangedEvent(); // Flags: Final|Native|Private 0x7FF4149C0A78
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0x4]; // 0x1A0(0x4) UNKNOWN PROPERTY
		FName WeaponKeyName; // 0x1A4(0x4)
		FName MoveToDestinationKeyName; // 0x1A8(0x4)
		FName TargetActorName; // 0x1AC(0x4)
		unsigned char UnknownData03_7[0x8]; // 0x1B0(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0xC]; // 0x1AC(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x90]; // 0x1C8(0x90) UNKNOWN PROPERTY
		...
		void OnAssignedPerksChangedEvent(); // Flags: Final|Native|Private 0x7FF4149C0B58
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x14]; // 0xDC(0x14) UNKNOWN PROPERTY
		...
		void OnZiplineStateChanged(bool bIsZiplining, AFortPlayerPawn FortPlayerPawn); // Flags: Final|Native|Private 0x7FF4149C0D18
		void OnCharacterLaunchChanged(UFortMovementComp_Character MovementComponent, FVector& LaunchVelocity); // Flags: Final|Native|Private|HasOutParms|HasDefaults 0x7FF4149C0C38
	};
	...
	public:
		...
		TArray ExecutionStatusesToCheckedToAvoidStoppingWhenNearActorNames; // 0xB0(0x10)
		unsigned char UnknownData07_6[0x10]; // 0xC0(0x10) UNKNOWN PROPERTY
		TArray ExecutionStatusesToCheckForAllowToAvoidStoppingWhenNearActorNames; // 0xD0(0x10)
		unsigned char UnknownData08_6[0x10]; // 0xE0(0x10) UNKNOWN PROPERTY
		TArray MovementStatusesToCheckedToAvoidStoppingWhenNearActorNames; // 0xF0(0x10)
		unsigned char UnknownData09_6[0x10]; // 0x100(0x10) UNKNOWN PROPERTY
		bool bForceStopIfNoPlayerNearby; // 0x110(0x1)
		unsigned char UnknownData10_6[0x7]; // 0x111(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_7[0x108]; // 0x198(0x108) UNKNOWN PROPERTY
		...
		void OnPlayerPawnSpawned(AAIController Controller, AFortPawn Pawn); // Flags: Final|Native|Private 0x7FF4149C0DF8
	};
	...
	public:
		...
		void OnUnconvertedEvent(AFortPawn UnconvertedPawn, EUnconvertReason UnconvertReason); // Flags: Final|Native|Protected 0x7FF4149C0FB8
		void OnConvertedEvent(AFortPawn InstigatorPawn, AFortPawn ConvertedPawn); // Flags: Final|Native|Protected 0x7FF4149C0ED8
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x10]; // 0xB8(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_7[0x10]; // 0x138(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x1A4(0x2) UNKNOWN PROPERTY
		bool bAllowReachSquadmates : 1; // 0x1A6:0(0x1)
		bool bAllowReachSameFactionNPCs : 1; // 0x1A6:1(0x1)
		unsigned char UnknownData04_5[0x1]; // 0x1A7(0x1) UNKNOWN PROPERTY
		TArray AllyPawns; // 0x1A8(0x10)
		...
		unsigned char UnknownData05_7[0x18]; // 0x1E8(0x18) UNKNOWN PROPERTY
		...
		void OnAllyPawnDBNOStateChanged(AFortPawn InPlayer, bool bInIsDBNO); // Flags: Final|Native|Private 0x7FF4149C1098
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0xF8]; // 0xA8(0xF8) UNKNOWN PROPERTY
		UFortAthenaAIRuntimeParameters_EscalateBehavior EscalateRuntimeParameters; // 0x1A0(0x8)
		TArray EscalateTargetDatas; // 0x1A8(0x10)
		unsigned char UnknownData03_7[0x58]; // 0x1B8(0x58) UNKNOWN PROPERTY
		...
		void OnPlayerPawnSpawned(AAIController Controller, AFortPawn Pawn); // Flags: Final|Native|Private 0x7FF4149C1178
	};
	...
	{
	public:
		unsigned char UnknownData05_3[0xA8]; // 0xA8(0xA8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0xC]; // 0x168(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x2]; // 0x17A(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x18]; // 0x278(0x18) UNKNOWN PROPERTY
		...
		void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte MovementResult); // Flags: Final|Native|Public 0x7FF4149C1338
		void OnAssignedPerksChangedEvent(); // Flags: Final|Native|Private 0x7FF4149C1258
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0xC]; // 0x1BC(0xC) UNKNOWN PROPERTY
		TArray LocationsToEvaluate; // 0x1C8(0x10)
		TArray BestLocations; // 0x1D8(0x10)
		TArray ActorsInArea; // 0x1E8(0x10)
		unsigned char UnknownData03_7[0x20]; // 0x1F8(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0xC]; // 0x1C4(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData07_6[0xA]; // 0xBC(0xA) UNKNOWN PROPERTY
		bool bRandomlySelectFreeFallingMode; // 0xC6(0x1)
		unsigned char UnknownData08_6[0x1]; // 0xC7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_5[0x3]; // 0x149(0x3) UNKNOWN PROPERTY
		float SkyTubeDivingStuckTimeThreshold; // 0x14C(0x4)
		unsigned char UnknownData11_6[0x20]; // 0x150(0x20) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_6[0x8]; // 0x198(0x8) UNKNOWN PROPERTY
		AFortSkyTube CachedSkyTube; // 0x1A0(0x8)
		unsigned char UnknownData13_7[0x8]; // 0x1A8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x70]; // 0xC0(0x70) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x11C]; // 0xCC(0x11C) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0xC]; // 0xB4(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x8]; // 0x118(0x8) UNKNOWN PROPERTY
		...
		void HandlePlayerHealthOrShieldChanged(); // Flags: Final|Native|Private 0x7FF4149C1418
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x10]; // 0x278(0x10) UNKNOWN PROPERTY
		float MeleeAttackMaxDistToEvadeSqr; // 0x288(0x4)
		float MaxDistanceToEvadeSqr; // 0x28C(0x4)
		unsigned char UnknownData03_7[0x8]; // 0x290(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ExecutionStatusesToCheckedNames; // 0xA8(0x10)
		unsigned char UnknownData01_6[0x10]; // 0xB8(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x10]; // 0x1C0(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x48]; // 0x1E8(0x48) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x18]; // 0x248(0x18) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData03_3[0x4]; // 0x1B8(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x18]; // 0x1D0(0x18) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0xC]; // 0x1FC(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0xB0(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0xC]; // 0xBC(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte PathQueryType; // 0xC0(0x1)
		...
		unsigned char UnknownData05_7[0x3]; // 0xC5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_7[0x20]; // 0x218(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		TArray AwareAllyPawns; // 0xF8(0x10)
		TArray AlreadyTestedPawns; // 0x108(0x10)
	...
	{
	public:
		unsigned char UnknownData06_3[0x40]; // 0x1B8(0x40) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x12]; // 0x21C(0x12) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x2]; // 0x23E(0x2) UNKNOWN PROPERTY
		float RangeReachHysteresisRatio; // 0x240(0x4)
		unsigned char UnknownData09_6[0x4]; // 0x244(0x4) UNKNOWN PROPERTY
		FValueOrBBKey_Bool ResetCanFireNextTimeOnEnter; // 0x248(0xC)
		unsigned char UnknownData10_6[0x1C]; // 0x254(0x1C) UNKNOWN PROPERTY
		...
		TWeakObjectPtr CacheZoneManager; // 0x290(0x8)
		TWeakObjectPtr CachedAIServiceCover; // 0x298(0x8)
		AActor ExcludeReachingTarget; // 0x2A0(0x8)
		unsigned char UnknownData11_7[0xB0]; // 0x2A8(0xB0) UNKNOWN PROPERTY
		...
		void FindShootingPosition_Async(int32_t RequestID, float DistanceFromTarget, float WeaponIdealAttackRange, FVector& TargetPosition); // Flags: Final|Native|Protected|HasOutParms|HasDefaults 0x7FF4149C14F8
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x1AC(0x8) UNKNOWN PROPERTY
		TWeakObjectPtr CurrentBeacon; // 0x1B4(0x8)
		unsigned char UnknownData03_7[0x4]; // 0x1BC(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData05_3[0x68]; // 0x1A0(0x68) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x7]; // 0x361(0x7) UNKNOWN PROPERTY
		FScalableFloat ReactToEmotes; // 0x368(0x28)
		FName ReactToVerbTargetActorKeyName; // 0x390(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x394(0x4) UNKNOWN PROPERTY
		FName ReactToVerbShouldMoveKeyName; // 0x398(0x4)
		unsigned char UnknownData08_6[0x4]; // 0x39C(0x4) UNKNOWN PROPERTY
		FName GameplayEffectReactionKeyName; // 0x3A0(0x4)
		unsigned char UnknownData09_6[0x2C]; // 0x3A4(0x2C) UNKNOWN PROPERTY
		...
		void HandlePawnStoppedEmote(UFortItemDefinition MontageItemDef, AFortPawn PawnEmoting); // Flags: Final|Native|Protected 0x7FF4149C16B8
		void HandlePawnStartedEmote(UFortItemDefinition MontageItemDef, AFortPawn PawnEmoting); // Flags: Final|Native|Protected 0x7FF4149C15D8
	};
	...
	public:
		...
		TArray ExecutionStatusToListenKeyNames; // 0x1C8(0x10)
		...
		unsigned char UnknownData01_7[0x24]; // 0x1E4(0x24) UNKNOWN PROPERTY
	...
	public:
		FName WeaponKeyName; // 0xA8(0x4)
		unsigned char UnknownData02_6[0x2]; // 0xAC(0x2) UNKNOWN PROPERTY
		bool bCanReloadWeaponsInInventory; // 0xAE(0x1)
		unsigned char UnknownData03_7[0x1]; // 0xAF(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x18]; // 0x1B8(0x18) UNKNOWN PROPERTY
		...
		void HandlePlayerHealthOrShieldChanged(); // Flags: Final|Native|Protected 0x7FF4149C1798
	};
	...
	public:
		...
		TArray DBNOAllyPawns; // 0x1E0(0x10)
		UFortAthenaAIBotReviveDigestedSkillSet ReviveSkillSet; // 0x1F0(0x8)
		unsigned char UnknownData01_7[0x10]; // 0x1F8(0x10) UNKNOWN PROPERTY
		...
		void OnCurrentTargetRevived(AFortPlayerPawn RevivedPawn); // Flags: Final|Native|Private 0x7FF4149C1878
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x108(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x10]; // 0x160(0x10) UNKNOWN PROPERTY
		...
		void OnBotControllerAlertLevelChanged(AFortAthenaAIBotController BotController, EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel); // Flags: Final|Native|Private 0x7FF4149C1A38
		void Jump(); // Flags: Final|Native|Protected 0x7FF4149C1958
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x8]; // 0x1A8(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x38]; // 0x1C0(0x38) UNKNOWN PROPERTY
		FTimerHandle NextSearchTimerHandle; // 0x1F8(0x8)
		TArray FailedBotPOIList; // 0x200(0x10)
		int32_t CachedSelectedBotPOIID; // 0x210(0x4)
		unsigned char UnknownData05_7[0x4]; // 0x214(0x4) UNKNOWN PROPERTY
		...
		void ReachingPositionFail_Async(int32_t RequestID); // Flags: Final|Native|Private 0x7FF4149C1DB8
		void OnSafeZonePhaseChanged(FFortSafeZonePhaseUpdatedEvent& Event); // Flags: Final|Native|Private|HasOutParms 0x7FF4149C1CD8
		void OnGamePhaseLogicReady(FFortBattleRoyaleGamePhaseLogicComponentReadyEvent& Event); // Flags: Final|Native|Private|HasOutParms 0x7FF4149C1BF8
		void OnAgentDied(AFortAthenaAIBotController BotController, AFortPawn FortPawn); // Flags: Final|Native|Protected 0x7FF4149C1B18
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x1B9(0x3) UNKNOWN PROPERTY
		float CurrentPOICompletionTime; // 0x1BC(0x4)
		float DurationInsideCurrentPOI; // 0x1C0(0x4)
		unsigned char UnknownData05_6[0x4]; // 0x1C4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x1B0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x5]; // 0x1EB(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		TArray ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames; // 0x220(0x10)
		...
		unsigned char UnknownData04_6[0x20]; // 0x248(0x20) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x10]; // 0x2A8(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x12]; // 0xE4(0x12) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x2C]; // 0x114(0x2C) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x80]; // 0xD0(0x80) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0xC]; // 0x1A4(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x38]; // 0x1C8(0x38) UNKNOWN PROPERTY
		...
		void OnSafeZoneStateChanged(EFortSafeZoneState NewState); // Flags: Final|Native|Public 0x7FF4149C1E98
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x10]; // 0x1D0(0x10) UNKNOWN PROPERTY
		ABuildingActor CachedCoverBuildingActor; // 0x1E0(0x8)
		TArray ExcludedBuildingActors; // 0x1E8(0x10)
		unsigned char UnknownData03_7[0x38]; // 0x1F8(0x38) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x18]; // 0x1F0(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x28]; // 0x228(0x28) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0xAC(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x3]; // 0xBD(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x14]; // 0xBC(0x14) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x40]; // 0x210(0x40) UNKNOWN PROPERTY
		...
		void OnZiplineStateChanged(bool bIsZiplining, AFortPlayerPawn FortPlayerPawn); // Flags: Final|Native|Protected 0x7FF4149C1F78
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x30]; // 0x38(0x30) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData09_6[0x6]; // 0xA2(0x6) UNKNOWN PROPERTY
		FGameplayAbilityEvaluatorModule GameplayAbilityEvaluatorModule; // 0xA8(0x28)
		bool bCooldownEvaluator; // 0xD0(0x1)
		unsigned char UnknownData10_6[0x3]; // 0xD1(0x3) UNKNOWN PROPERTY
		float Cooldown; // 0xD4(0x4)
		float CooldownVariation; // 0xD8(0x4)
		TEnumAsByte CooldownType; // 0xDC(0x1)
		bool bDistanceEvaluator; // 0xDD(0x1)
		unsigned char UnknownData11_6[0x2]; // 0xDE(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData15_6[0x8]; // 0x1F0(0x8) UNKNOWN PROPERTY
		bool bEvaluateOnBlackboardKeyChange; // 0x1F8(0x1)
		unsigned char UnknownData16_6[0x7]; // 0x1F9(0x7) UNKNOWN PROPERTY
		TArray ListeningBlackboardKeyNames; // 0x200(0x10)
		unsigned char UnknownData17_7[0x18]; // 0x210(0x18) UNKNOWN PROPERTY
		...
		void TaskEvaluate(UBehaviorTreeComponent OwnerComp); // Flags: Event|Protected|BlueprintEvent 0x7FF4149C2678
		void OnExit(UBehaviorTreeComponent OwnerComp); // Flags: Event|Protected|BlueprintEvent 0x7FF4149C2598
		void OnEnter(UBehaviorTreeComponent OwnerComp); // Flags: Event|Protected|BlueprintEvent 0x7FF4149C24B8
		void OnBlackboardKeyValueChanged(UBehaviorTreeComponent OwnerComp, FName ChangedKeyName); // Flags: Event|Protected|BlueprintEvent 0x7FF4149C23D8
		float GetTime(UBehaviorTreeComponent OwnerComp); // Flags: Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 0x7FF4149C22F8
		bool EvaluateStartingConditions(UBehaviorTreeComponent OwnerComp); // Flags: Native|Event|Protected|BlueprintEvent 0x7FF4149C2218
		bool EvaluateOngoingConditions(UBehaviorTreeComponent OwnerComp); // Flags: Native|Event|Protected|BlueprintEvent 0x7FF4149C2138
		void AddTimeout(float TimeoutLength, float TimeoutLengthVariation); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF4149C2058
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0xCA(0x6) UNKNOWN PROPERTY
		FScalableFloat DelayAfterPhase; // 0xD0(0x28)
		FScalableFloat RandomDeviationAfterPhase; // 0xF8(0x28)
		unsigned char UnknownData03_7[0x28]; // 0x120(0x28) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x10]; // 0x1C0(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0xC]; // 0xAC(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		TArray RequiredAttitudes; // 0x100(0x10)
		...
		unsigned char UnknownData07_7[0xE8]; // 0x160(0xE8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x8]; // 0xB0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x2]; // 0xBE(0x2) UNKNOWN PROPERTY
		...
		TArray ExecutionStatusesToCheckForAllowToAvoidGoingToSOKeyNames; // 0x120(0x10)
		unsigned char UnknownData06_6[0x10]; // 0x130(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x10]; // 0x158(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x7C(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0xC]; // 0x88(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte InteractionBeingAttempted; // 0x138(0x1)
	...
	public:
		...
		unsigned char UnknownData05_7[0x4]; // 0x84(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x14]; // 0x98(0x14) UNKNOWN PROPERTY
		...
		void ManageWeaponTargeting(UBehaviorTreeComponent OwnerComp); // Flags: Final|Native|Protected|Const 0x7FF4149C2758
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0xD1(0xF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_7[0x7]; // 0x89(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		void OnStopSliding(AFortPlayerPawn Pawn); // Flags: Final|Native|Private 0x7FF4149C2838
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0x40]; // 0x70(0x40) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xB]; // 0x95(0xB) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x138(0x4) UNKNOWN PROPERTY
		bool bAllowRestartOnPartialSuccess : 1; // 0x13C:0(0x1)
		bool bAllowPartialPathToUncompleteNavigationArea : 1; // 0x13C:1(0x1)
		unsigned char UnknownData03_7[0x3]; // 0x13D(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x144(0x2) UNKNOWN PROPERTY
		bool bAllowRandomWobble : 1; // 0x146:0(0x1)
		unsigned char UnknownData04_5[0x1]; // 0x147(0x1) UNKNOWN PROPERTY
		FValueOrBBKey_Bool AllowRandomWobble; // 0x148(0xC)
		bool bIsUrgentMovement : 1; // 0x154:0(0x1)
		unsigned char UnknownData05_5[0x3]; // 0x155(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x20]; // 0xC8(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x74(0x2) UNKNOWN PROPERTY
		bool bResetEvaluatorStatusKeyOnFinish; // 0x76(0x1)
		unsigned char UnknownData03_7[0x1]; // 0x77(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		void BP_OnHasEscalateTarget(AFortPlayerPawn OwnerActor, AFortPlayerPawn EscalateTarget); // Flags: Event|Protected|BlueprintEvent|Const 0x7FF4149C29F8
		void BP_OnEscalate(AFortPlayerPawn OwnerActor, AFortPlayerPawn EscalateTarget); // Flags: Event|Protected|BlueprintEvent|Const 0x7FF4149C2918
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x8]; // 0xE0(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x74(0x4) UNKNOWN PROPERTY
		TArray BespokeEmotes; // 0x78(0x10)
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0xC4(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x78(0x4) UNKNOWN PROPERTY
		FName SmartObjectDestinationRotationKeyName; // 0x7C(0x4)
		unsigned char UnknownData04_6[0x2]; // 0x80(0x2) UNKNOWN PROPERTY
		bool bHandleAbortWithSoftDisable; // 0x82(0x1)
		unsigned char UnknownData05_7[0x15]; // 0x83(0x15) UNKNOWN PROPERTY
	...
	public:
		...
		void OnZiplineStateChanged(bool bIsZiplining, AFortPlayerPawn FortPlayerPawn); // Flags: Final|Native|Public 0x7FF4149C2AD8
	};
	...
	public:
		...
		unsigned char UnknownData07_6[0x4]; // 0x3AC(0x4) UNKNOWN PROPERTY
		FName EncampmentMovementStateKeyName; // 0x3B0(0x4)
		unsigned char UnknownData08_6[0x4]; // 0x3B4(0x4) UNKNOWN PROPERTY
		FName EncampmentCenterLocationKeyName; // 0x3B8(0x4)
		unsigned char UnknownData09_6[0x4]; // 0x3BC(0x4) UNKNOWN PROPERTY
		FName EncampmentDestinationKeyName; // 0x3C0(0x4)
		unsigned char UnknownData10_6[0x4]; // 0x3C4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_6[0x4]; // 0x3D4(0x4) UNKNOWN PROPERTY
		FName DefensiveBuildName; // 0x3D8(0x4)
		unsigned char UnknownData13_7[0x6C]; // 0x3DC(0x6C) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x18]; // 0x1C0(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x4]; // 0x294(0x4) UNKNOWN PROPERTY
		FName FollowSquadLeaderMovementStateKeyName; // 0x298(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x29C(0x4) UNKNOWN PROPERTY
		FName FollowSquadLeaderDestinationKeyName; // 0x2A0(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x2A4(0x4) UNKNOWN PROPERTY
		FName TooFarFromLeaderKeyName; // 0x2A8(0x4)
		unsigned char UnknownData08_6[0x4]; // 0x2AC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x4]; // 0x2EC(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x1BE(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x10]; // 0x1BC(0x10) UNKNOWN PROPERTY
		float DistanceToTestPoint; // 0x1CC(0x4)
		bool bCanDisablePatrolling; // 0x1D0(0x1)
		bool bCanReenablePatrolling; // 0x1D1(0x1)
		unsigned char UnknownData05_6[0x2]; // 0x1D2(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x6]; // 0x1DA(0x6) UNKNOWN PROPERTY
		UFortAthenaNpcPatrollingComponent CachedNpcPatrollingComponent; // 0x1E0(0x8)
		unsigned char UnknownData07_7[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x5]; // 0x83(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData08_6[0x4]; // 0x5C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x3]; // 0xCD(0x3) UNKNOWN PROPERTY
		float DelayBetweenLoops; // 0xD0(0x4)
		float RandomDeviationBetweenLoops; // 0xD4(0x4)
		TArray WarpTargets; // 0xD8(0x10)
		bool bFindAnimSetBasedOnWarpTargets; // 0xE8(0x1)
		unsigned char UnknownData11_7[0x17]; // 0xE9(0x17) UNKNOWN PROPERTY
		...
		void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Flags: Final|Native|Public|HasOutParms 0x7FF4149C2C98
		void OnMontageEnded(UAnimMontage EndedMontage, bool bInterrupted); // Flags: Final|Native|Public 0x7FF4149C2BB8
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x3]; // 0x89(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x42]; // 0x96(0x42) UNKNOWN PROPERTY
		...
		void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Flags: Final|Native|Private|HasOutParms 0x7FF4149C2E58
		void OnMontageEnded(UAnimMontage EndedMontage, bool bInterrupted); // Flags: Final|Native|Private 0x7FF4149C2D78
	};
	...
	public:
		...
		unsigned char UnknownData07_6[0x7]; // 0x71(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x3]; // 0x91(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_7[0x1B]; // 0xA5(0x1B) UNKNOWN PROPERTY
		...
		void HandleNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload); // Flags: Final|Native|Private|HasOutParms 0x7FF4149C3018
		void HandleMontageEnded(UAnimMontage EndedMontage, bool bInterrupted); // Flags: Final|Native|Private 0x7FF4149C2F38
	};
	...
	public:
		...
		void HandleWorldStateChanged(); // Flags: Final|Native|Private 0x7FF4149C30F8
	};
