...
namespace SDK
{
	...
	public:
		...
		TArray Destinations; // 0x68(0x10)
		TArray Sources; // 0x78(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0xE(0x2) UNKNOWN PROPERTY
		TArray Payload; // 0x10(0x10)
	};
	...
	public:
		...
		TArray Payload; // 0x10(0x10)
		TArray NodeIds; // 0x20(0x10)
		TArray Hashes; // 0x30(0x10)
	};
