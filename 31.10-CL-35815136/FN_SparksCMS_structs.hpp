...
namespace SDK
{
	...
	public:
		...
		TArray<FString> Channels; // 0x10(0x10)
		TArray<float> Vols; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<FSparksSongQuicksilverTrack> Tracks; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<ESparksGenre> Genre; // 0x50(0x10)
		...
		TArray<char> MidiData; // 0xE8(0x10)
		FString LipSyncUrl; // 0xF8(0x10)
		TArray<char> LipSyncData; // 0x108(0x10)
		...
		unsigned char UnknownData03_7[0x7]; // 0x189(0x7) UNKNOWN PROPERTY
	};
