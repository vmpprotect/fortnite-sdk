...
namespace SDK
{
	...
	public:
		...
		TArray VoteSelections; // 0x18(0x10)
	};
	...
	public:
		...
		TArray VoteSettingsList; // 0x18(0x10)
	...
	public:
		...
		TArray VoteSelectionResults; // 0x110(0x10)
	};
	...
	public:
		...
		FName VoteSessionId; // 0x18(0x4)
		FName VoteId; // 0x1C(0x4)
		TArray VoteSelectionIds; // 0x20(0x10)
	...
	public:
		UWorld WorldRef; // 0x108(0x8)
		TArray VotingResults; // 0x110(0x10)
	};
	...
	public:
		UWorld WorldRef; // 0x108(0x8)
		TArray VotingSessions; // 0x110(0x10)
	};
