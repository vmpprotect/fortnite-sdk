...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData04_5[0x3]; // 0x49(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr ActorToTrack; // 0x0(0x20)
	...
	public:
		...
		unsigned char UnknownData04_6[0x18]; // 0x8(0x18) UNKNOWN PROPERTY
		TWeakObjectPtr ActorToTrack; // 0x20(0x20)
