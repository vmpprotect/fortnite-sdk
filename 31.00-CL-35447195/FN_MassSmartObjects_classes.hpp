...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0x64C]; // 0xC4(0x64C) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x338]; // 0xD8(0x338) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x640]; // 0x4A0(0x640) UNKNOWN PROPERTY
	...
	public:
		...
		TArray SmartObjectAnnotationDataArray; // 0x548(0x10)
		FZoneGraphTag BehaviorTag; // 0x558(0x1)
		unsigned char UnknownData04_6[0x7]; // 0x559(0x7) UNKNOWN PROPERTY
