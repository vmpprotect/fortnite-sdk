...
namespace SDK
{
	...
	{
	public:
		TArray VariableDefinitions; // 0x0(0x10)
	};
	...
	public:
		...
		TEnumAsByte InitialOffset; // 0x8(0x1)
	...
	public:
		...
		bool bLoop; // 0x18(0x1)
		unsigned char UnknownData07_6[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
		int32_t StartOffset; // 0x1C(0x4)
		bool bRandomStartTime; // 0x20(0x1)
		unsigned char UnknownData08_6[0x3]; // 0x21(0x3) UNKNOWN PROPERTY
		float DurationOverride; // 0x24(0x4)
		ECameraAnimationPlaySpace Playspace; // 0x28(0x1)
		unsigned char UnknownData09_6[0x7]; // 0x29(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte AspectRatioAxisConstraint; // 0x5D(0x1)
		unsigned char UnknownData01_7[0x12]; // 0x5E(0x12) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray InterfaceParameters; // 0x10(0x10)
	};
	...
	{
	public:
		TArray ActiveCameraRigs; // 0x0(0x10)
	};
