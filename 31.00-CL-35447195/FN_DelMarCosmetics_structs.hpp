...
namespace SDK
{
	...
	{
	public:
		TArray OverrideFloatParameters; // 0x0(0x10)
		TArray OverrideVectorParameters; // 0x10(0x10)
		TArray OverrideTextureParameters; // 0x20(0x10)
	};
	...
	public:
		...
		TArray OverrideBoolParameters; // 0x8(0x10)
		TArray OverrideIntParameters; // 0x18(0x10)
		TArray OverrideFloatParameters; // 0x28(0x10)
		TArray OverrideVectorParameters; // 0x38(0x10)
		TArray OverrideColorParameters; // 0x48(0x10)
		TArray OverrideTextureParameters; // 0x58(0x10)
		TArray OverrideMaterialsParameters; // 0x68(0x10)
		TArray OverrideStaticMeshParameters; // 0x78(0x10)
		TArray OverrideActorParameters; // 0x88(0x10)
	};
	...
	{
	public:
		TArray MaterialOverrides; // 0x0(0x10)
		TArray NiagaraOverrides; // 0x10(0x10)
	};
	...
	public:
		...
		TArray CharacterVariantChannels; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData12_6[0x2]; // 0x2(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_6[0x3]; // 0x2D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_6[0x2]; // 0x5A(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData15_6[0x2]; // 0x7A(0x2) UNKNOWN PROPERTY
		float OversteerAccumulationPercentage; // 0x7C(0x4)
		bool bStartlineBoostActive; // 0x80(0x1)
		bool bFailedStartlineBoost; // 0x81(0x1)
		unsigned char UnknownData16_6[0x2]; // 0x82(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData17_6[0x3]; // 0x99(0x3) UNKNOWN PROPERTY
		float NumCurrentCharges; // 0x9C(0x4)
		float NumMaxCharges; // 0xA0(0x4)
		EDelMarTurboZoneState BonusZoneState; // 0xA4(0x1)
		unsigned char UnknownData18_6[0x3]; // 0xA5(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData19_6[0x1]; // 0xBF(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData20_6[0x3]; // 0xCD(0x3) UNKNOWN PROPERTY
		FVector ReattachmentDirection; // 0xD0(0x18)
		bool bUnderthrustActive; // 0xE8(0x1)
		unsigned char UnknownData21_6[0x3]; // 0xE9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData22_6[0x1]; // 0xF7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData23_7[0x7]; // 0x101(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray CustomizationInfo; // 0x8(0x10)
	};
