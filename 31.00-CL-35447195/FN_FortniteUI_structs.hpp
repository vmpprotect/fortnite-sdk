...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr Texture; // 0x0(0x20)
		TWeakObjectPtr Material; // 0x20(0x20)
		TWeakObjectPtr PreBlurMaterial; // 0x40(0x20)
		TArray SpawnFXList; // 0x60(0x10)
		TArray SpawnActorList; // 0x70(0x10)
		TArray CameraPositionOverrideList; // 0x80(0x10)
	...
	public:
		...
		TWeakObjectPtr NiagaraFX; // 0x60(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
		FVector IndicatorRelativeLocation; // 0x8(0x18)
		EFortBuildingHealthDisplayRule HealthDisplayRule; // 0x20(0x1)
		unsigned char UnknownData07_6[0x3]; // 0x21(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x1]; // 0x2B(0x1) UNKNOWN PROPERTY
		float AttachedTrapMaxDurability; // 0x2C(0x4)
		EFortBuildingInteraction InteractionType; // 0x30(0x1)
		unsigned char UnknownData09_6[0x3]; // 0x31(0x3) UNKNOWN PROPERTY
		int32_t InteractionCost; // 0x34(0x4)
		TEnumAsByte BuildingMaterial; // 0x38(0x1)
		unsigned char UnknownData10_6[0x3]; // 0x39(0x3) UNKNOWN PROPERTY
		FName QuickEditClass; // 0x3C(0x4)
		bool bIsPlayerBuilt; // 0x40(0x1)
		unsigned char UnknownData11_7[0x7]; // 0x41(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr TabIcon; // 0x10(0x20)
	...
	public:
		...
		unsigned char UnknownData02_6[0xA]; // 0x6(0xA) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr IconResource; // 0xC0(0x20)
		FFortPrioritizedWidgetData PriorityData; // 0xE0(0x2)
		unsigned char UnknownData01_7[0x6]; // 0xE2(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte ModifierType; // 0x3C(0x1)
	...
	public:
		...
		unsigned char UnknownData01_7[0x14]; // 0x204(0x14) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x54]; // 0x34(0x54) UNKNOWN PROPERTY
		bool bHasEtherealBackground; // 0x88(0x1)
		unsigned char UnknownData06_6[0xF]; // 0x89(0xF) UNKNOWN PROPERTY
		TArray VariantOverrides; // 0x98(0x10)
		UFortItem SourceItemInstance; // 0xA8(0x8)
		unsigned char UnknownData07_7[0x18]; // 0xB0(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x37C]; // 0x4(0x37C) UNKNOWN PROPERTY
		TArray SettingRootList; // 0x380(0x10)
		TArray SettingWhiteList; // 0x390(0x10)
	};
	...
	public:
		...
		TArray MaterialScalarAnimations; // 0x28(0x10)
		unsigned char UnknownData06_6[0x14]; // 0x38(0x14) UNKNOWN PROPERTY
		TWeakObjectPtr WeakWorld; // 0x4C(0x8)
		unsigned char UnknownData07_7[0x34]; // 0x54(0x34) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x13]; // 0x4D(0x13) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray StaticStorefrontNames; // 0x0(0x10)
		TArray DynamicStorefrontNames; // 0x10(0x10)
		...
		TWeakObjectPtr StaticReloadMtxScreenClass; // 0x40(0x20)
		TWeakObjectPtr DynamicReloadMtxScreenClass; // 0x60(0x20)
	};
	...
	{
	public:
		TArray ItemDefinitionsToRemove; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr CreativeContentBrowserTabClass; // 0x10(0x20)
	...
	public:
		...
		TWeakObjectPtr ActorPtr; // 0x38(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr CustomRatingTextStyle; // 0x100(0x20)
	...
	public:
		...
		TWeakObjectPtr PersonnelPowerRatingTextStyle; // 0x1E0(0x20)
		FSlateBrush SchematicPowerRatingIconBrush; // 0x200(0xB0)
		TWeakObjectPtr SchematicPowerRatingTextStyle; // 0x2B0(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr PowerRatingTextStyle; // 0x1E0(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TWeakObjectPtr TextStyle; // 0x8(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr ItemNameTextStyle; // 0x3B0(0x20)
		...
		unsigned char UnknownData04_6[0x4]; // 0x3F4(0x4) UNKNOWN PROPERTY
		...
		TWeakObjectPtr RarityNameTextStyle; // 0x430(0x20)
		float ClassIconImageLeftPadding; // 0x450(0x4)
		unsigned char UnknownData05_6[0x4]; // 0x454(0x4) UNKNOWN PROPERTY
		FVector2D ClassIconSize; // 0x458(0x10)
		float PaddingBetweenClassIconAndName; // 0x468(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x46C(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr ClassNameTextStyle; // 0x470(0x20)
		float TierMeterLeftPadding; // 0x490(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x494(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x27C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x4]; // 0x2CC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x434(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x2B4(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray EquipSlotIndices; // 0x0(0x10)
	};
	...
	public:
		...
		TArray QueriedIconComponents; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray QueriedVisibilityComponents; // 0x8(0x10)
	};
	...
	public:
		FGameplayTagContainer Tags; // 0x0(0x20)
		ETagComparisonType ComparisonType; // 0x20(0x1)
		TEnumAsByte InteractionType; // 0x21(0x1)
	...
	public:
		...
		TEnumAsByte InteractionType; // 0x2(0x1)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x2]; // 0x86(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray TextReplacementValues; // 0x10(0x10)
	};
	...
	public:
		...
		TArray ConditionInfo; // 0x30(0x10)
		TArray ChildConditions; // 0x40(0x10)
	};
	...
	public:
		...
		TArray SurveyTags; // 0x10(0x10)
		FString Title; // 0x20(0x10)
		TArray ConditionGroupIDs; // 0x30(0x10)
		TArray Conditions; // 0x40(0x10)
		TArray Questions; // 0x50(0x10)
		TArray TextReplacementOverrides; // 0x60(0x10)
	...
	{
	public:
		TArray ConditionGroups; // 0x0(0x10)
		TArray FrequentlyAskedQuestions; // 0x10(0x10)
		TArray CustomTextReplacements; // 0x20(0x10)
		TArray WhitelistedTextReplacements; // 0x30(0x10)
		TArray Surveys; // 0x40(0x10)
	...
	{
	public:
		TWeakObjectPtr TargetClass; // 0x0(0x20)
		TArray Decorators; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x1F]; // 0x1(0x1F) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr TabScreenClass; // 0x0(0x20)
	...
	public:
		...
		unsigned char UnknownData07_6[0x4]; // 0x19C(0x4) UNKNOWN PROPERTY
		UClass OverrideTabWidget; // 0x1A0(0x8)
		TArray PersistentTabObjects; // 0x1A8(0x10)
		bool bIsDynamicTab; // 0x1B8(0x1)
		EFortTopBarTabButtonGroup ButtonGroup; // 0x1B9(0x1)
		unsigned char UnknownData08_6[0x6]; // 0x1BA(0x6) UNKNOWN PROPERTY
		UClass ViewModel; // 0x1C0(0x8)
		unsigned char UnknownData09_7[0x8]; // 0x1C8(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray DisabledTabNames; // 0x0(0x10)
		TArray HiddenTabNames; // 0x10(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr FrontendExperienceFlowClass; // 0x10(0x20)
	};
	...
	public:
		...
		TArray Descriptions; // 0x30(0x10)
		TArray PreviewImages; // 0x40(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr Image; // 0x20(0x20)
	...
	{
	public:
		TWeakObjectPtr MatchmakingWidgetClass; // 0x0(0x20)
		TWeakObjectPtr MatchmakingWidgetOverrideClass; // 0x20(0x20)
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x18]; // 0x48(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray DisplayConditions; // 0x8(0x10)
	...
	public:
		...
		TArray OptionalAdditionalStyleDefinitions; // 0x8(0x10)
	...
	public:
		...
		TArray Styles; // 0x8(0x10)
		TArray CharacterPrerequisites; // 0x18(0x10)
	...
	public:
		UInputAction InputAction; // 0x0(0x8)
		TArray InputModifiers; // 0x8(0x10)
		TArray InputTriggers; // 0x18(0x10)
	...
	{
	public:
		TArray ActionContexts; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData07_6[0x1]; // 0x17(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x1]; // 0x2F(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x2]; // 0x56(0x2) UNKNOWN PROPERTY
		USoundMix SoundMixOverride; // 0x58(0x8)
		bool bOverrideSoundMix; // 0x60(0x1)
		unsigned char UnknownData10_6[0x7]; // 0x61(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_6[0x1]; // 0x73(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_6[0x2]; // 0x7E(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_7[0x5]; // 0x93(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		FText TabTitle; // 0x0(0x10)
		TWeakObjectPtr TabIcon; // 0x10(0x20)
		TWeakObjectPtr TabClass; // 0x30(0x20)
	...
	{
	public:
		unsigned char UnknownData01_1[0x8]; // 0x10(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		FMargin Padding; // 0x0(0x10)
		TEnumAsByte HorizontalAlignment; // 0x10(0x1)
		TEnumAsByte VerticalAlignment; // 0x11(0x1)
	...
	{
	public:
		TWeakObjectPtr QuestItem; // 0x0(0x8)
	...
	public:
		...
		TWeakObjectPtr FlameDisplayObject; // 0x28(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr MainIconTexture; // 0x30(0x20)
	};
	...
	{
	public:
		TArray PortraitIndexArray; // 0x0(0x10)
	};
	...
	{
	public:
		TArray SafezoneStateText; // 0x0(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x2]; // 0x16(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x1]; // 0x13(0x1) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr CategoryData; // 0x0(0x8)
	};
	...
	public:
		...
		TWeakObjectPtr Ribbon; // 0x20(0x20)
	...
	public:
		...
		TArray CustomPropertyModels; // 0x38(0x10)
	};
	...
	public:
		FGameplayTag HUDWidgetBehaviorTag; // 0x0(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray HUDWidgetBehaviorExtensions; // 0x8(0x10)
	};
	...
	public:
		...
		TArray WidgetEntriesToAdd; // 0x10(0x10)
		TArray BehaviorEntriesToAdd; // 0x20(0x10)
		TArray BehaviorExtensionEntriesToAdd; // 0x30(0x10)
		TArray WidgetEntriesToRemove; // 0x40(0x10)
		TArray BehaviorEntriesToRemove; // 0x50(0x10)
		TArray BehaviorExtensionEntriesToRemove; // 0x60(0x10)
	...
	{
	public:
		TWeakObjectPtr IconOverride; // 0x0(0x20)
	...
	public:
		...
		TArray ContextLayouts; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x14]; // 0x44(0x14) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray InfoModalEntries; // 0x0(0x10)
	...
	{
	public:
		TArray CrewPackItems; // 0x68(0x10)
		...
		TArray NextCrewPackItems; // 0xC8(0x10)
	};
	...
	public:
		...
		TArray ValidPlatformAndCountriesPairs; // 0x10(0x10)
		...
		TArray PlatformSpecificBodyTables; // 0x78(0x10)
	...
	{
	public:
		TArray CancellationInfoErrorStateModals; // 0x0(0x10)
		TArray PlatformAndCountriesNotificationModals; // 0x10(0x10)
	};
	...
	public:
		...
		TArray Images; // 0x30(0x10)
		TArray TileImages; // 0x40(0x10)
		...
		unsigned char UnknownData05_7[0x56]; // 0x8A(0x56) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x18]; // 0xE0(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x20]; // 0xE0(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x28]; // 0xE0(0x28) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x30]; // 0xE0(0x30) UNKNOWN PROPERTY
	};
	...
	public:
		FString Title; // 0x0(0x10)
		FString Body; // 0x10(0x10)
		unsigned char UnknownData01_7[0x20]; // 0x20(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray ErrorCodeMessageList; // 0x0(0x10)
	};
	...
	{
	public:
		TArray CompressedImage; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData05_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		...
		TWeakObjectPtr RegionThemeIcon; // 0x78(0x20)
		FText DifficultyName; // 0x98(0x10)
		TArray MissionRewards; // 0xA8(0x10)
		FTimespan AvailableTime; // 0xB8(0x8)
		ERatingsEnforcementType RatingsEnforcement; // 0xC0(0x1)
		unsigned char UnknownData07_6[0x3]; // 0xC1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x3]; // 0xD5(0x3) UNKNOWN PROPERTY
		...
		TArray GameplayModifiers; // 0x108(0x10)
		TArray Objectives; // 0x118(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xE]; // 0x462(0xE) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr ActorPtr; // 0x8(0x20)
		FString DisplayName; // 0x28(0x10)
		TArray OutgoingEvents; // 0x38(0x10)
		TArray CalledFunctions; // 0x48(0x10)
	...
	public:
		...
		TWeakObjectPtr ActorPtr; // 0x18(0x20)
	};
	...
	{
	public:
		TArray ItemDefinitionsToAdd; // 0x0(0x10)
	};
	...
	public:
		unsigned char UnknownData02_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TArray CachedDataProviders; // 0x8(0x10)
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray ItemOptionData; // 0x10(0x10)
	};
	...
	public:
		...
		TEnumAsByte HorizontalAlignment; // 0x18(0x1)
		TEnumAsByte VerticalAlignment; // 0x19(0x1)
	...
	public:
		FText Label; // 0x0(0x10)
		FSlateBrush Brush; // 0x10(0xB0)
		TWeakObjectPtr SoftIcon; // 0xC0(0x20)
	};
	...
	{
	public:
		TEnumAsByte BuildingType; // 0xE0(0x1)
		unsigned char UnknownData01_7[0xF]; // 0xE1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0xF1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte BuildingAttachmentType; // 0xF0(0x1)
		unsigned char UnknownData01_7[0xF]; // 0xF1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x2F1(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr PlayerState; // 0x4(0x8)
	...
	public:
		...
		unsigned char UnknownData05_6[0x7]; // 0xD1(0x7) UNKNOWN PROPERTY
		UCommonActivatableWidget TabWidget; // 0xD8(0x8)
		TWeakObjectPtr ExternalTabWidget; // 0xE0(0x20)
		...
		unsigned char UnknownData07_7[0x3]; // 0x11D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x6]; // 0x22(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		unsigned char UnknownData01_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TArray OriginalMaterials; // 0x8(0x10)
	};
	...
	{
	public:
		TArray PlatformPrefixIcons; // 0x0(0x10)
	};
	...
	{
	public:
		TArray CategoryEntryList; // 0x0(0x10)
	};
	...
	public:
		...
		TArray LegendEntryTextures; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x88]; // 0x10(0x88) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray GiftBoxCurrencyData; // 0x0(0x10)
	};
	...
	{
	public:
		TArray ItemTypeFilters; // 0x0(0x10)
		unsigned char UnknownData02_6[0x40]; // 0x10(0x40) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x5]; // 0x3B(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		TArray AssociatedDetailsAttributes; // 0x10(0x10)
	};
	...
	{
	public:
		TArray TextureMetadata; // 0x0(0x10)
		TArray TextMetadata; // 0x10(0x10)
		TArray StringMetadata; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray OfferGroups; // 0x8(0x10)
		FFortItemShopCMSBackground Background; // 0x18(0x20)
		TArray StackRanks; // 0x38(0x10)
		unsigned char UnknownData03_6[0x10]; // 0x48(0x10) UNKNOWN PROPERTY
		TArray Subsections; // 0x58(0x10)
	};
	...
	public:
		FString VisualId; // 0x0(0x10)
		TArray Presentations; // 0x10(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr WidgetClass; // 0x10(0x20)
	};
	...
	public:
		...
		TArray Characters; // 0x10(0x10)
		TArray AdditionalRewards; // 0x20(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0xD0]; // 0x0(0xD0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray ConsoleCommands; // 0x30(0x10)
	};
	...
	{
	public:
		TArray RewardTokens; // 0x0(0x10)
		unsigned char UnknownData03_6[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
		FText OverrideName; // 0x20(0x10)
		TWeakObjectPtr TileMaterial; // 0x30(0x20)
		bool bHidden; // 0x50(0x1)
		bool bAllowPreviewStyles; // 0x51(0x1)
		bool bIsLocked; // 0x52(0x1)
		unsigned char UnknownData04_6[0x1]; // 0x53(0x1) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ThresholdEntries; // 0x0(0x10)
		unsigned char UnknownData01_7[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr HighlightWidgetOverride; // 0x18(0x20)
	...
	public:
		...
		TArray KeybindWidget_NameArray; // 0xA8(0x10)
		TArray KeybindWidget_GamepadNameArray; // 0xB8(0x10)
		bool ForceSingleInputKeybind; // 0xC8(0x1)
		unsigned char UnknownData04_6[0x7]; // 0xC9(0x7) UNKNOWN PROPERTY
		TArray HighlightInfo; // 0xD0(0x10)
		...
		unsigned char UnknownData05_7[0x5]; // 0xE3(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray StepScreenInfo; // 0x8(0x10)
	};
	...
	{
	public:
		TArray StepScreenInfo; // 0x0(0x10)
	};
	...
	public:
		FText DisplayName; // 0x0(0x10)
		TWeakObjectPtr IconTexture; // 0x10(0x20)
	...
	public:
		unsigned char UnknownData01_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TWeakObjectPtr UIManagerClass; // 0x8(0x20)
	};
	...
	{
	public:
		TWeakObjectPtr LocalPlayer; // 0x0(0x8)
	...
	public:
		...
		TScriptInterface Manager; // 0x8(0x10)
	};
