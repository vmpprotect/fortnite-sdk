...
namespace SDK
{
	...
	public:
		...
		TMap<FString, FString> Modules; // 0x20(0x50)
	};
	...
	public:
		...
		TArray<FString> EditorPermissions; // 0x70(0x10)
		...
		TArray<FValkyriePluginReferenceDescriptor> Plugins; // 0xA8(0x10)
		TMap<FString, FJsonObjectWrapper> DataSets; // 0xB8(0x50)
		TArray<FValkyrieProjectReferenceDescriptor> Dependencies; // 0x108(0x10)
		unsigned char UnknownData03_6[0xC8]; // 0x118(0xC8) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FName> References; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FVkArtifactOption> Artifacts; // 0x18(0x10)
	};
	...
	public:
		...
		TMap<EConsumerRole, bool> Relevance; // 0x68(0x50)
	...
	public:
		...
		TMap<FString, int32_t> Resolutions; // 0x18(0x50)
	};
	...
	public:
		FString ProjectID; // 0x0(0x10)
		TMap<FString, FString> ProjectFlags; // 0x10(0x50)
		TArray<FVkModuleVersionWithArtifacts> Content; // 0x60(0x10)
	...
	{
	public:
		TArray<FString> References; // 0x0(0x10)
	};
	...
	public:
		...
		TMap<FString, FVkModuleImports> Imports; // 0x10(0x50)
	};
	...
	public:
		...
		TArray<FString> Files; // 0x20(0x10)
		...
		TArray<FVkInstallMetadata> InstallMetadata; // 0x50(0x10)
	};
	...
	public:
		FString ProjectID; // 0x0(0x10)
		TArray<FVkResolvedModule> Content; // 0x10(0x10)
	...
	public:
		...
		TArray<FVkCookedModuleUpdate> Modules; // 0x70(0x10)
	};
	...
	{
	public:
		TMap<FString, FVkFileSize> FileSizeMap; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<FVkExtendedErrorParam> Params; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<FVkExtendedError> AdditionalErrors; // 0x20(0x10)
	};
	...
	{
	public:
		TArray<FVkResolvedModule> Content; // 0x0(0x10)
	};
	...
	public:
		...
		TMap<FString, bool> Access; // 0x38(0x50)
		TArray<FString> Permissions; // 0x88(0x10)
	};
	...
	public:
		...
		TArray<FString> GameFeaturesets; // 0x40(0x10)
	};
	...
	public:
		...
		TMap<EConsumerRole, bool> Relevance; // 0x40(0x50)
	...
	{
	public:
		TMap<FString, FString> RawFiles; // 0x0(0x50)
		TArray<FVkModuleVersionDependency> Dependencies; // 0x50(0x10)
		TArray<FString> StaticDependencies; // 0x60(0x10)
		FJsonObjectWrapper Meta; // 0x70(0x20)
		FString Checksum; // 0x90(0x10)
		FString ManifestLink; // 0xA0(0x10)
		TArray<FString> GameFeaturesets; // 0xB0(0x10)
	};
	...
	public:
		...
		TArray<FVkVersionedLinkCode> Palette; // 0x68(0x10)
	...
	public:
		...
		TArray<FVkVersionedLinkCode> Palette; // 0xA8(0x10)
	...
	public:
		FString Name; // 0x0(0x10)
		TMap<FString, bool> Access; // 0x10(0x50)
	...
	public:
		...
		TArray<FVkTeamAuthorizedEmailDomain> EmailDomains; // 0x20(0x10)
	};
	...
	public:
		...
		TMap<FString, FVkProjectAccessControl> Playtesters; // 0x30(0x50)
	};
	...
	public:
		...
		TMap<FString, FString> DeltaFileLinks; // 0x10(0x50)
	};
	...
	public:
		...
		TMap<FString, float> Stat; // 0x20(0x50)
	};
	...
	public:
		...
		TMap<FString, float> Stat; // 0x30(0x50)
	};
	...
	public:
		...
		TArray<FVkProfileBuildResult_Client> Clients; // 0x98(0x10)
	};
	...
	public:
		...
		TMap<FString, int32_t> Public_Modules; // 0x38(0x50)
	};
	...
	{
	public:
		TMap<FString, FString> _validation_flags; // 0x0(0x50)
	};
