...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<EBoneModificationMode> TranslationMode; // 0x120(0x1)
		TEnumAsByte<EBoneModificationMode> RotationMode; // 0x121(0x1)
		TEnumAsByte<EBoneModificationMode> ScaleMode; // 0x122(0x1)
		TEnumAsByte<EBoneControlSpace> TranslationSpace; // 0x123(0x1)
		TEnumAsByte<EBoneControlSpace> RotationSpace; // 0x124(0x1)
		TEnumAsByte<EBoneControlSpace> ScaleSpace; // 0x125(0x1)
	...
	public:
		...
		TEnumAsByte<EBoneAxis> RotationAxisToRefer; // 0xE4(0x1)
		bool bIsAdditive; // 0xE5(0x1)
		unsigned char UnknownData00_7[0x2]; // 0xE6(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x105(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x1C]; // 0x14(0x1C) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x28]; // 0x38(0x28) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0xC0]; // 0x70(0xC0) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x3C]; // 0x184(0x3C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EBoneControlSpace> TransformsSpace; // 0x60(0x1)
	...
	public:
		...
		unsigned char UnknownData00_7[0x28]; // 0x20(0x28) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAnimGroupRole> GroupRole; // 0x6C(0x1)
		EAnimSyncMethod Method; // 0x6D(0x1)
		bool bIgnoreForRelevancyTest; // 0x6E(0x1)
		unsigned char UnknownData00_6[0x1]; // 0x6F(0x1) UNKNOWN PROPERTY
		float X; // 0x70(0x4)
		float Y; // 0x74(0x4)
		float PlayRate; // 0x78(0x4)
		bool bLoop; // 0x7C(0x1)
		bool bResetPlayTimeWhenBlendSpaceChanges; // 0x7D(0x1)
		unsigned char UnknownData01_6[0x2]; // 0x7E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x14]; // 0x20(0x14) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr<USkeletalMeshComponent*> SourceMeshComponent; // 0x10(0x8)
		...
		unsigned char UnknownData00_5[0x1]; // 0x1B(0x1) UNKNOWN PROPERTY
		FName RootBoneToCopy; // 0x1C(0x4)
		unsigned char UnknownData01_7[0x130]; // 0x20(0x130) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TScriptInterface<Class> CurveSource; // 0x28(0x10)
	};
	...
	public:
		...
		TArray<UBlendProfile*> BlendMasks; // 0x38(0x10)
		TArray<FInputBlendPose> LayerSetup; // 0x48(0x10)
		TArray<float> BlendWeights; // 0x58(0x10)
		bool bMeshSpaceRotationBlend; // 0x68(0x1)
		bool bMeshSpaceScaleBlend; // 0x69(0x1)
		TEnumAsByte<ECurveBlendOption> CurveBlendOption; // 0x6A(0x1)
		...
		TArray<FPerBoneBlendWeight> PerBoneBlendWeights; // 0x78(0x10)
		FGuid SkeletonGuid; // 0x88(0x10)
		FGuid VirtualBoneGuid; // 0x98(0x10)
		unsigned char UnknownData03_7[0x48]; // 0xA8(0x48) UNKNOWN PROPERTY
	};
	...
	public:
		FPoseLink SourcePose; // 0x10(0x10)
		TMap<FName, float> CurveMap; // 0x20(0x50)
		TArray<float> CurveValues; // 0x70(0x10)
		TArray<FName> CurveNames; // 0x80(0x10)
		unsigned char UnknownData00_6[0x88]; // 0x90(0x88) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x60]; // 0x40(0x60) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FPoseDriverTransform> BoneTransforms; // 0x0(0x10)
		...
		unsigned char UnknownData01_6[0x8]; // 0xB4(0x8) UNKNOWN PROPERTY
		bool bIsHidden; // 0xBC(0x1)
		unsigned char UnknownData02_7[0x3]; // 0xBD(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		FPoseLink SourcePose; // 0xA0(0x10)
		TArray<FBoneReference> SourceBones; // 0xB0(0x10)
		...
		TArray<FBoneReference> OnlyDriveBones; // 0xD0(0x10)
		TArray<FPoseDriverTarget> PoseTargets; // 0xE0(0x10)
		FRBFParams RBFParams; // 0xF0(0x38)
		EPoseDriverSource DriveSource; // 0x128(0x1)
		EPoseDriverOutput DriveOutput; // 0x129(0x1)
		unsigned char UnknownData01_6[0x42]; // 0x12A(0x42) UNKNOWN PROPERTY
		int32_t LODThreshold; // 0x16C(0x4)
		unsigned char UnknownData02_7[0x30]; // 0x170(0x30) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EBoneAxis> TwistAxis; // 0xF(0x1)
	...
	public:
		...
		unsigned char UnknownData01_7[0x37]; // 0x49(0x37) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x50]; // 0x20(0x50) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x112(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x102(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ESequenceEvalReinit> ReinitializationBehavior; // 0x5E(0x1)
		unsigned char UnknownData02_6[0x1]; // 0x5F(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x23]; // 0x25(0x23) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAnimGroupRole> GroupRole; // 0x24(0x1)
	...
	public:
		...
		unsigned char UnknownBit00 : 1; // 0x31:1(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit01 : 1; // 0x31:2(0x1) UNKNOWN PROPERTY
		bool bResetChildOnActivation : 1; // 0x31:3(0x1)
		bool bAlwaysUpdateChildren : 1; // 0x31:4(0x1)
		unsigned char UnknownData02_5[0x2]; // 0x32(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x458]; // 0x798(0x458) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0x3B(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0xC0]; // 0xD0(0xC0) UNKNOWN PROPERTY
		...
		TArray<FAnimPhysBodyDefinition> PhysicsBodyDefinitions; // 0x1B8(0x10)
		...
		unsigned char UnknownData03_6[0x4]; // 0x1F4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x4]; // 0x24C(0x4) UNKNOWN PROPERTY
		TArray<FAnimPhysSphericalLimit> SphericalLimits; // 0x250(0x10)
		FVector ExternalForce; // 0x260(0x18)
		TArray<FAnimPhysPlanarLimit> PlanarLimits; // 0x278(0x10)
		AnimPhysSimSpaceType SimulationSpace; // 0x288(0x1)
		unsigned char UnknownData05_6[0x2]; // 0x289(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownBit06 : 1; // 0x28C:0(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_5[0x3]; // 0x28D(0x3) UNKNOWN PROPERTY
		FRotationRetargetingInfo RetargetingSettings; // 0x290(0x1A0)
		unsigned char UnknownData08_7[0xE0]; // 0x430(0xE0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EComponentType> SourceComponent; // 0x11A(0x1)
		...
		unsigned char UnknownData02_7[0x3]; // 0x11D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EBoneControlSpace> EffectorLocationSpace; // 0xE0(0x1)
		unsigned char UnknownData00_6[0xF]; // 0xE1(0xF) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x6]; // 0x192(0x6) UNKNOWN PROPERTY
		TArray<float> RotationLimitPerJoints; // 0x198(0x10)
	...
	public:
		...
		TEnumAsByte<EBoneControlSpace> ControlSpace; // 0xE3(0x1)
	...
	public:
		...
		TEnumAsByte<EBoneControlSpace> EffectorTransformSpace; // 0x1D0(0x1)
		TEnumAsByte<EBoneRotationSource> EffectorRotationSource; // 0x1D1(0x1)
	...
	public:
		...
		TArray<FBoneReference> IKBonesToMove; // 0xF8(0x10)
		FVector PerAxisAlpha; // 0x108(0x18)
		float HandFKWeight; // 0x120(0x4)
		unsigned char UnknownData00_7[0x4]; // 0x124(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAxis> FootBoneForwardAxis; // 0x20(0x1)
		TEnumAsByte<EAxis> HingeRotationAxis; // 0x21(0x1)
	...
	public:
		...
		TArray<FAnimLegIKDefinition> LegsDefinition; // 0xD8(0x10)
	...
	public:
		FBoneReference BoneToModify; // 0xC8(0xC)
		unsigned char UnknownData00_6[0xC]; // 0xD4(0xC) UNKNOWN PROPERTY
		...
		TEnumAsByte<EInterpolationBlend> InterpolationType; // 0x199(0x1)
		unsigned char UnknownData01_6[0x6]; // 0x19A(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x6C]; // 0x1CC(0x6C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EBoneControlSpace> DisplaySpace; // 0xD4(0x1)
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0xC8(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> OverlapChannel; // 0x2F8(0x1)
		...
		unsigned char UnknownData02_6[0x1]; // 0x2FC(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_5[0x2]; // 0x2FE(0x2) UNKNOWN PROPERTY
		float WorldSpaceMinimumScale; // 0x300(0x4)
		float EvaluationResetTime; // 0x304(0x4)
		unsigned char UnknownData04_6[0x1]; // 0x308(0x1) UNKNOWN PROPERTY
		ESimulationTiming SimulationTiming; // 0x309(0x1)
		unsigned char UnknownData05_7[0x666]; // 0x30A(0x666) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x17]; // 0x69(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FTransform> ControlPoints; // 0xE8(0x10)
		float Roll; // 0xF8(0x4)
		...
		unsigned char UnknownData02_7[0x118]; // 0x140(0x118) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x6C]; // 0xF8(0x6C) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x3]; // 0x165(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x68]; // 0xC8(0x68) UNKNOWN PROPERTY
		FBoneReference TrailBone; // 0x130(0xC)
		int32_t ChainLength; // 0x13C(0x4)
		TEnumAsByte<EAxis> ChainBoneAxis; // 0x140(0x1)
		...
		unsigned char UnknownData01_5[0x2]; // 0x142(0x2) UNKNOWN PROPERTY
		...
		TArray<FRotationLimit> RotationLimits; // 0x208(0x10)
		TArray<FVector> RotationOffsets; // 0x218(0x10)
		TArray<FAnimPhysPlanarLimit> PlanarLimits; // 0x228(0x10)
		...
		unsigned char UnknownData04_7[0x38]; // 0x268(0x38) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x10]; // 0x100(0x10) UNKNOWN PROPERTY
		...
		TEnumAsByte<EBoneControlSpace> EffectorLocationSpace; // 0x250(0x1)
		TEnumAsByte<EBoneControlSpace> JointTargetLocationSpace; // 0x251(0x1)
		...
		unsigned char UnknownData03_7[0xD]; // 0x253(0xD) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x58]; // 0x8(0x58) UNKNOWN PROPERTY
