...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<AActor*> Target; // 0x4(0x8)
	...
	public:
		...
		FName Tag; // 0x40(0x4)
		unsigned char UnknownData01_6[0x8]; // 0x44(0x8) UNKNOWN PROPERTY
		unsigned char UnknownBit02 : 1; // 0x4C:0(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_5[0x2]; // 0x6(0x2) UNKNOWN PROPERTY
		float Value; // 0x8(0x4)
	...
	{
	public:
		TArray<UBlackboardKeyType*> AllowedTypes; // 0x0(0x10)
	...
	{
	public:
		TWeakObjectPtr<AActor*> GoalActor; // 0x0(0x8)
		unsigned char UnknownData00_7[0x48]; // 0x8(0x48) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EEnvDirection> DirMode; // 0x18(0x1)
	...
	public:
		...
		TEnumAsByte<ETraceTypeQuery> TraceChannel; // 0x28(0x1)
		TEnumAsByte<ECollisionChannel> SerializedChannel; // 0x29(0x1)
		unsigned char UnknownData01_6[0x2]; // 0x2A(0x2) UNKNOWN PROPERTY
		FName TraceProfileName; // 0x2C(0x4)
		TEnumAsByte<EEnvTraceShape> TraceShape; // 0x30(0x1)
		TEnumAsByte<EEnvQueryTrace> TraceMode; // 0x31(0x1)
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> OverlapChannel; // 0x28(0x1)
		TEnumAsByte<EEnvOverlapShape> OverlapShape; // 0x29(0x1)
		unsigned char UnknownData01_6[0x2]; // 0x2A(0x2) UNKNOWN PROPERTY
		bool bOnlyBlockingHits : 1; // 0x2C:0(0x1)
		bool bOverlapComplex : 1; // 0x2C:1(0x1)
		bool bSkipOverlapQuerier : 1; // 0x2C:2(0x1)
		unsigned char UnknownData02_7[0x3]; // 0x2D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x14]; // 0x18(0x14) UNKNOWN PROPERTY
		int32_t OptionIndex; // 0x2C(0x4)
		int32_t QueryID; // 0x30(0x4)
		unsigned char UnknownData02_7[0xC]; // 0x34(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FAIDynamicParam> QueryConfig; // 0x8(0x10)
		FBlackboardKeySelector EQSQueryBlackboardKey; // 0x18(0x28)
		TEnumAsByte<EEnvQueryRunMode> RunMode; // 0x40(0x1)
	...
	{
	public:
		unsigned char UnknownData00_1[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<EBTDecoratorLogic> Operation; // 0x0(0x1)
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0x20(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x50]; // 0x18(0x50) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x178]; // 0x8(0x178) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xB0]; // 0x8(0xB0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FAIStimulus> LastSensedStimuli; // 0x8(0x10)
