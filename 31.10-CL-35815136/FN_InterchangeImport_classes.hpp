...
namespace SDK
{
	...
	{
	public:
		TMap<FString, FString> MetaData; // 0x28(0x50)
	...
	{
	public:
		unsigned char UnknownData00_1[0x108]; // 0x30(0x108) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x40]; // 0x38(0x40) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x258]; // 0x38(0x258) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x199(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x17D(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x155(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x225(0x3) UNKNOWN PROPERTY
