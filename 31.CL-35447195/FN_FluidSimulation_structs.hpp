...
namespace SDK
{
	...
	{
	public:
		TMap SocketsandEndpoints_6_B3EDD8FC43A7C681151F46BE0AA158C5; // 0x0(0x50)
	};
	...
	{
	public:
		TEnumAsByte ForceType_28_DDC16EE543D2DFD3BA29C49D32198C9C; // 0x0(0x1)
	...
	public:
		...
		TMap SocketLocationMap_21_ABF6AA244A5F84728A5E83BE2328C7FA; // 0xA8(0x50)
		TMap SocketVelocityMap_26_82B0E24B45935A12E1949F918A59A537; // 0xF8(0x50)
	};
