...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_6[0x8]; // 0x1288(0x8) UNKNOWN PROPERTY
		...
		void AnimGraph(FPoseLink& AnimGraph); // Flags: HasOutParms|BlueprintCallable|BlueprintEvent 0x15D49AE8900
		void BlueprintUpdateAnimation(float DeltaTimeX); // Flags: Event|Public|BlueprintEvent 0x15D49AE8700
		void ExecuteUbergraph_Rock_Vehicle_Anim(int32_t EntryPoint); // Flags: Final 0x15D49AE8500
	};
