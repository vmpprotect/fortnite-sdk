...
namespace SDK
{
	...
	public:
		...
		TArray Rotations; // 0x240(0x10)
		ERigVMAnimEasingType RotationEaseType; // 0x250(0x1)
		unsigned char UnknownData05_6[0x3]; // 0x251(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x8]; // 0x388(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray ItemTransforms; // 0x8(0x10)
		TArray ItemSegments; // 0x18(0x10)
		TArray CachedItems; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x7]; // 0x229(0x7) UNKNOWN PROPERTY
