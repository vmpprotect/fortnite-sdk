...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<ERecastPartitioning> RegionPartitioning; // 0x30(0x1)
		TEnumAsByte<ERecastPartitioning> LayerPartitioning; // 0x31(0x1)
	...
	public:
		...
		unsigned char UnknownData01_5[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_5[0x2]; // 0x1A(0x2) UNKNOWN PROPERTY
		uint16_t LinkGenerationDebugFlags; // 0x1C(0x2)
		unsigned char UnknownData04_6[0x2]; // 0x1E(0x2) UNKNOWN PROPERTY
