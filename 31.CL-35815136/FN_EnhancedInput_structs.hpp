...
namespace SDK
{
	...
	public:
		...
		TArray<UInputTrigger*> Triggers; // 0x20(0x10)
		TArray<UInputModifier*> Modifiers; // 0x30(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_5[0x6]; // 0x2A(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0xB]; // 0x8(0xB) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x20]; // 0x38(0x20) UNKNOWN PROPERTY
	...
	{
	public:
		TSet<FPlayerKeyMapping> Mappings; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<UInputTrigger*> Triggers; // 0x0(0x10)
		TArray<UInputModifier*> Modifiers; // 0x10(0x10)
	...
	{
	public:
		TWeakObjectPtr<UInputMappingContext*> InputMappingContext; // 0x0(0x20)
	...
	{
	public:
		TArray<FInjectedInput> Injected; // 0x0(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EInputEvent> InputKeyEvent; // 0x20(0x1)
