...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr<UStaticMeshComponent*> ReplacementWheelMesh; // 0x0(0x8)
	};
	...
	{
	public:
		TArray<FFortVehicleCosmeticsLevelPreviewPaintedVariant> PaintedVariants; // 0x0(0x10)
	...
	public:
		...
		TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> SlotTemplate; // 0x8(0x20)
	...
	public:
		...
		TArray<FMaterialSlotWithParameterInfo> WheelMaterialSlotInfos; // 0x50(0x10)
	...
	{
	public:
		TWeakObjectPtr<USkeleton*> WheelSkeletonReference; // 0x0(0x20)
	...
	{
	public:
		TArray<FName> WheelMaterialSlotNames; // 0x0(0x10)
	...
	public:
		TWeakObjectPtr<USkeleton*> WheelSkeletonReference; // 0x0(0x20)
		FBoneSocketTarget WheelBone; // 0x20(0x80)
		TWeakObjectPtr<UStaticMesh*> WheelReplacementMesh; // 0xA0(0x20)
		TMap<EVehicleWheelLocations, FWheelTransformInfo> WheelTransformInfos; // 0xC0(0x50)
	};
	...
	public:
		...
		TWeakObjectPtr<UPhysicsAsset*> PhysicsAssetOverride; // 0x18(0x20)
	};
	...
	public:
		FGameplayTagQuery VehicleTagQuery; // 0x0(0x48)
		TArray<TWeakObjectPtr> CosmeticAttachments; // 0x48(0x10)
	};
	...
	public:
		FGameplayTagQuery VehicleTagQuery; // 0x0(0x48)
		TWeakObjectPtr<UClass*> AnimClass; // 0x48(0x20)
	};
	...
	{
	public:
		TArray<FVehicleCosmeticsCustomizableObjectFloatInfo> FloatParameters; // 0x0(0x10)
		TArray<FVehicleCosmeticsCustomizableObjectIntInfo> IntParameters; // 0x10(0x10)
		TArray<FVehicleCosmeticsCustomizableObjectColorInfo> ColorParameters; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TMap<EVehicleWheelLocations, float> PreviewWheelTravelOffset; // 0x8(0x50)
	};
