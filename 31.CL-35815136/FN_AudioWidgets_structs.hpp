...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0x3BA(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x8]; // 0x2D8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x5F4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x8]; // 0x648(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x134(0xC) UNKNOWN PROPERTY
	};
