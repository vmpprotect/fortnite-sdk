...
namespace SDK
{
	...
	public:
		...
		TArray<FConstraintsInWorld> ConstraintsInWorld; // 0x38(0x10)
		...
		void OnConstraintRemovedFromSystem__DelegateSignature(UConstraintSubsystem* Mananger, UTickableConstraint* Constraint, bool bDoNotCompensate); // Flags: MulticastDelegate|Public|Delegate, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void OnConstraintAddedToSystem__DelegateSignature(UConstraintSubsystem* Mananger, UTickableConstraint* Constraint); // Flags: MulticastDelegate|Public|Delegate, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x66]; // 0x2A(0x66) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UTickableConstraint*> Constraints; // 0x38(0x10)
		...
		void OnConstraintRemoved__DelegateSignature(UConstraintsManager* Mananger, UTickableConstraint* Constraint, bool bDoNotCompensate); // Flags: MulticastDelegate|Public|Delegate, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void OnConstraintAdded__DelegateSignature(UConstraintsManager* Mananger, UTickableConstraint* Constraint); // Flags: MulticastDelegate|Public|Delegate, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
	...
	public:
		...
		bool RemoveThisConstraint(UWorld* InWorld, UTickableConstraint* InTickableConstraint); // Flags: Final|RequiredAPI|Native|Static|Public|BlueprintCallable, Memory Exec: 0x7FF74C17F350(relative to base address)
		bool RemoveConstraint(UWorld* InWorld, int32_t InIndex); // Flags: Final|RequiredAPI|Native|Static|Public|BlueprintCallable, Memory Exec: 0x7FF74C17F280(relative to base address)
		TArray GetConstraintsArray(UWorld* InWorld); // Flags: Final|RequiredAPI|Native|Static|Public|BlueprintCallable, Memory Exec: 0x7FF74C17F1C8(relative to base address)
		UTransformableHandle CreateTransformableHandle(UWorld* InWorld, UObject* InObject, FName& InAttachmentName); // Flags: Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF74C17F0C8(relative to base address)
		UTransformableComponentHandle CreateTransformableComponentHandle(UWorld* InWorld, USceneComponent* InSceneComponent, FName& InSocketName); // Flags: Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF74C17EF10(relative to base address)
		UTickableTransformConstraint CreateFromType(UWorld* InWorld, ETransformConstraintType InType); // Flags: Final|RequiredAPI|Native|Static|Public|BlueprintCallable, Memory Exec: 0x7FF74C17ED1C(relative to base address)
		bool AddConstraint(UWorld* InWorld, UTransformableHandle* InParentHandle, UTransformableHandle* InChildHandle, UTickableTransformConstraint* InConstraint, bool bMaintainOffset); // Flags: Final|RequiredAPI|Native|Static|Public|BlueprintCallable, Memory Exec: 0x7FF74C17E9B4(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x1C]; // 0x44(0x1C) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr<USceneComponent*> Component; // 0x60(0x8)
	...
	public:
		...
		unsigned char UnknownData01_7[0xD]; // 0xE3(0xD) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x12A(0x6) UNKNOWN PROPERTY
