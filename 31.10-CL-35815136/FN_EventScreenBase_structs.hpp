...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> CustomItemTexture; // 0x20(0x20)
		TWeakObjectPtr<UTexture2D*> CustomItemTextureMobile; // 0x40(0x20)
	...
	public:
		...
		TArray<FEventScreenCMSMoreInfoGroup> MoreInfoGroups; // 0x100(0x10)
		...
		TArray<FText> PurchasePremiumTrackBodyList; // 0x1A0(0x10)
		...
		TArray<FEventScreenCMSResourceGroupOverride> ResourceGroupOverrides; // 0x1F0(0x10)
	};
	...
	{
	public:
		TMap<FString, FEventScreenCMSData> EventScreens; // 0x0(0x50)
	};
