...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x5F9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x1]; // 0x61B(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x3]; // 0x629(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x3]; // 0x645(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x1]; // 0x657(0x1) UNKNOWN PROPERTY
		float TurnInPlaceRotationSpeed; // 0x658(0x4)
		float TurnInPlaceAngleDelta; // 0x65C(0x4)
		bool bIsMovingBackwards; // 0x660(0x1)
		unsigned char UnknownData06_6[0x3]; // 0x661(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x2]; // 0x66E(0x2) UNKNOWN PROPERTY
		float BackwardVelocity; // 0x670(0x4)
		bool bShouldPlayStopBackwards; // 0x674(0x1)
		unsigned char UnknownData08_6[0x3]; // 0x675(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData15_7[0x3]; // 0x765(0x3) UNKNOWN PROPERTY
		...
		void UpdateTurnAngleStored(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF74C4A1E8C(relative to base address)
		void UpdateSwimmingYaw(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF75056B704(relative to base address)
		void UpdateRidingMovePlayRate(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF74C4A3840(relative to base address)
		void UpdatePlayLandAdditive(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF74C4A1EBC(relative to base address)
		void UpdateFootPhaseStop(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF74C4A1E44(relative to base address)
		void UpdateBoostPlayRate(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF74C4A247C(relative to base address)
		void UpdateBodyRoll(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF75056B4A8(relative to base address)
		void UpdateBackwardVelocity(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF75056B44C(relative to base address)
		void UpdateBackwardsPlayRate(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF75056B464(relative to base address)
		void FinishFootPhaseStopUpdate(); // Flags: Native|Event|Public|BlueprintEvent, Memory Exec: 0x7FF74C4A1E74(relative to base address)
		void CalculateLookAtAlpha(bool bForceDisableLookAt, float DeltaSeconds); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B254(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x77D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x4]; // 0x80C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0xD]; // 0x813(0xD) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x789(0x3) UNKNOWN PROPERTY
		float IdleShuffleBodyBend; // 0x78C(0x4)
		float IdleShufflePlayRate; // 0x790(0x4)
		bool bIdleShuffleTurnDirection; // 0x794(0x1)
		unsigned char UnknownData02_6[0x3]; // 0x795(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x1]; // 0x7F7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_7[0x8]; // 0x820(0x8) UNKNOWN PROPERTY
		...
		void UpdateStateVariables(bool bAccelerating); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B670(relative to base address)
		void UpdateShouldPlayFullBodyInPlace(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B648(relative to base address)
		void UpdateMovingRates(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B620(relative to base address)
		void UpdateMeshScale(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B5FC(relative to base address)
		void UpdateLocomotionPoseAlpha(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B5D0(relative to base address)
		void UpdateIdleStartTurn(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B52C(relative to base address)
		void UpdateEnableSniffAdditive(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B508(relative to base address)
		void UpdateEnableAlertAdditive(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B4C0(relative to base address)
		void UpdateBlinkAlpha(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B47C(relative to base address)
		bool DetermineShouldPlayFullBodyInPlace(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B428(relative to base address)
		bool DetermineIdleStartTurn(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B3BC(relative to base address)
		bool DetermineEnableSniffAdditive(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B39C(relative to base address)
		bool DetermineEnableAlertAdditive(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B35C(relative to base address)
		float CalculateWalkRunPlayRate(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B338(relative to base address)
		float CalculateMeshScale(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B318(relative to base address)
		float CalculateLocomotionPoseAlpha(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B22C(relative to base address)
		float CalculateBlinkAlpha(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B1DC(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x82A(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x76A(0x2) UNKNOWN PROPERTY
		float LowerBodyMaskAlpha; // 0x76C(0x4)
		bool bShouldExitJump; // 0x770(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x771(0x3) UNKNOWN PROPERTY
		float MovingPlayRate; // 0x774(0x4)
		bool bShouldLean; // 0x778(0x1)
		unsigned char UnknownData02_6[0x3]; // 0x779(0x3) UNKNOWN PROPERTY
		float LeanDirection; // 0x77C(0x4)
		bool bTurnAngleIsNegative; // 0x780(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x781(0x3) UNKNOWN PROPERTY
		FName InterruptibleCurveName; // 0x784(0x4)
		bool bIsIdleShuffleTurn; // 0x788(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x789(0x3) UNKNOWN PROPERTY
		float IdleShuffleBodyBend; // 0x78C(0x4)
		float IdleShufflePlayRate; // 0x790(0x4)
		bool bIdleShuffleTurnDirection; // 0x794(0x1)
		...
		unsigned char UnknownData05_6[0x2]; // 0x7A2(0x2) UNKNOWN PROPERTY
		...
		float ShouldLean_SpeedThreshold; // 0x7C4(0x4)
		float InterruptibleCurveValue_LargeThreshold; // 0x7C8(0x4)
		float Speed_MovingThreshold; // 0x7CC(0x4)
		float Speed_IdleThreshold; // 0x7D0(0x4)
		float IdleTurnTransition_SpeedThreshold; // 0x7D4(0x4)
		float LocomotionTurnTransition_SpeedThreshold; // 0x7D8(0x4)
		float IdleShuffleBodyBendMultiplier; // 0x7DC(0x4)
		float IdleShuffleTurnThreshold; // 0x7E0(0x4)
		float IdleShuffleTurnDirectionThreshold; // 0x7E4(0x4)
		float IdleShufflePlayRateInRangeA; // 0x7E8(0x4)
		float IdleShufflePlayRateInRangeB; // 0x7EC(0x4)
		float IdleShufflePlayRateOutRangeA; // 0x7F0(0x4)
		float IdleShufflePlayRateOutRangeB; // 0x7F4(0x4)
	...
	public:
		...
		unsigned char UnknownData00_7[0x6]; // 0x7FA(0x6) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x8]; // 0x768(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x3]; // 0x781(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x1]; // 0x78F(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x1]; // 0x8AB(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x3]; // 0x8BD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x2]; // 0x8EE(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x2]; // 0x90A(0x2) UNKNOWN PROPERTY
		...
		void UpdateStateVariables(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B6F0(relative to base address)
		void UpdateLocomotionPoseAdditiveAlpha(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B5A4(relative to base address)
		void UpdateIsFullBodyInPlace(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B57C(relative to base address)
		void UpdateIdleStartTurn(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B554(relative to base address)
		void UpdateEnableHeadTiltDownAdditive(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75056B4E4(relative to base address)
		bool DetermineIsFullBodyInPlace(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B404(relative to base address)
		bool DetermineIdleStartTurn(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B3E0(relative to base address)
		bool DetermineEnableHeadTiltDownAdditive(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B37C(relative to base address)
		float CalculateLocomotionPoseAdditiveAlpha(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF75056B204(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x769(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x3]; // 0x779(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x4]; // 0x79C(0x4) UNKNOWN PROPERTY
