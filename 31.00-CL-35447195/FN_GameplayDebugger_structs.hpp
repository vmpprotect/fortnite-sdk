...
namespace SDK
{
	...
	public:
		...
		TArray TextLines; // 0x8(0x10)
		TArray Shapes; // 0x18(0x10)
		TArray DataPacks; // 0x28(0x10)
	...
	public:
		...
		TArray InputHandlers; // 0x18(0x10)
	};
