...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownBit01 : 1; // 0x8:3(0x1) UNKNOWN PROPERTY
		bool bIsUsingSecondaryAbility : 1; // 0x8:4(0x1)
		unsigned char UnknownBit02 : 1; // 0x8:5(0x1) UNKNOWN PROPERTY
		bool bIsUsingTertiaryAbility : 1; // 0x8:6(0x1)
		unsigned char UnknownBit03 : 1; // 0x8:7(0x1) UNKNOWN PROPERTY
		bool bIsPetting : 1; // 0x9:0(0x1)
		unsigned char UnknownData04_7[0x2]; // 0xA(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<EFortWeaponCoreAnimation> CoreTypeToOverride; // 0x0(0x1)
	...
	public:
		...
		TWeakObjectPtr<URiderComponent*> Rider; // 0x8(0x20)
		TWeakObjectPtr<URidableComponent*> Ridable; // 0x28(0x20)
	};
