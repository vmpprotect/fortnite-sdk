...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData06_6[0x4]; // 0xFC(0x4) UNKNOWN PROPERTY
		FVector GravityOverride; // 0x100(0x18)
		bool bUseGravityOverride; // 0x118(0x1)
		unsigned char UnknownData07_6[0x3]; // 0x119(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x27]; // 0x131(0x27) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap WeightMaps; // 0x30(0x50)
		TArray InverseMasses; // 0x80(0x10)
		TArray BoneData; // 0x90(0x10)
		TSet SelfCollisionVertexSet; // 0xA0(0x50)
		...
		TArray SelfCollisionIndices; // 0x118(0x10)
	};
