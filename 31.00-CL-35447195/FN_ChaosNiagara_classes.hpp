...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData20_6[0x1]; // 0x16F(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData21_6[0x3]; // 0x1BD(0x3) UNKNOWN PROPERTY
		TSet ChaosBreakingMaterialSet; // 0x1C0(0x50)
		bool bGetExternalBreakingData; // 0x210(0x1)
		bool bGetExternalTrailingData; // 0x211(0x1)
		unsigned char UnknownData22_6[0x6]; // 0x212(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData23_6[0x3]; // 0x22D(0x3) UNKNOWN PROPERTY
		FVector2D RandomVelocityMagnitudeMinMax; // 0x230(0x10)
		float SpreadAngleMax; // 0x240(0x4)
		unsigned char UnknownData24_6[0x4]; // 0x244(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData25_6[0x3]; // 0x28D(0x3) UNKNOWN PROPERTY
		int32_t LastSpawnedPointID; // 0x290(0x4)
		float LastSpawnTime; // 0x294(0x4)
		unsigned char UnknownData26_6[0x10]; // 0x298(0x10) UNKNOWN PROPERTY
		float SolverTime; // 0x2A8(0x4)
		float TimeStampOfLastProcessedData; // 0x2AC(0x4)
		unsigned char UnknownData27_7[0x98]; // 0x2B0(0x98) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr GeometryCollectionActor; // 0x48(0x20)
