...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_2[0x228]; // 0x0(0x228) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FRigVMDrawInstruction> Instructions; // 0x8(0x10)
	};
	...
	public:
		FName Name; // 0x0(0x4)
		TEnumAsByte<ERigVMDrawSettings> PrimitiveType; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TArray<FVector> Positions; // 0x8(0x10)
	...
	{
	public:
		TArray<FRigVMGraphFunctionData> PublicFunctions; // 0x0(0x10)
		TArray<FRigVMGraphFunctionData> PrivateFunctions; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FName> FunctionNames; // 0xB0(0x10)
		TArray<FRigVMFunctionCompilationPropertyDescription> WorkPropertyDescriptions; // 0xC0(0x10)
		TArray<FRigVMFunctionCompilationPropertyPath> WorkPropertyPathDescriptions; // 0xD0(0x10)
		TArray<FRigVMFunctionCompilationPropertyDescription> LiteralPropertyDescriptions; // 0xE0(0x10)
		TArray<FRigVMFunctionCompilationPropertyPath> LiteralPropertyPathDescriptions; // 0xF0(0x10)
		TArray<FRigVMFunctionCompilationPropertyDescription> DebugPropertyDescriptions; // 0x100(0x10)
		TArray<FRigVMFunctionCompilationPropertyPath> DebugPropertyPathDescriptions; // 0x110(0x10)
		TArray<FRigVMFunctionCompilationPropertyDescription> ExternalPropertyDescriptions; // 0x120(0x10)
		TArray<FRigVMFunctionCompilationPropertyPath> ExternalPropertyPathDescriptions; // 0x130(0x10)
		TMap<int32_t, FName> ExternalRegisterIndexToVariable; // 0x140(0x50)
		TMap<FString, FRigVMOperand> Operands; // 0x190(0x50)
		uint32_t Hash; // 0x1E0(0x4)
		bool bEncounteredSurpressedErrors; // 0x1E4(0x1)
		unsigned char UnknownData00_7[0x53]; // 0x1E5(0x53) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> CPPTypeObject; // 0x18(0x20)
	...
	{
	public:
		TArray<char> ByteCode; // 0x0(0x10)
		int32_t NumInstructions; // 0x10(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x14(0x4) UNKNOWN PROPERTY
		TArray<FRigVMByteCodeEntry> Entries; // 0x18(0x10)
		TArray<FRigVMBranchInfo> BranchInfos; // 0x28(0x10)
		TArray<FRigVMPredicateBranch> PredicateBranches; // 0x38(0x10)
		FString PublicContextPathName; // 0x48(0x10)
		unsigned char UnknownData01_7[0x58]; // 0x58(0x58) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FRigVMGraphFunctionArgument> Arguments; // 0xC8(0x10)
		TMap<FRigVMGraphFunctionIdentifier, uint32_t> Dependencies; // 0xD8(0x50)
		TArray<FRigVMExternalVariable> ExternalVariables; // 0x128(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> CPPTypeObject; // 0x10(0x20)
		...
		TMap<FString, FText> PathToTooltip; // 0x50(0x50)
	};
	...
	public:
		FGuid Guid; // 0x0(0x10)
		TArray<FRigVMTag> Tags; // 0x10(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x40]; // 0x10(0x40) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FRigVMGraphFunctionHeader> Headers; // 0x0(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x9]; // 0x1(0x9) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0xD]; // 0x1(0xD) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x13]; // 0x1(0x13) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x19]; // 0x1(0x19) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x1F]; // 0x1(0x1F) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x25]; // 0x1(0x25) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x11]; // 0x1(0x11) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x8(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x4]; // 0x8(0x4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FRigVMInstruction> Instructions; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<uint32_t, uint32_t> SliceHashToNumInstruction; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<int32_t> Segments; // 0x0(0x10)
		...
		unsigned char UnknownData01_6[0x2]; // 0x2E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FRigVMRegister> Registers; // 0x8(0x10)
		TArray<FRigVMRegisterOffset> RegisterOffsets; // 0x18(0x10)
		TArray<char> Data; // 0x28(0x10)
		TArray<UScriptStruct*> ScriptStructs; // 0x38(0x10)
		TMap<FName, int32_t> NameMap; // 0x48(0x50)
	...
	public:
		...
		unsigned char UnknownData01_6[0x17]; // 0x29(0x17) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0xC]; // 0x144(0xC) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x150(0x60)
		bool bEnabled; // 0x1B0(0x1)
		unsigned char UnknownData01_7[0xF]; // 0x1B1(0xF) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FVector> Points; // 0x100(0x10)
		FLinearColor Color; // 0x110(0x10)
		float Thickness; // 0x120(0x4)
		unsigned char UnknownData00_6[0xC]; // 0x124(0xC) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x130(0x60)
		bool bEnabled; // 0x190(0x1)
		unsigned char UnknownData01_7[0xF]; // 0x191(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0xF]; // 0x1A1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x17C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		FTransform WorldOffset; // 0x180(0x60)
		bool bEnabled; // 0x1E0(0x1)
		unsigned char UnknownData02_7[0xF]; // 0x1E1(0xF) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FTransform> Transforms; // 0x100(0x10)
		TArray<int32_t> ParentIndices; // 0x110(0x10)
		...
		unsigned char UnknownData01_6[0x4]; // 0x13C(0x4) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x140(0x60)
		bool bEnabled; // 0x1A0(0x1)
		unsigned char UnknownData02_7[0xF]; // 0x1A1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		float Thickness; // 0x34(0x4)
		float Scale; // 0x38(0x4)
		unsigned char UnknownData02_7[0x4]; // 0x3C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x34(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		FQuat B; // 0x30(0x20)
		float T; // 0x50(0x4)
		unsigned char UnknownData01_6[0xC]; // 0x54(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<EAxis> Axis; // 0x30(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x31(0x7) UNKNOWN PROPERTY
		FVector Result; // 0x38(0x18)
	};
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x8(0x8) UNKNOWN PROPERTY
		FQuat Value; // 0x10(0x20)
		TEnumAsByte<EAxis> MirrorAxis; // 0x30(0x1)
		TEnumAsByte<EAxis> AxisToFlip; // 0x31(0x1)
		unsigned char UnknownData01_6[0xE]; // 0x32(0xE) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FMathRBFInterpolateQuatFloat_Target> Targets; // 0xF0(0x10)
		float Output; // 0x100(0x4)
		unsigned char UnknownData00_7[0xC]; // 0x104(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FMathRBFInterpolateQuatVector_Target> Targets; // 0xF0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateQuatColor_Target> Targets; // 0xF0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateQuatQuat_Target> Targets; // 0xF0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateQuatXform_Target> Targets; // 0xF0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateVectorFloat_Target> Targets; // 0xC0(0x10)
		float Output; // 0xD0(0x4)
		unsigned char UnknownData00_7[0xC]; // 0xD4(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FMathRBFInterpolateVectorVector_Target> Targets; // 0xC0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateVectorColor_Target> Targets; // 0xC0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateVectorQuat_Target> Targets; // 0xC0(0x10)
	...
	{
	public:
		TArray<FMathRBFInterpolateVectorXform_Target> Targets; // 0xC0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0xF]; // 0x111(0xF) UNKNOWN PROPERTY
		FTransform Root; // 0x120(0x60)
		TArray<int32_t> ParentIndices; // 0x180(0x10)
	};
	...
	public:
		...
		FTransform B; // 0x70(0x60)
		float T; // 0xD0(0x4)
		unsigned char UnknownData01_6[0xC]; // 0xD4(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FVector> Translations; // 0x18(0x10)
		TArray<FQuat> Rotations; // 0x28(0x10)
		TArray<FVector> Scales; // 0x38(0x10)
	};
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x8(0x8) UNKNOWN PROPERTY
		FTransform Value; // 0x10(0x60)
		TEnumAsByte<EAxis> Axis; // 0x70(0x1)
		TEnumAsByte<ERigVMClampSpatialMode> Type; // 0x71(0x1)
		unsigned char UnknownData01_6[0x2]; // 0x72(0x2) UNKNOWN PROPERTY
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x8(0x8) UNKNOWN PROPERTY
		FTransform Value; // 0x10(0x60)
		TEnumAsByte<EAxis> MirrorAxis; // 0x70(0x1)
		TEnumAsByte<EAxis> AxisToFlip; // 0x71(0x1)
		unsigned char UnknownData01_6[0xE]; // 0x72(0xE) UNKNOWN PROPERTY
	...
	public:
		FVector Value; // 0x8(0x18)
		TEnumAsByte<EAxis> Axis; // 0x20(0x1)
		TEnumAsByte<ERigVMClampSpatialMode> Type; // 0x21(0x1)
		unsigned char UnknownData00_6[0x2]; // 0x22(0x2) UNKNOWN PROPERTY
	...
	public:
		FVector Value; // 0x8(0x18)
		TEnumAsByte<EAxis> MirrorAxis; // 0x20(0x1)
		TEnumAsByte<EAxis> AxisToFlip; // 0x21(0x1)
		unsigned char UnknownData00_6[0xE]; // 0x22(0xE) UNKNOWN PROPERTY
	...
	{
	public:
		TEnumAsByte<EAxis> MirrorAxis; // 0x0(0x1)
		TEnumAsByte<EAxis> AxisToFlip; // 0x1(0x1)
		unsigned char UnknownData00_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0xC]; // 0x3E4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FString> Result; // 0x28(0x10)
	};
	...
	{
	public:
		TArray<FString> Values; // 0x8(0x10)
		FString Separator; // 0x18(0x10)
		FString Result; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0xE]; // 0x52(0xE) UNKNOWN PROPERTY
		FQuat Result; // 0x60(0x20)
	...
	public:
		...
		unsigned char UnknownData01_6[0xE]; // 0xD2(0xE) UNKNOWN PROPERTY
		FTransform Result; // 0xE0(0x60)
	...
	public:
		...
		unsigned char UnknownData01_6[0xB]; // 0xD5(0xB) UNKNOWN PROPERTY
		FTransform Result; // 0xE0(0x60)
		FTransform AccumulatedValue; // 0x140(0x60)
		bool bIsInitialized; // 0x1A0(0x1)
		unsigned char UnknownData02_7[0xF]; // 0x1A1(0xF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x59(0x3) UNKNOWN PROPERTY
		float InterpSpeedIncreasing; // 0x5C(0x4)
		float InterpSpeedDecreasing; // 0x60(0x4)
		unsigned char UnknownData04_6[0xC]; // 0x64(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0x91(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x24(0x4) UNKNOWN PROPERTY
		FVector Result; // 0x28(0x18)
		TArray<FVector> Buffer; // 0x40(0x10)
	...
	public:
		...
		TArray<FTransform> Buffer; // 0xE0(0x10)
		int32_t LastInsertIndex; // 0xF0(0x4)
		unsigned char UnknownData02_7[0xC]; // 0xF4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		float Result; // 0x18(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x1C(0x4) UNKNOWN PROPERTY
		TArray<float> Buffer; // 0x20(0x10)
		TArray<float> DeltaTimes; // 0x30(0x10)
	...
	public:
		...
		TArray<FVector> Buffer; // 0x48(0x10)
		TArray<float> DeltaTimes; // 0x58(0x10)
	...
	public:
		...
		FTransform Result; // 0x80(0x60)
		TArray<FTransform> Buffer; // 0xE0(0x10)
		TArray<float> DeltaTimes; // 0xF0(0x10)
