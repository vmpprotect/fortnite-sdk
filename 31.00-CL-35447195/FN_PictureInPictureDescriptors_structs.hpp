...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData03_7[0x48]; // 0x0(0x48) UNKNOWN PROPERTY
		...
		TSet PlatformDenylist; // 0xF8(0x50)
		TSet GameplayTagDenylist; // 0x148(0x50)
		TSet GameplayTagAllowlist; // 0x198(0x50)
		bool bManual; // 0x1E8(0x1)
		unsigned char UnknownData05_7[0x7]; // 0x1E9(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap PartnerActionTally; // 0x0(0x50)
