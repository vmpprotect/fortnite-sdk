...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData09_6[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		FTransform Transform; // 0x30(0x60)
		FString BaseName; // 0x90(0x10)
		TArray Materials; // 0xA0(0x10)
		TArray AssetMaterials; // 0xB0(0x10)
		bool bEnableCollision; // 0xC0(0x1)
		TEnumAsByte CollisionMode; // 0xC1(0x1)
		unsigned char UnknownData10_6[0x5E]; // 0xC2(0x5E) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_6[0x3]; // 0x125(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_7[0x500]; // 0x170(0x500) UNKNOWN PROPERTY
	};
