...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData04_6[0x28]; // 0x48(0x28) UNKNOWN PROPERTY
		UPolygonSelectionMechanic SelectionMechanic; // 0x70(0x8)
		unsigned char UnknownData05_7[0xA8]; // 0x78(0xA8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x260]; // 0x70(0x260) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x5]; // 0xB3(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0xCD(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x40]; // 0xF8(0x40) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x1]; // 0xAB(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x10]; // 0x118(0x10) UNKNOWN PROPERTY
		TArray OriginalMeshPreviews; // 0x128(0x10)
		UMaterialInstanceDynamic PreviewsGhostMaterial; // 0x138(0x8)
		ULineSetComponent DrawnLineSet; // 0x140(0x8)
		unsigned char UnknownData03_7[0x18]; // 0x148(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x20]; // 0x118(0x20) UNKNOWN PROPERTY
		ULineSetComponent DrawnLineSet; // 0x138(0x8)
		unsigned char UnknownData03_7[0x240]; // 0x140(0x240) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x5]; // 0xDB(0x5) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x2D]; // 0xEB(0x2D) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0x11A(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x6]; // 0x152(0x6) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0xC8]; // 0x98(0xC8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0xBA(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData04_3[0x8]; // 0x98(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x90]; // 0xC0(0x90) UNKNOWN PROPERTY
		UPreviewMesh PreviewMesh; // 0x150(0x8)
		unsigned char UnknownData06_6[0x410]; // 0x158(0x410) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x10]; // 0x580(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		void RegenerateExtraCorners(); // Flags: Final|Native|Public 0x7FF414CC0ED8
	};
	...
	public:
		...
		void SimplifyByGroups(); // Flags: Final|Native|Public 0x7FF414CC1E98
		void Retriangulate(); // Flags: Final|Native|Public 0x7FF414CC1DB8
		void RecalcNormals(); // Flags: Final|Native|Public 0x7FF414CC1CD8
		void PushPull(); // Flags: Final|Native|Public 0x7FF414CC1BF8
		void Outset(); // Flags: Final|Native|Public 0x7FF414CC1B18
		void Offset(); // Flags: Final|Native|Public 0x7FF414CC1A38
		void Merge(); // Flags: Final|Native|Public 0x7FF414CC1958
		void Inset(); // Flags: Final|Native|Public 0x7FF414CC1878
		void InsertEdgeLoop(); // Flags: Final|Native|Public 0x7FF414CC1798
		void InsertEdge(); // Flags: Final|Native|Public 0x7FF414CC16B8
		void Flip(); // Flags: Final|Native|Public 0x7FF414CC15D8
		void Extrude(); // Flags: Final|Native|Public 0x7FF414CC14F8
		void Duplicate(); // Flags: Final|Native|Public 0x7FF414CC1418
		void Disconnect(); // Flags: Final|Native|Public 0x7FF414CC1338
		void Delete(); // Flags: Final|Native|Public 0x7FF414CC1258
		void Decompose(); // Flags: Final|Native|Public 0x7FF414CC1178
		void CutFaces(); // Flags: Final|Native|Public 0x7FF414CC1098
		void Bevel(); // Flags: Final|Native|Public 0x7FF414CC0FB8
	};
	...
	public:
		...
		void RecalcNormals(); // Flags: Final|Native|Public 0x7FF414CC2918
		void PushPull(); // Flags: Final|Native|Public 0x7FF414CC2838
		void Poke(); // Flags: Final|Native|Public 0x7FF414CC2758
		void Outset(); // Flags: Final|Native|Public 0x7FF414CC2678
		void Offset(); // Flags: Final|Native|Public 0x7FF414CC2598
		void Inset(); // Flags: Final|Native|Public 0x7FF414CC24B8
		void Flip(); // Flags: Final|Native|Public 0x7FF414CC23D8
		void Extrude(); // Flags: Final|Native|Public 0x7FF414CC22F8
		void Duplicate(); // Flags: Final|Native|Public 0x7FF414CC2218
		void Disconnect(); // Flags: Final|Native|Public 0x7FF414CC2138
		void Delete(); // Flags: Final|Native|Public 0x7FF414CC2058
		void CutFaces(); // Flags: Final|Native|Public 0x7FF414CC1F78
	};
	...
	public:
		...
		void PlanarProjection(); // Flags: Final|Native|Public 0x7FF414CC29F8
	};
	...
	public:
		...
		void Weld(); // Flags: Final|Native|Public 0x7FF414CC30F8
		void Straighten(); // Flags: Final|Native|Public 0x7FF414CC3018
		void Simplify(); // Flags: Final|Native|Public 0x7FF414CC2F38
		void FillHole(); // Flags: Final|Native|Public 0x7FF414CC2E58
		void Extrude(); // Flags: Final|Native|Public 0x7FF414CC2D78
		void DeleteEdge(); // Flags: Final|Native|Public 0x7FF414CC2C98
		void Bridge(); // Flags: Final|Native|Public 0x7FF414CC2BB8
		void Bevel(); // Flags: Final|Native|Public 0x7FF414CC2AD8
	};
	...
	public:
		...
		void Weld(); // Flags: Final|Native|Public 0x7FF414CC3718
		void Split(); // Flags: Final|Native|Public 0x7FF414CC3638
		void Flip(); // Flags: Final|Native|Public 0x7FF414CC3558
		void FillHole(); // Flags: Final|Native|Public 0x7FF414CC3478
		void Extrude(); // Flags: Final|Native|Public 0x7FF414CC3398
		void Collapse(); // Flags: Final|Native|Public 0x7FF414CC32B8
		void Bridge(); // Flags: Final|Native|Public 0x7FF414CC31D8
	};
	...
	{
	public:
		unsigned char UnknownData03_3[0x20]; // 0x120(0x20) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0xD8]; // 0x1C0(0xD8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x640]; // 0x2C0(0x640) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr Material; // 0xA8(0x8)
	...
	public:
		...
		TArray GetUVChannelNamesFunc(); // Flags: Final|Native|Public|Const 0x7FF414CC37F8
	};
	...
	public:
		bool bShowWireframe; // 0xA8(0x1)
		unsigned char UnknownData05_6[0x3]; // 0xA9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x3]; // 0xE9(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr CustomMaterial; // 0xEC(0x8)
		unsigned char UnknownData09_7[0x4]; // 0xF4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		TArray UVChannelNamesList; // 0xB8(0x10)
		...
		TArray GetUVChannelNamesFunc(); // Flags: Final|Native|Public|Const 0x7FF414CC38D8
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x20]; // 0xF8(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		UPolyEditActivityContext ActivityContext; // 0x40(0x8)
		unsigned char UnknownData03_7[0xF8]; // 0x48(0xF8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_7[0x7]; // 0xD1(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		EPolyEditExtrudeDirection MeasureDirection; // 0xCC(0x4)
		bool bUseColinearityForSettingBorderGroups; // 0xD0(0x1)
		unsigned char UnknownData07_7[0x7]; // 0xD1(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData02_3[0x20]; // 0x30(0x20) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x158]; // 0x78(0x158) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x418]; // 0x58(0x418) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x5]; // 0xCB(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		UPolyEditActivityContext ActivityContext; // 0x50(0x8)
		unsigned char UnknownData03_7[0x3A8]; // 0x58(0x3A8) UNKNOWN PROPERTY
	...
	public:
		...
		UCollectSurfacePathMechanic SurfacePathMechanic; // 0x50(0x8)
		UPolyEditActivityContext ActivityContext; // 0x58(0x8)
		unsigned char UnknownData03_7[0x90]; // 0x60(0x90) UNKNOWN PROPERTY
	...
	public:
		...
		UExistingMeshMaterialProperties MaterialSettings; // 0xD0(0x8)
		TArray Previews; // 0xD8(0x10)
		TArray Factories; // 0xE8(0x10)
		unsigned char UnknownData04_6[0x68]; // 0xF8(0x68) UNKNOWN PROPERTY
	...
	public:
		...
		void Reset(); // Flags: Final|Native|Public 0x7FF414CC3B78
		void AutoFitAlign(); // Flags: Final|Native|Public 0x7FF414CC3A98
		void AutoFit(); // Flags: Final|Native|Public 0x7FF414CC39B8
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0xC9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x4]; // 0xE4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0xF]; // 0x121(0xF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x348]; // 0x170(0x348) UNKNOWN PROPERTY
		USingleClickInputBehavior ClickToSetPlaneBehavior; // 0x4B8(0x8)
		unsigned char UnknownData03_7[0x10]; // 0x4C0(0x10) UNKNOWN PROPERTY
