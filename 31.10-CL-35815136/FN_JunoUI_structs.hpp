...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UObject*> Icon; // 0x20(0x20)
	...
	{
	public:
		TArray<UMaterialInstanceDynamic*> Instances; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> OptionalIcon; // 0x18(0x20)
	};
	...
	public:
		...
		TArray<FJunoInventoryGroupUIData> GroupDataList; // 0x20(0x10)
	};
	...
	{
	public:
		TArray<UJunoItemSpawnerListEntry*> ListEntries; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FGameplayTag> ItemTags; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UTexture2D*> Icon; // 0x0(0x20)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UObject*> PrimaryIcon; // 0x8(0x20)
		TWeakObjectPtr<UObject*> SecondaryIcon; // 0x28(0x20)
	};
	...
	public:
		...
		TArray<UJunoKnowledgeBundle*> KnowledgeBundles; // 0x50(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x20(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> CraftingObjectRef; // 0x8(0x20)
	...
	{
	public:
		TArray<FGridListSlotInfo> GridListInfo; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<UUserWidget*> InactiveWidgets; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<UUserWidget*> ActiveWidgets; // 0x0(0x10)
		TMap<UClass*, FInactiveUserWidgets> InactiveWidgetsMap; // 0x10(0x50)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> FolderIcon; // 0x18(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr<UTexture*> EntryIcon; // 0x8(0x20)
	...
	public:
		...
		TArray<FAwesomeLevelRewardEntry> AwesomeLevelRewardEntries; // 0x108(0x10)
		FJunoAwesomeUpgradeRequirements CurrentUpgradeRequirements; // 0x118(0x20)
		TArray<FAwesomePerkReward> UnlockedPlayerPerks; // 0x138(0x10)
		TArray<FActiveCampNPCEntry> ActiveNPCEntries; // 0x148(0x10)
		...
		TArray<FActiveCampNPCEntry> VisitingNPCEntries; // 0x170(0x10)
		TArray<FActiveCampCreatureEntry> ActiveCreatureEntries; // 0x180(0x10)
		TMap<FGameplayTag, int32_t> JobCounts; // 0x190(0x50)
		TArray<TWeakObjectPtr> KnowledgeBundles; // 0x1E0(0x10)
		UFortItemDefinition* VillageCenterItemDefinition; // 0x1F0(0x8)
		bool bHasReachedGlobalNPCsCap; // 0x1F8(0x1)
		unsigned char UnknownData02_6[0x3]; // 0x1F9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x3]; // 0x209(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<UItemDefinitionBase*> ItemDefinitions; // 0x8(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> NotificationSoftClass; // 0x8(0x20)
	...
	public:
		...
		TMap<EPendingActionType, FPendingActionMsgText> MessageTextMap; // 0x8(0x50)
