...
namespace SDK
{
	...
	public:
		...
		FTransform BP_GetTransformOrigin(); // Flags: RequiredAPI|Event|Protected|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 0x7FF4144B3DB8
	};
	...
	public:
		...
		TArray BoundObjects; // 0x70(0x10)
		TArray BindingGuids; // 0x80(0x10)
	...
	{
	public:
		unsigned char UnknownData01_1[0x1B0]; // 0x40(0x1B0) UNKNOWN PROPERTY
	...
	public:
		...
		void SetConstraintBindingID(FMovieSceneObjectBindingID& InConstraintBindingID); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable 0x7FF4144B3F78
		FMovieSceneObjectBindingID GetConstraintBindingID(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B3E98
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0x8]; // 0x118(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x2]; // 0x12E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x22A(0x2) UNKNOWN PROPERTY
		bool bFollow : 1; // 0x22C:0(0x1)
		bool bReverse : 1; // 0x22C:1(0x1)
		bool bForceUpright : 1; // 0x22C:2(0x1)
		unsigned char UnknownData03_7[0x3]; // 0x22D(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ConstraintsChannels; // 0x28(0x10)
	...
	{
	public:
		unsigned char UnknownData03_3[0x40]; // 0xF0(0x40) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x7]; // 0xC31(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		TArray ActorGuidStrings; // 0x288(0x10)
	...
	{
	public:
		unsigned char UnknownData04_3[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
		...
		TMap Inputs_Float; // 0x338(0x50)
		TMap Inputs_String; // 0x388(0x50)
		TMap Inputs_Bool; // 0x3D8(0x50)
		TMap Inputs_Int; // 0x428(0x50)
		TMap Inputs_Trigger; // 0x478(0x50)
		...
		unsigned char UnknownData06_6[0x5]; // 0x5E3(0x5) UNKNOWN PROPERTY
		USoundAttenuation AttenuationSettings; // 0x5E8(0x8)
		FDelegateProperty OnQueueSubtitles; // 0x5F0(0xC)
		unsigned char UnknownData07_6[0x4]; // 0x5FC(0x4) UNKNOWN PROPERTY
		...
		void SetSuppressSubtitles(bool bInSuppressSubtitles); // Flags: Final|Native|Public|BlueprintCallable 0x7FF4144B49F8
		void SetStartOffset(FFrameNumber InStartOffset); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable 0x7FF4144B4918
		void SetSound(USoundBase InSound); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B4838
		void SetOverrideAttenuation(bool bInOverrideAttenuation); // Flags: Final|Native|Public|BlueprintCallable 0x7FF4144B4758
		void SetLooping(bool bInLooping); // Flags: Final|Native|Public|BlueprintCallable 0x7FF4144B4678
		void SetAttenuationSettings(USoundAttenuation InAttenuationSettings); // Flags: Final|Native|Public|BlueprintCallable 0x7FF4144B4598
		bool GetSuppressSubtitles(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B44B8
		FFrameNumber GetStartOffset(); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 0x7FF4144B43D8
		USoundBase GetSound(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B42F8
		bool GetOverrideAttenuation(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B4218
		bool GetLooping(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B4138
		USoundAttenuation GetAttenuationSettings(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B4058
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0xF9(0x3) UNKNOWN PROPERTY
		FGuid CameraGuid; // 0xFC(0x10)
		FMovieSceneObjectBindingID CameraBindingID; // 0x10C(0x18)
		unsigned char UnknownData06_6[0xC]; // 0x124(0xC) UNKNOWN PROPERTY
		FTransform InitialCameraCutTransform; // 0x130(0x60)
		bool bHasInitialCameraCutTransform; // 0x190(0x1)
		unsigned char UnknownData07_7[0xF]; // 0x191(0xF) UNKNOWN PROPERTY
		...
		void SetCameraBindingID(FMovieSceneObjectBindingID& InCameraBindingID); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable 0x7FF4144B4BB8
		FMovieSceneObjectBindingID GetCameraBindingID(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B4AD8
	};
	...
	public:
		...
		void SetShotDisplayName(FString InShotDisplayName); // Flags: Final|Native|Public|BlueprintCallable 0x7FF4144B4D78
		FString GetShotDisplayName(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B4C98
	};
	...
	public:
		unsigned char UnknownData01_3[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
		TArray ScalarParameterInfosAndCurves; // 0xF8(0x10)
		TArray ColorParameterInfosAndCurves; // 0x108(0x10)
		...
		bool RemoveScalarParameter(FMaterialParameterInfo& InParameterInfo); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 0x7FF4144B50F8
		bool RemoveColorParameter(FMaterialParameterInfo& InParameterInfo); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 0x7FF4144B5018
		void AddScalarParameterKey(FMaterialParameterInfo& InParameterInfo, FFrameNumber InTime, float InValue, FString InLayerName, FString InAssetName); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 0x7FF4144B4F38
		void AddColorParameterKey(FMaterialParameterInfo& InParameterInfo, FFrameNumber InTime, FLinearColor InValue, FString InLayerName, FString InAssetName); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 0x7FF4144B4E58
	};
	...
	public:
		unsigned char UnknownData01_3[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
		TArray BoolParameterNamesAndCurves; // 0xF8(0x10)
		TArray ScalarParameterNamesAndCurves; // 0x108(0x10)
		TArray Vector2DParameterNamesAndCurves; // 0x118(0x10)
		TArray VectorParameterNamesAndCurves; // 0x128(0x10)
		TArray ColorParameterNamesAndCurves; // 0x138(0x10)
		TArray TransformParameterNamesAndCurves; // 0x148(0x10)
		...
		bool RemoveVectorParameter(FName InParameterName); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B5C58
		bool RemoveVector2DParameter(FName InParameterName); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B5B78
		bool RemoveTransformParameter(FName InParameterName); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B5A98
		bool RemoveScalarParameter(FName InParameterName); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B59B8
		bool RemoveColorParameter(FName InParameterName); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B58D8
		bool RemoveBoolParameter(FName InParameterName); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B57F8
		void GetParameterNames(TSet& ParameterNames); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF4144B5718
		void AddVectorParameterKey(FName InParameterName, FFrameNumber InTime, FVector InValue); // Flags: Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 0x7FF4144B5638
		void AddVector2DParameterKey(FName InParameterName, FFrameNumber InTime, FVector2D InValue); // Flags: Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 0x7FF4144B5558
		void AddTransformParameterKey(FName InParameterName, FFrameNumber InTime, FTransform& InValue); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 0x7FF4144B5478
		void AddScalarParameterKey(FName InParameterName, FFrameNumber InTime, float InValue); // Flags: Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 0x7FF4144B5398
		void AddColorParameterKey(FName InParameterName, FFrameNumber InTime, FLinearColor InValue); // Flags: Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 0x7FF4144B52B8
		void AddBoolParameterKey(FName InParameterName, FFrameNumber InTime, bool InValue); // Flags: Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 0x7FF4144B51D8
	};
	...
	public:
		unsigned char UnknownData01_3[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
		TArray ConsoleVariableCollections; // 0xF8(0x10)
		...
		void SetFromString(FString InString); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B5E18
		FString GetString(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B5D38
	};
	...
	public:
		unsigned char UnknownData02_3[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
		TArray DataLayerAssets; // 0xF8(0x10)
		...
		void SetPrerollState(EDataLayerRuntimeState InPrerollState); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B67B8
		void SetFlushOnUnload(bool bFlushOnUnload); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B66D8
		void SetFlushOnActivated(bool bFlushOnActivated); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B65F8
		void SetDesiredState(EDataLayerRuntimeState InDesiredState); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B6518
		void SetDataLayerAssets(TArray& InDataLayerAssets); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable 0x7FF4144B6438
		bool HasPreRoll(); // Flags: Final|Native|Private|Const 0x7FF4144B6358
		EDataLayerRuntimeState GetPrerollState(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B6278
		bool GetFlushOnUnload(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B6198
		bool GetFlushOnActivated(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B60B8
		EDataLayerRuntimeState GetDesiredState(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B5FD8
		TArray GetDataLayerAssets(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B5EF8
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x10]; // 0xF0(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		void SetVisibility(ELevelVisibility InVisibility); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable 0x7FF4144B6B38
		void SetLevelNames(TArray& InLevelNames); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable 0x7FF4144B6A58
		ELevelVisibility GetVisibility(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B6978
		TArray GetLevelNames(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF4144B6898
	};
	...
	{
	public:
		unsigned char UnknownData05_3[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_5[0x3]; // 0x25D(0x3) UNKNOWN PROPERTY
		FName SlotName; // 0x260(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x264(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x7B]; // 0x2D5(0x7B) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x4]; // 0x53C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x4]; // 0x55C(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x190]; // 0x40(0x190) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0x190]; // 0x40(0x190) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x90]; // 0x40(0x90) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x148]; // 0x40(0x148) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0x310]; // 0x40(0x310) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0xC8]; // 0x68(0xC8) UNKNOWN PROPERTY
	...
	public:
		...
		UMovieSceneAsyncAction_SequencePrediction PredictWorldTransformAtTime(UMovieSceneSequencePlayer Player, USceneComponent TargetComponent, float TimeInSeconds); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF4144B6EB8
		UMovieSceneAsyncAction_SequencePrediction PredictWorldTransformAtFrame(UMovieSceneSequencePlayer Player, USceneComponent TargetComponent, FFrameTime FrameTime); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF4144B6DD8
		UMovieSceneAsyncAction_SequencePrediction PredictLocalTransformAtTime(UMovieSceneSequencePlayer Player, USceneComponent TargetComponent, float TimeInSeconds); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF4144B6CF8
		UMovieSceneAsyncAction_SequencePrediction PredictLocalTransformAtFrame(UMovieSceneSequencePlayer Player, USceneComponent TargetComponent, FFrameTime FrameTime); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF4144B6C18
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x90]; // 0x40(0x90) UNKNOWN PROPERTY
		TArray PendingPredictions; // 0xD0(0x10)
		TArray ProcessingPredictions; // 0xE0(0x10)
	...
	{
	public:
		unsigned char UnknownData01_1[0x60]; // 0x68(0x60) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x38]; // 0x40(0x38) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData02_3[0x88]; // 0x40(0x88) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ConstraintSections; // 0x98(0x10)
	...
	{
	public:
		TArray AudioSections; // 0x98(0x10)
	...
	{
	public:
		TArray CameraShakeSections; // 0x98(0x10)
	...
	{
	public:
		unsigned char UnknownData01_3[0x10]; // 0x98(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0x10]; // 0xB0(0x10) UNKNOWN PROPERTY
	...
	public:
		unsigned char UnknownData01_3[0x8]; // 0x98(0x8) UNKNOWN PROPERTY
		TArray ParticleSections; // 0xA0(0x10)
	...
	{
	public:
		TArray AnimationSections; // 0x98(0x10)
		...
		unsigned char UnknownData03_7[0xE]; // 0x132(0xE) UNKNOWN PROPERTY
		...
		void SetSwapRootBone(ESwapRootBone InValue); // Flags: Final|RequiredAPI|Native|Public 0x7FF4144B7078
		ESwapRootBone GetSwapRootBone(); // Flags: Final|RequiredAPI|Native|Public|Const 0x7FF4144B6F98
	};
