...
namespace SDK
{
	...
	public:
		...
		TArray TransitionEvents; // 0x8(0x10)
	};
	...
	public:
		...
		TArray SourceEnterStateReactions; // 0x10(0x10)
		TArray InstigatorEnterStateReactions; // 0x20(0x10)
		TArray Transitions; // 0x30(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr ConversationComponentPtr; // 0x4C(0x8)
	...
	{
	public:
		TWeakObjectPtr DepositItem; // 0x48(0x20)
