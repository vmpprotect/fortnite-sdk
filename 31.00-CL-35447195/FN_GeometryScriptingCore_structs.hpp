...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0x17]; // 0x1(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x16(0x2) UNKNOWN PROPERTY
		TArray ExtraViewFromPositions; // 0x18(0x10)
	};
	...
	public:
		...
		TArray CustomNavigablePositions; // 0x18(0x10)
		TArray UnreachablePlanes; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TArray NewMaterials; // 0x8(0x10)
		TArray NewMaterialSlotNames; // 0x18(0x10)
		...
		unsigned char UnknownData05_7[0x6]; // 0x7A(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData09_6[0x7]; // 0x9(0x7) UNKNOWN PROPERTY
		UTexture2D NormalMap; // 0x10(0x8)
		bool bHasNormalMap; // 0x18(0x1)
		unsigned char UnknownData10_6[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		UTexture2D PackedMRSMap; // 0x20(0x8)
		bool bHasPackedMRSMap; // 0x28(0x1)
		unsigned char UnknownData11_6[0x7]; // 0x29(0x7) UNKNOWN PROPERTY
		UTexture2D MetallicMap; // 0x30(0x8)
		bool bHasMetallicMap; // 0x38(0x1)
		unsigned char UnknownData12_6[0x7]; // 0x39(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_6[0x7]; // 0x59(0x7) UNKNOWN PROPERTY
		UTexture2D EmissiveMap; // 0x60(0x8)
		bool bHasEmissiveMap; // 0x68(0x1)
		unsigned char UnknownData15_6[0x7]; // 0x69(0x7) UNKNOWN PROPERTY
		UTexture2D OpacityMap; // 0x70(0x8)
		bool bHasOpacityMap; // 0x78(0x1)
		unsigned char UnknownData16_6[0x7]; // 0x79(0x7) UNKNOWN PROPERTY
		UTexture2D SubsurfaceColorMap; // 0x80(0x8)
		bool bHasSubsurfaceColorMap; // 0x88(0x1)
		unsigned char UnknownData17_7[0x7]; // 0x89(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray UV0; // 0x20(0x10)
		TArray UV1; // 0x30(0x10)
		TArray UV2; // 0x40(0x10)
		TArray UV3; // 0x50(0x10)
		TArray UV4; // 0x60(0x10)
		TArray UV5; // 0x70(0x10)
		TArray UV6; // 0x80(0x10)
		TArray UV7; // 0x90(0x10)
		TArray VertexColors; // 0xA0(0x10)
		TArray Triangles; // 0xB0(0x10)
		TArray TriGroupIDs; // 0xC0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0xF]; // 0xB1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x2]; // 0x12(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray InitialClusterCenters; // 0x0(0x10)
	...
	{
	public:
		TArray OptionalPriorityWeights; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0x61(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte CoordinateSpace; // 0x9(0x1)
