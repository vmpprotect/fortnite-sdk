...
namespace SDK
{
	...
	{
	public:
		TArray MaterialOnlyParameterNames; // 0x28(0x10)
	...
	{
	public:
		FCosmeticSlotSelector SlotValidWithin; // 0x4A0(0x2)
		unsigned char UnknownData01_6[0x6]; // 0x4A2(0x6) UNKNOWN PROPERTY
		FApparelCustomizableItemReference Parameter; // 0x4A8(0x20)
	...
	{
	public:
		TArray ParameterOptions; // 0x78(0x10)
		...
		void ApplyVariants(AActor Actor, FFortAthenaLoadout& Loadout); // Flags: Final|Native|Static|Private|HasOutParms|BlueprintCallable 0x7FF4149C5CB8
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x10]; // 0x2B0(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		void OnPostCustomizationAnimGameplayTags_BP(FGameplayTagContainer& GameplayTags); // Flags: Event|Public|HasOutParms|BlueprintEvent 0x7FF4149C5D98
	};
	...
	{
	public:
		TMap SlotDataConfig; // 0xA8(0x50)
		TMap SlottedCustomizableObjects; // 0xF8(0x50)
	...
	{
	public:
		TWeakObjectPtr SchemaAsset; // 0x28(0x20)
	...
	{
	public:
		TArray SupportedSchemas; // 0x28(0x10)
