...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x754(0x4) UNKNOWN PROPERTY
		...
		TWeakObjectPtr DashMontage; // 0x798(0x20)
		TWeakObjectPtr DeltaEquipMontage; // 0x7B8(0x20)
		TArray SwingMontages; // 0x7D8(0x10)
		...
		unsigned char UnknownData04_6[0x5]; // 0x7FB(0x5) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x5A]; // 0x826(0x5A) UNKNOWN PROPERTY
	...
	{
	public:
		TArray Swing01Montages; // 0x4B8(0x10)
		TArray Swing02Montages; // 0x4C8(0x10)
		TArray Swing03Montages; // 0x4D8(0x10)
		TArray Swing04Montages; // 0x4E8(0x10)
		TArray Swing05Montages; // 0x4F8(0x10)
		TArray UpperBodySwing01Montages; // 0x508(0x10)
		TArray UpperBodySwing02Montages; // 0x518(0x10)
		TArray InAirAttackMontages; // 0x528(0x10)
	...
	{
	public:
		TArray InAirMontages; // 0x4B8(0x10)
		bool bIsAirLand; // 0x4C8(0x1)
		unsigned char UnknownData01_7[0x7]; // 0x4C9(0x7) UNKNOWN PROPERTY
