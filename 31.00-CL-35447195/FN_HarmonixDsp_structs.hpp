...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_7[0xFC]; // 0x24(0xFC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x8(0x4) UNKNOWN PROPERTY
		float Freq; // 0xC(0x4)
		float Q; // 0x10(0x4)
	...
	public:
		...
		unsigned char UnknownData04_6[0x2]; // 0x2(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x2]; // 0x26(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		TArray Keyzones; // 0x0(0x10)
		FFusionPatchSettings Settings; // 0x10(0x588)
		TArray Presets; // 0x598(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x10]; // 0x8(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x1]; // 0x1F(0x1) UNKNOWN PROPERTY
		...
		TArray TrackMap; // 0xA8(0x10)
		bool UseSingletonVoicePool; // 0xB8(0x1)
		unsigned char UnknownData09_7[0x17]; // 0xB9(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap PitchShifterOptions; // 0x8(0x50)
	...
	public:
		...
		unsigned char UnknownData04_6[0x2]; // 0x12(0x2) UNKNOWN PROPERTY
