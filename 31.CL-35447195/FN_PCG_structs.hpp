...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_6[0xF]; // 0x31(0xF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x8]; // 0x48(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x7]; // 0x101(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x7]; // 0x159(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x6]; // 0x12(0x6) UNKNOWN PROPERTY
		TArray ExtraNames; // 0x18(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData07_7[0x8]; // 0x98(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray DoubleArrayProperty; // 0x0(0x10)
	};
	...
	{
	public:
		TArray IntArrayProperty; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData03_6[0xF]; // 0x11(0xF) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x208]; // 0x190(0x208) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte CollisionChannel; // 0x2(0x1)
		...
		TSet ParsedActorTagsList; // 0x20(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData02_5[0x2]; // 0x72(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x2]; // 0x6(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x3]; // 0x2D(0x3) UNKNOWN PROPERTY
		FVector StartPosition; // 0x30(0x18)
		FVector StartTangent; // 0x48(0x18)
		float StartRollDegrees; // 0x60(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x64(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x8]; // 0xC0(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData13_6[0x1]; // 0x3(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_6[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData25_7[0x1]; // 0x10F(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x164(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray WeightedEntries; // 0x168(0x10)
	...
	public:
		...
		TArray Instances; // 0x220(0x10)
		TArray InstancesMetadataEntry; // 0x230(0x10)
		unsigned char UnknownData01_7[0x8]; // 0x240(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x224(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray WeightedMeshEntries; // 0x18(0x10)
	};
	...
	{
	public:
		TArray TaggedData; // 0x0(0x10)
		bool bCancelExecutionOnEmpty; // 0x10(0x1)
		unsigned char UnknownData01_7[0x1F]; // 0x11(0x1F) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr PointMesh; // 0x8(0x20)
		TWeakObjectPtr MaterialOverride; // 0x28(0x20)
	};
	...
	public:
		...
		TSet PropertiesIDsOverridden; // 0x10(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x8]; // 0x98(0x8) UNKNOWN PROPERTY
	...
	public:
		FName Label; // 0x0(0x4)
		unsigned char UnknownData02_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray PropertiesNames; // 0x8(0x10)
		UStruct PropertyClass; // 0x18(0x8)
		TMap MapOfAliases; // 0x20(0x50)
		bool bHasNameClash; // 0x70(0x1)
		unsigned char UnknownData03_7[0x17]; // 0x71(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap TestResults; // 0x28(0x50)
		TArray AdditionalDetails; // 0x78(0x10)
