...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData06_6[0x4]; // 0x22C(0x4) UNKNOWN PROPERTY
		AFortPlayerPawnAthena CachedPlayer; // 0x230(0x8)
		AFortWeaponRangedDualSwing CachedWeapon; // 0x238(0x8)
		unsigned char UnknownData07_7[0x48]; // 0x240(0x48) UNKNOWN PROPERTY
		...
		void RemoveSelfFromCameraManager(); // Flags: Final|Native|Protected 0x7FF414BEE978
		void CalculateDynamicMultipliers(float& OutFOVBoundsMultiplier, float& OutBoostOffsetMultiplier); // Flags: Native|Event|Protected|HasOutParms|BlueprintEvent|Const 0x7FF414BEE898
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x2]; // 0x4CA(0x2) UNKNOWN PROPERTY
		float PlayerDistanceToGround; // 0x4CC(0x4)
		bool CalculateRotation; // 0x4D0(0x1)
		unsigned char UnknownData05_6[0x7]; // 0x4D1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x5]; // 0x5AB(0x5) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x8]; // 0x658(0x8) UNKNOWN PROPERTY
		...
		void GetPlayerAnglesFromAttachPoint(float& pitch, float& Roll, float& Yaw); // Flags: Final|Native|Public|HasOutParms 0x7FF414BEEB38
		FVector GetAttachVectorInPlayerSpace(FVector& InPlayerToAttachPoint); // Flags: Final|Native|Public|HasOutParms|HasDefaults 0x7FF414BEEA58
	};
