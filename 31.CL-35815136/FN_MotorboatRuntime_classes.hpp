...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x67C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0x5]; // 0x74B(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x21EC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x4]; // 0x225C(0x4) UNKNOWN PROPERTY
		uint64_t LandForceFeedbackHandle; // 0x2260(0x8)
		float TurnRumbleIntensity; // 0x2268(0x4)
		unsigned char UnknownData02_6[0x4]; // 0x226C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x4]; // 0x2284(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x10]; // 0x2368(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x38]; // 0x2388(0x38) UNKNOWN PROPERTY
		bool bBoostFailed; // 0x23C0(0x1)
		unsigned char UnknownData06_7[0x3F]; // 0x23C1(0x3F) UNKNOWN PROPERTY
		...
		void UpdateSnowAndDirtParams(float NormalizedForwardSpeed); // Flags: Final|Native|Protected|BlueprintCallable, Memory Exec: 0x7FF75063AC88(relative to base address)
		void StopTurnRumble(); // Flags: Final|Native|Protected|BlueprintCallable, Memory Exec: 0x7FF75063AC74(relative to base address)
		void StopLandRumble(); // Flags: Final|Native|Protected|BlueprintCallable, Memory Exec: 0x7FF75063AC60(relative to base address)
		void StopDriverCameraShake(); // Flags: Final|Native|Protected|BlueprintCallable, Memory Exec: 0x7FF75063AC4C(relative to base address)
		void SmashedThroughBuildingPiece(FVector& ImpactPoint, FVector& ImpactNormal, ABuildingActor* BuildingHitActor); // Flags: Event|Public|HasOutParms|HasDefaults|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		void ShowCooldownCue(AFortPlayerPawn* Pawn, float duration); // Flags: Event|Public|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
		...
		void LandShakeEnd(); // Flags: Final|Native|Protected|BlueprintCallable, Memory Exec: 0x7FF75063AC38(relative to base address)
		FQuat GetSeatRotation(); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF75063AC10(relative to base address)
		FVector GetSeatOffset(); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF75063ABE8(relative to base address)
		float GetBoostCharge(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF75063ABC0(relative to base address)
		void CacheGroundFXComponent(UNiagaraComponent* InGroundFXComponent); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75063AB34(relative to base address)
		void CacheAudioPointers(UFortVehicleAudioVoice* InAudioEngineUp, UFortVehicleAudioVoice* InAudioEngineDown, UFortVehicleAudioVoice* InAudioWakeTurn, UFortVehicleAudioVoice* InAudioWakeSpeed, UFortVehicleAudioVoice* InAudioScrape, UFortVehicleAudioVoice* InAudioEngineOutOfFuel); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75063A8B8(relative to base address)
	};
