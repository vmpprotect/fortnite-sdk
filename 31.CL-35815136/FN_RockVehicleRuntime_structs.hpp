...
namespace SDK
{
	...
	{
	public:
		TEnumAsByte<EPhysicalSurface> SurfaceType; // 0x0(0x1)
	...
	public:
		...
		TArray<FGroundTrailsData> GroundTrails; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x10(0x4) UNKNOWN PROPERTY
	};
