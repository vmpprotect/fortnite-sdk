...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData06_7[0x3]; // 0x3D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FHairGroupLODInfo> LODInfos; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<UTexture2D*> Textures; // 0x8(0x10)
	...
	{
	public:
		TArray<FHairLODSettings> Lods; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UNiagaraSystem*> CustomSystem; // 0x8(0x20)
