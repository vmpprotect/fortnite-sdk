...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData02_3[0x58]; // 0x108(0x58) UNKNOWN PROPERTY
		TArray InstanceDeltas; // 0x160(0x10)
	...
	public:
		...
		unsigned char UnknownData06_6[0x6]; // 0x1A(0x6) UNKNOWN PROPERTY
		double MaxInstanceDistance; // 0x20(0x8)
		TArray MaxInstanceDistances; // 0x28(0x10)
		TArray LODDistanceScales; // 0x38(0x10)
		TArray AffectDistanceFieldLighting; // 0x48(0x10)
		...
		unsigned char UnknownData08_6[0x3]; // 0x75(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x6]; // 0x8A(0x6) UNKNOWN PROPERTY
		TArray AppliedSettingsOverrides; // 0x90(0x10)
	};
	...
	{
	public:
		TArray ISMComponentDescriptors; // 0x0(0x10)
	};
	...
	public:
		...
		TArray ISMComponents; // 0x10(0x10)
		FStaticMeshInstanceVisualizationDescHandle MassStaticMeshDescHandle; // 0x20(0x2)
		unsigned char UnknownData01_7[0x2E]; // 0x22(0x2E) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr InstanceData; // 0x0(0x8)
