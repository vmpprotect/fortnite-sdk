...
namespace SDK
{
	...
	{
	public:
		TArray<FSoftObjectPath> Worlds; // 0x0(0x10)
	};
	...
	{
	public:
		TSet<EJunoBiome> ValidBiomes; // 0x0(0x50)
		FGameplayTagQuery SlotTagQuery; // 0x50(0x48)
		TArray<FSoftObjectPath> Worlds; // 0x98(0x10)
	...
	{
	public:
		TSet<EJunoPOISize> ValidSizes; // 0x0(0x50)
		...
		unsigned char UnknownData01_7[0xE]; // 0x102(0xE) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TSet<EJunoBiome> ValidBiomes; // 0x28(0x50)
		TSet<EJunoCaveGeneratorShellTags> ShellTags; // 0x78(0x50)
		...
		unsigned char UnknownData01_6[0x2]; // 0xEA(0x2) UNKNOWN PROPERTY
		...
		TArray<FJunoCaveGeneratorResourceWorlds> ResourceLevels; // 0x100(0x10)
		TArray<FJunoCaveGeneratorResourceWorlds> VariationResourceLevels; // 0x110(0x10)
		FVector ShellBoundsSize; // 0x120(0x18)
		FVector ShellBoundsCenter; // 0x138(0x18)
		TArray<FTransform> ExitLocations; // 0x150(0x10)
		int32_t NumOfSpawners; // 0x160(0x4)
		unsigned char UnknownData04_6[0x4]; // 0x164(0x4) UNKNOWN PROPERTY
		TArray<FJunoCaveGeneratorPOIMarker> POIMarkers; // 0x168(0x10)
		TArray<FJunoCaveGeneratorTeleporterMarker> TeleporterMarkers; // 0x178(0x10)
		int32_t NumOfAIPointProviders; // 0x188(0x4)
		unsigned char UnknownData05_6[0x4]; // 0x18C(0x4) UNKNOWN PROPERTY
		TMap<EJunoCaveGeneratorLayoutTags, FJunoCaveGeneratorWorldsList> SupportedLayouts; // 0x190(0x50)
		bool bHasFixedEntrance; // 0x1E0(0x1)
		unsigned char UnknownData06_6[0x3]; // 0x1E1(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FJunoCaveRuleChainShell> Shells; // 0x0(0x10)
	...
	{
	public:
		TArray<FJunoCaveRuleChain> PrimaryChains; // 0x0(0x10)
		TArray<FJunoCaveRuleChain> SecondaryChains; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FJunoCaveRuleChainStage> Stages; // 0x50(0x10)
	...
	public:
		...
		TArray<FJunoCaveGeneratorRule> Rules; // 0x10(0x10)
		TArray<FDataRegistryId> SharedRuleIds; // 0x20(0x10)
		EJunoCaveType Type; // 0x30(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x31(0x7) UNKNOWN PROPERTY
		TSet<EJunoBiome> ValidBiomes; // 0x38(0x50)
		FGameplayTagQuery SlotTagQuery; // 0x88(0x48)
		TSet<EJunoCaveGeneratorShellTags> ShellTags; // 0xD0(0x50)
		FGameplayTagQuery ShellQuery; // 0x120(0x48)
		TSet<EJunoCaveGeneratorLayoutTags> LayoutTags; // 0x168(0x50)
		TArray<FJunoCaveGeneratorTypeEntrancePOI> EntrancePOIs; // 0x1B8(0x10)
		TArray<FJunoCaveGeneratorTypeTeleporterRule> TeleporterRules; // 0x1C8(0x10)
	};
	...
	{
	public:
		TMap<FName, int32_t> ResourceWeight; // 0x0(0x50)
	};
	...
	{
	public:
		TWeakObjectPtr<UMaterialInterface*> CaveMaterial; // 0x8(0x20)
		TWeakObjectPtr<UMaterialInterface*> DestructibleCaveMaterial; // 0x28(0x20)
		TWeakObjectPtr<UDataTable*> ThemeResourceDataTable; // 0x48(0x20)
		TWeakObjectPtr<UDataTable*> POIDataTable; // 0x68(0x20)
		TMap<EJunoCaveGeneratorPCGType, FJunoCaveGeneratorPCGResourceMap> PCGTypeWeights; // 0x88(0x50)
		bool bEnabled; // 0xD8(0x1)
		unsigned char UnknownData00_6[0x3]; // 0xD9(0x3) UNKNOWN PROPERTY
		FName Name; // 0xDC(0x4)
		TSet<EJunoBiome> Biomes; // 0xE0(0x50)
		...
		unsigned char UnknownData02_6[0x4]; // 0x184(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> TeleporterClass; // 0x188(0x20)
	};
	...
	{
	public:
		TArray<FJunoCaveGeneratorShellData> Shells; // 0x8(0x10)
		TArray<FJunoCaveGeneratorThemeEntry> Themes; // 0x18(0x10)
		TArray<FJunoCaveGeneratorTypeData> Types; // 0x28(0x10)
	};
	...
	{
	public:
		TArray<FJunoGeneratedCaveShellData> Shells; // 0x0(0x10)
		unsigned char UnknownData00_6[0x20]; // 0x10(0x20) UNKNOWN PROPERTY
		TArray<FJunoPOIData> POIs; // 0x30(0x10)
	...
	public:
		...
		TArray<FSoftObjectPath> Levels; // 0x90(0x10)
		TArray<FSoftObjectPath> HLODLevels; // 0xA0(0x10)
		...
		TWeakObjectPtr<UDataTable*> EncounterCategoryTable; // 0xF8(0x20)
		FName RegistryItemName; // 0x118(0x4)
		int32_t PersistenceVersion; // 0x11C(0x4)
		TArray<FPCGJunoWorldTilePOITeleporter> Teleporters; // 0x120(0x10)
		EJunoPOISlotState SlotState; // 0x130(0x1)
		unsigned char UnknownData01_7[0xF]; // 0x131(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FSoftObjectPath> Levels; // 0x98(0x10)
	...
	public:
		...
		TWeakObjectPtr<UObject*> ThemeObject; // 0x18(0x20)
		...
		TArray<FJunoCaveTeleporterLink> Teleporters; // 0x50(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_2[0x230]; // 0x0(0x230) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UJunoGenerateTileCommandlet*> Commandlet; // 0x10(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x6]; // 0xA2(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UStaticMesh*> Mesh; // 0x30(0x20)
		bool bOverrideMaterials; // 0x50(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x51(0x7) UNKNOWN PROPERTY
		TArray<UMaterialInterface*> Materials; // 0x58(0x10)
		bool bOverrideCollisionEnabled; // 0x68(0x1)
		TEnumAsByte<ECollisionEnabled> CollisionEnabled; // 0x69(0x1)
		bool bOverrideHealth; // 0x6A(0x1)
		unsigned char UnknownData02_6[0x5]; // 0x6B(0x5) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FJunoLifecyclePhase> LifecyclePhases; // 0x0(0x10)
		unsigned char UnknownData00_6[0x1]; // 0x10(0x1) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<char> LifecyclePhaseVisualizations; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x1]; // 0x9(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FJunoPOIBucketWeightEntry> BucketWeights; // 0x58(0x10)
		int32_t BucketWeightSelectionPriority; // 0x68(0x4)
		int32_t WeightedPOISelectionDepth; // 0x6C(0x4)
		TSet<EJunoBiome> ValidCaveSlotBiomes; // 0x70(0x50)
		bool bMaximizeCaveBiomeVariety; // 0xC0(0x1)
		bool bEnforceMinDistanceBetweenCosmeticPOIs; // 0xC1(0x1)
	...
	public:
		...
		TArray<FName> SlotTags; // 0x18(0x10)
	...
	{
	public:
		TWeakObjectPtr<UWorld*> WorldAsset; // 0x8(0x20)
		TWeakObjectPtr<UWorld*> HLODWorldAsset; // 0x28(0x20)
		bool bEnabled; // 0x48(0x1)
		EJunoPOISize Size; // 0x49(0x1)
		unsigned char UnknownData00_6[0x6]; // 0x4A(0x6) UNKNOWN PROPERTY
		TSet<EJunoPOISize> SlotSizes; // 0x50(0x50)
		FVector BoundsSize; // 0xA0(0x18)
		TSet<EJunoBiome> Biomes; // 0xB8(0x50)
		TSet<FName> Tags; // 0x108(0x50)
		EJunoWorldTilePOIType Type; // 0x158(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x159(0x7) UNKNOWN PROPERTY
		FGameplayTagContainer EncounterCapabilities; // 0x160(0x20)
		bool bCanRerollEncounters; // 0x180(0x1)
		unsigned char UnknownData02_6[0x7]; // 0x181(0x7) UNKNOWN PROPERTY
		FScalableFloat RerollCooldownTimeOverride; // 0x188(0x28)
		int32_t EncounterVariantCount; // 0x1B0(0x4)
		unsigned char UnknownData03_6[0x4]; // 0x1B4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UDataTable*> EncounterCategoryTable; // 0x1B8(0x20)
		TArray<FPCGJunoWorldTilePOITeleporter> Teleporters; // 0x1D8(0x10)
		TArray<UClass*> PersistenceMigrations; // 0x1E8(0x10)
		EJunoPOIDistributionMethod DistributionMethod; // 0x1F8(0x1)
		unsigned char UnknownData04_7[0x7]; // 0x1F9(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<AActor*> Actors; // 0x10(0x10)
		TArray<FJunoCreateLevelWorldPartitionGrid> WorldPartitionGrids; // 0x20(0x10)
		...
		TWeakObjectPtr<UWorld*> TemplateWorld; // 0x40(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x20]; // 0x8(0x20) UNKNOWN PROPERTY
		double GenerationFlushDistance; // 0x28(0x8)
		bool InfiniteRange; // 0x30(0x1)
		bool EnabledServer; // 0x31(0x1)
		bool EnabledClient; // 0x32(0x1)
		unsigned char UnknownData01_7[0x3D]; // 0x33(0x3D) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x64]; // 0x24(0x64) UNKNOWN PROPERTY
	...
	{
	public:
		TMap<FName, FPersistenceFrameworkLevelSaveSpawnablePtr> Tiles; // 0x0(0x50)
		TMap<FName, FEventTilesArray> Events; // 0x50(0x50)
		TMap<FName, FJunoReservedAreaPersistentData> ReservedAreas; // 0xA0(0x50)
		TMap<FName, FJunoPOICellDistributionPersistentData> PerCellRarePOICounts; // 0xF0(0x50)
		TMap<FName, FJunoAdditionalPOIAssignmentData> PerCellAdditionalPOIs; // 0x140(0x50)
	};
	...
	{
	public:
		TArray<FDataRegistryId> AdditionalPOIs; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FName, int32_t> POICount; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FBox2D> Tiles; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FJunoReservedAreaPersistentData> ReservedAreas; // 0x0(0x50)
		TMap<FName, FJunoPOICellDistributionPersistentData> PerCellRarePOICounts; // 0x50(0x50)
		TMap<FName, FJunoAdditionalPOIAssignmentData> PerCellAdditionalPOIs; // 0xA0(0x50)
	...
	public:
		TMap<FName, FJunoReservedAreaPersistentData> ReservedAreas; // 0x0(0x50)
		TMap<FName, FJunoPOILayerDistributionData> PerCellLayerDistribution; // 0x50(0x50)
		TMap<FName, FJunoAdditionalPOIAssignmentData> PerCellAdditionalPOIs; // 0xA0(0x50)
		bool bHasAssignedNewGamePOIs; // 0xF0(0x1)
		unsigned char UnknownData00_7[0x7]; // 0xF1(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<FName, FJunoPOICellDistributionPersistentData> Layers; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x116(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x8]; // 0x108(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TSet<FName> RuntimeHashMigrationUpgradedCellNames; // 0x8(0x50)
	};
	...
	{
	public:
		TMap<FName, FJunoWorldPartitionLevelPersistentData> WPLevelPersistentDatas; // 0x0(0x50)
	};
	...
	public:
		...
		TWeakObjectPtr<UWorld*> HLODWorldAsset; // 0x20(0x20)
	...
	{
	public:
		TArray<FJunoWorldTileStreamingLevelEntry> Entries; // 0x108(0x10)
	...
	public:
		...
		TArray<FString> Levels; // 0x10(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UJunoCaveDataCollectionBase*> CaveDataCollection; // 0x8(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr<UWorld*> Terrain; // 0x18(0x20)
		TWeakObjectPtr<UTexture2D*> MiniMapTexture; // 0x38(0x20)
		TWeakObjectPtr<UWorld*> StaticBiomeDecorations; // 0x58(0x20)
		TArray<TWeakObjectPtr> Overlays; // 0x78(0x10)
		TArray<TWeakObjectPtr> PrimaryBiomeResourceVariations; // 0x88(0x10)
		TWeakObjectPtr<UWorld*> PrimaryBiomeResource; // 0x98(0x20)
		TArray<EJunoBiome> SlotBiomes; // 0xB8(0x10)
		...
		TArray<FJunoLayerSwap> LayerSwaps; // 0xD0(0x10)
		TWeakObjectPtr<UDataTable*> POISlots; // 0xE0(0x20)
	...
	{
	public:
		TWeakObjectPtr<UWorld*> TileWorld; // 0x8(0x20)
	...
	public:
		...
		unsigned char UnknownData05_6[0x4]; // 0xF4(0x4) UNKNOWN PROPERTY
		TSet<EJunoBiome> PreferredBiomes; // 0xF8(0x50)
		...
		unsigned char UnknownData09_7[0x4]; // 0x184(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FGuid> Entrances; // 0x10(0x10)
		TArray<FTransform> EntranceTeleporterTransforms; // 0x20(0x10)
	...
	{
	public:
		TArray<FPersistenceFrameworkLevelSaveSpawnablePtr> Shells; // 0x0(0x10)
	};
	...
	public:
		FGuid Guid; // 0x0(0x10)
		TArray<FPersistenceFrameworkLevelSaveSpawnablePtr> GameplayVolumes; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FJunoWorldTileSaveData_Cave_PersistentInfo> Caves; // 0x68(0x10)
		TArray<FJunoWorldTileSaveData_POI_PersistentInfo> POIs; // 0x78(0x10)
	};
	...
	{
	public:
		TMap<FGuid, FJunoPOISlotMetaData> POISlotMetaDatas; // 0x0(0x50)
		TArray<FJunoCaveSurfaceData> CaveSurfaceData; // 0x50(0x10)
	...
	public:
		...
		TArray<FJunoWorldTileSaveData_Cave_PersistentInfo> Caves; // 0x1E8(0x10)
		TArray<FJunoWorldTileSaveData_POI_PersistentInfo> POIs; // 0x1F8(0x10)
	};
	...
	public:
		TMap<FGuid, FJunoPOISlotMetaData> POISlotMetaDatas; // 0x0(0x50)
		TMap<FName, FJunoWorldTileCaveSurfaceSaveData> CaveSurfaceLayerData; // 0x50(0x50)
		int32_t UsedCaveSlotCount; // 0xA0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0xA4(0x4) UNKNOWN PROPERTY
		TMap<FName, FJunoWorldTileOverlayPOIInfo> AppliedOverlayRules; // 0xA8(0x50)
		TMap<FGameplayTag, FJunoWorldTilePOILimitBucket> EncounterPOIBuckets; // 0xF8(0x50)
		TMap<FGameplayTag, FJunoWorldTilePOILimitBucket> CosmeticPOIBuckets; // 0x148(0x50)
		TMap<FGuid, FJunoCaveStateSaveData> CaveStates; // 0x198(0x50)
	};
	...
	{
	public:
		TArray<FJunoCaveSurfaceData> CaveSurfaceData; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x24]; // 0x1C(0x24) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UMaterialInterface*> MaterialOverrides; // 0x30(0x10)
	...
	public:
		...
		TArray<FLandscapeSplineMeshEntry> SplineMeshes; // 0x8(0x10)
	...
	{
	public:
		TArray<FSplineGuide> Guides; // 0x0(0x10)
	};
	...
	public:
		...
		FName Type; // 0xC(0x4)
		TArray<float> LayerWeights; // 0x10(0x10)
	...
	public:
		...
		TWeakObjectPtr<UWorld*> Level; // 0x20(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr<UDataTable*> PotentialPOIs; // 0x18(0x20)
		TWeakObjectPtr<UTexture2D*> TerrainHeightPatch; // 0x38(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr<UAmbientAudioDataAsset*> Level; // 0x18(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr<UDataTable*> BiomeElements; // 0x8(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x364(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FRouteClassAvoidance> RouteClassesAvoidances; // 0x68(0x10)
	...
	public:
		...
		TArray<FJunoLivingWorldStaticPointProviderClusterEntryData> DataList; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FVector> InternalPoints; // 0x18(0x10)
	...
	public:
		...
		TArray<int32_t> SpawnedPointsIndex; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<TWeakObjectPtr> PointProviders; // 0x0(0x10)
	};
	...
	public:
		FName Name; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<UPCGSpatialData*> Data; // 0x8(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x190(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<ALandmassProceduralRoute*> LandmassProceduralRoute; // 0x190(0x8)
		unsigned char UnknownData00_7[0x8]; // 0x198(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x10]; // 0x190(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
		TArray<FPCGJunoSpawnLivingWorldStaticPointTag> ConditionalTags; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FPCGJunoSpawnLivingWorldStaticPointTagConditionSet> ConditionalTagsSets; // 0x38(0x10)
		TArray<FGraphRoadLengthTags> LengthTags; // 0x48(0x10)
	...
	public:
		...
		TArray<EJunoBiome> AllowedBiomes; // 0x18(0x10)
		bool bCanBeSecondaryBiome; // 0x28(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x29(0x7) UNKNOWN PROPERTY
		TArray<EJunoBiomeHabitat> AllowedHabitats; // 0x30(0x10)
