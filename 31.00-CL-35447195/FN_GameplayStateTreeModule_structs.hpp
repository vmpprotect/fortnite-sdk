...
namespace SDK
{
	...
	public:
		...
		TArray QueryConfig; // 0x18(0x10)
		TEnumAsByte RunMode; // 0x28(0x1)
		unsigned char UnknownData03_7[0x1F]; // 0x29(0x1F) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0x3F(0x1) UNKNOWN PROPERTY
		UAITask_MoveTo MoveToTask; // 0x40(0x8)
		TScriptInterface TaskOwner; // 0x48(0x10)
	};
