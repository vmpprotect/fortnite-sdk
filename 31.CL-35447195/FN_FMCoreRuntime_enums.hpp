...
namespace SDK
{
	...
	enum EMusicInterval
	{
		...
		EMusicInterval__Min7 = A,
		EMusicInterval__Maj7 = B,
		EMusicInterval__Num = C,
	};
	...
	enum EHarmonicProgression
	{
		...
		EHarmonicProgression__IV = A,
		EHarmonicProgression__V = B,
		EHarmonicProgression__VI = C,
		EHarmonicProgression__VII = D,
		EHarmonicProgression__PlusI = E,
		EHarmonicProgression__Num = F,
	};
