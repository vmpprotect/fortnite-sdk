...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte CollisionChannel; // 0x20(0x1)
	...
	public:
		...
		unsigned char UnknownData05_7[0x7]; // 0x49(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray Triggers; // 0x10(0x10)
		TArray Responses; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x7]; // 0x21(0x7) UNKNOWN PROPERTY
		FVector MaxAngularVelocity; // 0x28(0x18)
		bool bClampMaxPosition; // 0x40(0x1)
		unsigned char UnknownData06_6[0x7]; // 0x41(0x7) UNKNOWN PROPERTY
		FVector MaxPosition; // 0x48(0x18)
		bool bClampMinPosition; // 0x60(0x1)
		unsigned char UnknownData07_6[0x7]; // 0x61(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		TArray AxisValues; // 0x0(0x10)
		TArray ActionValues; // 0x10(0x10)
