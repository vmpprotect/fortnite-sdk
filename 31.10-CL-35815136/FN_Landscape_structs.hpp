...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<ELandscapeBlendMode> BlendMode; // 0x20(0x1)
	...
	{
	public:
		TArray<UTexture2D*> Textures; // 0x0(0x10)
	...
	public:
		...
		TArray<UMaterialInterface*> OverrideMaterials; // 0x8(0x10)
		...
		unsigned char UnknownData04_6[0x3]; // 0x17D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x3]; // 0x199(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x7]; // 0x1B1(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		...
		TEnumAsByte<LandscapeSplineMeshOrientation> orientation; // 0x50(0x1)
		TEnumAsByte<ESplineMeshAxis> ForwardAxis; // 0x51(0x1)
		TEnumAsByte<ESplineMeshAxis> UpAxis; // 0x52(0x1)
	...
	public:
		...
		TEnumAsByte<ELandscapeLayerBlendType> BlendType; // 0x4(0x1)
	...
	public:
		...
		unsigned char UnknownData00_7[0x2F]; // 0x9(0x2F) UNKNOWN PROPERTY
	};
