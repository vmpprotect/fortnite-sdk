...
namespace SDK
{
	...
	{
	public:
		TArray<int32_t> IntArray; // 0x28(0x10)
		TArray<FDataAssetDirectoryTestSimpleStruct> SimpleStructArray; // 0x38(0x10)
	...
	{
	public:
		TMap<FString, int32_t> StringIntMap; // 0x28(0x50)
		TMap<FString, int32_t> ShrinkStringIntMap; // 0x78(0x50)
		TMap<FString, int32_t> GrowStringIntMap; // 0xC8(0x50)
		TMap<int32_t, FDataAssetDirectoryTestSimpleStruct> IntStructMap; // 0x118(0x50)
	...
	public:
		...
		TArray<UObject*> PatchedAssets; // 0x1A0(0x10)
		...
		unsigned char UnknownData01_7[0x11]; // 0x1BF(0x11) UNKNOWN PROPERTY
