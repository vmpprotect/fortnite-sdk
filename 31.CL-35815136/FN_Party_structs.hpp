...
namespace SDK
{
	...
	public:
		...
		TArray<FPartyMemberJoinInProgressResponse> Responses; // 0x38(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x10]; // 0x18(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x37]; // 0x151(0x37) UNKNOWN PROPERTY
		FString JoinMethod; // 0x188(0x10)
		unsigned char UnknownData03_6[0x30]; // 0x198(0x30) UNKNOWN PROPERTY
		FPartyMemberJoinInProgressData JoinInProgressData; // 0x1C8(0x48)
		unsigned char UnknownData04_7[0x60]; // 0x210(0x60) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x9]; // 0x18(0x9) UNKNOWN PROPERTY
		FPartyPrivacySettings PrivacySettings; // 0x21(0x3)
		unsigned char UnknownData01_6[0x34]; // 0x24(0x34) UNKNOWN PROPERTY
		TArray<FPartyPlatformSessionInfo> PlatformSessions; // 0x58(0x10)
	...
	public:
		...
		TArray<USocialChatChannel*> ListenChannels; // 0x18(0x10)
