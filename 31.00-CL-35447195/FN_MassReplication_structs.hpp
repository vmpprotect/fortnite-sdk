...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData01_1[0x2]; // 0x0(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData03_3[0x20]; // 0x0(0x20) UNKNOWN PROPERTY
		TArray BubbleInfos; // 0x20(0x10)
		unsigned char UnknownData04_6[0x2360]; // 0x30(0x2360) UNKNOWN PROPERTY
		UMassReplicatorBase CachedReplicator; // 0x2390(0x8)
		unsigned char UnknownData05_7[0x8]; // 0x2398(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xC]; // 0x0(0xC) UNKNOWN PROPERTY
	};
