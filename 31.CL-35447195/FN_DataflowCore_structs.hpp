...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData01_1[0x1]; // 0x0(0x1) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData02_7[0xC8]; // 0x0(0xC8) UNKNOWN PROPERTY
		bool bActive; // 0xC8(0x1)
		unsigned char UnknownData03_7[0xCF]; // 0xC9(0xCF) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray Inputs; // 0x198(0x10)
		int32_t SelectedIndex; // 0x1A8(0x4)
		FDataflowAnyType Result; // 0x1AC(0x1)
		unsigned char UnknownData01_7[0x3]; // 0x1AD(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0x1B1(0x7) UNKNOWN PROPERTY
	};
