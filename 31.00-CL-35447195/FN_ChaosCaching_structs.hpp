...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData05_7[0xF8]; // 0x88(0xF8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray KeyTimestamps; // 0x38(0x10)
	};
	...
	{
	public:
		TArray CompressedRichCurves; // 0x0(0x10)
	};
