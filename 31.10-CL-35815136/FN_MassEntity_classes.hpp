...
namespace SDK
{
	...
	public:
		...
		TArray<UMassProcessor*> ProcessorCDOs; // 0x100(0x10)
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0x59(0x2) UNKNOWN PROPERTY
		bool bRequiresGameThreadExecution; // 0x5B(0x1)
		unsigned char UnknownData02_7[0x64]; // 0x5C(0x64) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x24]; // 0xDC(0x24) UNKNOWN PROPERTY
	...
	{
	public:
		TMap<FName, UMassModuleSettings*> ModuleSettings; // 0x30(0x50)
