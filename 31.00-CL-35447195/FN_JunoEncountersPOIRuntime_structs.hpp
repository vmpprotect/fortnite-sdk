...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr VillagerProvider; // 0x0(0x8)
	...
	public:
		...
		TWeakObjectPtr VillagerProvider; // 0x50(0x8)
	};
	...
	public:
		...
		TWeakObjectPtr ChosenEncounterDefinition; // 0x8(0x20)
		TWeakObjectPtr ChosenFaction; // 0x28(0x20)
	...
	public:
		...
		TMap Variables; // 0x58(0x50)
		TMap PersistentValues; // 0xA8(0x50)
		bool bIsPOISetup; // 0xF8(0x1)
		bool bEncounterFinished; // 0xF9(0x1)
		bool bFactionChosen; // 0xFA(0x1)
		unsigned char UnknownData05_7[0x5]; // 0xFB(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray RetainmentEntries; // 0x48(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr HLODActorClass; // 0x0(0x20)
	...
	public:
		...
		TArray HLODActorsEntries; // 0xE0(0x10)
		TArray DestroyActorsEntries; // 0xF0(0x10)
		TArray POIVariables; // 0x100(0x10)
		FGameplayTagQuery RepeatWeightMitigationIdentityQuery; // 0x110(0x48)
		FScalableFloat RepeatWeightMitigationFactor; // 0x158(0x28)
		TArray SuccessFollowupEncounters; // 0x180(0x10)
		TArray FailureFollowupEncounters; // 0x190(0x10)
	...
	public:
		...
		unsigned char UnknownData05_6[0x6]; // 0x82(0x6) UNKNOWN PROPERTY
		...
		TWeakObjectPtr SpawnedActor; // 0xD4(0x8)
		...
		unsigned char UnknownData09_7[0x8]; // 0xF0(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr CampActor; // 0x48(0x8)
		AActor UserActor; // 0x50(0x8)
	...
	public:
		...
		TWeakObjectPtr Villager; // 0x38(0x8)
