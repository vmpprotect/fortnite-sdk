...
namespace SDK
{
	...
	public:
		...
		TArray CachedListOfUnequippableWeapons; // 0x50(0x10)
	...
	public:
		...
		TEnumAsByte TeleportToPlayerRunMode; // 0x80(0x1)
	...
	public:
		...
		TEnumAsByte TeleportToLandscapeRunMode; // 0x80(0x1)
		unsigned char UnknownData02_6[0x7]; // 0x81(0x7) UNKNOWN PROPERTY
		...
		TEnumAsByte TeleportToNavmeshRunMode; // 0xE0(0x1)
	...
	public:
		...
		TWeakObjectPtr Encounter; // 0x368(0x20)
		TArray PointProviderClasses; // 0x388(0x10)
		bool bRegisterReservoir; // 0x398(0x1)
		unsigned char UnknownData01_7[0x7]; // 0x399(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray RaritiesConfiguration; // 0x8(0x10)
	...
	{
	public:
		TArray PossibleVisitors; // 0x0(0x10)
	...
	public:
		...
		TWeakObjectPtr CreaturePawn; // 0x10(0x8)
	};
	...
	public:
		TWeakObjectPtr VillagerProvider; // 0x0(0x8)
		TWeakObjectPtr Villager; // 0x8(0x8)
	...
	public:
		...
		unsigned char UnknownData01_7[0x1]; // 0xF(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x7]; // 0x389(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray PossibleFTUETagQueryPickingConfigurations; // 0x398(0x10)
		TArray GEsToAddToFTUENPC; // 0x3A8(0x10)
		...
		unsigned char UnknownData01_7[0x6]; // 0x48A(0x6) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray PointProviderClasses; // 0x390(0x10)
	};
	...
	public:
		...
		TArray PointProviders; // 0x38(0x10)
		unsigned char UnknownData01_7[0x50]; // 0x48(0x50) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr AssignedPointProvider; // 0x0(0x8)
		unsigned char UnknownData02_6[0x10]; // 0x8(0x10) UNKNOWN PROPERTY
		TWeakObjectPtr EventData; // 0x18(0x8)
	...
	public:
		...
		TScriptInterface EncounterPointProvider; // 0x8(0x10)
		...
		unsigned char UnknownData03_7[0x10]; // 0x80(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr EventData; // 0x60(0x8)
		TWeakObjectPtr CachedRootJunoAIManagement; // 0x68(0x8)
	...
	{
	public:
		TWeakObjectPtr CachedRootAIPersistence; // 0x8(0x8)
