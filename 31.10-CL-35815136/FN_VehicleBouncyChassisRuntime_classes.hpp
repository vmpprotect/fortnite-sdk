...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x674(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x3]; // 0x6DD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x114]; // 0x794(0x114) UNKNOWN PROPERTY
