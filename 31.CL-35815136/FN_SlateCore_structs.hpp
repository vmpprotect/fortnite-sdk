...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<ESlateBrushDrawType> DrawAs; // 0x1C(0x1)
		TEnumAsByte<ESlateBrushTileType> Tiling; // 0x1D(0x1)
		TEnumAsByte<ESlateBrushMirrorType> Mirroring; // 0x1E(0x1)
		TEnumAsByte<ESlateBrushImageType> ImageType; // 0x1F(0x1)
		...
		unsigned char UnknownData01_5[0x13]; // 0x95(0x13) UNKNOWN PROPERTY
		FName ResourceName; // 0xA8(0x4)
		unsigned char UnknownData02_7[0x4]; // 0xAC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ESlateBrushRoundingType> RoundingType; // 0x38(0x1)
	...
	{
	public:
		unsigned char UnknownData00_1[0x58]; // 0x20(0x58) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x644(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x7D8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<EVerticalAlignment> DownArrowAlign; // 0x530(0x1)
		unsigned char UnknownData02_7[0xF]; // 0x531(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0x50(0x1) UNKNOWN PROPERTY
		bool bForceMonospaced; // 0x51(0x1)
		unsigned char UnknownData02_6[0x2]; // 0x52(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0xC]; // 0x74(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xE]; // 0x2D2(0xE) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x514(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x20(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x20]; // 0x20(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x60]; // 0x20(0x60) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x10(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FTypefaceEntry> Fonts; // 0x0(0x10)
	};
	...
	{
	public:
		TEnumAsByte<ESlateCheckBoxType> CheckBoxType; // 0x8(0x1)
		...
		unsigned char UnknownData01_7[0x8]; // 0x948(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0x221(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x174(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x8]; // 0xCE8(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0xD]; // 0xFC3(0xD) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x434(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xE]; // 0xC2(0xE) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0xC]; // 0xE04(0xC) UNKNOWN PROPERTY
		FSlateBrush BackgroundBrush; // 0xE10(0xB0)
		FSlateColor ForegroundColor; // 0xEC0(0x14)
		unsigned char UnknownData02_6[0xC]; // 0xED4(0xC) UNKNOWN PROPERTY
		FSlateBrush HorizontalSeparatorBrush; // 0xEE0(0xB0)
		float HorizontalSeparatorThickness; // 0xF90(0x4)
		unsigned char UnknownData03_7[0xC]; // 0xF94(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0xBB4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0xC]; // 0x12D4(0xC) UNKNOWN PROPERTY
		FSlateBrush OutlineBrush; // 0x12E0(0xB0)
		FSlateColor OutlineColor; // 0x1390(0x14)
		unsigned char UnknownData02_6[0xC]; // 0x13A4(0xC) UNKNOWN PROPERTY
		FSlateBrush BorderBrush; // 0x13B0(0xB0)
		FSlateColor BorderColor; // 0x1460(0x14)
		unsigned char UnknownData03_6[0xC]; // 0x1474(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_7[0xC]; // 0x15F4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x3D0]; // 0x3D0(0x3D0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x3625(0x3) UNKNOWN PROPERTY
