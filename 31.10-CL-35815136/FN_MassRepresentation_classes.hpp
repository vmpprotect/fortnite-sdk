...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_3[0x968]; // 0xC0(0x968) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x320]; // 0xC0(0x320) UNKNOWN PROPERTY
		FMassRepresentationUpdateParams UpdateParams; // 0x3E0(0x1)
		unsigned char UnknownData01_7[0xF]; // 0x3E1(0xF) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<UClass*> TemplateActors; // 0x38(0x10)
		...
		unsigned char UnknownData01_7[0x58]; // 0x78(0x58) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FMassInstancedStaticMeshInfo> InstancedStaticMeshInfos; // 0xA0(0x10)
		unsigned char UnknownData00_7[0x150]; // 0xB0(0x150) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0xC88]; // 0xC0(0xC88) UNKNOWN PROPERTY
		UScriptStruct* FilterTag; // 0xD48(0x8)
		bool bDoAdjustmentFromCount; // 0xD50(0x1)
		unsigned char UnknownData01_7[0xF]; // 0xD51(0xF) UNKNOWN PROPERTY
