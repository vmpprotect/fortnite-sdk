...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x9EC(0x4) UNKNOWN PROPERTY
		...
		void SetFlappingParameters(UFXSystemComponent FlyingTrailFX, TArray& AudioComponents, AFortPlayerPawn PlayerPawn, float FlappingAlpha, float RollCombined, float RollingAlpha, float PitchAlpha, bool bIsBoosting, bool bIsAscending, bool bAllowWingFlap, bool bIsSkimming, float Speed, bool bIsDiving, float CurrentHeight); // Flags: Final|Native|Private|HasOutParms|BlueprintCallable 0x7FF414CF8538
	};
	...
	{
	public:
		TWeakObjectPtr WingsSkeletalMesh; // 0x9B0(0x8)
		TWeakObjectPtr SkimFX; // 0x9B8(0x8)
		TWeakObjectPtr SkimAudioComponent; // 0x9C0(0x8)
		TWeakObjectPtr SkimLoopSound; // 0x9C8(0x8)
		...
		void ShowWingFX(FVector SkimLocationLeft, FVector SkimNormalLeft, float SkimDistanceLeft, FVector SkimLocationRight, FVector SkimNormalRight, float SkimDistanceRight); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable 0x7FF414CF8618
	};
	...
	public:
		...
		unsigned char UnknownData09_6[0x10]; // 0x98(0x10) UNKNOWN PROPERTY
		FScalableFloat NativeFlyingSpeedBase; // 0xA8(0x28)
		unsigned char UnknownData10_6[0x8]; // 0xD0(0x8) UNKNOWN PROPERTY
		FScalableFloat NativeFlyingSpeedAddedAtMaxDistanceFromCeilingHeight; // 0xD8(0x28)
		unsigned char UnknownData11_6[0x8]; // 0x100(0x8) UNKNOWN PROPERTY
		FScalableFloat NativeFlyingDownZSpeedAddedWhileFalling; // 0x108(0x28)
		unsigned char UnknownData12_6[0x8]; // 0x130(0x8) UNKNOWN PROPERTY
		FScalableFloat NativeFlyingHeightDecayMin; // 0x138(0x28)
		unsigned char UnknownData13_6[0x8]; // 0x160(0x8) UNKNOWN PROPERTY
		FScalableFloat NativePreCrashWindupDuration; // 0x168(0x28)
		unsigned char UnknownData14_6[0x8]; // 0x190(0x8) UNKNOWN PROPERTY
		FScalableFloat NativeFlyingInputWeightHorizontal; // 0x198(0x28)
		unsigned char UnknownData15_6[0x8]; // 0x1C0(0x8) UNKNOWN PROPERTY
		FScalableFloat NativeFlyingInputWeightLookDirection; // 0x1C8(0x28)
		unsigned char UnknownData16_6[0x4]; // 0x1F0(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData17_7[0x77]; // 0x2F9(0x77) UNKNOWN PROPERTY
		...
		bool UseNativeCalculation(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414CF86F8
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x10]; // 0x168(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData06_3[0x2]; // 0x78(0x2) UNKNOWN PROPERTY
		EWingedFlyingStatus FlyingStatus; // 0x7A(0x1)
		unsigned char UnknownData07_6[0x1]; // 0x7B(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x1]; // 0xA0(0x1) UNKNOWN PROPERTY
		bool bIsStartingFlying; // 0xA1(0x1)
		unsigned char UnknownData10_6[0x2]; // 0xA2(0x2) UNKNOWN PROPERTY
		float FlyingEnergy; // 0xA4(0x4)
		unsigned char UnknownData11_7[0x28]; // 0xA8(0x28) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData05_3[0x10]; // 0x128(0x10) UNKNOWN PROPERTY
		...
		TArray FlyingStatusConfigs; // 0x188(0x10)
		...
		unsigned char UnknownData07_6[0x4]; // 0x1E4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x180]; // 0x1118(0x180) UNKNOWN PROPERTY
		...
		bool IsClientReplaying(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414CF8D18
		void HandleFlyingStatusChanged(UFortMovementMode_WingedFlyingRuntimeData MoveStatus, EWingedFlyingStatus NewStatus, bool bIsActive, FGameplayTag& FailureTag); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414CF8C38
		void HandleFlyingStatusActivationFailed(EWingedFlyingStatus FailedStatus, FGameplayTag& FailureTag); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414CF8B58
		void CanStartFlyingStatus(UFortMovementMode_WingedFlyingRuntimeData MoveStatus, EWingedFlyingStatus StatusToStart, bool& bOutCanStart, FGameplayTag& OutFailureTag); // Flags: Native|Event|Protected|HasOutParms|BlueprintEvent|Const 0x7FF414CF8A78
		bool CanEndFlyingStatus(UFortMovementMode_WingedFlyingRuntimeData MoveStatus, EWingedFlyingStatus StatusToEnd, float ElapsedDuration); // Flags: Native|Event|Protected|BlueprintEvent|Const 0x7FF414CF8998
		void CanContinueFlyingStatus(UFortMovementMode_WingedFlyingRuntimeData MoveStatus, EWingedFlyingStatus StatusToContinue, float ElapsedDuration, bool& bOutCanContinue, FGameplayTag& OutFailureTag); // Flags: Native|Event|Protected|HasOutParms|BlueprintEvent|Const 0x7FF414CF88B8
		void BlueprintUpdateForMovement(UFortMovementMode_WingedFlyingRuntimeData MoveStatus, float DeltaTime, FVector& InVelocity, FVector& InAcceleration, FVector& OutNewVelocity, FVector& OutNewAcceleration); // Flags: Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 0x7FF414CF87D8
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x7]; // 0xC1(0x7) UNKNOWN PROPERTY
		UClass FlyingMovementModeExtension; // 0xC8(0x8)
		FGameplayTagContainer TagsToEnableSkimmingCheck; // 0xD0(0x20)
		TEnumAsByte SkimCheckTraceChannel; // 0xF0(0x1)
		unsigned char UnknownData06_6[0x3]; // 0xF1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0xB0]; // 0x158(0xB0) UNKNOWN PROPERTY
		...
		void UpdateCurrentFlyingEnergy(float NewFlyingEnergy, bool bForceUpdateFX); // Flags: Final|BlueprintCosmetic|Native|Public|BlueprintCallable 0x7FF414CF96B8
		void StartFlying(FFortMovementMode_WingedFlyingCreationData& CreationData); // Flags: BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 0x7FF414CF95D8
		void StartCustomFlying(UClass FlyingMMEToStart, FFortMovementMode_WingedFlyingCreationData& CreationData); // Flags: Final|BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 0x7FF414CF94F8
		void HandleRightSkimCheckComplete(FHitResult& HitResult); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414CF9418
		void HandleOwnerASCInitialized(UFortAbilitySystemComponent AbilitySystemComponent, AFortPlayerPawn AffectedPawn); // Flags: Final|Native|Protected 0x7FF414CF9338
		void HandleLeftSkimCheckComplete(FHitResult& HitResult); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414CF9258
		void HandleForwardSpeedUpdated(float NewForwardSpeed); // Flags: Event|Public|BlueprintEvent 0x7FF414CF9178
		void HandleFlyingMoveStatusUpdated(UFortMovementMode_WingedFlyingRuntimeData MoveStatus); // Flags: Native|Event|Public|BlueprintEvent 0x7FF414CF9098
		void HandleAddedDownZVelocityUpdated(float NewAddedDownZVelocity); // Flags: Event|Public|BlueprintEvent 0x7FF414CF8FB8
		FVector2D GetLocalFlyingMoveActionValue(); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 0x7FF414CF8ED8
		void EndFlying(); // Flags: Final|BlueprintCosmetic|Native|Public|BlueprintCallable 0x7FF414CF8DF8
	};


	// Class SunRoseFlyingRuntime.FortWeaponWings
	// Inherited from AFortWeapon -> AActor -> UObject
	// Size: 0x130 (0x1710 - 0x15E0)
	class AFortWeaponWings : public AFortWeapon	
	{
	public:
		unsigned char UnknownData03_3[0x30]; // 0x15E0(0x30) UNKNOWN PROPERTY
		UMaterialInstanceDynamic WingsMaterialInstance; // 0x1610(0x8)
		FGameplayTag IsFlyingGameplayTag; // 0x1618(0x4)
		FName IsFallingAudioParamName; // 0x161C(0x4)
		FName FeatherDissolveName; // 0x1620(0x4)
		FName ReplenishAnimationName; // 0x1624(0x4)
		USoundBase OutOfEnergy2DSound; // 0x1628(0x8)
		FGameplayTagContainer OwnedGameplayTags; // 0x1630(0x20)
		UFortAbilitySystemComponent AbilitySystemComponent; // 0x1650(0x8)
		UFortHealthSet HealthSet; // 0x1658(0x8)
		TEnumAsByte PrimarySurfaceType; // 0x1660(0x1)
		TEnumAsByte WeaponResponseType; // 0x1661(0x1)
		unsigned char UnknownData04_6[0x6]; // 0x1662(0x6) UNKNOWN PROPERTY
		UClass DamageGameplayEffectClass; // 0x1668(0x8)
		FGameplayTag SetByCallerDamageTag; // 0x1670(0x4)
		unsigned char UnknownData05_6[0x4]; // 0x1674(0x4) UNKNOWN PROPERTY
		FGameplayTagContainer TagsToPreventReload; // 0x1678(0x20)
		FScalableFloat ServerMeshRelativeRotationRoll; // 0x1698(0x28)
		FScalableFloat ServerMeshRelativeLocationY; // 0x16C0(0x28)
		FScalableFloat ServerMeshRelativeLocationZ; // 0x16E8(0x28)
		...
		void TryResetADSInput(AFortWeapon Weapon); // Flags: Final|Native|Protected 0x7FF414CF9BF8
		void NativeUpdateEnergyFX(bool bForceUpdate); // Flags: Final|BlueprintCosmetic|Native|Public|BlueprintCallable 0x7FF414CF9B18
		void HandleWeaponAttachmentChanged(AFortWeapon NewWeapon, AFortWeapon PrevWeapon); // Flags: Final|Native|Protected 0x7FF414CF9A38
		void HandleSecondaryFirePressed(AFortWeapon Weapon); // Flags: Event|Protected|BlueprintEvent 0x7FF414CF9958
		void HandleDBNOStateChanged(AFortPawn FortPawn, bool bInIsDBNO); // Flags: Final|Native|Protected 0x7FF414CF9878
		void BP_ModifyIncomingDamage(float Damage, FGameplayTagContainer& DamageTags, FHitResult& DamageHit, AController EventInstigator, AActor DamageCauser, float& OutNewDamage); // Flags: BlueprintAuthorityOnly|Event|Protected|HasOutParms|BlueprintEvent 0x7FF414CF9798
	};
	...
	public:
		...
		void TraceForWorldAndWater(AActor PlayerPawn, FVector& TraceStart, FVector& TraceEnd, bool& bIsBlockingHit, FHitResult& ClosestHit); // Flags: Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 0x7FF414CFA4B8
		void SetInputActionDisplayContext(AFortPawn PlayerPawn, UFortInputMappingContext InputMappingContext); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF414CFA3D8
		float GetFlyingStatusElapsedTime(EWingedFlyingStatus FlyingStatus, UFortMovementMode_WingedFlyingRuntimeData MoveStatus); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414CFA2F8
		void GetFlyingDuration(); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414CFA218
		float GetDodgeElapsedTime(UFortMovementMode_WingedFlyingRuntimeData MoveStatus); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414CFA138
		void FlyingStatusRemoveFlags(EWingedFlyingStatus Status, int32_t FlagsToRemove, EWingedFlyingStatus& NewStatus); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 0x7FF414CFA058
		bool FlyingStatusHasAnyFlags(EWingedFlyingStatus Status, int32_t Flags); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414CF9F78
		bool FlyingStatusHasAllFlags(EWingedFlyingStatus Status, int32_t Flags); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414CF9E98
		void FlyingStatusAddFlags(EWingedFlyingStatus Status, int32_t FlagsToAdd, EWingedFlyingStatus& NewStatus); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 0x7FF414CF9DB8
		void ClearInputActionDisplayContext(AFortPawn PlayerPawn, UFortInputMappingContext InputMappingContext); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF414CF9CD8
	};
	...
	// Size: 0x80 (0x1490 - 0x1410)
	class USunRoseFlying_PlayerAnimInstance : public UFortPlayerAnimInstanceProxy	
	{
	public:
		FGameplayTag AscenderTag; // 0x1410(0x4)
		FGameplayTag GrindRailsTag; // 0x1414(0x4)
		FGameplayTag WingedFlightTag; // 0x1418(0x4)
		FGameplayTag WingsForceCrashTag; // 0x141C(0x4)
		FGameplayTag WingsLeapingTag; // 0x1420(0x4)
		float CurrentHeightAboveWorld; // 0x1424(0x4)
		float Fuel; // 0x1428(0x4)
		float GlidePitch; // 0x142C(0x4)
		float GlidePitchAlpha; // 0x1430(0x4)
		float GlidePitchInterp; // 0x1434(0x4)
		float GlidePitchTarget; // 0x1438(0x4)
		float GlideRoll; // 0x143C(0x4)
		float GlideRollCombined; // 0x1440(0x4)
		float GlideRollCombinedTarget; // 0x1444(0x4)
		float GlideRollInterp; // 0x1448(0x4)
		float GroundBlendTime; // 0x144C(0x4)
		float pelvis; // 0x1450(0x4)
		float PitchAlpha; // 0x1454(0x4)
		float RollAlpha; // 0x1458(0x4)
		float SlowDownOrLandAlpha; // 0x145C(0x4)
		float SlowDownOrLandTarget; // 0x1460(0x4)
		float SlowSpeedAlpha; // 0x1464(0x4)
		float YawAlpha; // 0x1468(0x4)
		float YawBlend; // 0x146C(0x4)
		int32_t RandomInteger; // 0x1470(0x4)
		bool bIsAllowWingFlap : 1; // 0x1474:0(0x1)
		bool bIsAscending : 1; // 0x1474:1(0x1)
		bool bIsBoostStartEnd : 1; // 0x1474:2(0x1)
		bool bIsDodgeLeft : 1; // 0x1474:3(0x1)
		bool bIsDodgeRight : 1; // 0x1474:4(0x1)
		bool bIsExtBoostEarly : 1; // 0x1474:5(0x1)
		bool bIsFlyingStart : 1; // 0x1474:6(0x1)
		bool bIsForceDive : 1; // 0x1474:7(0x1)
		bool bIsLeapInterruptible : 1; // 0x1475:0(0x1)
		bool bIsHighWithNoFuel : 1; // 0x1475:1(0x1)
		bool bIsOnAscender : 1; // 0x1475:2(0x1)
		bool bIsOnGrindRail : 1; // 0x1475:3(0x1)
		bool bIsPlayDiveHitToIdle : 1; // 0x1475:4(0x1)
		bool bIsPlayLandAdditive : 1; // 0x1475:5(0x1)
		bool bIsWingLeaping : 1; // 0x1475:6(0x1)
		bool bIsWingReplenish : 1; // 0x1475:7(0x1)
		bool bIsWingsBoosting : 1; // 0x1476:0(0x1)
		bool bIsWingsCrashing : 1; // 0x1476:1(0x1)
		bool bIsWingsFlying : 1; // 0x1476:2(0x1)
		bool bIsDiveStart : 1; // 0x1476:3(0x1)
		bool bToBoosting : 1; // 0x1476:4(0x1)
		unsigned char UnknownData01_7[0x19]; // 0x1477(0x19) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xA]; // 0x796(0xA) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0xB44(0x4) UNKNOWN PROPERTY
		TArray TelegraphCollisionObjectTypes; // 0xB48(0x10)
		float TelegraphInterpSpeed; // 0xB58(0x4)
		unsigned char UnknownData04_6[0x2C]; // 0xB5C(0x2C) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x4]; // 0xB9C(0x4) UNKNOWN PROPERTY
		...
		void UpdateTelegraph(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414CFA758
		void EndTelegraph(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414CFA678
		void BeginTelegraph(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414CFA598
	};
