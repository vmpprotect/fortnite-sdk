...
namespace SDK
{
	...
	public:
		...
		TArray<FSparksCameraPoolWrapper> Pools; // 0x28(0x10)
	...
	{
	public:
		TArray<float> TimeStamps; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<AActor*> PreferredTarget; // 0xC(0x8)
	...
	public:
		...
		TArray<FSparksCameraDirectorSequenceEntry> Entries; // 0x18(0x10)
	};
