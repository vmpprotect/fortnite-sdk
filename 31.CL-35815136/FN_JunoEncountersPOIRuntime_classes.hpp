...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UClass*> EncounterPrefabClass; // 0x100(0x20)
		TArray<FGameplayTagQuery> VariantQueries; // 0x120(0x10)
		FScalableFloat RerollCooldownTime; // 0x130(0x28)
		TWeakObjectPtr<AJunoPOIGameplayVolume*> POIPlayspaceVolume; // 0x158(0x8)
		TWeakObjectPtr<AJunoPOIEncounterPrefab*> EncounterPrefab; // 0x160(0x8)
		unsigned char UnknownData01_6[0x18]; // 0x168(0x18) UNKNOWN PROPERTY
		FJunoPOIEncounterSaveData EncounterConfigData; // 0x180(0x160)
		TWeakObjectPtr<UDataTable*> EncounterCategoryTable; // 0x2E0(0x20)
		unsigned char UnknownData02_7[0x68]; // 0x300(0x68) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x10]; // 0x390(0x10) UNKNOWN PROPERTY
		FJunoLivingWorldPointProviderEventLimiter EventLimiter; // 0x3A0(0x20)
		TArray<FJunoEncounterConditionalTags> ConditionalTags; // 0x3C0(0x10)
		FGuid SavedActorGuid; // 0x3D0(0x10)
		unsigned char UnknownData01_7[0x20]; // 0x3E0(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x9DA(0x2) UNKNOWN PROPERTY
		TWeakObjectPtr<UJunoPOIEncounterPlayspaceComponent*> POIPlayspaceComponent; // 0x9DC(0x8)
		unsigned char UnknownData01_7[0x4]; // 0x9E4(0x4) UNKNOWN PROPERTY
		...
		void OnRep_EncounterShouldBeLoaded(); // Flags: Final|Native|Private, Memory Exec: 0x7FF74E9225A0(relative to base address)
		void OnRep_EncounterInitialized(); // Flags: Final|Native|Private, Memory Exec: 0x7FF751C26C28(relative to base address)
	};
	...
	public:
		...
		TWeakObjectPtr<UJunoPOIEncounterPlayspaceComponent*> POIEncountersPlayspace; // 0x298(0x8)
