...
namespace SDK
{
	...
	public:
		...
		TArray<FDelMarAIDifficultySpawnInfo> BotSpawnInfo; // 0x18(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> SlotTemplate; // 0x0(0x20)
		TWeakObjectPtr<UDataTable*> VehicleSlotCosmeticDataTable; // 0x20(0x20)
	};
	...
	public:
		TWeakObjectPtr<UCosmeticLoadoutSlotTemplate*> SlotTemplate; // 0x0(0x20)
		TWeakObjectPtr<UObject*> EquippedItemDefinitionObject; // 0x20(0x20)
	};
	...
	{
	public:
		TArray<FDelMarCosmeticLoadoutSlotData> LoadoutSlots; // 0x8(0x10)
	...
	{
	public:
		TWeakObjectPtr<UObject*> EquippedItemDefinitionObject; // 0x8(0x20)
	...
	{
	public:
		TWeakObjectPtr<ADelMarTrack*> Track; // 0x0(0x8)
	...
	{
	public:
		TMap<TWeakObjectPtr, UDriveHazardInfo*> DriveHazardInfoMap; // 0x0(0x50)
		TArray<UDriveHazardInfo*> NonJumpableDriveHazardInfos; // 0x50(0x10)
		TArray<UDriveHazardInfo*> JumpableDriveHazardInfos; // 0x60(0x10)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> UnassignedPreviewImage; // 0x30(0x20)
	};
	...
	{
	public:
		TArray<TWeakObjectPtr> ReadyPlayers; // 0x0(0x10)
		TArray<TWeakObjectPtr> UnreadyPlayers; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<UInputAction*> AssociatedInputActions; // 0x38(0x10)
	};
	...
	public:
		...
		FText GamepadText; // 0x10(0x10)
		FText TouchText; // 0x20(0x10)
		TArray<UInputAction*> AssociatedInputActions; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<FDelMarLapRecord> LapRecords; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<double> SectionTimes; // 0x8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<AFortPlayerState*> Player; // 0x0(0x8)
	...
	public:
		...
		float Value; // 0x8(0x4)
		TEnumAsByte<EDelMarFloatOperation> Operation; // 0xC(0x1)
		TEnumAsByte<EDelMarModifierStackingPolicy> StackingPolicy; // 0xD(0x1)
	...
	public:
		...
		TArray<FDelMarFloatModifier> Modifiers; // 0x18(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FDelMarActivatedInput> Inputs; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x179(0x7) UNKNOWN PROPERTY
		TArray<TWeakObjectPtr> RequiredCosmetics; // 0x180(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x7]; // 0x191(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x7]; // 0x1A1(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x38]; // 0x8(0x38) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<UMaterialInstanceDynamic*> MaterialArray; // 0x0(0x10)
	};
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TWeakObjectPtr<USoundBase*> PreRaceMusic; // 0x8(0x8)
		TWeakObjectPtr<USoundBase*> PostRaceMusic; // 0x10(0x8)
		unsigned char UnknownData01_7[0x4]; // 0x18(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<AActor*> DisabledActors; // 0x18(0x10)
		...
		unsigned char UnknownData02_7[0x3]; // 0x95(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x129(0x7) UNKNOWN PROPERTY
		FRuntimeFloatCurve BlendOutLambdaCurve; // 0x130(0x88)
		float Tolerance; // 0x1B8(0x4)
		unsigned char UnknownData03_7[0x14]; // 0x1BC(0x14) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x64(0x8)
	...
	public:
		...
		TWeakObjectPtr<AActor*> ActorSource; // 0x14(0x8)
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0x122(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x1F4(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x8A0]; // 0x1A0(0x8A0) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0xA60]; // 0xE0(0xA60) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x160]; // 0x50(0x160) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0xA28]; // 0x28(0xA28) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FFortVerb_ObjectWrapper> Cosmetics; // 0x128(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x6]; // 0x142(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x142(0x2) UNKNOWN PROPERTY
	...
	public:
		double FinishTime; // 0x138(0x8)
		char FinalPlacement; // 0x140(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x141(0x3) UNKNOWN PROPERTY
		EDelMarJellyHazardProcessorInfo JellyHazardInfo; // 0x144(0x4)
		EDelMarDemolishedProcessorInfo DemolishedInfo; // 0x148(0x4)
		unsigned char UnknownData01_7[0x4]; // 0x14C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FAudioMixModifier> Modifiers; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<UDelMarCosmeticItemDefinition*> Items; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FGameplayTag, UDelMarCosmeticItemDefinition*> Items; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<UDelMarPhysMatAttribute*> Attributes; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FDelMarMapStatus> Levels; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<int32_t> PlacementPointsMap; // 0x0(0x10)
	...
	{
	public:
		TArray<UClass*> Modifiers; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FDelMarRandomRange> IntervalRanges; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> StateClass; // 0x8(0x20)
	};
	...
	{
	public:
		TArray<FDelMarStateOverride> StateOverrides; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UCameraShakeBase*> CameraShakeInstance; // 0x8(0x8)
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x131(0x3) UNKNOWN PROPERTY
		...
		TArray<FRuntimeFloatCurve> SteerAngleCurveOverrides; // 0x1D0(0x10)
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> TrackTraceChannel; // 0x1F4(0x1)
		unsigned char UnknownData01_7[0x3]; // 0x1F5(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0x27(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x4]; // 0x5BC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_7[0x7]; // 0x711(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x1D1(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> LineOfSightChannel; // 0xA8(0x1)
	...
	public:
		...
		unsigned char UnknownData00_7[0x2]; // 0x136(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<UClass*> NonDriveableActorClasses; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<FDelMarTurboBonusZone> BonusZones; // 0x28(0x10)
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x15E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0x9E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x9D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> LandingCollisionChannel; // 0x91(0x1)
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> SuctionChannel; // 0x144(0x1)
		unsigned char UnknownData06_6[0x3]; // 0x145(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x4]; // 0x154(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> ReattachmentChannel; // 0x98(0x1)
	...
	{
	public:
		TArray<FDelMarWorldBonusSpeedSourceCap> BonusSpeedSourceCaps; // 0x0(0x10)
		float MaxBonusSpeedPerStack; // 0x10(0x4)
		float MaxStackDuration; // 0x14(0x4)
		TArray<UClass*> WorldBonusSpeedActors; // 0x18(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x10]; // 0x118(0x10) UNKNOWN PROPERTY
	};
