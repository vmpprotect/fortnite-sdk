...
namespace SDK
{
	...
	public:
		...
		TArray<FInputActionKeyMapping> ActionKeys; // 0x18(0x10)
		TArray<FInputAxisKeyMapping> AxisKeys; // 0x28(0x10)
		FGuid Guid; // 0x38(0x10)
		TArray<FInstancedStruct> Triggers; // 0x48(0x10)
		TArray<FInstancedStruct> Modifiers; // 0x58(0x10)
		TArray<FInstancedStruct> Actions; // 0x68(0x10)
		TArray<FName> InputNames; // 0x78(0x10)
	...
	{
	public:
		TArray<FVerseInputActionData> InputActions; // 0x108(0x10)
