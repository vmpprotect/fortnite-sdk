...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_7[0x24]; // 0x2C(0x24) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<USceneComponent*> UpdatedComponent; // 0x0(0x8)
		TWeakObjectPtr<UPrimitiveComponent*> UpdatedPrimitive; // 0x8(0x8)
		TWeakObjectPtr<UMoverComponent*> MoverComponent; // 0x10(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x2]; // 0x6E(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4C]; // 0x7C(0x4C) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_2[0xE8]; // 0x0(0xE8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UPrimitiveComponent*> MovementBase; // 0x0(0x8)
