...
namespace SDK
{
	...
	public:
		...
		TArray<bool> AsBoolean; // 0x8(0x10)
		TArray<int32_t> AsInteger; // 0x18(0x10)
		TArray<float> AsFloat; // 0x28(0x10)
		TArray<FString> AsString; // 0x38(0x10)
		TArray<UObject*> AsUObject; // 0x48(0x10)
	};
	...
	public:
		...
		TArray<FGuid> AccessorNodeIDs; // 0x90(0x10)
		TArray<FGuid> DeferredAccessorNodeIDs; // 0xA0(0x10)
	};
	...
	{
	public:
		TArray<FMetasoundFrontendVertex> Inputs; // 0x0(0x10)
		TArray<FMetasoundFrontendVertex> Outputs; // 0x10(0x10)
		TArray<FMetasoundFrontendVertex> Environment; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<FMetasoundFrontendVertexLiteral> InputLiterals; // 0x58(0x10)
	};
	...
	public:
		...
		TArray<FMetasoundFrontendEdgeStyleLiteralColorPair> LiteralColorPairs; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FMetasoundFrontendNode> Nodes; // 0x0(0x10)
		TArray<FMetasoundFrontendEdge> Edges; // 0x10(0x10)
		TArray<FMetasoundFrontendVariable> Variables; // 0x20(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0x4]; // 0x2C(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FMetasoundFrontendClassInput> Inputs; // 0x0(0x10)
		TArray<FMetasoundFrontendClassOutput> Outputs; // 0x10(0x10)
		TArray<FMetasoundFrontendClassEnvironmentVariable> Environment; // 0x20(0x10)
	...
	public:
		...
		TArray<FMetasoundFrontendInterfaceVertexBinding> VertexBindings; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<FMetasoundFrontendInterfaceUClassOptions> UClassOptions; // 0x50(0x10)
	};
	...
	public:
		...
		TSet<FName> InputsInheritingDefault; // 0x8(0x50)
	};
	...
	public:
		...
		TArray<FMetasoundFrontendGraph> PagedGraphs; // 0xC0(0x10)
	...
	public:
		...
		TSet<FMetasoundFrontendVersion> Interfaces; // 0x20(0x50)
		FMetasoundFrontendGraphClass RootGraph; // 0x70(0x128)
		TArray<FMetasoundFrontendGraphClass> Subgraphs; // 0x198(0x10)
		TArray<FMetasoundFrontendClass> Dependencies; // 0x1A8(0x10)
		uint32_t IdCounter; // 0x1B8(0x4)
		unsigned char UnknownData02_7[0x4]; // 0x1BC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TScriptInterface<Class> DocumentInterface; // 0x8(0x10)
