...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x38(0x8)
	};
	...
	{
	public:
		TArray<FProceduralScatterPoint> Points; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FName> AllowedActorTags; // 0x8(0x10)
		TArray<FName> DisallowedActorTags; // 0x18(0x10)
		TArray<FName> AllowedComponentTags; // 0x28(0x10)
		TArray<FName> DisallowedComponentTags; // 0x38(0x10)
	};
	...
	{
	public:
		TArray<UProceduralContentVariationsWeightsModifier*> Modifiers; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<UProceduralDensityModifier*> Modifiers; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<UProceduralScaleModifier*> Modifiers; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<UProceduralRotationModifier*> Modifiers; // 0x0(0x10)
	};
