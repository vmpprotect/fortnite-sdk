...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x98(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x1AB]; // 0x10D(0x1AB) UNKNOWN PROPERTY
		UWaterBodyComponent* CurrentWaterBodyComponent; // 0x2B8(0x8)
		unsigned char UnknownData05_7[0x10]; // 0x2C0(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FSphericalPontoon> Pontoons; // 0x0(0x10)
		...
		unsigned char UnknownData03_6[0x5]; // 0x63(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x8]; // 0x708(0x8) UNKNOWN PROPERTY
	};
