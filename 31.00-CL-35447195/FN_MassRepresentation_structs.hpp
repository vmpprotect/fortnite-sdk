...
namespace SDK
{
	...
	{
	public:
		TEnumAsByte LOD; // 0x0(0x1)
		TEnumAsByte PrevLOD; // 0x1(0x1)
	...
	{
	public:
		unsigned char UnknownData01_3[0x2020]; // 0x0(0x2020) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0x2018]; // 0x0(0x2018) UNKNOWN PROPERTY
	...
	public:
		...
		TArray InstancedStaticMeshComponents; // 0x80(0x10)
		TArray LODSignificanceRanges; // 0x90(0x10)
	};
