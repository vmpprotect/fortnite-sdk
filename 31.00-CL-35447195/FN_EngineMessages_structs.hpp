...
namespace SDK
{
	...
	{
	public:
		TArray Channels; // 0x0(0x10)
		TArray Ids; // 0x10(0x10)
		TArray Descriptions; // 0x20(0x10)
		TArray ReadOnlyIds; // 0x30(0x10)
	};
	...
	{
	public:
		TArray ChannelIdsToEnable; // 0x0(0x10)
		TArray ChannelIdsToDisable; // 0x10(0x10)
	};
