...
namespace SDK
{
	...
	public:
		...
		TArray<FVerseAssetParameterConfig> ParameterConfigs; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<char> Dependency; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0xF]; // 0x11(0xF) UNKNOWN PROPERTY
		TArray<FString> DependencyPackages; // 0x20(0x10)
	...
	public:
		...
		TArray<FVerseSourceCode> CodeChunks; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FVerseSourceFile> SourceFiles; // 0x68(0x10)
		TArray<char> AssetDigest; // 0x78(0x10)
		TArray<FString> AssetDependencies; // 0x88(0x10)
	...
	{
	public:
		TArray<FVersePackageContainer> Packages; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x20]; // 0x10(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<int32_t, FVerseClassVarAccessor> Getters; // 0x0(0x50)
		TMap<int32_t, FVerseClassVarAccessor> Setters; // 0x50(0x50)
	};
