...
namespace SDK
{
	...
	public:
		...
		TArray<FUIFrameworkWidgetTreeEntry> Entries; // 0x138(0x10)
		AActor* ReplicatedOwner; // 0x148(0x8)
		unsigned char UnknownData01_7[0xA8]; // 0x150(0xA8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FUIFrameworkGameLayerSlot> Entries; // 0x108(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x6D(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FUIFrameworkCanvasBoxSlot> Slots; // 0x108(0x10)
	...
	public:
		...
		TWeakObjectPtr<UObject*> ResourceObject; // 0x10(0x20)
		FVector2f DesiredSize; // 0x30(0x8)
		TEnumAsByte<ESlateBrushTileType> Tiling; // 0x38(0x1)
	...
	{
	public:
		TArray<FUIFrameworkOverlaySlot> Slots; // 0x108(0x10)
	...
	{
	public:
		TEnumAsByte<EHorizontalAlignment> HorizontalAlignment; // 0x28(0x1)
		TEnumAsByte<EVerticalAlignment> VerticalAlignment; // 0x29(0x1)
	...
	{
	public:
		TArray<FUIFrameworkStackBoxSlot> Slots; // 0x108(0x10)
	...
	{
	public:
		TArray<FUIFrameworkUserWidgetNamedSlot> Slots; // 0x108(0x10)
		UUIFrameworkUserWidget* Owner; // 0x118(0x8)
	};
