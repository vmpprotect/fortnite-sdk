...
namespace SDK
{
	...
	public:
		...
		TArray<FBakedResourceData> SavedPackages; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<char> ConfigBytes; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FClothLODDataCommon> LODData; // 0x0(0x10)
		TArray<int32_t> LodMap; // 0x10(0x10)
		TArray<FName> UsedBoneNames; // 0x20(0x10)
		TArray<int32_t> UsedBoneIndices; // 0x30(0x10)
		int32_t ReferenceBoneIndex; // 0x40(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x44(0x4) UNKNOWN PROPERTY
		TArray<FCustomizableObjectClothConfigData> ConfigsData; // 0x48(0x10)
		FName Name; // 0x58(0x4)
	...
	public:
		...
		TWeakObjectPtr<UClass*> AnimInstance; // 0x8(0x20)
	};
	...
	public:
		...
		TArray<UPhysicsAsset*> PhysicsAssetsToMerge; // 0x10(0x10)
		unsigned char UnknownData01_6[0x10]; // 0x20(0x10) UNKNOWN PROPERTY
		TArray<UPhysicsAsset*> AdditionalPhysicsAssets; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<uint16_t> SkeletonIds; // 0x8(0x10)
		TArray<USkeleton*> SkeletonsToMerge; // 0x18(0x10)
	};
	...
	{
	public:
		TMap<FName, TWeakObjectPtr> AnimSlotToBP; // 0x0(0x50)
		TSet<UAssetUserData*> AssetUserDataArray; // 0x50(0x50)
		unsigned char UnknownData00_6[0x10]; // 0xA0(0x10) UNKNOWN PROPERTY
		...
		TArray<UMaterialInterface*> OverrideMaterials; // 0x138(0x10)
	};
	...
	{
	public:
		TArray<FAnimInstanceOverridePhysicsAsset> AnimInstancePropertyIndexAndPhysicsAssets; // 0x0(0x10)
	};


	// Struct CustomizableObject.ExtensionInstanceData
	// Size: 0x18 (0x18 - 0x0)
	struct FExtensionInstanceData	
	{
	public:
		TWeakObjectPtr<UCustomizableObjectExtension*> Extension; // 0x0(0x8)
	...
	public:
		...
		FGuid ID; // 0x20(0x10)
		TArray<FString> ParameterRangeValueNames; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<float> ParameterRangeValues; // 0x28(0x10)
	};
	...
	public:
		...
		FGuid ID; // 0x14(0x10)
		unsigned char UnknownData00_6[0x4]; // 0x24(0x4) UNKNOWN PROPERTY
		TArray<FName> ParameterRangeValues; // 0x28(0x10)
	};
	...
	public:
		...
		FGuid ID; // 0x48(0x10)
		TArray<FCustomizableObjectProjector> RangeValues; // 0x58(0x10)
	};
	...
	public:
		...
		TArray<FMutableModelParameterValue> PossibleValues; // 0x18(0x10)
	};
	...
	public:
		...
		TEnumAsByte<TextureFilter> Filter; // 0x10(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		bool SRGB : 1; // 0x14:0(0x1)
		bool FlipGreenChannel : 1; // 0x14:1(0x1)
		bool IsPassThrough : 1; // 0x14:2(0x1)
		unsigned char UnknownData01_5[0x3]; // 0x15(0x3) UNKNOWN PROPERTY
		int32_t LODBias; // 0x18(0x4)
		TEnumAsByte<TextureMipGenSettings> MipGenSettings; // 0x1C(0x1)
		TEnumAsByte<TextureGroup> LODGroup; // 0x1D(0x1)
		TEnumAsByte<TextureAddress> AddressX; // 0x1E(0x1)
		TEnumAsByte<TextureAddress> AddressY; // 0x1F(0x1)
	};
	...
	public:
		...
		TWeakObjectPtr<USkeletalMesh*> SoftSkeletalMesh; // 0x8(0x20)
		USkeletalMeshLODSettings* SkeletalMeshLODSettings; // 0x28(0x8)
		TArray<FMutableRefLODData> LODData; // 0x30(0x10)
		TArray<FMutableRefSocket> Sockets; // 0x40(0x10)
		...
		TWeakObjectPtr<UClass*> PostProcessAnimInst; // 0xA0(0x20)
		UPhysicsAsset* ShadowPhysicsAsset; // 0xC0(0x8)
		TArray<FMutableRefAssetUserData> AssetUserData; // 0xC8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UClass*> AnimInstanceClass; // 0x0(0x20)
		TWeakObjectPtr<UPhysicsAsset*> SourceAsset; // 0x20(0x20)
	...
	{
	public:
		TArray<FName> NameResolutionMap; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x24(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UTexture2D*> UIThumbnail; // 0x28(0x20)
		TMap<FString, FString> ExtraInformation; // 0x48(0x50)
		TMap<FString, TWeakObjectPtr> ExtraAssets; // 0x98(0x50)
	};
	...
	public:
		...
		TMap<FString, FIntegerParameterUIData> ArrayIntegerParameterOption; // 0xF8(0x50)
	...
	public:
		...
		unsigned char UnknownData00_6[0x5]; // 0xEB(0x5) UNKNOWN PROPERTY
		TMap<FString, FString> ForcedParameterValues; // 0xF0(0x50)
	};
	...
	{
	public:
		TArray<FMutableRefSkeletalMeshData> ReferenceSkeletalMeshesData; // 0x0(0x10)
		TArray<TWeakObjectPtr> Skeletons; // 0x10(0x10)
		TArray<TWeakObjectPtr> Materials; // 0x20(0x10)
		TArray<TWeakObjectPtr> PassThroughTextures; // 0x30(0x10)
		TArray<TWeakObjectPtr> PassThroughMeshes; // 0x40(0x10)
		TArray<TWeakObjectPtr> PhysicsAssets; // 0x50(0x10)
		TArray<TWeakObjectPtr> AnimBPs; // 0x60(0x10)
		TArray<FAnimBpOverridePhysicsAssetsInfo> AnimBpOverridePhysiscAssetsInfo; // 0x70(0x10)
		TArray<FName> MaterialSlotNames; // 0x80(0x10)
		TMap<FString, uint32_t> BoneNamesMap; // 0x90(0x50)
		TArray<FMutableRefSocket> SocketArray; // 0xE0(0x10)
		TArray<FMutableSkinWeightProfileInfo> SkinWeightProfilesInfo; // 0xF0(0x10)
		TArray<FMutableModelImageProperties> ImageProperties; // 0x100(0x10)
		TMap<uint32_t, FMutableMeshMetadata> MeshMetadata; // 0x110(0x50)
		TMap<uint32_t, FMutableSurfaceMetadata> SurfaceMetadata; // 0x160(0x50)
		TMap<FString, FMutableParameterData> ParameterUIDataMap; // 0x1B0(0x50)
		TMap<FString, FMutableStateData> StateUIDataMap; // 0x200(0x50)
		TMap<uint32_t, FRealTimeMorphStreamable> RealTimeMorphStreamables; // 0x250(0x50)
		TArray<FCustomizableObjectClothConfigData> ClothSharedConfigsData; // 0x2A0(0x10)
		TArray<FCustomizableObjectClothingAssetData> ClothingAssetsData; // 0x2B0(0x10)
		TMap<uint32_t, FClothingStreamable> ClothingStreamables; // 0x2C0(0x50)
		bool bAllowClothingPhysicsEditsPropagation; // 0x310(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x311(0x7) UNKNOWN PROPERTY
		TMap<uint32_t, FMutableStreamableBlock> HashToStreamableBlock; // 0x318(0x50)
		char NumComponents; // 0x368(0x1)
		char NumLODs; // 0x369(0x1)
		char NumLODsToStream; // 0x36A(0x1)
		char FirstLODAvailable; // 0x36B(0x1)
		unsigned char UnknownData01_7[0x4]; // 0x36C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FGeneratedTexture> Textures; // 0x8(0x10)
	...
	public:
		TArray<FString> Tags; // 0x0(0x10)
		TMap<FString, FFParameterOptionsTags> ParameterOptions; // 0x10(0x50)
	};
	...
	public:
		...
		TArray<FCustomizableObjectBoolParameterValue> BoolParameters; // 0x10(0x10)
		TArray<FCustomizableObjectIntParameterValue> IntParameters; // 0x20(0x10)
		TArray<FCustomizableObjectFloatParameterValue> FloatParameters; // 0x30(0x10)
		TArray<FCustomizableObjectTextureParameterValue> TextureParameters; // 0x40(0x10)
		TArray<FCustomizableObjectVectorParameterValue> VectorParameters; // 0x50(0x10)
		TArray<FCustomizableObjectProjectorParameterValue> ProjectorParameters; // 0x60(0x10)
	};
	...
	public:
		...
		TArray<FCustomizableObjectBoolParameterValue> BoolParameters; // 0x8(0x10)
		TArray<FCustomizableObjectIntParameterValue> IntParameters; // 0x18(0x10)
		TArray<FCustomizableObjectFloatParameterValue> FloatParameters; // 0x28(0x10)
		TArray<FCustomizableObjectTextureParameterValue> TextureParameters; // 0x38(0x10)
		TArray<FCustomizableObjectVectorParameterValue> VectorParameters; // 0x48(0x10)
		TArray<FCustomizableObjectProjectorParameterValue> ProjectorParameters; // 0x58(0x10)
		int32_t State; // 0x68(0x4)
		unsigned char UnknownData00_6[0x1C]; // 0x6C(0x1C) UNKNOWN PROPERTY
		TMap<FName, FMultilayerProjector> MultilayerProjectors; // 0x88(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TMap<FName, int32_t> VirtualLayersMapping; // 0x8(0x50)
		TMap<FName, int32_t> VirtualLayersOrder; // 0x58(0x50)
		TMap<FName, FMultilayerProjectorLayer> DisableVirtualLayers; // 0xA8(0x50)
	};
	...
	{
	public:
		TWeakObjectPtr<UCustomizableObjectResourceDataContainer*> ContainerPath; // 0x0(0x20)
	...
	{
	public:
		TArray<UMaterialInterface*> Materials; // 0x0(0x10)
