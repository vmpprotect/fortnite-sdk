...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UWidget*> WidgetPtr; // 0x4(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x68]; // 0x20(0x68) UNKNOWN PROPERTY
	};
	...
	public:
		float Value; // 0x0(0x4)
		TEnumAsByte<ESlateSizeRule> SizeRule; // 0x4(0x1)
	...
	public:
		...
		TWeakObjectPtr<UWidget*> Widget; // 0x8(0x8)
	...
	{
	public:
		unsigned char UnknownData00_2[0x2]; // 0x0(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0xB8(0x10) UNKNOWN PROPERTY
	};
