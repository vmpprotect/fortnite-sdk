...
namespace SDK
{
	...
	public:
		...
		TArray<FString> TargetUVLayerNamesList; // 0x120(0x10)
		TArray<FString> SourceUVLayerNamesList; // 0x130(0x10)
		...
		TArray GetTargetUVLayerNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF75112CA00(relative to base address)
		TArray GetSourceUVLayerNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF75112C9E4(relative to base address)
	};
	...
	public:
		...
		TArray<FString> UVLayerNamesList; // 0xC0(0x10)
		...
		TArray GetUVLayerNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF750BAAF08(relative to base address)
	};
	...
	{
	public:
		TArray<UTexture2D*> MaterialIDSourceTextures; // 0xA8(0x10)
		FString UVLayer; // 0xB8(0x10)
		TArray<FString> UVLayerNamesList; // 0xC8(0x10)
		TArray<UTexture2D*> AllSourceTextures; // 0xD8(0x10)
		...
		TArray GetUVLayerNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF75112BF5C(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x720]; // 0x128(0x720) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x43]; // 0xAD(0x43) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0xB5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x58]; // 0xF8(0x58) UNKNOWN PROPERTY
		UPatternTool_OutputSettings* OutputSettings; // 0x150(0x8)
		unsigned char UnknownData01_6[0x48]; // 0x158(0x48) UNKNOWN PROPERTY
		UTransformProxy* PatternGizmoProxy; // 0x1A0(0x8)
		UCombinedTransformGizmo* PatternGizmo; // 0x1A8(0x8)
		unsigned char UnknownData02_6[0x18]; // 0x1B0(0x18) UNKNOWN PROPERTY
		UDragAlignmentMechanic* DragAlignmentMechanic; // 0x1C8(0x8)
		UConstructionPlaneMechanic* PlaneMechanic; // 0x1D0(0x8)
		unsigned char UnknownData03_6[0x1E0]; // 0x1D8(0x1E0) UNKNOWN PROPERTY
		TSet<UPrimitiveComponent*> AllComponents; // 0x3B8(0x50)
		unsigned char UnknownData04_6[0xA0]; // 0x408(0xA0) UNKNOWN PROPERTY
	...
	public:
		...
		bool IsPreventTinyTrianglesEnabled(); // Flags: Native|Protected|Const, Memory Exec: 0x7FF74C3493C4(relative to base address)
		bool IsPreventNormalFlipsEnabled(); // Flags: Native|Protected|Const, Memory Exec: 0x7FF7495F94FC(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x6]; // 0x132(0x6) UNKNOWN PROPERTY
		FVector AxisOrigin; // 0x138(0x18)
		FVector2D AxisOrientation; // 0x150(0x10)
		bool bResetAxisOnStart; // 0x160(0x1)
		unsigned char UnknownData02_7[0x7]; // 0x161(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		void ResetAxis(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751141724(relative to base address)
	};
	...
	public:
		...
		TWeakObjectPtr<UWorld*> TargetWorld; // 0xC0(0x8)
		TArray<TWeakObjectPtr> ActorsWithSplines; // 0xC8(0x10)
		unsigned char UnknownData01_7[0x28]; // 0xD8(0x28) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x78]; // 0x118(0x78) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x68]; // 0xC0(0x68) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x90]; // 0xC8(0x90) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FString> MapPreviewNamesList; // 0xD8(0x10)
		...
		TArray GetMapPreviewNamesFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511416EC(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xB0]; // 0xF8(0xB0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x8]; // 0x1A8(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x50]; // 0x1D0(0x50) UNKNOWN PROPERTY
		TMap<EBakeMapType, UTexture2D*> CachedMaps; // 0x220(0x50)
		unsigned char UnknownData02_6[0x98]; // 0x270(0x98) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x58]; // 0x338(0x58) UNKNOWN PROPERTY
	...
	{
	public:
		TMap<EBakeMapType, UTexture2D*> Result; // 0xA8(0x50)
	...
	public:
		...
		unsigned char UnknownData00_7[0x2]; // 0xC6(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xD0]; // 0x1D8(0xD0) UNKNOWN PROPERTY
	...
	public:
		...
		AActor* TargetDynamicMesh; // 0xB8(0x8)
		FString TargetUVLayer; // 0xC0(0x10)
		TArray<FBakeMultiMeshDetailProperties> SourceMeshes; // 0xD0(0x10)
		float ProjectionDistance; // 0xE0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0xE4(0x4) UNKNOWN PROPERTY
		TArray<FString> TargetUVLayerNamesList; // 0xE8(0x10)
		...
		TArray GetTargetUVLayerNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF751141708(relative to base address)
	};
	...
	public:
		...
		UBakeMeshAttributeMapsResultToolProperties* ResultSettings; // 0x330(0x8)
		unsigned char UnknownData00_7[0x90]; // 0x338(0x90) UNKNOWN PROPERTY
	...
	public:
		...
		UCreateMeshObjectTypeProperties* OutputTypeProperties; // 0xA8(0x8)
		TArray<TWeakObjectPtr> Inputs; // 0xB0(0x10)
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0xCE(0x2) UNKNOWN PROPERTY
		...
		TArray<FString> OptionsList; // 0xE0(0x10)
		...
		TArray GetGroupOptionsList(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511706F8(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x68]; // 0x148(0x68) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0xE]; // 0xDA(0xE) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x3]; // 0xFD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x5]; // 0x10B(0x5) UNKNOWN PROPERTY
		double PlaneTolerance; // 0x110(0x8)
		bool bHitUnrelatedGeometry; // 0x118(0x1)
		bool bHitGridGroundPlaneIfCloser; // 0x119(0x1)
		unsigned char UnknownData04_6[0x2]; // 0x11A(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x10]; // 0x150(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_7[0x6]; // 0x1A2(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		void SlideForward(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511707D0(relative to base address)
		void SlideBack(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511707B8(relative to base address)
		void ResetGridFromActor(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511707A0(relative to base address)
		void Push(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751170788(relative to base address)
		void Pull(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751170770(relative to base address)
		void Flip(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511706E0(relative to base address)
		void CornerMode(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751170698(relative to base address)
		void AcceptAndStartNew(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751170680(relative to base address)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x28]; // 0x98(0x28) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x180]; // 0x128(0x180) UNKNOWN PROPERTY
		UMeshOpPreviewWithBackgroundCompute* Preview; // 0x2A8(0x8)
		unsigned char UnknownData02_7[0x370]; // 0x2B0(0x370) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0xAE(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x10]; // 0x100(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0x16D8]; // 0x128(0x16D8) UNKNOWN PROPERTY
	...
	{
	public:
		EDisplaceMeshToolDisplaceType DisplacementType; // 0xA8(0x1)
		unsigned char UnknownData00_6[0x3]; // 0xA9(0x3) UNKNOWN PROPERTY
		float DisplaceIntensity; // 0xAC(0x4)
		int32_t RandomSeed; // 0xB0(0x4)
		EDisplaceMeshToolSubdivisionType SubdivisionType; // 0xB4(0x1)
		unsigned char UnknownData01_6[0x3]; // 0xB5(0x3) UNKNOWN PROPERTY
		int32_t Subdivisions; // 0xB8(0x4)
		FName WeightMap; // 0xBC(0x4)
		TArray<FString> WeightMapsList; // 0xC0(0x10)
		bool bInvertWeightMap; // 0xD0(0x1)
		bool bShowWireframe; // 0xD1(0x1)
		bool bDisableSizeWarning; // 0xD2(0x1)
		unsigned char UnknownData02_7[0x5]; // 0xD3(0x5) UNKNOWN PROPERTY
		...
		TArray GetWeightMapsFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751170734(relative to base address)
	};
	...
	public:
		...
		TArray<FString> MaterialIDList; // 0xB0(0x10)
		...
		TArray GetMaterialIDsFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750BAAECC(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x7]; // 0xE9(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FPerlinLayerProperties> PerlinLayerProperties; // 0xA8(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x348]; // 0x160(0x348) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x18]; // 0x98(0x18) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0xC0]; // 0xD0(0xC0) UNKNOWN PROPERTY
		UConstructionPlaneMechanic* PlaneMechanic; // 0x190(0x8)
		unsigned char UnknownData02_6[0xC0]; // 0x198(0xC0) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x8]; // 0x278(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x40]; // 0x298(0x40) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0xC5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		void DiscardAttributes(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511706B0(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x60]; // 0x140(0x60) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0xE38]; // 0x1D0(0xE38) UNKNOWN PROPERTY
		UCombinedTransformGizmo* PlaneTransformGizmo; // 0x1008(0x8)
		UTransformProxy* PlaneTransformProxy; // 0x1010(0x8)
		unsigned char UnknownData02_7[0x8]; // 0x1018(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UMeshOpPreviewWithBackgroundCompute*> Previews; // 0xD0(0x10)
		unsigned char UnknownData01_6[0x70]; // 0xE0(0x70) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x160]; // 0x160(0x160) UNKNOWN PROPERTY
	...
	public:
		...
		void WorldOrigin(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD254(relative to base address)
		void Top(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD224(relative to base address)
		void Right(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD120(relative to base address)
		void Left(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD0C0(relative to base address)
		void Front(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD048(relative to base address)
		void Center(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE70(relative to base address)
		void Bottom(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE58(relative to base address)
		void Back(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE28(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x148]; // 0xD8(0x148) UNKNOWN PROPERTY
		TArray<FEditPivotTarget> ActiveGizmos; // 0x220(0x10)
		UDragAlignmentMechanic* DragAlignmentMechanic; // 0x230(0x8)
		unsigned char UnknownData02_7[0x78]; // 0x238(0x78) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x8]; // 0x100(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x398]; // 0x148(0x398) UNKNOWN PROPERTY
	...
	public:
		...
		void SelectAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD150(relative to base address)
		void Clear(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE88(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x160]; // 0xE0(0x160) UNKNOWN PROPERTY
	...
	public:
		...
		void Constrain(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACEFC(relative to base address)
		void ClearConstraints(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACED0(relative to base address)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x98]; // 0xE8(0x98) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0x77]; // 0x199(0x77) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x10]; // 0xB8(0x10) UNKNOWN PROPERTY
		...
		TArray GetAttributeNames(); // Flags: Final|Native|Public, Memory Exec: 0x7FF75112BF78(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x500]; // 0x2F0(0x500) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0xE0]; // 0xB0(0xE0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x1]; // 0xCB(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		void UnfreezeAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD108(relative to base address)
		void ShrinkCurrent(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE10(relative to base address)
		void GrowCurrent(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACFD0(relative to base address)
		void FreezeOthers(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACFB8(relative to base address)
		void FreezeCurrent(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF88(relative to base address)
		void FloodFillCurrent(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD018(relative to base address)
		void ClearCurrent(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACEE4(relative to base address)
		void ClearAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACEB8(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x120]; // 0x110(0x120) UNKNOWN PROPERTY
		TMap<int32_t, UMeshSculptBrushOpProps*> BrushOpPropSets; // 0x230(0x50)
		unsigned char UnknownData01_6[0x50]; // 0x280(0x50) UNKNOWN PROPERTY
		TMap<int32_t, UMeshSculptBrushOpProps*> SecondaryBrushOpPropSets; // 0x2D0(0x50)
		unsigned char UnknownData02_6[0x6F0]; // 0x320(0x6F0) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x7]; // 0xA29(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_7[0x150]; // 0xA50(0x150) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x8]; // 0xBC8(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0x3F0]; // 0xBF0(0x3F0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x160]; // 0xF0(0x160) UNKNOWN PROPERTY
	...
	public:
		...
		void Shrink(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD1F4(relative to base address)
		void SelectAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD168(relative to base address)
		void OptimizeBorder(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD0F0(relative to base address)
		void LargestTriCountPart(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD0A8(relative to base address)
		void LargestAreaPart(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD090(relative to base address)
		void Invert(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD078(relative to base address)
		void Grow(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD060(relative to base address)
		void FloodFill(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD000(relative to base address)
		void ExpandToMaterials(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACFA0(relative to base address)
		void Clear(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACEA0(relative to base address)
	};
	...
	public:
		...
		void SmoothBorder(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD20C(relative to base address)
		void Separate(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD180(relative to base address)
		void FlipNormals(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACFE8(relative to base address)
		void Duplicate(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF70(relative to base address)
		void Disconnect(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF40(relative to base address)
		void Delete(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF28(relative to base address)
		void CreatePolygroup(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF10(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x58]; // 0x318(0x58) UNKNOWN PROPERTY
		UMeshSelectionSet* Selection; // 0x370(0x8)
		TArray<AActor*> SpawnedActors; // 0x378(0x10)
		unsigned char UnknownData02_7[0x398]; // 0x388(0x398) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0xBD(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		void ShiftToCenter(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD198(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x198]; // 0x128(0x198) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0xB3(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x5]; // 0xBB(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		void PaintAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD108(relative to base address)
		void FillWhite(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACFD0(relative to base address)
		void FillBlack(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACFB8(relative to base address)
		void EraseAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF88(relative to base address)
	};
	...
	public:
		...
		TArray<FString> LODNamesList; // 0xE8(0x10)
		...
		TArray GetWeightMapsFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751170734(relative to base address)
		TArray GetLODNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF751141708(relative to base address)
		void ApplySelectedOperation(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE10(relative to base address)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x8]; // 0xBA0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0x8]; // 0xBE0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x538]; // 0xC08(0x538) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr<UMeshVertexSculptTool*> Tool; // 0xAC(0x8)
		unsigned char UnknownData00_7[0x4]; // 0xB4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x18]; // 0xBC8(0x18) UNKNOWN PROPERTY
		AInternalToolFrameworkActor* PreviewMeshActor; // 0xBE0(0x8)
		UDynamicMeshComponent* DynamicMeshComponent; // 0xBE8(0x8)
		unsigned char UnknownData02_7[0x910]; // 0xBF0(0x910) UNKNOWN PROPERTY
	...
	public:
		...
		void Up(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD23C(relative to base address)
		void ShiftToCenter(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD1DC(relative to base address)
		void Right(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD138(relative to base address)
		void Left(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD0D8(relative to base address)
		void Forward(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511AD030(relative to base address)
		void Down(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACF58(relative to base address)
		void Backward(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511ACE40(relative to base address)
	};
	...
	public:
		...
		TArray<UDynamicMeshReplacementChangeTarget*> MeshesToMirror; // 0xE0(0x10)
		TArray<UMeshOpPreviewWithBackgroundCompute*> Previews; // 0xF0(0x10)
		unsigned char UnknownData01_6[0x30]; // 0x100(0x30) UNKNOWN PROPERTY
		UConstructionPlaneMechanic* PlaneMechanic; // 0x130(0x8)
		unsigned char UnknownData02_7[0x40]; // 0x138(0x40) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FPhysicsSphereData> Spheres; // 0xC0(0x10)
		TArray<FPhysicsBoxData> Boxes; // 0xD0(0x10)
		TArray<FPhysicsCapsuleData> Capsules; // 0xE0(0x10)
		TArray<FPhysicsConvexData> Convexes; // 0xF0(0x10)
		TArray<FPhysicsLevelSetData> LevelSets; // 0x100(0x10)
	...
	public:
		...
		UPreviewMesh* PreviewMesh; // 0xD8(0x8)
		unsigned char UnknownData00_7[0x248]; // 0xE0(0x248) UNKNOWN PROPERTY
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0xB8(0x8) UNKNOWN PROPERTY
		UCollisionGeometryVisualizationProperties* VizSettings; // 0xC0(0x8)
		TArray<UPhysicsObjectToolPropertySet*> ObjectData; // 0xC8(0x10)
		TArray<UPreviewGeometry*> PreviewElements; // 0xD8(0x10)
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0xB6(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x2]; // 0xCA(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x3]; // 0xE5(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x3]; // 0x109(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_7[0x2]; // 0x11E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x278]; // 0xF8(0x278) UNKNOWN PROPERTY
	...
	public:
		...
		void Duplicate(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511E3090(relative to base address)
		void DeleteAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511E307C(relative to base address)
		void Delete(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511E3068(relative to base address)
		void AddSphere(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511E303C(relative to base address)
		void AddCapsule(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511E3028(relative to base address)
		void AddBox(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7511E3014(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x20]; // 0xC0(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UMeshOpPreviewWithBackgroundCompute*> Previews; // 0xC0(0x10)
		TArray<UDynamicMeshReplacementChangeTarget*> MeshesToCut; // 0xD0(0x10)
		UConstructionPlaneMechanic* PlaneMechanic; // 0xE0(0x8)
		unsigned char UnknownData00_7[0xA8]; // 0xE8(0xA8) UNKNOWN PROPERTY
		...
		void FlipPlane(); // Flags: Final|Native|Protected, Memory Exec: 0x7FF7511E30A4(relative to base address)
		void Cut(); // Flags: Final|Native|Protected, Memory Exec: 0x7FF7511E3050(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x4]; // 0xDC(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x4]; // 0xFC(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0x108(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x3]; // 0xD5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UMeshOpPreviewWithBackgroundCompute*> Previews; // 0xD0(0x10)
		TArray<UPreviewMesh*> PreviewCopies; // 0xE0(0x10)
		unsigned char UnknownData00_7[0xE0]; // 0xF0(0xE0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x30]; // 0x1E0(0x30) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xE0]; // 0x2F0(0xE0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x38]; // 0x118(0x38) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x28]; // 0xF8(0x28) UNKNOWN PROPERTY
		TArray<UPreviewGeometry*> PerTargetPreviews; // 0x120(0x10)
	...
	public:
		...
		TArray<FString> SourceLODNamesList; // 0xD8(0x10)
		unsigned char UnknownData02_6[0x10]; // 0xE8(0x10) UNKNOWN PROPERTY
		TArray<FString> TargetLODNamesList; // 0xF8(0x10)
		unsigned char UnknownData03_6[0x10]; // 0x108(0x10) UNKNOWN PROPERTY
		bool bIsStaticMeshTarget; // 0x118(0x1)
		unsigned char UnknownData04_7[0x7]; // 0x119(0x7) UNKNOWN PROPERTY
		...
		TArray GetTargetLODNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF7511E30BC(relative to base address)
		TArray GetSourceLODNamesFunc(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF7511416EC(relative to base address)
	};
	...
	public:
		...
		TArray<FTransformMeshesTarget> ActiveGizmos; // 0xD0(0x10)
		UDragAlignmentMechanic* DragAlignmentMechanic; // 0xE0(0x8)
		unsigned char UnknownData01_7[0xB8]; // 0xE8(0xB8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x5]; // 0xD3(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x10]; // 0x108(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		TLazyObjectPtr<AVolume*> TargetVolume; // 0xB0(0x18)
		ULineSetComponent* VolumeEdgesSet; // 0xC8(0x8)
		unsigned char UnknownData00_7[0x230]; // 0xD0(0x230) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x5]; // 0xBB(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0xBE(0x2) UNKNOWN PROPERTY
		double ThickenShells; // 0xC0(0x8)
	...
	public:
		...
		unsigned char UnknownData00_7[0x60]; // 0x140(0x60) UNKNOWN PROPERTY
