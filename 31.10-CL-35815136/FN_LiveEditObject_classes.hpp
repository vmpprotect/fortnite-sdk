...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_1[0xF8]; // 0xB0(0xF8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x338]; // 0x28(0x338) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<ULiveEditObjectConnection*> Connections; // 0x38(0x10)
		unsigned char UnknownData01_7[0x260]; // 0x48(0x260) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<ULiveEditObjectSubsystemState*> NetDriverStates; // 0x40(0x10)
