...
namespace SDK
{
	...
	public:
		...
		TArray InjectionSupportingBehaviors; // 0x10(0x10)
		UBlackboardData InjectionBlackboard; // 0x20(0x8)
		TMap BehaviorToRuntimeBehavior; // 0x28(0x50)
	...
	public:
		...
		unsigned char UnknownData03_7[0x18]; // 0x10(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray InjectedDecisions; // 0x0(0x10)
	...
	{
	public:
		TArray InjectedDecisionsByTag; // 0x0(0x10)
		unsigned char UnknownData01_7[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData03_7[0x78]; // 0x0(0x78) UNKNOWN PROPERTY
		USmartObjectComponent PickedSmartObjectComponent; // 0x78(0x8)
		unsigned char UnknownData04_6[0x70]; // 0x80(0x70) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x20]; // 0x170(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray OptionalApprovedList; // 0x0(0x10)
	...
	{
	public:
		TWeakObjectPtr Montage; // 0x8(0x20)
		TWeakObjectPtr SceneAsset; // 0x28(0x20)
	...
	public:
		...
		TArray InjectedBehaviors; // 0x48(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr InjectedBehavior; // 0x20(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr UpgradeIconImage; // 0x8(0x20)
	...
	public:
		...
		TArray RangeSettings; // 0x50(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData03_3[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		FScalableFloat IntervalMultiplier; // 0x8(0x28)
		unsigned char UnknownData04_6[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
		FScalableFloat RandomDeviationMultiplier; // 0x38(0x28)
		unsigned char UnknownData05_7[0x8]; // 0x60(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x18]; // 0x170(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x58]; // 0x10(0x58) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray InjectedBehaviorsByTagQuery; // 0x8(0x10)
	};
	...
	public:
		...
		TArray InjectedBehaviorsByTagQuery; // 0x70(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x2]; // 0x92(0x2) UNKNOWN PROPERTY
		float EncounterAILifespan; // 0x94(0x4)
		float ScoreMultiplier; // 0x98(0x4)
		bool bDebugSpawnedAI; // 0x9C(0x1)
		unsigned char UnknownData07_6[0x3]; // 0x9D(0x3) UNKNOWN PROPERTY
		TArray AbilitySetsToGrantOnSpawn; // 0xA0(0x10)
		TArray ModifiersToApplyOnSpawn; // 0xB0(0x10)
	...
	{
	public:
		TArray PhaseSpawningItems; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x48]; // 0x2A8(0x48) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte CombatFactor; // 0x0(0x1)
	...
	public:
		...
		TEnumAsByte ContributingFactor; // 0x4(0x1)
		EFortAIDirectorFactor ContributingAIDirectorFactor; // 0x5(0x1)
		TEnumAsByte ContributionType; // 0x6(0x1)
	...
	public:
		...
		unsigned char UnknownData01_7[0x5C]; // 0xC(0x5C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray PawnCapsPerPlayerCount; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x50]; // 0xF0(0x50) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray PopulationCategories; // 0x20(0x10)
	};
	...
	public:
		FGameplayTagContainer EncounterTypeTags; // 0x0(0x20)
		TArray MaxSpawnPointsPerPlayerCount; // 0x20(0x10)
		TArray MinSpawnPointsPerPlayerCount; // 0x30(0x10)
	};
	...
	{
	public:
		TEnumAsByte AssociatedMissionType; // 0x0(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		TArray LootDropModifierRows; // 0x50(0x10)
	};
	...
	{
	public:
		TArray QueryLocations; // 0x0(0x10)
		TArray QueryActors; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x6]; // 0x2A(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		float MaxContribution; // 0x4(0x4)
		TEnumAsByte ContributionType; // 0x8(0x1)
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray ContributingEvents; // 0x8(0x10)
	...
	public:
		...
		TArray PawnUpgrades; // 0xB8(0x10)
		TArray ModifiersForAllPawns; // 0xC8(0x10)
		TArray PawnList; // 0xD8(0x10)
		TArray LifespanExpiredList; // 0xE8(0x10)
	};
	...
	public:
		...
		TArray AdditionalModifiers; // 0x38(0x10)
	};
	...
	public:
		...
		TArray AbilitySetsToGrantOnSpawn; // 0x50(0x10)
	...
	public:
		...
		TEnumAsByte ChosenDirection; // 0x2D(0x1)
		unsigned char UnknownData02_6[0x2]; // 0x2E(0x2) UNKNOWN PROPERTY
		TArray QueryLocations; // 0x30(0x10)
		TArray FoundRifts; // 0x40(0x10)
	...
	public:
		...
		TEnumAsByte CurrentSection; // 0x14(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x15(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray QueryInstances; // 0x0(0x10)
		TArray PendingRifts; // 0x10(0x10)
		TArray Rifts; // 0x20(0x10)
		TArray UsedRiftLocations; // 0x30(0x10)
		TArray PathEstimators; // 0x40(0x10)
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray PreviousQueryDirections; // 0x8(0x10)
		TArray ChosenDirections; // 0x18(0x10)
		TArray FailedDirections; // 0x28(0x10)
		TArray AvailableDirections; // 0x38(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr CurrentAssignment; // 0x0(0x8)
		...
		TWeakObjectPtr PreviousAssignment; // 0x44(0x8)
		...
		unsigned char UnknownData03_7[0x7D]; // 0x7B(0x7D) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr Material; // 0x0(0x20)
	...
	public:
		FGameplayTagQuery TagQuery; // 0x0(0x48)
		TArray PawnUpgradeDataPerPlayerCount; // 0x48(0x10)
	};
	...
	public:
		...
		TEnumAsByte AssignmentTeam; // 0x28(0x1)
	...
	public:
		...
		TEnumAsByte Operator; // 0x30(0x1)
		TEnumAsByte ComparisonType; // 0x31(0x1)
		unsigned char UnknownData05_7[0x6]; // 0x32(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr NameDataTable; // 0x10(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr CloudActor; // 0x68(0x8)
		unsigned char UnknownData04_6[0x1]; // 0x70(0x1) UNKNOWN PROPERTY
		bool bThreatActivated; // 0x71(0x1)
		EFortThreatDeactivationType DeactivationType; // 0x72(0x1)
		unsigned char UnknownData05_7[0x15]; // 0x73(0x15) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr GoalSelectionQuery; // 0x0(0x20)
	};
	...
	public:
		...
		TArray GoalSelectionCriteria; // 0x40(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x2]; // 0x26(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x18]; // 0x10(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TScriptInterface PathRendererInterface; // 0x0(0x10)
	...
	{
	public:
		TArray AvailablePerks; // 0x0(0x10)
	...
	public:
		...
		TWeakObjectPtr TokenProvider; // 0x10(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x36(0x2) UNKNOWN PROPERTY
		TArray TokenReservations; // 0x38(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x38]; // 0x140(0x38) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x18]; // 0xF0(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x2]; // 0x106(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		FScalableFloat IdealAttackRange; // 0x1B8(0x28)
		FScalableFloat TargetingIdealAttackRange; // 0x1E0(0x28)
		FScalableFloat MaxAttackRangeFactor; // 0x208(0x28)
		FScalableFloat ShouldAimAtTargetsFeet; // 0x230(0x28)
		FScalableFloat ChanceToAimAtTargetsFeetWhenTimeToHit; // 0x258(0x28)
		FScalableFloat ShouldUseProjectileArcForAiming; // 0x280(0x28)
		FScalableFloat KeepAimingOnSameSideWhileFiring; // 0x2A8(0x28)
		FScalableFloat MaxTrackingHeightOffsetError; // 0x2D0(0x28)
		FScalableFloat MinRotationInterpSpeed; // 0x2F8(0x28)
		FScalableFloat MaxRotationInterpSpeed; // 0x320(0x28)
		FScalableFloat ConsiderProjectileTravelTime; // 0x348(0x28)
		bool bOverrideAimingCircleSettings; // 0x370(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x371(0x7) UNKNOWN PROPERTY
		FAimingCircleSettings AimingCircleSettingsOverride; // 0x378(0x460)
	};


	// Struct FortniteAI.WeaponAccuracyCategorySpecialization
	// Size: 0x7F8 (0x7F8 - 0x0)
	struct FWeaponAccuracyCategorySpecialization	
	{
	public:
		FGameplayTagContainer Tags; // 0x0(0x20)
		FWeaponAccuracy WeaponAccuracy; // 0x20(0x7D8)
	};


	// Struct FortniteAI.WeaponAccuracyCategory
	// Size: 0x808 (0x808 - 0x0)
	struct FWeaponAccuracyCategory	
	{
	public:
		FGameplayTagContainer Tags; // 0x0(0x20)
		FWeaponAccuracy WeaponAccuracy; // 0x20(0x7D8)
		TArray Specializations; // 0x7F8(0x10)
	};
	...
	public:
		...
		float ChanceToAimAtTargetsFeetWhenTimeToHit; // 0x180(0x4)
		...
		unsigned char UnknownData04_6[0x3]; // 0x1B1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x6]; // 0x1C2(0x6) UNKNOWN PROPERTY
	...
	public:
		FGameplayTagContainer Tags; // 0x0(0x20)
		FDigestedWeaponAccuracy WeaponAccuracy; // 0x20(0x330)
		TArray Specializations; // 0x350(0x10)
	};
	...
	public:
		...
		TEnumAsByte BuildingType; // 0xC(0x1)
	...
	public:
		...
		TArray BuildDescriptors; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray BuildDescriptors; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x2]; // 0x4A(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		TArray TokenWeights; // 0x348(0x10)
	};
	...
	public:
		...
		TArray TargetInAirFiringPatterns; // 0x118(0x10)
		TArray FiringPatterns; // 0x128(0x10)
	...
	public:
		FGameplayTagContainer Tags; // 0x0(0x20)
		FRangedWeaponSkill WeaponSkill; // 0x20(0x188)
		TArray Specializations; // 0x1A8(0x10)
	};
	...
	public:
		...
		TArray TargetInAirFiringPatterns; // 0x28(0x10)
		TArray FiringPatterns; // 0x38(0x10)
	};
	...
	public:
		FGameplayTagContainer Tags; // 0x0(0x20)
		FDigestedRangedWeaponSkill WeaponSkill; // 0x20(0x48)
		TArray Specializations; // 0x68(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x6]; // 0x242(0x6) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x4]; // 0x0(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_5[0x3]; // 0xA1(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr PatrolEmote; // 0x0(0x20)
	...
	public:
		...
		TArray LootTiers; // 0x98(0x10)
		TArray ItemClassToDropOnDeathInsteadOfGrant; // 0xA8(0x10)
		TArray ItemToDropOnDeathInsteadOfGrant; // 0xB8(0x10)
	...
	{
	public:
		TArray LootDroppingBehaviors; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x18]; // 0x18(0x18) UNKNOWN PROPERTY
		ABuildingActor AlternateTargetingActor; // 0x30(0x8)
		unsigned char UnknownData05_7[0x110]; // 0x38(0x110) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x30]; // 0x10(0x30) UNKNOWN PROPERTY
	};
	...
	public:
		AActor SourceActor; // 0x0(0x8)
		unsigned char UnknownData01_7[0x60]; // 0x8(0x60) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x58]; // 0x40(0x58) UNKNOWN PROPERTY
	...
	public:
		...
		TArray ValidPOIVolumeList; // 0x70(0x10)
	...
	public:
		...
		TArray SpawningInfos; // 0x20(0x10)
		unsigned char UnknownData03_7[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray NavMeshLocations; // 0x48(0x10)
		bool bIsMainPOI; // 0x58(0x1)
		char Usage; // 0x59(0x1)
		unsigned char UnknownData05_7[0x16]; // 0x5A(0x16) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte Operation; // 0x48(0x1)
	...
	public:
		...
		TEnumAsByte Operation; // 0xA8(0x1)
	...
	public:
		...
		TEnumAsByte Operation; // 0x40(0x1)
	...
	public:
		...
		unsigned char UnknownData07_6[0x4]; // 0x34(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x4]; // 0x6C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x4]; // 0x8C(0x4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray AttributeClamps; // 0x8(0x10)
	};
