...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData01_2[0x268]; // 0x0(0x268) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xB8]; // 0x268(0xB8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x8]; // 0x1C0(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray ClassCollection; // 0x0(0x10)
	};
	...
	public:
		...
		TArray ProcessorCDOs; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0x17]; // 0x29(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray ExecuteBefore; // 0x8(0x10)
		TArray ExecuteAfter; // 0x18(0x10)
	};
