...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<ETwoPlayerSplitScreenType> TwoPlayerSplitscreenLayout; // 0x51(0x1)
		TEnumAsByte<EThreePlayerSplitScreenType> ThreePlayerSplitscreenLayout; // 0x52(0x1)
		...
		void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable, Memory Exec: 0x7FF74B740628(relative to base address)
		bool GetSkipAssigningGamepadToPlayer1(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF74B740614(relative to base address)
		UGameMapsSettings GetGameMapsSettings(); // Flags: Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF74B7405E4(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x1]; // 0xFF(0x1) UNKNOWN PROPERTY
