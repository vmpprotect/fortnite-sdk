...
namespace SDK
{
	...
	public:
		...
		void OnSurfaceTouching(AWaterBody WaterBodyActor, UPrimitiveComponent WaterComponent, UPrimitiveComponent SubmergedComponent, float SubmergedVolume, FVector& SubmergedCenterOfMass, FVector& SubmergedVelocity); // Flags: Event|Public|HasOutParms|HasDefaults|BlueprintEvent 0x7FF41465D1D8
		void OnSurfaceTouchEnd(AWaterBody WaterBodyActor, UPrimitiveComponent WaterComponent, UPrimitiveComponent SubmergedComponent, float SubmergedVolume, FVector& SubmergedCenterOfMass, FVector& SubmergedVelocity); // Flags: Event|Public|HasOutParms|HasDefaults|BlueprintEvent 0x7FF41465D0F8
		void OnSurfaceTouchBegin(AWaterBody WaterBodyActor, UPrimitiveComponent WaterComponent, UPrimitiveComponent SubmergedComponent, float SubmergedVolume, FVector& SubmergedCenterOfMass, FVector& SubmergedVelocity); // Flags: Event|Public|HasOutParms|HasDefaults|BlueprintEvent 0x7FF41465D018
	};
	...
	public:
		...
		TEnumAsByte CollisionChannelForWaterObjects; // 0x3C(0x1)
		...
		unsigned char UnknownData09_7[0x4]; // 0x5C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		bool IsEnabled(); // Flags: Final|Native|Public|Const 0x7FF41465D2B8
	};
