...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr<ADelMarTrackBase*> Track; // 0x0(0x8)
	};
	...
	{
	public:
		TArray<UMaterialInstanceConstant*> MICs; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<UClass*> SegmentActors; // 0x8(0x10)
	...
	public:
		...
		TWeakObjectPtr<UStaticMesh*> StaticMesh; // 0x20(0x20)
		TWeakObjectPtr<UClass*> Blueprint; // 0x40(0x20)
	...
	{
	public:
		TArray<FDelMarTrackPointIndexRange> RangesToApplyTo; // 0x0(0x10)
		...
		unsigned char UnknownData02_6[0x5]; // 0xDB(0x5) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<ADelMarTrackSegmentBase*> Segments; // 0x0(0x10)
		ADelMarTrackBase* Track; // 0x10(0x8)
		TArray<UActorComponent*> PropComponents; // 0x18(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UClass*> AtoB; // 0x8(0x20)
		TWeakObjectPtr<UClass*> BtoA; // 0x28(0x20)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> StartCap; // 0x8(0x20)
		TWeakObjectPtr<UClass*> EndCap; // 0x28(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> TrackSegmentClass; // 0x8(0x20)
		TArray<FString> MeshCustomizations; // 0x28(0x10)
	...
	public:
		...
		TWeakObjectPtr<UClass*> SegmentClass; // 0x10(0x20)
		TMap<FString, bool> EnabledMeshCustomizations; // 0x30(0x50)
	};
