...
namespace SDK
{
	...
	{
	public:
		TArray<FSynchedActionWarpPointInfo_Replicated> LedgeLaunchWarpPointInfos; // 0x128(0x10)
		...
		unsigned char UnknownData00_7[0x1]; // 0x13F(0x1) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FTransform> LedgeTransforms; // 0x0(0x10)
		TArray<FTransform> WindowLedgeTransforms; // 0x10(0x10)
	};
	...
	{
	public:
		TMap<EPlayerBuiltWallType, FLedgeLaunchConfigEntry> Transforms; // 0x0(0x50)
	};
	...
	{
	public:
		unsigned char UnknownData00_2[0x7C]; // 0x0(0x7C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FVector> NextLedgeLaunchWarpPoints; // 0xD0(0x10)
	};
