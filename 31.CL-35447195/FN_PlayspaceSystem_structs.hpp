...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr ControllerCached; // 0x50(0x8)
	};
	...
	public:
		...
		TWeakObjectPtr RequestingPlayspace; // 0x30(0x8)
		...
		unsigned char UnknownData03_7[0x3]; // 0x95(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr PlayspaceComponentClass; // 0x0(0x20)
	...
	{
	public:
		TWeakObjectPtr PlayspaceClass; // 0x0(0x20)
	...
	public:
		...
		unsigned char UnknownData03_7[0x6]; // 0xA(0x6) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray PlayspaceUsers; // 0x108(0x10)
		unsigned char UnknownData02_6[0x54]; // 0x118(0x54) UNKNOWN PROPERTY
		bool bIsInitialized; // 0x16C(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x16D(0x3) UNKNOWN PROPERTY
