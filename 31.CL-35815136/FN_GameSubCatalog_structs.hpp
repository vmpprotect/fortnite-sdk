...
namespace SDK
{
	...
	{
	public:
		TArray<FOfferNumericPriceAdjustment> OfferPriceAdjustments; // 0x0(0x10)
	};
	...
	public:
		...
		TEnumAsByte<ECatalogSaleType> SaleType; // 0x4(0x1)
	...
	{
	public:
		TEnumAsByte<EStoreCurrencyType> CurrencyType; // 0x0(0x1)
		...
		TEnumAsByte<ECatalogSaleType> SaleType; // 0x30(0x1)
	...
	public:
		...
		TMap<FString, FString> CheckoutProperties; // 0x80(0x50)
	...
	{
	public:
		TArray<FAdditionalCheckoutProperty> AdditionalCheckoutProperties; // 0x0(0x10)
	...
	public:
		EAppStore AppStore; // 0x0(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray<FString> AuthTokens; // 0x8(0x10)
		TArray<FString> ReceiptIds; // 0x18(0x10)
		...
		TArray<FString> CatalogItems; // 0x30(0x10)
	...
	public:
		...
		TEnumAsByte<EStoreCurrencyType> Currency; // 0x14(0x1)
	...
	public:
		FString OfferId; // 0x0(0x10)
		TEnumAsByte<EStoreCurrencyType> Currency; // 0x10(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x11(0x7) UNKNOWN PROPERTY
		FString CurrencySubType; // 0x18(0x10)
		int32_t ExpectedTotalPrice; // 0x28(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x2C(0x4) UNKNOWN PROPERTY
		FString GameContext; // 0x30(0x10)
		TArray<FString> ReceiverAccountIds; // 0x40(0x10)
	...
	public:
		...
		TEnumAsByte<EStoreCurrencyType> CurrencyType; // 0xC(0x1)
		unsigned char UnknownData00_6[0x3]; // 0xD(0x3) UNKNOWN PROPERTY
		FString CurrencySubType; // 0x10(0x10)
		TEnumAsByte<ECatalogSaleType> DisplayType; // 0x20(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x21(0x7) UNKNOWN PROPERTY
		TArray<FCatalogDynamicBundleItem> BundleItems; // 0x28(0x10)
	};
	...
	public:
		...
		TArray<FCatalogOfferRequirement> PurchaseRequirements; // 0x18(0x10)
	};
	...
	public:
		...
		TArray<FString> Categories; // 0x90(0x10)
		...
		TArray<FItemQuantity> ItemGrants; // 0x1E8(0x10)
		TArray<FCatalogOfferRequirement> Requirements; // 0x1F8(0x10)
		...
		TArray<FString> DenyItemTemplateIds; // 0x238(0x10)
	};
	...
	public:
		...
		TArray<FCatalogOffer> CatalogEntries; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FStorefront> Storefronts; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<FString> Fulfillments; // 0x0(0x10)
		TMap<FString, int32_t> FulfillmentCounts; // 0x10(0x50)
		TMap<EAppStore, FMcpEntitlementRefreshTimerInfo> RefreshTimers; // 0x60(0x50)
		TArray<FMcpProcessedConsumables> ProcessedConsumables; // 0xB0(0x10)
		TArray<ECheckpointToSendClientLogs> CheckpointToSendClientLogs; // 0xC0(0x10)
	};
