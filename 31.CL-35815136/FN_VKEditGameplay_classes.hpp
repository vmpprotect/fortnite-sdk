...
namespace SDK
{
	...
	{
	public:
		TArray<TWeakObjectPtr> Assets; // 0x30(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0x50]; // 0x6A0(0x50) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> EditorOnlyMinigameSettingsMachineClassToSpawn; // 0x6F0(0x20)
		TWeakObjectPtr<UClass*> EditorOnlyWorldManagerClassToSpawn; // 0x710(0x20)
		...
		void OnClientActivatedContent(FUniqueNetIdRepl& ClientNetId); // Flags: Final|Native|Private|HasOutParms|Const, Memory Exec: 0x7FF7519F8704(relative to base address)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0xC0]; // 0xF8(0xC0) UNKNOWN PROPERTY
		int32_t EditConnections; // 0x1B8(0x4)
		EVkEditStatus VkEditStatus; // 0x1BC(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x1BD(0x3) UNKNOWN PROPERTY
		...
		void OnRep_VkEditStatus(); // Flags: Final|Native|Protected|Const, Memory Exec: 0x7FF7519F8840(relative to base address)
		void OnRep_EditConnections(); // Flags: Final|Native|Protected|Const, Memory Exec: 0x7FF7519F87D4(relative to base address)
	};
