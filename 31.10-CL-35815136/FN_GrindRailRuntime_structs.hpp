...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_5[0x3]; // 0x2ED(0x3) UNKNOWN PROPERTY
		FName LFootOnGroundCurveName; // 0x2F0(0x4)
		bool bLeftCurveHighMeansFootDown : 1; // 0x2F4:0(0x1)
		unsigned char UnknownData01_5[0x3]; // 0x2F5(0x3) UNKNOWN PROPERTY
		FName RFootOnGroundCurveName; // 0x2F8(0x4)
		bool bRightCurveHighMeansFootDown : 1; // 0x2FC:0(0x1)
		unsigned char UnknownData02_5[0x3]; // 0x2FD(0x3) UNKNOWN PROPERTY
		FBoneReference LeftFootFKBone; // 0x300(0xC)
		unsigned char UnknownData03_7[0x3C]; // 0x30C(0x3C) UNKNOWN PROPERTY
	};
