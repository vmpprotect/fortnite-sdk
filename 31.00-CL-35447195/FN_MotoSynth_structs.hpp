...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData09_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x7]; // 0x29(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_6[0x3]; // 0x75(0x3) UNKNOWN PROPERTY
		FVector2D NoiseVolumeRange; // 0x78(0x10)
		bool bNoiseEnvelopeEnabled; // 0x88(0x1)
		unsigned char UnknownData12_6[0x7]; // 0x89(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_6[0x3]; // 0xE1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_6[0x4]; // 0xFC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData15_6[0x3]; // 0x111(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData16_6[0x3]; // 0x129(0x3) UNKNOWN PROPERTY
		float StereoWidenerFilterFrequency; // 0x12C(0x4)
		float StereoWidenerFilterQ; // 0x130(0x4)
		unsigned char UnknownData17_7[0x4]; // 0x134(0x4) UNKNOWN PROPERTY
	};
