...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_5[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_5[0x3]; // 0x1D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte PreInfinityExtrap; // 0x50(0x1)
		TEnumAsByte PostInfinityExtrap; // 0x51(0x1)
		unsigned char UnknownData02_6[0x6]; // 0x52(0x6) UNKNOWN PROPERTY
		TArray Times; // 0x58(0x10)
		bool DefaultValue; // 0x68(0x1)
		bool bHasDefaultValue; // 0x69(0x1)
		unsigned char UnknownData03_6[0x6]; // 0x6A(0x6) UNKNOWN PROPERTY
		TArray Values; // 0x70(0x10)
	...
	public:
		...
		TEnumAsByte TangentWeightMode; // 0x10(0x1)
	...
	public:
		...
		TEnumAsByte InterpMode; // 0x1C(0x1)
		TEnumAsByte TangentMode; // 0x1D(0x1)
	...
	public:
		...
		TEnumAsByte InterpMode; // 0x18(0x1)
		TEnumAsByte TangentMode; // 0x19(0x1)
	...
	{
	public:
		TWeakObjectPtr SoftPtr; // 0x0(0x20)
	...
	public:
		...
		unsigned char UnknownData03_7[0xA0]; // 0xF0(0xA0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr SourceSectionPtr; // 0x14(0x8)
	...
	{
	public:
		TWeakObjectPtr EntityOwner; // 0x0(0x8)
	...
	public:
		...
		TArray Entities; // 0xC0(0x10)
		TArray EntityMetaData; // 0xD0(0x10)
		TArray SharedMetaData; // 0xE0(0x10)
	};
	...
	{
	public:
		TArray LUTIndices; // 0x0(0x10)
		TArray TrackLUT; // 0x10(0x10)
		TArray SectionLUT; // 0x20(0x10)
	};
	...
	{
	public:
		TArray ActiveSequences; // 0x0(0x10)
		TArray ActiveEntities; // 0x10(0x10)
	};
	...
	public:
		...
		TArray Groups; // 0x10(0x10)
		TArray MetaData; // 0x20(0x10)
	};
	...
	public:
		...
		TMap TrackSignatureToTrackIdentifier; // 0x8(0x50)
		TMap SubSectionRanges; // 0x58(0x50)
	};
	...
	{
	public:
		TWeakObjectPtr Section; // 0x0(0x8)
	...
	public:
		...
		TWeakObjectPtr SourceTrack; // 0x14(0x8)
		unsigned char UnknownData04_6[0x4]; // 0x1C(0x4) UNKNOWN PROPERTY
		TArray ChildTemplates; // 0x20(0x10)
		...
		unsigned char UnknownData05_7[0x3]; // 0x6D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x1]; // 0xD7(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		TArray NestedTransforms; // 0x10(0x10)
	};
	...
	public:
		...
		TMap SubSequences; // 0x78(0x50)
		TMap Hierarchy; // 0xC8(0x50)
	...
	public:
		...
		TWeakObjectPtr Object; // 0x18(0x20)
	...
	{
	public:
		TArray SortedReferences; // 0x0(0x10)
	};
	...
	public:
		...
		TScriptInterface EaseIn; // 0x8(0x10)
		...
		TScriptInterface EaseOut; // 0x20(0x10)
	...
	public:
		...
		TEnumAsByte LastKnownStatus; // 0x8(0x1)
	...
	public:
		...
		unsigned char UnknownData05_7[0x5]; // 0x3B(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray ChildPossessables; // 0xC8(0x10)
