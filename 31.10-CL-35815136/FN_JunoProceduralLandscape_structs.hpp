...
namespace SDK
{
	...
	public:
		...
		TArray<FJunoLandscapeCustomOutputInfo> AvailableGrasses; // 0x8(0x10)
		TArray<FJunoLandscapeCustomOutputInfo> AvailablePhysicsMaterials; // 0x18(0x10)
	...
	{
	public:
		TArray<FName> OrderedLayers; // 0x0(0x10)
	...
	{
	public:
		TArray<FJunoLandscapeLayerInfo> LandscapeInfos; // 0x0(0x10)
	...
	public:
		...
		TArray<FName> PrecacheWeightmaps; // 0x8(0x10)
	...
	{
	public:
		TArray<ULandscapeGrassType*> SerializedGrassReferences; // 0x0(0x10)
		TArray<UPhysicalMaterial*> SerializedPhysicalMaterials; // 0x10(0x10)
		TArray<FJunoLandscapeCustomRenderIdentifier> SerializedCustomRenders; // 0x20(0x10)
		unsigned char UnknownData00_7[0xC8]; // 0x30(0xC8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2C]; // 0x4(0x2C) UNKNOWN PROPERTY
		TArray<FName> SerializedWeightmaps; // 0x30(0x10)
		unsigned char UnknownData01_6[0x50]; // 0x40(0x50) UNKNOWN PROPERTY
		TMap<FJunoLandscapeMaterialInstanceCacheKey, FJunoLandscapeComponentPrecachedDataLayers> PrecachedLayersMap; // 0x90(0x50)
	};
	...
	{
	public:
		TMap<FJunoLandscapeCombinedMaterialCacheKey, UJunoLandscapeCombinedMaterial*> ExternalCombinedMaterials; // 0x0(0x50)
		TMap<FJunoLandscapeCombinedMaterialCacheKey, UJunoLandscapeCombinedMaterial*> MaterialCombinations; // 0x50(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UObject*> Generator; // 0x8(0x20)
		TWeakObjectPtr<UMaterialInterface*> LandscapeMaterial; // 0x28(0x20)
		TWeakObjectPtr<UJunoLandscapeLayersData*> LayersData; // 0x48(0x20)
	};
