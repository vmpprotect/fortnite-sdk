...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x141(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x3]; // 0x159(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x4]; // 0x19C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		void SetAnimDriveDamperStiffness(float InStiffness); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable, Memory Exec: 0x7FF74C42CE74(relative to base address)
	};
