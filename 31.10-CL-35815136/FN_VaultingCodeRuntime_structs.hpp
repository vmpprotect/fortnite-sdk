...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_6[0x78]; // 0x190(0x78) UNKNOWN PROPERTY
		FScalableFloat Phase2_UpAngleTolerance; // 0x208(0x28)
		FScalableFloat Phase2_Floor_MaxHeightForHurlde; // 0x230(0x28)
		unsigned char UnknownData01_6[0x28]; // 0x258(0x28) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x4]; // 0x66C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x5]; // 0x3(0x5) UNKNOWN PROPERTY
		...
		TWeakObjectPtr<AActor*> TargetActor; // 0x100(0x8)
		TWeakObjectPtr<UPrimitiveComponent*> TargetActorComponent; // 0x108(0x8)
