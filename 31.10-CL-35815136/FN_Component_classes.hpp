...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_1[0x1D8]; // 0x28(0x1D8) UNKNOWN PROPERTY
	...
	public:
		...
		void OnRep_StartTime(); // Flags: Final|Native|Private, Memory Exec: 0x7FF74D6BA924(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x10]; // 0x2A8(0x10) UNKNOWN PROPERTY
		UMaterialInstanceDynamic* TextMaterialInstanceDynamic; // 0x2B8(0x8)
		UFont* Font; // 0x2C0(0x8)
		unsigned char UnknownData02_7[0x20]; // 0x2C8(0x20) UNKNOWN PROPERTY
