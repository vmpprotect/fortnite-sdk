...
namespace SDK
{
	...
	{
	public:
		TArray<FString> AccoladeNames; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FPFWAccoladeCollection_AchievedAccolade_PersistentInfoData> AccoladeCollection_AchievedAccolades; // 0x0(0x10)
	...
	public:
		...
		TArray<FFortAccoladeCollectionDataItem> AccoladeCollectionData; // 0x110(0x10)
	};
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x108(0x8) UNKNOWN PROPERTY
		TArray<FFortUpdatedTrackedAccoladeData> UpdatedTrackedAccolades; // 0x110(0x10)
	};
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x108(0x8) UNKNOWN PROPERTY
		TArray<FFortCompletedAccoladeData> CompletedAccolades; // 0x110(0x10)
	};
	...
	public:
		...
		TArray<FInstancedStruct> EventRewards; // 0x18(0x10)
		TArray<FInstancedStruct> OneTimeEventRewards; // 0x28(0x10)
		...
		unsigned char UnknownData00_6[0x1]; // 0x5F(0x1) UNKNOWN PROPERTY
		TWeakObjectPtr<USoundCue*> AwardedSoundCue; // 0x60(0x20)
		TWeakObjectPtr<UTexture2D*> PreviewImage; // 0x80(0x20)
