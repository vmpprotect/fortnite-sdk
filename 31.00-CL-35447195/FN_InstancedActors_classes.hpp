...
namespace SDK
{
	...
	public:
		...
		void OnRep_InstanceHandle(); // Flags: Final|Native|Protected 0x7FF414C84398
		bool HasMassEntity(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414C842B8
	};
	...
	public:
		...
		unsigned char UnknownData08_6[0x10]; // 0x60(0x10) UNKNOWN PROPERTY
		TArray InstanceTransforms; // 0x70(0x10)
		uint16_t NumValidInstances; // 0x80(0x2)
		unsigned char UnknownData09_6[0x6]; // 0x82(0x6) UNKNOWN PROPERTY
		FBox Bounds; // 0x88(0x38)
		uint16_t NumInstances; // 0xC0(0x2)
		unsigned char UnknownData10_6[0x6]; // 0xC2(0x6) UNKNOWN PROPERTY
		TArray Entities; // 0xC8(0x10)
		unsigned char UnknownData11_6[0x30]; // 0xD8(0x30) UNKNOWN PROPERTY
		TArray InstanceVisualizations; // 0x108(0x10)
		unsigned char UnknownData12_6[0x20]; // 0x118(0x20) UNKNOWN PROPERTY
		FBox CachedLocalBounds; // 0x138(0x38)
		unsigned char UnknownData13_6[0x10]; // 0x170(0x10) UNKNOWN PROPERTY
		...
		AInstancedActorsManager GetManager(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414C84478
	};
	...
	{
	public:
		unsigned char UnknownData06_3[0x10]; // 0x290(0x10) UNKNOWN PROPERTY
		UInstancedActorsSubsystem InstancedActorSubsystem; // 0x2A0(0x8)
		FInstancedActorsManagerHandle ManagerHandle; // 0x2A8(0x4)
		unsigned char UnknownData07_6[0x14]; // 0x2AC(0x14) UNKNOWN PROPERTY
		FGuid SavedActorGuid; // 0x2C0(0x10)
		bool bHasSpawnedEntities; // 0x2D0(0x1)
		unsigned char UnknownData08_6[0x1]; // 0x2D1(0x1) UNKNOWN PROPERTY
		uint16_t NextInstanceDataID; // 0x2D2(0x2)
		unsigned char UnknownData09_6[0x4]; // 0x2D4(0x4) UNKNOWN PROPERTY
		TArray PerActorClassInstanceData; // 0x2D8(0x10)
		FBox InstanceBounds; // 0x2E8(0x38)
		unsigned char UnknownData10_6[0x40]; // 0x320(0x40) UNKNOWN PROPERTY
		TMap ISMComponentToInstanceDataMap; // 0x360(0x50)
		UClass InstancedActorsDataClass; // 0x3B0(0x8)
		unsigned char UnknownData11_7[0x328]; // 0x3B8(0x328) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x7]; // 0x4C9(0x7) UNKNOWN PROPERTY
		FVector Extent; // 0x4D0(0x18)
		float Radius; // 0x4E8(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x4EC(0x4) UNKNOWN PROPERTY
		TArray Modifiers; // 0x4F0(0x10)
		bool bIgnoreOwnLevelsInstances; // 0x500(0x1)
		unsigned char UnknownData07_6[0x7]; // 0x501(0x7) UNKNOWN PROPERTY
		TArray LevelsToIgnore; // 0x508(0x10)
		FColor Color; // 0x518(0x4)
		bool bDrawOnlyIfSelected; // 0x51C(0x1)
		unsigned char UnknownData08_6[0x3]; // 0x51D(0x3) UNKNOWN PROPERTY
		float LineThickness; // 0x520(0x4)
		FInstancedActorsModifierVolumeHandle ModifierVolumeHandle; // 0x524(0x4)
		TArray ModifiedManagers; // 0x528(0x10)
		unsigned char UnknownData09_7[0x8]; // 0x538(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x8]; // 0xD0(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x18]; // 0x68(0x18) UNKNOWN PROPERTY
		FInstancedActorsConfig CompiledActiveConfig; // 0x80(0x20)
		TArray ClassConfigOverrides; // 0xA0(0x10)
	...
	{
	public:
		unsigned char UnknownData01_3[0x640]; // 0xC0(0x640) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData03_3[0x20]; // 0x40(0x20) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x250]; // 0x80(0x250) UNKNOWN PROPERTY
		UWorld ExemplarActorWorld; // 0x2D0(0x8)
		unsigned char UnknownData05_6[0x50]; // 0x2D8(0x50) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr InstanceData; // 0x118(0x8)
