...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_7[0x23]; // 0x25(0x23) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x10]; // 0xC0(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x100]; // 0x230(0x100) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData09_6[0x6]; // 0xA(0x6) UNKNOWN PROPERTY
		TArray LimitEnabled; // 0x10(0x10)
		...
		unsigned char UnknownData11_6[0x2]; // 0x12E(0x2) UNKNOWN PROPERTY
		FName ShapeName; // 0x130(0x4)
		FLinearColor ShapeColor; // 0x134(0x10)
		bool bIsTransientControl; // 0x144(0x1)
		unsigned char UnknownData12_6[0x3]; // 0x145(0x3) UNKNOWN PROPERTY
		UEnum ControlEnum; // 0x148(0x8)
		FRigControlElementCustomization Customization; // 0x150(0x20)
		TArray DrivenControls; // 0x170(0x10)
		unsigned char UnknownData13_6[0x10]; // 0x180(0x10) UNKNOWN PROPERTY
		bool bGroupWithParentControl; // 0x190(0x1)
		bool bRestrictSpaceSwitching; // 0x191(0x1)
		unsigned char UnknownData14_6[0x6]; // 0x192(0x6) UNKNOWN PROPERTY
		TArray FilteredChannels; // 0x198(0x10)
		EEulerRotationOrder PreferredRotationOrder; // 0x1A8(0x1)
		bool bUsePreferredRotationOrder; // 0x1A9(0x1)
		unsigned char UnknownData15_7[0x6]; // 0x1AA(0x6) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray AvailableSpaces; // 0x0(0x10)
		TArray RemovedSpaces; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x3]; // 0x81(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray ExposedConnectors; // 0x68(0x10)
	};
	...
	{
	public:
		TArray Maps; // 0x0(0x10)
		TMap EventToIndex; // 0x10(0x50)
	};
	...
	public:
		...
		TArray Entries; // 0x8(0x10)
		TMap KeyToIndex; // 0x18(0x50)
	};
	...
	public:
		...
		TMap VariableBindings; // 0x20(0x50)
		unsigned char UnknownData03_7[0x18]; // 0x70(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte EntryType; // 0x8(0x1)
		TEnumAsByte TransformType; // 0x9(0x1)
		unsigned char UnknownData03_6[0x6]; // 0xA(0x6) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x8]; // 0x230(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x23C(0x4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x18]; // 0x238(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x8]; // 0x238(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray Parents; // 0x18(0x10)
		TArray ParentWeights; // 0x28(0x10)
	...
	{
	public:
		TArray Elements; // 0x0(0x10)
		TArray Types; // 0x10(0x10)
		TArray Contents; // 0x20(0x10)
		TArray LocalTransforms; // 0x30(0x10)
		TArray GlobalTransforms; // 0x40(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xC0]; // 0xF0(0xC0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray InputBonesToTransfer; // 0x70(0x10)
		TArray OutputBonesToTransfer; // 0x80(0x10)
		TArray AssetUserData; // 0x90(0x10)
		unsigned char UnknownData05_6[0x170]; // 0xA0(0x170) UNKNOWN PROPERTY
		TWeakObjectPtr NodeMappingContainer; // 0x210(0x8)
		FControlRigIOSettings InputSettings; // 0x218(0x2)
		FControlRigIOSettings OutputSettings; // 0x21A(0x2)
		bool bExecute; // 0x21C(0x1)
		unsigned char UnknownData06_6[0xB]; // 0x21D(0xB) UNKNOWN PROPERTY
		TArray EventQueue; // 0x228(0x10)
		unsigned char UnknownData07_7[0x10]; // 0x238(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap ControlRigPerClass; // 0x260(0x50)
		...
		unsigned char UnknownData04_5[0x2]; // 0x2B6(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x4]; // 0x33C(0x4) UNKNOWN PROPERTY
		TMap InputMapping; // 0x340(0x50)
		TMap OutputMapping; // 0x390(0x50)
		unsigned char UnknownData06_6[0xB0]; // 0x3E0(0xB0) UNKNOWN PROPERTY
		int32_t LODThreshold; // 0x490(0x4)
		unsigned char UnknownData07_7[0x3C]; // 0x494(0x3C) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr ControlRig; // 0x248(0x8)
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xE8]; // 0x798(0xE8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0x1A0]; // 0x0(0x1A0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr StaticMesh; // 0x8(0x20)
		unsigned char UnknownData04_6[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		FTransform Transform; // 0x30(0x60)
		unsigned char UnknownData05_7[0x10]; // 0x90(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x58]; // 0x18(0x58) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0xA(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		TArray Points; // 0x18(0x10)
		TArray Springs; // 0x28(0x10)
		TArray Forces; // 0x38(0x10)
		TArray CollisionVolumes; // 0x48(0x10)
		TArray Constraints; // 0x58(0x10)
		TArray PreviousStep; // 0x68(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0xB]; // 0x75(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr Class; // 0x30(0x20)
		TMap Connections; // 0x50(0x50)
		TMap ConfigValues; // 0xA0(0x50)
		TMap Bindings; // 0xF0(0x50)
		FName PreviousName; // 0x140(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x144(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ConnectionList; // 0x0(0x10)
		unsigned char UnknownData01_7[0x50]; // 0x10(0x50) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray Dependents; // 0x140(0x10)
		ERigBoneType Type; // 0x150(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x151(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x1]; // 0x19F(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x2]; // 0x2AA(0x2) UNKNOWN PROPERTY
		FName GizmoName; // 0x2AC(0x4)
		FTransform GizmoTransform; // 0x2B0(0x60)
		FLinearColor GizmoColor; // 0x310(0x10)
		TArray Dependents; // 0x320(0x10)
		bool bIsTransientControl; // 0x330(0x1)
		unsigned char UnknownData09_6[0x7]; // 0x331(0x7) UNKNOWN PROPERTY
	...
	public:
		FRigElementKey Connector; // 0x0(0x8)
		TArray Matches; // 0x8(0x10)
		TArray Excluded; // 0x18(0x10)
	...
	public:
		...
		unsigned char UnknownData03_7[0xB]; // 0xD(0xB) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x8]; // 0x18(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0xA8]; // 0x798(0xA8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray BindingIds; // 0x0(0x10)
		TArray References; // 0x10(0x10)
	};
	...
	public:
		...
		TArray ConstraintsIndex; // 0x28(0x10)
	};
	...
	{
	public:
		TArray Enums; // 0x80(0x10)
		TArray Integers; // 0x90(0x10)
		TArray Spaces; // 0xA0(0x10)
		TArray Constraints; // 0xB0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0xC]; // 0x94(0xC) UNKNOWN PROPERTY
	...
	{
	public:
		TArray CopyOfControls; // 0x0(0x10)
		unsigned char UnknownData01_7[0x50]; // 0x10(0x50) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x30]; // 0x70(0x30) UNKNOWN PROPERTY
	};
	...
	public:
		FVector Start; // 0x8(0x18)
		FVector End; // 0x20(0x18)
		TEnumAsByte TraceChannel; // 0x38(0x1)
		unsigned char UnknownData02_6[0x3]; // 0x39(0x3) UNKNOWN PROPERTY
		float Radius; // 0x3C(0x4)
		bool bHit; // 0x40(0x1)
		unsigned char UnknownData03_6[0x7]; // 0x41(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x8]; // 0x1D8(0x8) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x1E0(0x60)
		bool bEnabled; // 0x240(0x1)
		unsigned char UnknownData05_7[0xF]; // 0x241(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x8]; // 0x248(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x208(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x20C(0x4) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x210(0x60)
		bool bEnabled; // 0x270(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x271(0xF) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray Points; // 0x1C0(0x10)
		FLinearColor Color; // 0x1D0(0x10)
		float Thickness; // 0x1E0(0x4)
		FName Space; // 0x1E4(0x4)
		unsigned char UnknownData02_6[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x1EC(0x4) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x1F0(0x60)
		bool bEnabled; // 0x250(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x251(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x23C(0x4) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x240(0x60)
		bool bEnabled; // 0x2A0(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x2A1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		FTransform WorldOffset; // 0x250(0x60)
		bool bEnabled; // 0x2B0(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x2B1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x24C(0x4) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x250(0x60)
		bool bEnabled; // 0x2B0(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x2B1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0xF]; // 0xF1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x221(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0xC]; // 0x244(0xC) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x250(0x60)
		bool bEnabled; // 0x2B0(0x1)
		unsigned char UnknownData05_7[0xF]; // 0x2B1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		TArray Transforms; // 0x1C0(0x10)
		TArray ParentIndices; // 0x1D0(0x10)
		ERigUnitDebugTransformMode Mode; // 0x1E0(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x1E1(0x3) UNKNOWN PROPERTY
		FLinearColor Color; // 0x1E4(0x10)
		float Thickness; // 0x1F4(0x4)
		float Scale; // 0x1F8(0x4)
		FRigElementKey Space; // 0x1FC(0x8)
		unsigned char UnknownData04_6[0xC]; // 0x204(0xC) UNKNOWN PROPERTY
		FTransform WorldOffset; // 0x210(0x60)
		bool bEnabled; // 0x270(0x1)
		unsigned char UnknownData05_7[0xF]; // 0x271(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x104(0x4) UNKNOWN PROPERTY
		FString Prefix; // 0x108(0x10)
		float AccumulatedTime; // 0x118(0x4)
		int32_t MeasurementsLeft; // 0x11C(0x4)
		bool bIsInitialized; // 0x120(0x1)
		unsigned char UnknownData03_7[0xF]; // 0x121(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		float Scale; // 0x38(0x4)
		FRigElementKey Space; // 0x3C(0x8)
		unsigned char UnknownData05_7[0xC]; // 0x44(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_7[0xC]; // 0x84(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray ConstraintData; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x1C6(0x2) UNKNOWN PROPERTY
		FVector AimVector; // 0x1C8(0x18)
		FVector UpVector; // 0x1E0(0x18)
		TArray AimTargets; // 0x1F8(0x10)
		TArray UpTargets; // 0x208(0x10)
	...
	public:
		FName Joint; // 0x1C0(0x4)
		unsigned char UnknownData03_6[0xC]; // 0x1C4(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x5]; // 0x23B(0x5) UNKNOWN PROPERTY
		FTransform BaseTransform; // 0x240(0x60)
		FName BaseJoint; // 0x2A0(0x4)
		unsigned char UnknownData05_7[0xC]; // 0x2A4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0xA]; // 0x1C6(0xA) UNKNOWN PROPERTY
		FTransform BaseTransform; // 0x1D0(0x60)
		FName BaseJoint; // 0x230(0x4)
		unsigned char UnknownData03_6[0xC]; // 0x234(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0xC]; // 0x1E4(0xC) UNKNOWN PROPERTY
		FTransform EndEffector; // 0x1F0(0x60)
		float IKBlend; // 0x250(0x4)
		unsigned char UnknownData05_6[0xC]; // 0x254(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0xC]; // 0x384(0xC) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0xB]; // 0x4C5(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		FLinearColor Color; // 0x1C4(0x10)
		unsigned char UnknownData01_7[0xC]; // 0x1D4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		FRigElementKeyCollection Collection; // 0x8(0x10)
		TArray ParentIndices; // 0x18(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x1C1(0x3) UNKNOWN PROPERTY
		FRigElementKey Child; // 0x1C4(0x8)
		FRigElementKey Parent; // 0x1CC(0x8)
		bool bMaintainGlobal; // 0x1D4(0x1)
		unsigned char UnknownData03_7[0xB]; // 0x1D5(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x1C5(0x3) UNKNOWN PROPERTY
		TArray Items; // 0x1C8(0x10)
		unsigned char UnknownData03_7[0x8]; // 0x1D8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x7]; // 0x1C9(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0x8]; // 0x1D8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray DrivenControls; // 0x8(0x10)
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x12(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0x241(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x24C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		TArray FilteredChannels; // 0xF0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x8]; // 0x258(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x6(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x5]; // 0x13(0x5) UNKNOWN PROPERTY
		...
		TArray FilteredChannels; // 0x170(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x8]; // 0x248(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x1DC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xA]; // 0x1E6(0xA) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xA]; // 0x226(0xA) UNKNOWN PROPERTY
	};
	...
	public:
		FRigElementKey Item; // 0x1C0(0x8)
		unsigned char UnknownData01_6[0x8]; // 0x1C8(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData04_3[0x8]; // 0x1D8(0x8) UNKNOWN PROPERTY
		FTransform Transform; // 0x1E0(0x60)
		ERigVMTransformSpace Space; // 0x240(0x1)
		unsigned char UnknownData05_6[0x3]; // 0x241(0x3) UNKNOWN PROPERTY
		FLinearColor Color; // 0x244(0x10)
		unsigned char UnknownData06_6[0x4]; // 0x254(0x4) UNKNOWN PROPERTY
		FString Description; // 0x258(0x10)
		unsigned char UnknownData07_7[0x8]; // 0x268(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0x232(0x6) UNKNOWN PROPERTY
		FRigElementKeyCollection ItemsToSet; // 0x238(0x10)
		float Weight; // 0x248(0x4)
		unsigned char UnknownData03_7[0x4]; // 0x24C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0xFA(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		bool Valid; // 0x81(0x1)
		unsigned char UnknownData02_6[0xE]; // 0x82(0xE) UNKNOWN PROPERTY
	...
	public:
		...
		bool Valid; // 0x79(0x1)
		unsigned char UnknownData01_6[0x6]; // 0x7A(0x6) UNKNOWN PROPERTY
		TArray Transforms; // 0x80(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0xC]; // 0x1C4(0xC) UNKNOWN PROPERTY
		FTransform Transform; // 0x1D0(0x60)
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0x1D1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0x89(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0xE]; // 0x12(0xE) UNKNOWN PROPERTY
		FTransform Transform; // 0x20(0x60)
	...
	public:
		...
		TArray Transforms; // 0x20(0x10)
		TArray CachedIndex; // 0x30(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x1CE(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0x1CA(0x6) UNKNOWN PROPERTY
		FCachedRigElement CachedIndex; // 0x1D0(0x18)
		unsigned char UnknownData03_7[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		FRigElementKey Item; // 0x1C0(0x8)
		TArray Tags; // 0x1C8(0x10)
		ERigMetaDataNameSpace NameSpace; // 0x1D8(0x1)
		unsigned char UnknownData02_6[0x7]; // 0x1D9(0x7) UNKNOWN PROPERTY
		FCachedRigElement CachedIndex; // 0x1E0(0x18)
		unsigned char UnknownData03_7[0x8]; // 0x1F8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray Result; // 0x30(0x10)
		TArray CachedIndices; // 0x40(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x235(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x4]; // 0x1CC(0x4) UNKNOWN PROPERTY
		FRigElementKeyCollection Parents; // 0x1D0(0x10)
		FTransform InitialGlobalTransform; // 0x1E0(0x60)
		float Weight; // 0x240(0x4)
		unsigned char UnknownData05_6[0xC]; // 0x244(0xC) UNKNOWN PROPERTY
		FTransform Transform; // 0x250(0x60)
		bool Switched; // 0x2B0(0x1)
		unsigned char UnknownData06_6[0x7]; // 0x2B1(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0x1D(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x5]; // 0x1CB(0x5) UNKNOWN PROPERTY
		FCachedRigElement CachedIndex; // 0x1D0(0x18)
		unsigned char UnknownData03_7[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x6]; // 0x292(0x6) UNKNOWN PROPERTY
	...
	public:
		FName bone; // 0x1C0(0x4)
		unsigned char UnknownData04_6[0xC]; // 0x1C4(0xC) UNKNOWN PROPERTY
		FQuat Rotation; // 0x1D0(0x20)
		ERigVMTransformSpace Space; // 0x1F0(0x1)
		unsigned char UnknownData05_6[0x3]; // 0x1F1(0x3) UNKNOWN PROPERTY
		float Weight; // 0x1F4(0x4)
		bool bPropagateToChildren; // 0x1F8(0x1)
		unsigned char UnknownData06_6[0x7]; // 0x1F9(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		FTransform Result; // 0x230(0x60)
		ERigVMTransformSpace Space; // 0x290(0x1)
		unsigned char UnknownData05_6[0x3]; // 0x291(0x3) UNKNOWN PROPERTY
		float Weight; // 0x294(0x4)
		bool bPropagateToChildren; // 0x298(0x1)
		unsigned char UnknownData06_6[0x7]; // 0x299(0x7) UNKNOWN PROPERTY
		FCachedRigElement CachedBone; // 0x2A0(0x18)
		unsigned char UnknownData07_7[0x8]; // 0x2B8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0x1E1(0x3) UNKNOWN PROPERTY
		float Weight; // 0x1E4(0x4)
		bool bPropagateToChildren; // 0x1E8(0x1)
		unsigned char UnknownData06_6[0x7]; // 0x1E9(0x7) UNKNOWN PROPERTY
		FCachedRigElement CachedBone; // 0x1F0(0x18)
		unsigned char UnknownData07_7[0x8]; // 0x208(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x7]; // 0x231(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x1C5(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray Entries; // 0x1C0(0x10)
		TArray CachedControlIndices; // 0x1D0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x1D4(0x4) UNKNOWN PROPERTY
		TArray CachedControlIndices; // 0x1D8(0x10)
		unsigned char UnknownData03_7[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x1D9(0x7) UNKNOWN PROPERTY
		TArray CachedControlIndices; // 0x1E0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x8]; // 0x1C8(0x8) UNKNOWN PROPERTY
		FTransform Transform; // 0x1D0(0x60)
		float Weight; // 0x230(0x4)
		bool bPropagateToChildren; // 0x234(0x1)
	...
	public:
		...
		unsigned char UnknownData03_6[0xF]; // 0x1D1(0xF) UNKNOWN PROPERTY
		FTransform Value; // 0x1E0(0x60)
		float Weight; // 0x240(0x4)
		bool bPropagateToChildren; // 0x244(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x245(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		FRigElementKey Parent; // 0x1C8(0x8)
		bool bParentInitial; // 0x1D0(0x1)
		unsigned char UnknownData03_6[0x7]; // 0x1D1(0x7) UNKNOWN PROPERTY
		FVector Value; // 0x1D8(0x18)
		float Weight; // 0x1F0(0x4)
		bool bPropagateToChildren; // 0x1F4(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x1F5(0x3) UNKNOWN PROPERTY
		FCachedRigElement CachedChild; // 0x1F8(0x18)
		FCachedRigElement CachedParent; // 0x210(0x18)
		unsigned char UnknownData05_7[0x8]; // 0x228(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x205(0x3) UNKNOWN PROPERTY
		FCachedRigElement CachedChild; // 0x208(0x18)
		FCachedRigElement CachedParent; // 0x220(0x18)
		unsigned char UnknownData05_7[0x8]; // 0x238(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		ERigVMTransformSpace Space; // 0x1C8(0x1)
		bool bInitial; // 0x1C9(0x1)
		unsigned char UnknownData03_6[0x6]; // 0x1CA(0x6) UNKNOWN PROPERTY
		FVector Value; // 0x1D0(0x18)
		float Weight; // 0x1E8(0x4)
		bool bPropagateToChildren; // 0x1EC(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x1ED(0x3) UNKNOWN PROPERTY
		FCachedRigElement CachedIndex; // 0x1F0(0x18)
		unsigned char UnknownData05_7[0x8]; // 0x208(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		float Weight; // 0x1F0(0x4)
		bool bPropagateToChildren; // 0x1F4(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x1F5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0x1D2(0x6) UNKNOWN PROPERTY
		TArray Transforms; // 0x1D8(0x10)
		float Weight; // 0x1E8(0x4)
		bool bPropagateToChildren; // 0x1EC(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x1ED(0x3) UNKNOWN PROPERTY
		TArray CachedIndex; // 0x1F0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x249(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x2]; // 0x256(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		float WaveMaximum; // 0x250(0x4)
		EEulerRotationOrder RotationOrder; // 0x254(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x255(0x3) UNKNOWN PROPERTY
		FRigUnit_BoneHarmonics_WorkData WorkData; // 0x258(0x28)
	};
	...
	public:
		...
		TArray Items; // 0x18(0x10)
		TArray Ratio; // 0x28(0x10)
		TArray LocalTip; // 0x38(0x10)
		TArray PendulumTip; // 0x48(0x10)
		TArray PendulumPosition; // 0x58(0x10)
		TArray PendulumVelocity; // 0x68(0x10)
		TArray HierarchyLine; // 0x78(0x10)
		TArray VelocityLines; // 0x88(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x1C4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x8]; // 0x488(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		FRigUnit_ChainHarmonics_Pendulum Pendulum; // 0x328(0x58)
		bool bDrawDebug; // 0x380(0x1)
		unsigned char UnknownData02_6[0xF]; // 0x381(0xF) UNKNOWN PROPERTY
		FTransform DrawWorldOffset; // 0x390(0x60)
		FRigUnit_ChainHarmonics_WorkData WorkData; // 0x3F0(0x98)
		unsigned char UnknownData03_7[0x8]; // 0x488(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0xC]; // 0x104(0xC) UNKNOWN PROPERTY
		FTransform Result; // 0x110(0x60)
		...
		unsigned char UnknownData05_7[0xF]; // 0x211(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x24D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x7]; // 0x309(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x25C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x7]; // 0x319(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x4]; // 0x2C4(0x4) UNKNOWN PROPERTY
		FCachedRigElement WorldUpSpaceCache; // 0x2C8(0x18)
		FCachedRigElement ChildCache; // 0x2E0(0x18)
		TArray ParentCaches; // 0x2F8(0x10)
		bool bIsInitialized; // 0x308(0x1)
		unsigned char UnknownData07_7[0x7]; // 0x309(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray Chain; // 0x0(0x10)
		TArray CachedItems; // 0x10(0x10)
		TArray RotationLimitIndex; // 0x20(0x10)
		TArray RotationLimitsPerItem; // 0x30(0x10)
	...
	public:
		...
		unsigned char UnknownData05_6[0x8]; // 0x1C8(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x3]; // 0x23D(0x3) UNKNOWN PROPERTY
		float BaseRotationLimit; // 0x240(0x4)
		unsigned char UnknownData07_6[0x4]; // 0x244(0x4) UNKNOWN PROPERTY
		TArray RotationLimits; // 0x248(0x10)
		bool bPropagateToChildren; // 0x258(0x1)
		unsigned char UnknownData08_6[0x7]; // 0x259(0x7) UNKNOWN PROPERTY
		FRigUnit_CCDIK_WorkData WorkData; // 0x260(0x58)
		unsigned char UnknownData09_7[0x8]; // 0x2B8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		int32_t MaxIterations; // 0x238(0x4)
		bool bStartFromTail; // 0x23C(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x23D(0x3) UNKNOWN PROPERTY
		float BaseRotationLimit; // 0x240(0x4)
		unsigned char UnknownData05_6[0x4]; // 0x244(0x4) UNKNOWN PROPERTY
		TArray RotationLimits; // 0x248(0x10)
		bool bPropagateToChildren; // 0x258(0x1)
		unsigned char UnknownData06_6[0x7]; // 0x259(0x7) UNKNOWN PROPERTY
		FRigUnit_CCDIK_WorkData WorkData; // 0x260(0x58)
		unsigned char UnknownData07_7[0x8]; // 0x2B8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		TArray CachedItems; // 0x0(0x10)
		TArray ItemRotationA; // 0x10(0x10)
		TArray ItemRotationB; // 0x20(0x10)
		TArray ItemRotationT; // 0x30(0x10)
		TArray ItemLocalTransforms; // 0x40(0x10)
	};
	...
	public:
		...
		TArray Rotations; // 0x1C8(0x10)
		ERigVMAnimEasingType RotationEaseType; // 0x1D8(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x1D9(0x3) UNKNOWN PROPERTY
		float Weight; // 0x1DC(0x4)
		bool bPropagateToChildren; // 0x1E0(0x1)
		unsigned char UnknownData04_6[0x7]; // 0x1E1(0x7) UNKNOWN PROPERTY
	...
	public:
		FRigElementKeyCollection Items; // 0x1C0(0x10)
		TArray Rotations; // 0x1D0(0x10)
		ERigVMAnimEasingType RotationEaseType; // 0x1E0(0x1)
		unsigned char UnknownData02_6[0x3]; // 0x1E1(0x3) UNKNOWN PROPERTY
		float Weight; // 0x1E4(0x4)
		FRigUnit_DistributeRotation_WorkData WorkData; // 0x1E8(0x50)
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x239(0x3) UNKNOWN PROPERTY
		int32_t MaxIterations; // 0x23C(0x4)
		FRigUnit_FABRIK_WorkData WorkData; // 0x240(0x38)
		bool bSetEffectorTransform; // 0x278(0x1)
		unsigned char UnknownData05_7[0x7]; // 0x279(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray ItemPositions; // 0x8(0x10)
		TArray ItemSegments; // 0x18(0x10)
		TArray CurvePositions; // 0x28(0x10)
		TArray CurveSegments; // 0x38(0x10)
		TArray CachedItems; // 0x48(0x10)
		TArray ItemRotationA; // 0x58(0x10)
		TArray ItemRotationB; // 0x68(0x10)
		TArray ItemRotationT; // 0x78(0x10)
		TArray ItemLocalTransforms; // 0x88(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x229(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x8]; // 0x3C8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0xF]; // 0x2A1(0xF) UNKNOWN PROPERTY
		FRigUnit_FitChainToCurve_DebugSettings DebugSettings; // 0x2B0(0x90)
		FRigUnit_FitChainToCurve_WorkData WorkData; // 0x340(0x98)
		unsigned char UnknownData07_7[0x8]; // 0x3D8(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray BoneToModify; // 0x1C0(0x10)
		float Weight; // 0x1D0(0x4)
	...
	{
	public:
		TArray ItemToModify; // 0x1C0(0x10)
		float Weight; // 0x1D0(0x4)
		float WeightMinimum; // 0x1D4(0x4)
		float WeightMaximum; // 0x1D8(0x4)
		EControlRigModifyBoneMode Mode; // 0x1DC(0x1)
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0x1DD(0x3) UNKNOWN PROPERTY
		int32_t MaxIterations; // 0x1E0(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x1E4(0x4) UNKNOWN PROPERTY
		FRigUnit_MultiFABRIK_WorkData WorkData; // 0x1E8(0x68)
		bool bIsInitialized; // 0x250(0x1)
		unsigned char UnknownData07_7[0xF]; // 0x251(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		float ChainLength; // 0x0(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray ItemSegments; // 0x8(0x10)
		TArray CachedItems; // 0x18(0x10)
		TArray Transforms; // 0x28(0x10)
		TArray BlendedTransforms; // 0x38(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x1D5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x2]; // 0x22A(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x4]; // 0x26C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x7]; // 0x349(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x1FA(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x6]; // 0x23A(0x6) UNKNOWN PROPERTY
	...
	public:
		TArray ConstraintData; // 0x0(0x10)
		TMap ConstraintDataToTargets; // 0x10(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0xB]; // 0x1C5(0xB) UNKNOWN PROPERTY
		FTransform BaseTransform; // 0x1D0(0x60)
		FName BaseBone; // 0x230(0x4)
		unsigned char UnknownData04_6[0x4]; // 0x234(0x4) UNKNOWN PROPERTY
		TArray Targets; // 0x238(0x10)
		bool bUseInitialTransforms; // 0x248(0x1)
		unsigned char UnknownData05_6[0x7]; // 0x249(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x1C9(0x7) UNKNOWN PROPERTY
		FTransform BaseTransform; // 0x1D0(0x60)
		FRigElementKey BaseItem; // 0x230(0x8)
		TArray Targets; // 0x238(0x10)
		bool bUseInitialTransforms; // 0x248(0x1)
		unsigned char UnknownData03_6[0x7]; // 0x249(0x7) UNKNOWN PROPERTY
		FRigUnit_TransformConstraint_WorkData WorkData; // 0x250(0x60)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x6]; // 0x1D2(0x6) UNKNOWN PROPERTY
		TArray Parents; // 0x1D8(0x10)
		FRigUnit_ParentConstraint_AdvancedSettings AdvancedSettings; // 0x1E8(0x2)
		unsigned char UnknownData04_6[0x2]; // 0x1EA(0x2) UNKNOWN PROPERTY
		float Weight; // 0x1EC(0x4)
		FCachedRigElement ChildCache; // 0x1F0(0x18)
		TArray ParentCaches; // 0x208(0x10)
		unsigned char UnknownData05_7[0x8]; // 0x218(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		unsigned char UnknownData02_3[0x8]; // 0x8(0x8) UNKNOWN PROPERTY
		FTransform Input; // 0x10(0x60)
		TArray Parents; // 0x70(0x10)
		FRigUnit_ParentConstraintMath_AdvancedSettings AdvancedSettings; // 0x80(0x1)
		unsigned char UnknownData03_6[0xF]; // 0x81(0xF) UNKNOWN PROPERTY
		FTransform Output; // 0x90(0x60)
		TArray ParentCaches; // 0xF0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0xC]; // 0x1E4(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray Parents; // 0x1D0(0x10)
		float Weight; // 0x1E0(0x4)
		unsigned char UnknownData03_6[0x4]; // 0x1E4(0x4) UNKNOWN PROPERTY
		FCachedRigElement ChildCache; // 0x1E8(0x18)
		TArray ParentCaches; // 0x200(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x2]; // 0x1E2(0x2) UNKNOWN PROPERTY
		float Weight; // 0x1E4(0x4)
		unsigned char UnknownData05_7[0x8]; // 0x1E8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray Parents; // 0x1D0(0x10)
		FRigUnit_RotationConstraint_AdvancedSettings AdvancedSettings; // 0x1E0(0x2)
		unsigned char UnknownData03_6[0x2]; // 0x1E2(0x2) UNKNOWN PROPERTY
		float Weight; // 0x1E4(0x4)
		FCachedRigElement ChildCache; // 0x1E8(0x18)
		TArray ParentCaches; // 0x200(0x10)
	};
	...
	public:
		TArray CachedItems; // 0x0(0x10)
		TArray ItemRatios; // 0x10(0x10)
		TArray ItemTransforms; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x1F9(0x3) UNKNOWN PROPERTY
		float Weight; // 0x1FC(0x4)
		bool bPropagateToChildren; // 0x200(0x1)
		unsigned char UnknownData04_6[0x7]; // 0x201(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x7]; // 0x209(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x4]; // 0x1CC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x4]; // 0x264(0x4) UNKNOWN PROPERTY
		FVector PoleVector; // 0x268(0x18)
		EControlRigVectorKind PoleVectorKind; // 0x280(0x1)
		unsigned char UnknownData07_6[0x3]; // 0x281(0x3) UNKNOWN PROPERTY
		FName PoleVectorSpace; // 0x284(0x4)
		bool bEnableStretch; // 0x288(0x1)
		unsigned char UnknownData08_6[0x3]; // 0x289(0x3) UNKNOWN PROPERTY
		...
		bool bPropagateToChildren; // 0x2A0(0x1)
		unsigned char UnknownData09_6[0xF]; // 0x2A1(0xF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_6[0x8]; // 0x1D8(0x8) UNKNOWN PROPERTY
		FTransform Effector; // 0x1E0(0x60)
		FVector PrimaryAxis; // 0x240(0x18)
		FVector SecondaryAxis; // 0x258(0x18)
		float SecondaryAxisWeight; // 0x270(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x274(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x3]; // 0x29D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0xB]; // 0x2B5(0xB) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData06_6[0x3]; // 0x125(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray Links; // 0x110(0x10)
		TArray Forces; // 0x120(0x10)
		TArray CollisionVolumes; // 0x130(0x10)
		...
		TArray BoneTargets; // 0x150(0x10)
		bool bLimitLocalPosition; // 0x160(0x1)
		bool bPropagateToChildren; // 0x161(0x1)
		unsigned char UnknownData07_6[0x6]; // 0x162(0x6) UNKNOWN PROPERTY
		FVector PrimaryAimAxis; // 0x168(0x18)
		FVector SecondaryAimAxis; // 0x180(0x18)
		unsigned char UnknownData08_6[0x8]; // 0x198(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x8]; // 0x308(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0xB]; // 0x85(0xB) UNKNOWN PROPERTY
		FQuat Result; // 0x90(0x20)
		FVector AngularVelocity; // 0xB0(0x18)
		unsigned char UnknownData07_6[0x8]; // 0xC8(0x8) UNKNOWN PROPERTY
