...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData06_6[0x3]; // 0x74D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x2]; // 0x786(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x4]; // 0x79C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x2]; // 0x7BA(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x2]; // 0x7C6(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_7[0x47]; // 0x7D9(0x47) UNKNOWN PROPERTY
