...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UClass*> SpawnerData; // 0x20(0x20)
		...
		TArray<FFortAthenaLivingWorldEventTagDensityRegistration> TagDensityRegistrations; // 0xD8(0x10)
		TArray<FFortAthenaLivingWorldTagTimer> PostDestructionTagDensityPersistenceDuration; // 0xE8(0x10)
	...
	{
	public:
		TArray<FPointProviderTagDebugColor> DebugColors; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xA8]; // 0x8(0xA8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FFortLivingWorldEventTableVariation> EventTableVariations; // 0x38(0x10)
		...
		TArray<TWeakObjectPtr> Encounters; // 0xC0(0x10)
	...
	public:
		FName Name; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UDataTable*> CategoryTable; // 0x8(0x20)
	...
	{
	public:
		unsigned char UnknownData00_1[0xD8]; // 0xC0(0xD8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UFortAthenaLivingWorldEventData*> EventData; // 0x0(0x20)
	...
	{
	public:
		TWeakObjectPtr<UFortAthenaLivingWorldEventData*> EventData; // 0x8(0x20)
		TArray<FFortAthenaLivingWorldEventDataEntry> EventDatas; // 0x28(0x10)
		FScalableFloat IsEnabled; // 0x38(0x28)
		TArray<float> MaxCount; // 0x60(0x10)
		TArray<float> MaxSpawnedCount; // 0x70(0x10)
		TArray<float> EventInstanceMaxCount; // 0x80(0x10)
		TArray<float> EventInstanceMaxSpawnedCount; // 0x90(0x10)
		...
		TArray<float> MinRespawnTime; // 0xB0(0x10)
		TArray<float> MaxRespawnTime; // 0xC0(0x10)
		TArray<float> InstantDeathMinRespawnTime; // 0xD0(0x10)
		TArray<float> InstantDeathMaxRespawnTime; // 0xE0(0x10)
		bool bOnlyInSafeZone; // 0xF0(0x1)
		bool bOnlyInNextSafeZone; // 0xF1(0x1)
		bool bOnlyInNextSafeZoneIfStormShrinking; // 0xF2(0x1)
		unsigned char UnknownData02_6[0x5]; // 0xF3(0x5) UNKNOWN PROPERTY
		...
		TArray<FFortAthenaLivingWorldEventTagDensityCondition> TagDensityConditions; // 0x128(0x10)
		bool bCanSpawnWithoutMatchingPlayerDistance; // 0x138(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x139(0x3) UNKNOWN PROPERTY
		...
		TArray<FFortAthenaLivingWorldDespawnCondition> DespawnConditions; // 0x168(0x10)
	...
	{
	public:
		TArray<FLivingWorldCalendarEventCondition> Conditions; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x5]; // 0x103(0x5) UNKNOWN PROPERTY
		UEnvQuery* SpawnAroundEnvironmentQuery; // 0x108(0x8)
		TEnumAsByte<EEnvQueryRunMode> SpawnAroundEnvironmentQueryRunMode; // 0x110(0x1)
	...
	{
	public:
		TWeakObjectPtr<UWorld*> SourceWorld; // 0x0(0x20)
		FGameplayTagContainer PlaylistTag; // 0x20(0x20)
		TWeakObjectPtr<UFortAthenaLivingWorldConfigData*> LagerConfig; // 0x40(0x20)
	...
	{
	public:
		TSet<AFortAthenaAIBotController*> TrackedBotControllers; // 0x0(0x50)
		TArray<AFortPawn*> TrackedPawns; // 0x50(0x10)
		TArray<AController*> TrackedPlayerControllers; // 0x60(0x10)
		TArray<TWeakObjectPtr> Listeners; // 0x70(0x10)
	...
	public:
		UFortAthenaLivingWorldManager* LivingWorldManager; // 0x0(0x8)
		unsigned char UnknownData00_7[0x90]; // 0x8(0x90) UNKNOWN PROPERTY
	};
	...
	public:
		UFortAthenaLivingWorldManager* LivingWorldManager; // 0x0(0x8)
		TArray<UClass*> LoadedSpawnerDataClass; // 0x8(0x10)
		TArray<UClass*> LoadedActorClasses; // 0x18(0x10)
		unsigned char UnknownData00_7[0xB8]; // 0x28(0xB8) UNKNOWN PROPERTY
	};
	...
	public:
		UFortAthenaLivingWorldManager* LivingWorldManager; // 0x0(0x8)
		TMap<AActor*, UObject*> RuntimePointProviderMap; // 0x8(0x50)
	...
	public:
		FGameplayTag SpawnActionTag; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> SpawnActionClass; // 0x8(0x20)
	};
	...
	{
	public:
		TArray<FFortAthenaLivingWorldCategoryTableData> CategoryTableDatas; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> Encounter; // 0x0(0x20)
		TArray<UClass*> PointProviderClasses; // 0x20(0x10)
	...
	{
	public:
		TArray<TScriptInterface> PointAroundPlayerProviders; // 0x0(0x10)
	...
	{
	public:
		TArray<UClass*> SpawnedSingleUseSpawnerData; // 0x0(0x10)
		FGameplayTagQuery SingleUseSpawnerDataQuery; // 0x10(0x48)
		TArray<UClass*> SpawnedConcurrentSingleUseSpawnerData; // 0x58(0x10)
