...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData14_5[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
		ESynth1OscType Osc1Type; // 0xC(0x1)
		unsigned char UnknownData15_6[0x3]; // 0xD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData17_5[0x3]; // 0x41(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData18_6[0x1]; // 0x57(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData19_6[0x1]; // 0x63(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData20_6[0x2]; // 0x7A(0x2) UNKNOWN PROPERTY
		bool bInvertModulationEnvelope : 1; // 0x7C:0(0x1)
		bool bInvertModulationEnvelopeBias : 1; // 0x7C:1(0x1)
		unsigned char UnknownData21_5[0x3]; // 0x7D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData22_5[0x3]; // 0x95(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData23_6[0x2]; // 0xA2(0x2) UNKNOWN PROPERTY
		bool bStereoDelayEnabled : 1; // 0xA4:0(0x1)
		unsigned char UnknownData24_5[0x3]; // 0xA5(0x3) UNKNOWN PROPERTY
		ESynthStereoDelayMode StereoDelayMode; // 0xA8(0x1)
		unsigned char UnknownData25_6[0x3]; // 0xA9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData26_5[0x3]; // 0xBD(0x3) UNKNOWN PROPERTY
		float ChorusDepth; // 0xC0(0x4)
		float ChorusFeedback; // 0xC4(0x4)
		float ChorusFrequency; // 0xC8(0x4)
		unsigned char UnknownData27_6[0x4]; // 0xCC(0x4) UNKNOWN PROPERTY
		TArray Patches; // 0xD0(0x10)
	};
	...
	public:
		...
		TArray AudioBusModulation; // 0x10(0x10)
	};
	...
	public:
		...
		TMap ModulationMappings; // 0x20(0x50)
	...
	public:
		...
		unsigned char UnknownData04_6[0x1]; // 0xF(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x2]; // 0x16(0x2) UNKNOWN PROPERTY
		float SurroundRearChannelBleedAmount; // 0x18(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x1C(0x4) UNKNOWN PROPERTY
		UAudioImpulseResponse ImpulseResponse; // 0x20(0x8)
		bool AllowHardwareAcceleration; // 0x28(0x1)
		unsigned char UnknownData07_7[0x7]; // 0x29(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
		TArray Bands; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0xC]; // 0x384(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0x2D9(0x7) UNKNOWN PROPERTY
	};
