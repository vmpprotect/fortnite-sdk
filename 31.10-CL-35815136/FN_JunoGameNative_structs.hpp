...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr<UPrimitiveComponent*> OverlappedPreviewComponent; // 0x0(0x8)
		FJunoBuildingMultiOverlapResult OverlapResult; // 0x8(0x10)
		TArray<FJunoBuildingSupportedComponent> SupportedComponents; // 0x18(0x10)
		unsigned char UnknownData00_6[0x10]; // 0x28(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x0(0x8)
	...
	{
	public:
		TArray<TWeakObjectPtr> SupportingComponents; // 0x0(0x10)
	};
	...
	public:
		AActor* Actor; // 0x0(0x8)
		TArray<FTemperatureRange> NewTemperatureRanges; // 0x8(0x10)
	};
	...
	{
	public:
		ECampRemovalStatus RemovalStatus; // 0x0(0x1)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> NPCPortrait; // 0x58(0x20)
	};
	...
	{
	public:
		TWeakObjectPtr<AJunoGuidedBuildingActor*> GuidedBuildingActor; // 0x0(0x8)
	};
	...
	{
	public:
		TMap<FName, UPrimaryDataAsset*> DataAssetMap; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<FJunoActiveBuffData> ActiveBuffs; // 0x0(0x10)
	};
	...
	public:
		...
		TMap<FGameplayTag, float> SetByCallerTagMagnitudes; // 0x8(0x50)
	};
	...
	public:
		...
		TArray<FGameplayTag> CompletedFirstTimeConversationNPCIdentifiers; // 0x70(0x10)
	...
	public:
		...
		TWeakObjectPtr<AActor*> CheckpointActor; // 0x10(0x8)
	...
	public:
		FGuid Guid; // 0x0(0x10)
		TWeakObjectPtr<AJunoInventory*> Inventory; // 0x10(0x8)
		unsigned char UnknownData00_7[0xC]; // 0x18(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> IndicatedActor; // 0x0(0x8)
	...
	// Struct JunoGameNative.JunoEvent_OpenHudMenuMessage
	// Size: 0x1 (0x1 - 0x0)
	struct FJunoEvent_OpenHudMenuMessage	
	{
	public:
		unsigned char UnknownData00_2[0x1]; // 0x0(0x1) UNKNOWN PROPERTY
	};
	...
	// Struct JunoGameNative.JunoEvent_CloseHudMenuMessage
	// Size: 0x1 (0x1 - 0x0)
	struct FJunoEvent_CloseHudMenuMessage	
	{
	public:
		unsigned char UnknownData00_2[0x1]; // 0x0(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xC]; // 0x10(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap<EFortPhysicsSimSize, UAnimMontage*> SizeToMontageMap; // 0x88(0x50)
	};
	...
	{
	public:
		TMap<FGameplayTag, FJunoActorLocationsData> ActorWorldLocations; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<FJunoActorLocationInfo> LocationInfos; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FGameplayTag, FSavedAIData> SavedAIDataPerUniqueAIIdentifier; // 0x0(0x50)
		TMap<FGameplayTag, FSavedCreatureData> SavedCreatureDataPerUniqueAIIdentifier; // 0x50(0x50)
	...
	{
	public:
		TArray<FSavedGlobalAIData_DynamicUniqueAI> AllAIs; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FGuid, FJunoRecruitmentObjectAssignedData> RecruitmentObjectToAssignedData; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, int32_t> CountOfRewardedLootTierGroups; // 0x0(0x50)
		TArray<FSavedGlobalAIData_RewardsPerPlayer> DataPerPlayer; // 0x50(0x10)
	};
	...
	public:
		...
		TMap<FName, int32_t> CountOfRewardedLootTierGroups; // 0x30(0x50)
	};
	...
	{
	public:
		TMap<FGameplayTag, FSavedGlobalAIData_FTUE> FTUEPerTag; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<FSavedAIData_Merchant_StockEntry> StockEntries; // 0x8(0x10)
	...
	{
	public:
		TMap<FName, double> GeneratingLootTierGroups; // 0x0(0x50)
		TArray<FSavedAIData_Resources_GeneratedItem> GeneratedItems; // 0x50(0x10)
	...
	public:
		...
		unsigned char UnknownData02_7[0x7]; // 0x81(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UFortItemDefinition*> WeaponDefinition; // 0x8(0x20)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> SmallIcon; // 0x20(0x20)
		TWeakObjectPtr<UTexture2D*> LargeIcon; // 0x40(0x20)
		TWeakObjectPtr<UTexture2D*> FullScreenIcon; // 0x60(0x20)
	};
	...
	{
	public:
		TArray<FText> AnimalNames; // 0x8(0x10)
	...
	{
	public:
		TWeakObjectPtr<UFortItemDefinition*> ResourceCostItemDefinition; // 0x0(0x20)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> UpgradeStepIcon; // 0xA0(0x20)
	...
	{
	public:
		TArray<FJunoAwesomeUpgradeStep> UpgradeSteps; // 0x0(0x10)
		FText UpgradeStageName; // 0x10(0x10)
		FText UpgradeStageDescription; // 0x20(0x10)
		TWeakObjectPtr<UTexture2D*> UpgradeStageIcon; // 0x30(0x20)
	};
	...
	{
	public:
		TArray<FJunoAwesomeUpgradeStage> UpgradeStages; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FJunoAwesomeUpgradeResourceCost> ResourceCostList; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<int32_t> AwesomePointGoals; // 0x10(0x10)
		TArray<FJunoAwesomeUpgradeRequirements> UpgradeRequirements; // 0x20(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UFortItemDefinition*> SaleItemDefinition; // 0x0(0x20)
	...
	{
	public:
		TWeakObjectPtr<UFortItemDefinition*> WantItemDefinition; // 0x8(0x20)
		TArray<FJunoBarterSaleItemData> SaleItemDatas; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr<AActor*> ActorRequiringRefresh; // 0x4(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x8]; // 0x268(0x8) UNKNOWN PROPERTY
		...
		TArray<FJunoBuildingSnapEntry> BuildingSnapEntries; // 0x438(0x10)
		TMap<FName, UClass*> BuildingPreviewComponentTemplates; // 0x448(0x50)
		unsigned char UnknownData01_7[0x8]; // 0x498(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TSet<TWeakObjectPtr> Classes; // 0x0(0x50)
		TSet<TWeakObjectPtr> ExcludedSubclasses; // 0x50(0x50)
	};
	...
	{
	public:
		TWeakObjectPtr<USceneComponent*> Component; // 0x0(0x8)
		TSet<int32_t> Ids; // 0x8(0x50)
	};
	...
	public:
		...
		TWeakObjectPtr<USceneComponent*> Component; // 0xD0(0x8)
	...
	{
	public:
		TArray<FJunoBuildingConnectionPoint> Value; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<EConnectionFieldGender, FJunoBuildingConnectionPoints> PointsMap; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<FVector> Locations; // 0x1C0(0x10)
	};
	...
	public:
		...
		TArray<FJunoBuildingSnapEntry> BuildingSnapEntries; // 0x2E8(0x10)
		TMap<FName, UClass*> BuildingPreviewComponentTemplates; // 0x2F8(0x50)
	...
	public:
		bool bMet; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr<AJunoCampActor*> CampActor; // 0x4(0x8)
	};
	...
	{
	public:
		TArray<FJunoCampSaveData> Camps; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FName> LastRewardsRollLootTierGroupsToSave; // 0x98(0x10)
		...
		unsigned char UnknownData02_6[0x3]; // 0xD5(0x3) UNKNOWN PROPERTY
		FText RandomName; // 0xD8(0x10)
	};
	...
	{
	public:
		TArray<FFortItemEntry> Items; // 0x0(0x10)
		TArray<FJunoCampRewardRecipeResult> Recipes; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<FText> RandomVillageNames; // 0x8(0x10)
		bool bAllBiomes; // 0x18(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		TArray<EJunoBiome> AllowedBiomes; // 0x20(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> NPCIconSmall; // 0x20(0x20)
		TWeakObjectPtr<UTexture2D*> NPCIconLarge; // 0x40(0x20)
		TWeakObjectPtr<UTexture2D*> NPCIconWide; // 0x60(0x20)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> CreatureIconSmall; // 0x28(0x20)
		TWeakObjectPtr<UTexture2D*> CreatureIconLarge; // 0x48(0x20)
		TWeakObjectPtr<UTexture2D*> CreatureIconFullScreen; // 0x68(0x20)
	...
	{
	public:
		unsigned char UnknownData00_3[0x4]; // 0x8(0x4) UNKNOWN PROPERTY
		FGameplayTag ItemTag; // 0xC(0x4)
		TWeakObjectPtr<UFortItemDefinition*> Item; // 0x10(0x20)
		FText NameOverride; // 0x30(0x10)
		FText DescriptionOverride; // 0x40(0x10)
		FText FlavorOverride; // 0x50(0x10)
		TWeakObjectPtr<UClass*> AIBotSpawnerData; // 0x60(0x20)
		TWeakObjectPtr<UObject*> SmallPreviewImage; // 0x80(0x20)
		TWeakObjectPtr<UObject*> LargePreviewImage; // 0xA0(0x20)
		...
		TArray<FName> LootPackageIDs; // 0x128(0x10)
	...
	public:
		...
		TArray<int32_t> AdjacentVerticesIndices; // 0x20(0x10)
	...
	{
	public:
		TArray<FJunoConnectivityDebugVertexData> VertexDataToDraw; // 0x0(0x10)
		bool bDebugDrawEnabled; // 0x10(0x1)
		unsigned char UnknownData00_7[0x27]; // 0x11(0x27) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<FInstancedStruct> EventFilters; // 0x10(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0xD0]; // 0x0(0xD0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> CraftingObjectRef; // 0x10(0x20)
	};
	...
	public:
		...
		TArray<FGeometryCollectionAutoInstanceMesh> InstancedMeshes; // 0x1A0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr<UFortAthenaLivingWorldEventData*> EventData; // 0x4(0x8)
	...
	{
	public:
		TArray<FJunoFogOfWar> TileDatas; // 0x0(0x10)
		TMap<FIntPoint, FJunoFogOfWar> TileDataMap; // 0x10(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<char> ExplorationMask; // 0x8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UFortItemDefinition*> Item; // 0x8(0x20)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x30]; // 0x108(0x30) UNKNOWN PROPERTY
		TArray<FJunoGameEventsFastArrayEntry> Items; // 0x138(0x10)
	};
	...
	{
	public:
		TArray<FComponentReference> ComponentReferences; // 0x0(0x10)
	...
	{
	public:
		TWeakObjectPtr<AJunoGuidedBuildingActor*> GuidedBuild; // 0x0(0x8)
		TWeakObjectPtr<AFortPlayerState*> PlayerState; // 0x8(0x8)
	...
	{
	public:
		TArray<uint32_t> Vertices; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FJunoIndexedSerializedEdgeData> Edges; // 0x18(0x10)
		TMap<FGraphIslandHandle, FJunoIndexedSerializedIslandData> Islands; // 0x28(0x50)
		TArray<bool> ConnectivityVertexData; // 0x78(0x10)
	};
	...
	{
	public:
		TArray<FPersistenceFrameworkLevelSaveSpawnablePtr> Inventories; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FGameplayTag> PreferredDestinationGroupOrder; // 0x68(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<FGameplayTagContainer> ItemTypeSortOrder; // 0x10(0x10)
	};
	...
	{
	public:
		TMap<FGuid, FJunoSavedInventoryUIData> InventoryUIData; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<FJunoItemSlot> AllSlotData; // 0x10(0x10)
		TArray<FJunoSelectedSlotData> SelectedItemGroupSlot; // 0x20(0x10)
	};
	...
	public:
		...
		TMap<UItemDefinitionBase*, FJunoKnowledgeItemStateEntry> ItemStates; // 0x40(0x50)
		TMap<FName, FJunoKnowledgeRecipeStateEntry> RecipeStates; // 0x90(0x50)
		TMap<FGameplayTag, FJunoKnowledgeCreatureStateEntry> CreatureStates; // 0xE0(0x50)
	...
	public:
		...
		TSet<FUniqueNetIdRepl> ViewedPlayerIds; // 0x8(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TSet<FUniqueNetIdRepl> ViewedPlayerIds; // 0x8(0x50)
		TSet<FUniqueNetIdRepl> EverAcquiredPlayerIds; // 0x58(0x50)
	};
	...
	public:
		...
		TArray<char> PackedTileMask; // 0x78(0x10)
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> MiniMapTexture; // 0x20(0x20)
		FGameplayTagContainer GameplayTags; // 0x40(0x20)
	};
	...
	{
	public:
		TArray<FJunoExploredTile> ExploredTiles; // 0x108(0x10)
		int32_t KnownClearedPixelCount; // 0x118(0x4)
		unsigned char UnknownData00_7[0x54]; // 0x11C(0x54) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UObject*> Icon; // 0x8(0x20)
		...
		TWeakObjectPtr<UObject*> CompassIcon; // 0xB8(0x20)
	...
	{
	public:
		TArray<TWeakObjectPtr> Icons; // 0x8(0x10)
		TArray<FLinearColor> Colors; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FJunoMarker> MarkersData; // 0x0(0x10)
		TArray<FGuid> MarkersIds; // 0x10(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UFortItemDefinition*> WantItemDefinition; // 0x0(0x20)
	...
	public:
		...
		TArray<FJunoMerchantPricingLevel> PricingLevels; // 0x10(0x10)
		TArray<FJunoMerchantWantedItemData> WantedItemDatas; // 0x20(0x10)
	...
	public:
		...
		TArray<FJunoPersistenceAssetBackwardCompatibilityIssue> Issues; // 0x50(0x10)
	};
	...
	public:
		...
		TArray<FJunoPersistenceAssetInfo> PersistenceAssetInfos; // 0x40(0x10)
	};
	...
	public:
		...
		TArray<FJunoPersistentProperty> PersistentProperties; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FJunoPersitentTypeSchema> TypeSchemas; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		TMap<FGameplayTag, float> GameplayTagToDespawnTime; // 0x20(0x50)
		TMap<EFortRarity, float> RarityToDespawnTime; // 0x70(0x50)
	};
	...
	{
	public:
		TArray<FJunoMCPBuildingPlaced> GuestWorldsWithMCPBuildings; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData02_7[0x10]; // 0x30(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> SpawnedActor; // 0x0(0x8)
		FVector SpawnLocation; // 0x8(0x18)
		FDateTime SpawnTime; // 0x20(0x8)
		UClass* ActorClass; // 0x28(0x8)
		TWeakObjectPtr<UItemDefinitionBase*> ItemDef; // 0x30(0x8)
		FName Recipe; // 0x38(0x4)
		TWeakObjectPtr<AJunoCampActor*> CampAtLocation; // 0x3C(0x8)
	...
	{
	public:
		TArray<FJunoBuildingSessionEntry> Entries; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0x7]; // 0x5(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<FName, int32_t> PersistentValueTable; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FGuid, FJunoPlayspaceIndexNode> PlayspaceNodes; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<FGuid> ChildrenIds; // 0x20(0x10)
	...
	{
	public:
		TWeakObjectPtr<UClass*> PickupClass; // 0x0(0x20)
	...
	public:
		...
		TArray<FFortItemEntry> MultiItemList; // 0x1A8(0x10)
	...
	{
	public:
		TMap<TWeakObjectPtr, FPickupTypePersistenceInfo> PersistentPickupTypeMap; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<FPickupPersistenceInfo> PersistentPickupList; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FName, FJunoUserGeneratedTextEntry> TextEntries; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<FSubjectTagsPair> BuildContributors; // 0xB0(0x10)
	};
	...
	public:
		...
		TArray<FSubjectTagsPair> Players; // 0xB0(0x10)
	...
	{
	public:
		TArray<FSavedWeather> SavedWeathers; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FJunoWeatherPhase> NextPhaseQueue; // 0x80(0x10)
	};
	...
	public:
		FJunoWeatherLocation Location; // 0x0(0x2)
		unsigned char UnknownData00_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
		TArray<FJunoWeatherPhaseForecast> WeatherTypes; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<FJunoWeatherLocalizedForecasts> LocalizedForecasts; // 0x10(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EArithmeticKeyOperation> CheckOperator; // 0x18(0x1)
	...
	public:
		FWorldConditionContextDataRef PlayerControllerRef; // 0x10(0x8)
		TArray<FInstancedStruct> RecipeUnlockTypes; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FName> TaintedSettings; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FJunoRecipeMessageData> FoundRecipes; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FJunoRecipeMessageData> VisibleRecipes; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<AJunoCampActor*> CampActor; // 0x0(0x8)
	...
	public:
		...
		ECampRemovalStatus RemovalStatus; // 0x54(0x1)
	...
	public:
		...
		TArray<UClass*> GEsToApply; // 0x48(0x10)
	};
	...
	{
	public:
		TMap<FGameplayTag, FPlayerPerksPerAwesomenessLevelDigested> PerksPerCampTag; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FGameplayTag, FNPCPerksPerAwesomenessLevelDigested> PerksPerCampTag; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<FTestPropertyToMap> TestArray; // 0x0(0x10)
		TArray<FTestMappingPropertyContainer> TestContainerArray; // 0x10(0x10)
	};
	...
	{
	public:
		TMap<FTestPropertyToMap, FTestPropertyToMap> TestMap; // 0x0(0x50)
		TMap<FTestMappingPropertyContainer, FTestMappingPropertyContainer> TestContainerMap; // 0x50(0x50)
	};
	...
	{
	public:
		TSet<FTestPropertyToMap> TestSet; // 0x0(0x50)
		TSet<FTestMappingPropertyContainer> TestContainerSet; // 0x50(0x50)
	};
	...
	{
	public:
		TArray<UJunoActionConfig*> ThresholdActionConfigs; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x9(0x7) UNKNOWN PROPERTY
		TWeakObjectPtr<UJunoBuildInstructionsItemDefinition*> ItemDefinition; // 0x10(0x20)
	...
	{
	public:
		TArray<TWeakObjectPtr> BuildInstructions; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FName> CraftingRowNames; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FInstancedStruct> RecipeUnlockTypes; // 0x8(0x10)
	...
	{
	public:
		TArray<UFortItem*> ResourceInstances; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x14(0x4) UNKNOWN PROPERTY
		TArray<FAwesomePerkReward> PlayerPerkRewards; // 0x18(0x10)
		TArray<FAwesomePerkReward> NPCPerkRewards; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x119(0x3) UNKNOWN PROPERTY
		FInt32Range RequiredRemainingPoints; // 0x11C(0x10)
		EJunoAwesomeLevelIncrementType IncrementBy; // 0x12C(0x1)
		unsigned char UnknownData03_7[0x3]; // 0x12D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x13D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> AICharacterIcon; // 0x18(0x20)
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TArray<FJunoBedAssignmentCharacterInfo> AssignedCharacterInfo; // 0x8(0x10)
		TArray<FUniqueNetIdRepl> PlayerNetIds; // 0x18(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UFortWorldItemDefinition*> ItemDefinition; // 0x8(0x20)
		TMap<EJunoResourceScale, int32_t> Amount; // 0x28(0x50)
	};
	...
	public:
		...
		TArray<FString> Keyholders; // 0x80(0x10)
		TArray<FString> Occupants; // 0x90(0x10)
		double WorldOwnerGuestReservationExpiration; // 0xA0(0x8)
		FDateTime CreatedAt; // 0xA8(0x8)
		FDateTime LastPlayed; // 0xB0(0x8)
		TArray<FJunoReplicatedPlayerMetadata> Players; // 0xB8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UWorld*> PersistentLevel; // 0x8(0x20)
		TArray<TWeakObjectPtr> OverlayLevels; // 0x28(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TMap<int32_t, FGameplayTagContainer> SlotTagMap; // 0x10(0x50)
	};
	...
	{
	public:
		TArray<FJunoInventoryGroupConfig> InventoryGroupConfigs; // 0x0(0x10)
	...
	public:
		FGameplayTag GroupType; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FJunoItemSlot> SlotList; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FJunoItemSlot> ItemSlots; // 0x118(0x10)
	};
	...
	public:
		TWeakObjectPtr<AActor*> Actor; // 0x0(0x8)
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x8(0x8)
	};
	...
	{
	public:
		TArray<FJunoBuilderToolSelectedActor> SelectedActors; // 0x0(0x10)
		FTransform SelectionTransform; // 0x10(0x60)
		TWeakObjectPtr<AActor*> AttachmentActor; // 0x70(0x8)
		TArray<FJunoBuilderToolSupportCandidate> SupportCandidates; // 0x78(0x10)
		APawn* Instigator; // 0x88(0x8)
		FName RecipeName; // 0x90(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x94(0x4) UNKNOWN PROPERTY
		TArray<FName> StableNames; // 0x98(0x10)
	...
	{
	public:
		TArray<TWeakObjectPtr> Actors; // 0x0(0x10)
		unsigned char UnknownData00_7[0x8]; // 0x10(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FJunoBuildingSnapEntryContext> TargetEntries; // 0x20(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x8]; // 0x60(0x8) UNKNOWN PROPERTY
		FHitResult TargetTraceResult; // 0x68(0xF8)
		EJunoBuildingPlacementType PlacementType; // 0x160(0x1)
		unsigned char UnknownData01_6[0xF]; // 0x161(0xF) UNKNOWN PROPERTY
		FTransform UnsnappedTargetTransform; // 0x170(0x60)
		FTransform TargetTransform; // 0x1D0(0x60)
		FTransform CoordinateBasis; // 0x230(0x60)
		TWeakObjectPtr<AActor*> AttachmentActor; // 0x290(0x8)
		unsigned char UnknownData02_7[0x8]; // 0x298(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x25D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FName> ComponentTags; // 0x70(0x10)
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x80(0x8)
	...
	public:
		...
		TArray<FJunoGuidedBuildingComponentData> CompData; // 0x80(0x10)
	};
	...
	public:
		...
		TArray<int32_t> ActorIndexes; // 0x10(0x10)
		TArray<int32_t> AutoCompleteIndexes; // 0x20(0x10)
	...
	public:
		...
		TArray<FName> ActorNames; // 0x60(0x10)
		TArray<FName> AutoCompleteActorNames; // 0x70(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		TArray<FJunoGuidedBuildingStageData> Stages; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<FJunoGuidedBuildingStageEditorData> EditorStages; // 0x38(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<int32_t> ActorIndexesToDestroy; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FName> ActorNamesToDestroy; // 0x18(0x10)
	};
	...
	public:
		...
		TArray<FJunoGuidedBuildingDestructionEntry> DestructionEntries; // 0x70(0x10)
		TArray<FJunoGuidedBuildingSectionData> Sections; // 0x80(0x10)
	};
	...
	{
	public:
		TArray<FJunoGuidedBuildingDestructionEditorEntry> DestructionEditorEntries; // 0x90(0x10)
		TArray<FJunoGuidedBuildingSectionEditorData> EditorSections; // 0xA0(0x10)
	};
	...
	public:
		...
		TArray<FJunoBuildingEditorActorEntry> ActorEntries; // 0x10(0x10)
		...
		TArray<FString> PluginsToActivate; // 0xE0(0x10)
		TArray<FJunoStageKey> AllStageKeys; // 0xF0(0x10)
	...
	public:
		...
		TArray<UPrimitiveComponent*> Components; // 0x48(0x10)
		...
		unsigned char UnknownData01_5[0x3]; // 0x65(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr<AActor*> FilledActor; // 0x10(0x8)
	...
	{
	public:
		TArray<FJunoGuidedBuildingStateEntry> Entries; // 0x108(0x10)
	...
	{
	public:
		TArray<int32_t> UpdatedSnaps; // 0x0(0x10)
		TArray<FJunoStageKey> UpdatedStages; // 0x10(0x10)
		TArray<FJunoStageKey> CompletedStages; // 0x20(0x10)
		TArray<FJunoStageKey> CompletedSections; // 0x30(0x10)
		bool bSetComplete; // 0x40(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x41(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr<AActor*> FinishingPlayer; // 0x44(0x8)
	...
	{
	public:
		TWeakObjectPtr<AJunoGuidedBuildingActor*> NewActor; // 0x0(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x2(0x2) UNKNOWN PROPERTY
		TWeakObjectPtr<AActor*> FinishingPlayer; // 0x4(0x8)
	...
	public:
		...
		TWeakObjectPtr<AActor*> SpawnedActor; // 0x4(0x8)
		bool bAutoComplete; // 0xC(0x1)
		unsigned char UnknownData00_7[0x3]; // 0xD(0x3) UNKNOWN PROPERTY
	};


	// Struct JunoGameNative.AutoCompleteBlockedIndex
	// Size: 0x28 (0x28 - 0x0)
	struct FAutoCompleteBlockedIndex	
	{
	public:
		int32_t BuildingIndex; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		FGameplayTagContainer Reasons; // 0x8(0x20)
	};
	...
	{
	public:
		TArray<FAutoCompleteData> AutoCompleteData; // 0x0(0x10)
		TWeakObjectPtr<APawn*> Instigator; // 0x10(0x8)
		TArray<FAutoCompleteBlockedIndex> BlockedIndexes; // 0x18(0x10)
	...
	{
	public:
		TWeakObjectPtr<AFortPlayerState*> PlayerState; // 0xC(0x8)
	};
	...
	public:
		unsigned char UnknownData00_3[0x30]; // 0x108(0x30) UNKNOWN PROPERTY
		TArray<FJunoGuidedBuildingRegisteredPlayer> Entries; // 0x138(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray<UPrimitiveComponent*> Comps; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x2FC(0x4) UNKNOWN PROPERTY
		FJunoBuilderToolInteractionActorClassSet BuildingOverlappableClasses; // 0x300(0xA0)
		TArray<FJunoBuildingSnapEntry> BuildingSnapEntries; // 0x3A0(0x10)
		TMap<FName, UClass*> BuildingPreviewComponentTemplates; // 0x3B0(0x50)
		TWeakObjectPtr<UMaterial*> GuidedBuildingMaterial; // 0x400(0x20)
		...
		unsigned char UnknownData02_6[0x4]; // 0x434(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr<UClass*> BlueprintClass; // 0x8(0x20)
	...
	{
	public:
		TArray<UFortWorldItem*> AddedItems; // 0x0(0x10)
		TArray<UFortWorldItem*> RemovedItems; // 0x10(0x10)
		TArray<UFortWorldItem*> ChangedItems; // 0x20(0x10)
	};
	...
	{
	public:
		TMap<UActorComponent*, USceneComponent*> AttachParents; // 0x0(0x50)
		unsigned char UnknownData00_7[0xD0]; // 0x50(0xD0) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<UActorComponent*> DefaultComponents; // 0x0(0x10)
	...
	{
	public:
		TArray<UJunoBuildingPreviewComponent*> PreviewComponents; // 0x0(0x10)
		TArray<UPrimitiveComponent*> CollisionComponents; // 0x10(0x10)
		TArray<UMeshComponent*> MeshComponents; // 0x20(0x10)
		TArray<FJunoBuildingSnapEntryPreview> SnapEntryPreviews; // 0x30(0x10)
		TArray<FJunoComponentActorMapEntry> ComponentToClassMap; // 0x40(0x10)
		...
		unsigned char UnknownData00_7[0xC8]; // 0x108(0xC8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0xB1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ECollisionResponse> Response; // 0x1(0x1)
	};
	...
	{
	public:
		TArray<FJunoCollisionChannelResponsePair> CollisionResponses; // 0x0(0x10)
	...
	public:
		FGuid Guid; // 0x0(0x10)
		TArray<UMeshComponent*> MeshComponents; // 0x10(0x10)
	...
	{
	public:
		TWeakObjectPtr<UStaticMesh*> PickupStaticMesh; // 0x0(0x20)
		TWeakObjectPtr<USkeletalMesh*> PickupSkeletalMesh; // 0x20(0x20)
		TWeakObjectPtr<UClass*> PickupEffectOverride; // 0x40(0x20)
		TWeakObjectPtr<USoundBase*> PickupSound; // 0x60(0x20)
		TWeakObjectPtr<USoundBase*> PickupByNearbyPawnSound; // 0x80(0x20)
		TWeakObjectPtr<USoundBase*> DropSound; // 0xA0(0x20)
		TWeakObjectPtr<USoundBase*> DroppedLoopSound; // 0xC0(0x20)
		TWeakObjectPtr<USoundBase*> LandedSound; // 0xE0(0x20)
	};
	...
	public:
		...
		TWeakObjectPtr<UClass*> ActorClassToBuild; // 0x8(0x20)
	...
	public:
		...
		TWeakObjectPtr<AActor*> ActorToUpgrade; // 0x10(0x8)
		TWeakObjectPtr<AActor*> CraftingObject; // 0x18(0x8)
		TWeakObjectPtr<AJunoPersistentPlayspace*> Playspace; // 0x20(0x8)
		...
		TArray<FFortItemEntry> ConsumedIngredients; // 0xA0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray<FGraphVertexHandle> Vertices; // 0x8(0x10)
		TMap<FGraphHandle, FSerializedEdgeData> Edges; // 0x18(0x50)
		TMap<FGraphIslandHandle, FSerializedIslandData> Islands; // 0x68(0x50)
	};
	...
	{
	public:
		TMap<FGraphVertexHandle, FSerializableConnectivityGraphVertex> ConnectivityVertexData; // 0xB8(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x5]; // 0xF(0x5) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FJunoKnowledgeRecipeStateFastEntry> Entries; // 0x108(0x10)
		TWeakObjectPtr<UJunoKnowledgeComponent*> ParentComp; // 0x118(0x8)
	};
	...
	public:
		FGameplayTag MoodReactionTag; // 0x0(0x4)
		TWeakObjectPtr<AActor*> Instigator; // 0x4(0x8)
	...
	{
	public:
		TMap<FName, FName> ActorNameRedirectors; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TMap<FString, FString> PackageDeltaFiles; // 0x8(0x50)
	};
	...
	public:
		int32_t WorldCompatibilityVersion; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TMap<FString, FJsonObjectWrapper> DeltasMetadata; // 0x8(0x50)
	};
	...
	{
	public:
		TWeakObjectPtr<AJunoPersistentPlayspace*> PersistentPlayspaceWeakPtr; // 0x0(0x8)
		unsigned char UnknownData00_7[0x1C]; // 0x8(0x1C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x44]; // 0x1C(0x44) UNKNOWN PROPERTY
		UObject* ImplementationCustomStateObject; // 0x60(0x8)
		TScriptInterface<Class> Data; // 0x68(0x10)
		UClass* SourceImplementationDataClass; // 0x78(0x8)
		TScriptInterface<Class> DifferentImplementationData; // 0x80(0x10)
		unsigned char UnknownData02_7[0x30]; // 0x90(0x30) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<FGraphIslandHandle, FJunoSingleClusterUnionSaveData> PerClusterUnionData; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FGuid, FJunoSinglePhysicsToySaveData> PerToyData; // 0x0(0x50)
	};
	...
	public:
		...
		bool bCanDeathBePermanent; // 0x1(0x1)
		unsigned char UnknownData00_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<UClass*> Classes; // 0x8(0x10)
	...
	public:
		...
		TEnumAsByte<ECollisionTraceFlag> CollisionTraceFlag; // 0x38(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x39(0x7) UNKNOWN PROPERTY
		TArray<int32_t> TriCounts; // 0x40(0x10)
	...
	public:
		...
		TArray<int32_t> TriCounts; // 0x38(0x10)
	...
	public:
		...
		TArray<UStaticMesh*> RootProxyMeshes; // 0x68(0x10)
		uint64_t NumAutoInstancedMeshes; // 0x78(0x8)
		TArray<UStaticMesh*> AutoInstancedMeshes; // 0x80(0x10)
