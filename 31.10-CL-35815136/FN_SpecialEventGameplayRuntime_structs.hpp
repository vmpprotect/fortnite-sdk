...
namespace SDK
{
	...
	public:
		...
		TArray<FSpecialEventTODMSubphaseData> SubphaseDataArray; // 0x8(0x10)
	...
	{
	public:
		TEnumAsByte<EEasingFunc> EasingFunc; // 0x0(0x1)
	...
	public:
		...
		TWeakObjectPtr<UClass*> SoftActorClass; // 0x20(0x20)
		...
		TArray<FDestroyActorsAndComponentsMutator_ComponentDefinition> ComponentDefinitions; // 0x48(0x10)
		...
		TArray<AActor*> ActorsToProcess; // 0x60(0x10)
	};
	...
	public:
		unsigned char UnknownData00_3[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<FFakeKillRelevancyVictim> Victims; // 0x10(0x10)
	...
	{
	public:
		TArray<FFakeKillRelevancyPlayerDataEntry> Entries; // 0x108(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FName> MapNames; // 0x8(0x10)
	...
	{
	public:
		TArray<UCustomCharacterPart*> OverrideParts; // 0x0(0x10)
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> TraceChannel; // 0x211(0x1)
		unsigned char UnknownData02_6[0x6]; // 0x212(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr<UObject*> InstigatingObject; // 0x4(0x8)
	};
	...
	{
	public:
		TArray<FSpecialEventRewindComponentFrame_PlayerPawn> Frames; // 0x108(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x10]; // 0x50(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UWorld*> LevelToLoad; // 0x60(0x20)
	...
	public:
		...
		unsigned char UnknownData00_7[0x17]; // 0x69(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UClass*> ReplicatedLevelSequenceActorClass; // 0x38(0x20)
		UClass* ReplicatedLevelSequenceActorClass_HardRef; // 0x58(0x8)
		TWeakObjectPtr<AReplicatedLevelSequenceActor*> LevelSequenceActor; // 0x60(0x8)
		unsigned char UnknownData02_6[0x1]; // 0x68(0x1) UNKNOWN PROPERTY
		...
		TArray<FPhaseLevelEntry> Levels; // 0x78(0x10)
		TArray<FPhaseDataLayerEntry> DataLayers; // 0x88(0x10)
	};
	...
	{
	public:
		TArray<FSpecialEventStatArrayEntry> Stats; // 0x108(0x10)
