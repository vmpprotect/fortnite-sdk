...
namespace SDK
{
	...
	{
	public:
		TArray RegisteredControllers; // 0x0(0x10)
	...
	{
	public:
		TScriptInterface Vehicle; // 0x0(0x10)
		TWeakObjectPtr Asset; // 0x10(0x20)
	};
	...
	{
	public:
		TEnumAsByte SurfaceType; // 0x8(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x9(0x7) UNKNOWN PROPERTY
		TArray SurfaceSounds; // 0x10(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr CollisionAudioComponent; // 0x8(0x8)
	...
	public:
		...
		unsigned char UnknownData08_6[0x7]; // 0xC9(0x7) UNKNOWN PROPERTY
		...
		TEnumAsByte CurrentSurface; // 0x130(0x1)
		unsigned char UnknownData10_6[0x7]; // 0x131(0x7) UNKNOWN PROPERTY
		TArray SurfaceParams; // 0x138(0x10)
		unsigned char UnknownData11_7[0x30]; // 0x148(0x30) UNKNOWN PROPERTY
	};
