...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_6[0x8]; // 0x4E0(0x8) UNKNOWN PROPERTY
		...
		void UpdateWorldLocalState(bool bWorldIn); // Flags: Final|Native|Public, Memory Exec: 0x7FF750AA5458(relative to base address)
		void UpdateHoverState(bool bHoveringIn); // Flags: Final|Native|Public, Memory Exec: 0x7FF750AA51FC(relative to base address)
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x88]; // 0x48(0x88) UNKNOWN PROPERTY
		TScriptInterface<Class> AxisSource; // 0xD0(0x10)
		TScriptInterface<Class> TransformSource; // 0xE0(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0xC8]; // 0x48(0xC8) UNKNOWN PROPERTY
		TScriptInterface<Class> AxisSource; // 0x110(0x10)
		TScriptInterface<Class> TransformSource; // 0x120(0x10)
	...
	{
	public:
		TScriptInterface<Class> AxisSource; // 0x48(0x10)
		TScriptInterface<Class> TransformSource; // 0x58(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0x48]; // 0x48(0x48) UNKNOWN PROPERTY
		TScriptInterface<Class> AxisSource; // 0x90(0x10)
		TScriptInterface<Class> TransformSource; // 0xA0(0x10)
		...
		unsigned char UnknownData02_6[0x8]; // 0x148(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0xA0]; // 0x80(0xA0) UNKNOWN PROPERTY
		bool bUpdateModifiersDuringDrag; // 0x120(0x1)
		unsigned char UnknownData01_7[0x1F]; // 0x121(0x1F) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x140]; // 0x140(0x140) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x40]; // 0x80(0x40) UNKNOWN PROPERTY
		bool HitTestOnRelease; // 0xC0(0x1)
		unsigned char UnknownData01_7[0x6F]; // 0xC1(0x6F) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0xD0]; // 0x130(0xD0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x148]; // 0x98(0x148) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0xB0]; // 0x80(0xB0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x58]; // 0x128(0x58) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0xE0]; // 0x30(0xE0) UNKNOWN PROPERTY
	...
	public:
		...
		TScriptInterface<Class> AxisSource; // 0x48(0x10)
		TScriptInterface<Class> AngleSource; // 0x58(0x10)
		TScriptInterface<Class> HitTarget; // 0x68(0x10)
		TScriptInterface<Class> StateTarget; // 0x78(0x10)
		UClickDragInputBehavior* MouseBehavior; // 0x88(0x8)
		unsigned char UnknownData01_6[0x80]; // 0x90(0x80) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x20]; // 0x1B0(0x20) UNKNOWN PROPERTY
	...
	public:
		unsigned char UnknownData00_3[0x10]; // 0x38(0x10) UNKNOWN PROPERTY
		TScriptInterface<Class> AxisSource; // 0x48(0x10)
		TScriptInterface<Class> ParameterSource; // 0x58(0x10)
		UGizmoViewContext* GizmoViewContext; // 0x68(0x8)
		TScriptInterface<Class> HitTarget; // 0x70(0x10)
		TScriptInterface<Class> StateTarget; // 0x80(0x10)
		UClickDragInputBehavior* MouseBehavior; // 0x90(0x8)
		bool bEnableSignedAxis; // 0x98(0x1)
		unsigned char UnknownData01_6[0x88]; // 0x99(0x88) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x2C]; // 0x194(0x2C) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x2]; // 0x96(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_7[0x20]; // 0xB8(0x20) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x7]; // 0x61(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x12B]; // 0x85(0x12B) UNKNOWN PROPERTY
		TArray<UPrimitiveComponent*> ActiveComponents; // 0x1B0(0x10)
		TArray<UInteractiveGizmo*> ActiveGizmos; // 0x1C0(0x10)
		...
		unsigned char UnknownData05_7[0x140]; // 0x260(0x140) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x51C(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x2]; // 0x54E(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x1]; // 0x51F(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x149(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x144(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x6]; // 0x15A(0x6) UNKNOWN PROPERTY
		TArray<UGizmoElementBase*> Elements; // 0x160(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x1AC(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x3]; // 0x1D5(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FVector> Vertices; // 0x108(0x10)
		FVector base; // 0x118(0x18)
		FVector UpDirection; // 0x130(0x18)
		FVector SideDirection; // 0x148(0x18)
		unsigned char UnknownData00_7[0x10]; // 0x160(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		void SetTransform(FTransform& NewTransform); // Flags: Native|Public|HasOutParms|HasDefaults, Memory Exec: 0x7FF750AA4E5C(relative to base address)
		FTransform GetTransform(); // Flags: Native|Public|HasDefaults|Const, Memory Exec: 0x7FF750AA4CD0(relative to base address)
	};
	...
	public:
		...
		bool HasTangentVectors(); // Flags: Native|Public|Const, Memory Exec: 0x7FF7484CB9B0(relative to base address)
		void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut); // Flags: Native|Public|HasOutParms|HasDefaults|Const, Memory Exec: 0x7FF750AA4B6C(relative to base address)
		FVector GetOrigin(); // Flags: Native|Public|HasDefaults|Const, Memory Exec: 0x7FF750AA4B04(relative to base address)
		FVector GetDirection(); // Flags: Native|Public|HasDefaults|Const, Memory Exec: 0x7FF750AA4ACC(relative to base address)
	};
	...
	public:
		...
		void UpdateInteractingState(bool bInteracting); // Flags: Native|Public, Memory Exec: 0x7FF750AA53D4(relative to base address)
		void UpdateHoverState(bool bHovering); // Flags: Native|Public, Memory Exec: 0x7FF74E27B760(relative to base address)
	};
	...
	public:
		...
		void UpdateInteractingState(bool bInteracting, uint32_t InPartIdentifier); // Flags: Native|Public, Memory Exec: 0x7FF750AA5284(relative to base address)
		void UpdateHoverState(bool bHovering, uint32_t InPartIdentifier); // Flags: Native|Public, Memory Exec: 0x7FF750AA50AC(relative to base address)
		void UpdateHittableState(bool bHittable, uint32_t InPartIdentifier); // Flags: Native|Public, Memory Exec: 0x7FF750AA4F5C(relative to base address)
	};
	...
	public:
		...
		void UpdateVisibilityState(bool bVisible, uint32_t InPartIdentifier); // Flags: Native|Public, Memory Exec: 0x7FF750AA50AC(relative to base address)
	};
	...
	public:
		...
		void EndUpdate(); // Flags: Native|Public, Memory Exec: 0x7FF749263428(relative to base address)
		void BeginUpdate(); // Flags: Native|Public, Memory Exec: 0x7FF748D7CC28(relative to base address)
	};
	...
	public:
		...
		void SetParameter(float NewValue); // Flags: Native|Public, Memory Exec: 0x7FF750AA4D50(relative to base address)
		float GetParameter(); // Flags: Native|Public|Const, Memory Exec: 0x7FF74E24082C(relative to base address)
		void EndModify(); // Flags: Native|Public, Memory Exec: 0x7FF74EEDF7EC(relative to base address)
		void BeginModify(); // Flags: Native|Public, Memory Exec: 0x7FF749263428(relative to base address)
	};
	...
	public:
		...
		void SetParameter(FVector2D& NewValue); // Flags: Native|Public|HasOutParms|HasDefaults, Memory Exec: 0x7FF750AA4DD4(relative to base address)
		FVector2D GetParameter(); // Flags: Native|Public|HasDefaults|Const, Memory Exec: 0x7FF750AA4B3C(relative to base address)
		void EndModify(); // Flags: Native|Public, Memory Exec: 0x7FF74EEDF7EC(relative to base address)
		void BeginModify(); // Flags: Native|Public, Memory Exec: 0x7FF749263428(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xB]; // 0x535(0xB) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x1B8]; // 0x28(0x1B8) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UPrimitiveComponent*> ActiveComponents; // 0xA0(0x10)
		TArray<UInteractiveGizmo*> ActiveGizmos; // 0xB0(0x10)
		unsigned char UnknownData01_6[0x18]; // 0xC0(0x18) UNKNOWN PROPERTY
		UGizmoComponentAxisSource* AxisYSource; // 0xD8(0x8)
		UGizmoComponentAxisSource* AxisZSource; // 0xE0(0x8)
		unsigned char UnknownData02_7[0x118]; // 0xE8(0x118) UNKNOWN PROPERTY
	...
	{
	public:
		TScriptInterface<Class> FloatParameterSource; // 0x48(0x10)
	...
	public:
		...
		unsigned char UnknownData01_6[0x8D]; // 0x93(0x8D) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x88]; // 0x1E8(0x88) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x90]; // 0x3A0(0x90) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x48]; // 0x38(0x48) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0xC]; // 0xF4(0xC) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x50]; // 0x80(0x50) UNKNOWN PROPERTY
	...
	public:
		...
		TScriptInterface<Class> TransactionManager; // 0x48(0x10)
	...
	public:
		unsigned char UnknownData00_3[0x20]; // 0x28(0x20) UNKNOWN PROPERTY
		TScriptInterface<Class> TransactionManager; // 0x48(0x10)
		unsigned char UnknownData01_7[0xE8]; // 0x58(0xE8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x1E]; // 0xD2(0x1E) UNKNOWN PROPERTY
	...
	{
	public:
		TScriptInterface<Class> ChildTransformSource; // 0x48(0x10)
		unsigned char UnknownData00_7[0x88]; // 0x58(0x88) UNKNOWN PROPERTY
	...
	{
	public:
		TScriptInterface<Class> ScaledTransformSource; // 0x48(0x10)
		TScriptInterface<Class> UnscaledTransformSource; // 0x58(0x10)
	...
	public:
		...
		TMap<FString, UInteractiveToolPropertySet*> CachedPropertiesMap; // 0x38(0x50)
		bool bIsPropertySetEnabled; // 0x88(0x1)
		unsigned char UnknownData01_7[0x1F]; // 0x89(0x1F) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x2]; // 0xBE(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UObject*> ToolPropertyObjects; // 0x68(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0x50]; // 0xA8(0x50) UNKNOWN PROPERTY
		TWeakObjectPtr<UWorld*> TargetWorld; // 0xF8(0x8)
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x109(0x3) UNKNOWN PROPERTY
		float WorldToLocalScale; // 0x10C(0x4)
		FBrushStampData LastBrushStamp; // 0x110(0x138)
		unsigned char UnknownData01_6[0x10]; // 0x248(0x10) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> PropertyClass; // 0x258(0x20)
		UBrushStampIndicator* BrushStampIndicator; // 0x278(0x8)
		unsigned char UnknownData02_7[0x10]; // 0x280(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x98(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<UObject*> ContextObjects; // 0x28(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0xE]; // 0x2A(0xE) UNKNOWN PROPERTY
		UInputBehaviorSet* ActiveInputBehaviors; // 0x38(0x8)
		unsigned char UnknownData01_7[0x150]; // 0x40(0x150) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x18]; // 0xA8(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x98]; // 0x68(0x98) UNKNOWN PROPERTY
		TMap<FString, UInteractiveToolBuilder*> ToolBuilders; // 0x100(0x50)
		unsigned char UnknownData02_7[0x60]; // 0x150(0x60) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x280]; // 0x80(0x280) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> ToolManagerClass; // 0x300(0x20)
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x98(0x8) UNKNOWN PROPERTY
		TArray<UToolTarget*> Targets; // 0xA0(0x10)
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		TArray<UToolTargetFactory*> Factories; // 0x30(0x10)
