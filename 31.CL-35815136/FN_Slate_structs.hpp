...
namespace SDK
{
	...
	{
	public:
		TArray<FCharRange> Ranges; // 0x0(0x10)
	};
	...
	public:
		...
		TMap<FName, FCustomizedToolMenuEntry> Entries; // 0x8(0x50)
		TMap<FName, FCustomizedToolMenuSection> Sections; // 0x58(0x50)
		TArray<FName> SuppressExtenders; // 0xA8(0x10)
		unsigned char UnknownData01_7[0xE8]; // 0xB8(0xE8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<FName, FCustomizedToolMenuNameArray> EntryOrder; // 0x1A0(0x50)
		TArray<FName> SectionOrder; // 0x1F0(0x10)
	};
