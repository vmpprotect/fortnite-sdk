...
namespace SDK
{
	...
	{
	public:
		TArray<UComputeDataProvider*> DataProviders; // 0x0(0x10)
	...
	{
	public:
		TArray<FComputeKernelPermutationBool> BooleanOptions; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FComputeKernelDefinition> Defines; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FString, uint32_t> Permutations; // 0x0(0x50)
	...
	{
	public:
		TArray<char> ArrayOfValues; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<char> ShaderValue; // 0x0(0x10)
		TArray<FArrayShaderValue> ArrayList; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x17]; // 0x9(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		FString Name; // 0x0(0x10)
		TArray<FShaderParamTypeDefinition> ParamTypes; // 0x10(0x10)
