...
namespace SDK
{
	...
	{
	public:
		TArray SpecializedConfigs; // 0x30(0x10)
	...
	{
	public:
		unsigned char UnknownData01_1[0xA0]; // 0x1F8(0xA0) UNKNOWN PROPERTY
		...
		void Client_SetCachedContextualMessageResult(FJunoContextualMessageQueryResult Result); // Flags: Final|Net|NetReliableNative|Event|Private|NetClient 0x7FF414E1CDC0
	};
	...
	public:
		...
		void Server_RequestNPCHardRemoval(FGameplayTag UniqueAIIdentifier); // Flags: RequiredAPI|Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 0x7FF414E1CF80
		void Server_RequestCreatureHardRemoval(FGameplayTag UniqueAIIdentifier); // Flags: RequiredAPI|Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 0x7FF414E1CEA0
	};
	...
	public:
		...
		bool ValidateUniqueResidentTag(FGameplayTag& OtherResidentIdentifier); // Flags: Final|Native|Private|HasOutParms|Const 0x7FF414E1D140
		bool ValidateRoleTag(FGameplayTag& OtherResidentIdentifier, UPlayspaceComponent_JunoAIPersistence RootAIPersistenceComp); // Flags: Final|Native|Private|HasOutParms|Const 0x7FF414E1D060
	};
	...
	public:
		...
		TArray Editor_GetValidObjectives(); // Flags: Final|Native|Private|Const 0x7FF414E1D220
	};
	...
	{
	public:
		TMap ConversationRequirementMappings; // 0x30(0x50)
	...
	public:
		...
		unsigned char UnknownData01_7[0x3]; // 0x195(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray InventoryGroupTypesToPickItemsFrom; // 0x188(0x10)
	...
	{
	public:
		TArray RewardsToGive; // 0x190(0x10)
	...
	public:
		...
		unsigned char UnknownData05_7[0x48]; // 0x1B0(0x48) UNKNOWN PROPERTY
		...
		void PlayClientVoiceLine(FConversationContext& Context, FJunoContextualMessageQueryResult& MessageParams); // Flags: Native|Event|Protected|HasOutParms|BlueprintEvent|Const 0x7FF414E1D300
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x1B4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr ParticipantIconSmall; // 0x688(0x20)
		unsigned char UnknownData01_7[0x60]; // 0x6A8(0x60) UNKNOWN PROPERTY
		...
		void OnRep_ParticipantIconSmall(); // Flags: Final|Native|Protected 0x7FF414E1D3E0
	};
	...
	{
	public:
		TWeakObjectPtr InventoryComponent; // 0x28(0x8)
		...
		void HandleInventoryChangedEvent(FJunoItemSlot& ItemSlot); // Flags: Final|Native|Public|HasOutParms 0x7FF414E1D4C0
	};
	...
	{
	public:
		TWeakObjectPtr QuestToProgress; // 0x170(0x20)
		FName ObjectiveBackendName; // 0x190(0x4)
		unsigned char UnknownData01_7[0x4]; // 0x194(0x4) UNKNOWN PROPERTY
		...
		TArray Editor_GetValidObjectives(); // Flags: Final|Native|Private|Const 0x7FF414E1D5A0
	};
	...
	{
	public:
		TWeakObjectPtr QuestToGrant; // 0x170(0x20)
	...
	{
	public:
		TWeakObjectPtr QuestToTurnIn; // 0x170(0x20)
	...
	public:
		...
		void RollGrantableQuestID(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414E1D920
		void HandleOnJunoQuestComplete(TScriptInterface& QuestInstance); // Flags: Final|Native|Private|HasOutParms 0x7FF414E1D840
		FString GetGrantableQuestID(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1D760
		void BindToQuestManagerDelegates(); // Flags: Final|Native|Private 0x7FF414E1D680
	};
	...
	public:
		...
		void ReceiveToken(FGameplayTag& JunoToken); // Flags: Native|Public|HasOutParms|BlueprintCallable 0x7FF414E1DAE0
		FGameplayTagContainer GetSavedTokens(); // Flags: Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1DA00
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0xA0]; // 0xF8(0xA0) UNKNOWN PROPERTY
		TArray QuestPoolAssets; // 0x198(0x10)
		...
		EJunoQuestState GetJunoQuestState(FString QuestID); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1DBC0
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x60]; // 0x450(0x60) UNKNOWN PROPERTY
		...
		void SendQuestStatEvent(EFortQuestObjectiveStatEvent Type, FGameplayTagContainer SourceTags, FGameplayTagContainer TargetTags, int32_t Count); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 0x7FF414E1DE60
		AActor GetQuestGiverForQuestID(FString QuestID); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1DD80
		void ActivateQuest(UFortQuestItemDefinition_Athena QuestDefinition, AActor QuestGiver); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 0x7FF414E1DCA0
	};
	...
	{
	public:
		TMap JunoTokenToJunoActions; // 0x28(0x50)
	...
	{
	public:
		TArray JunoActionsDBs; // 0xF8(0x10)
	...
	public:
		...
		TArray Editor_GetValidObjectiveNames(); // Flags: Final|Native|Private|Const 0x7FF414E1DF40
	};
	...
	public:
		...
		UJunoQuestManagerComponent GetJunoQuestManager(UObject WorldContextObject); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414E1E100
		UJunoQuestDatabaseComponent GetJunoQuestDatabase(UObject WorldContextObject); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure 0x7FF414E1E020
	};
	...
	public:
		...
		void JunoSpawnVisitorInClosestCamp(FString PartialUniqueAIIdentifier, int32_t Count); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 0x7FF414E1E720
		void JunoRepopulateAvailableQuestsWithTags(FString QuestPoolTags); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1E640
		void JunoRepopulateAvailableQuests(); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1E560
		void JunoQueueScriptRowMessagesForNpcConversation(FString ScriptName, FString RowName); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1E480
		void JunoPrintNPCsInfo(bool bIgnoreAIsWithNoAssignment); // Flags: Final|Exec|Native|Private|Const 0x7FF414E1E3A0
		void JunoPrintCurrentConversationInfo(); // Flags: Final|Exec|Native|Private|Const 0x7FF414E1E2C0
		void JunoInjectDisplayTextForNpcConversation(FString TestString); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private|Const 0x7FF414E1E1E0
	};
