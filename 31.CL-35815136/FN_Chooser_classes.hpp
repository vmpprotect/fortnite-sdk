...
namespace SDK
{
	...
	public:
		...
		TArray<FName> PropertyBindingChain; // 0x30(0x10)
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		TScriptInterface<Class> InputValue; // 0x30(0x10)
		TArray<bool> RowValues; // 0x40(0x10)
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		TScriptInterface<Class> InputValue; // 0x30(0x10)
		TArray<FChooserEnumRowData> RowValues; // 0x40(0x10)
	...
	public:
		unsigned char UnknownData00_3[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
		TScriptInterface<Class> InputValue; // 0x30(0x10)
		TArray<FChooserFloatRangeRowData> RowValues; // 0x40(0x10)
	...
	public:
		...
		TArray<FGameplayTagContainer> RowValues; // 0x48(0x10)
	...
	public:
		...
		TArray<FInstancedStruct> CookedResults; // 0x60(0x10)
		TArray<FInstancedStruct> ColumnsStructs; // 0x70(0x10)
		TArray<FInstancedStruct> ContextData; // 0x80(0x10)
	...
	public:
		...
		FInstancedStruct MakeEvaluateChooser(UChooserTable* Chooser); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF74DC28F1C(relative to base address)
		FChooserEvaluationContext MakeChooserEvaluationContext(); // Flags: Final|Native|Static|Public|BlueprintCallable, Memory Exec: 0x7FF74DC28EA0(relative to base address)
		void GetChooserStructOutput(FChooserEvaluationContext& Context, int32_t Index, int32_t& Value); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF74DC28B78(relative to base address)
		TArray EvaluateObjectChooserBaseMulti(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, UClass* ObjectClass, bool bResultIsClass); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF74DC28870(relative to base address)
		UObject EvaluateObjectChooserBase(FChooserEvaluationContext& Context, FInstancedStruct& ObjectChooser, UClass* ObjectClass, bool bResultIsClass); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF74DC28588(relative to base address)
		TArray EvaluateChooserMulti(UObject* ContextObject, UChooserTable* ChooserTable, UClass* ObjectClass); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF74DC28450(relative to base address)
		UObject EvaluateChooser(UObject* ContextObject, UChooserTable* ChooserTable, UClass* ObjectClass); // Flags: Final|Native|Static|Public|BlueprintCallable|BlueprintPure, Memory Exec: 0x7FF74DC28340(relative to base address)
		void AddChooserStructInput(FChooserEvaluationContext& Context, int32_t Value); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF74DC28100(relative to base address)
		void AddChooserObjectInput(FChooserEvaluationContext& Context, UObject* Object); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF74DC27F60(relative to base address)
	};
