...
namespace SDK
{
	...
	public:
		...
		TArray AudioComponents; // 0x8(0x10)
	};
	...
	{
	public:
		TSet LibrarySet; // 0x0(0x50)
		ESoundLibrarySelectionBehavior SelectionType; // 0x50(0x1)
		unsigned char UnknownData01_7[0x1F]; // 0x51(0x1F) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte LocationType; // 0x38(0x1)
	...
	public:
		...
		TSet SoundLibraries; // 0x20(0x50)
		TArray SoundLibraryContexts; // 0x70(0x10)
