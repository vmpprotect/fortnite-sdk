...
namespace SDK
{
	...
	public:
		...
		void PrepareForPooling(); // Flags: Native|Event|Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF748D7CC28(relative to base address)
		void PrepareForGame(); // Flags: Native|Event|Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF74D099118(relative to base address)
		bool CanBePooled(); // Flags: Native|Event|Public|BlueprintCallable|BlueprintEvent, Memory Exec: 0x7FF7484CBA18(relative to base address)
	};
	...
	{
	public:
		TArray<FInstancedStruct> SpawnRequests; // 0x38(0x10)
		TArray<AActor*> ActorsToDestroy; // 0x48(0x10)
		TArray<AActor*> DeactivatedActorsToDestroy; // 0x58(0x10)
		unsigned char UnknownData00_7[0x88]; // 0x68(0x88) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0xA0]; // 0xA0(0xA0) UNKNOWN PROPERTY
		FMassEntityConfig EntityConfig; // 0x140(0x30)
		unsigned char UnknownData01_6[0x2C]; // 0x170(0x2C) UNKNOWN PROPERTY
		...
		void OnRep_NetID(); // Flags: Native|Public, Memory Exec: 0x7FF74C8DF6C0(relative to base address)
		void KillEntity(bool bDestroyActor); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF750509E3C(relative to base address)
		void Enable(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF750509E18(relative to base address)
		void Disable(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF750509DF4(relative to base address)
	};
	...
	public:
		...
		TMap<FMassEntityTemplateID, FMassAgentInitializationQueue> PendingAgentEntities; // 0x58(0x50)
		TMap<FMassEntityTemplateID, FMassAgentInitializationQueue> PendingPuppets; // 0xA8(0x50)
		UMassReplicationSubsystem* ReplicationSubsystem; // 0xF8(0x8)
		TMap<FMassNetworkID, UMassAgentComponent*> ReplicatedAgentComponents; // 0x100(0x50)
		unsigned char UnknownData01_7[0x30]; // 0x150(0x30) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x320]; // 0xE0(0x320) UNKNOWN PROPERTY
