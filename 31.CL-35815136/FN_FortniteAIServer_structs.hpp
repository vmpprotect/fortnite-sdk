...
namespace SDK
{
	...
	public:
		...
		TArray<FTokenEQSParameter> QueryConfig; // 0x50(0x10)
	...
	public:
		...
		TArray<AActor*> ActorsToTeleportOnFailure; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<AActor*> ActorsToTeleportOnExit; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<AActor*> ActorsToCleanup; // 0x8(0x10)
	...
	{
	public:
		TArray<FFortAthenaPickAnimByWorldConditionsConfig> PossibleAnims; // 0x0(0x10)
	...
	{
	public:
		TArray<FFortAthenaPickRandomMontageConfig> PossibleMontages; // 0x0(0x10)
	...
	public:
		...
		TWeakObjectPtr<UFortWorldItem*> Item; // 0x10(0x8)
	};
	...
	public:
		...
		TArray<FDigestedWeaponFiringTime> FiringTimes; // 0x10(0x10)
	...
	public:
		...
		TScriptInterface<Class> TaskOwner; // 0x30(0x10)
	};
	...
	public:
		AAIController* AIController; // 0x0(0x8)
		TEnumAsByte<EPathFollowingStatus> MoveStatus; // 0x8(0x1)
		unsigned char UnknownData00_7[0x7]; // 0x9(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xF]; // 0x79(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		FWorldConditionContextDataRef ActorRef; // 0x10(0x8)
		TArray<FPrimaryAssetId> AllowedCharacters; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FString> TriggeredReactionRowNames; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UBehaviorTree*> TreeAsset; // 0x0(0x20)
		FGameplayTag InjectionTag; // 0x20(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x24(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> AIEvaluatorClass; // 0x28(0x20)
	};
	...
	{
	public:
		TWeakObjectPtr<UCurveFloat*> Curve; // 0x0(0x20)
		TArray<FFortPointOnCurveRange> RangesForPointsOnCurve; // 0x20(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UCurveFloat*> TestScoreCurve; // 0x40(0x20)
	...
	public:
		...
		AActor* TargetActor; // 0x8(0x8)
		FGameplayTagContainer AbilityTag; // 0x10(0x20)
		TArray<FDistanceToTargetComparison> DistanceComparisons; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<UClass*> GEsToApply; // 0x68(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<AFortPlayerPawn*> Target; // 0x0(0x8)
		unsigned char UnknownData00_7[0x10]; // 0x8(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x4E]; // 0x42(0x4E) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<TInteractionType> InteractType; // 0x0(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
