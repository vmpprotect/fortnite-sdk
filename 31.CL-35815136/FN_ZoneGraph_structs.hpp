...
namespace SDK
{
	...
	public:
		...
		TArray<FZoneGraphLaneHandle> Lanes; // 0x8(0x10)
	};
	...
	{
	public:
		TMap<UZoneShapeComponent*, FZoneShapeComponentBuildData> ZoneShapeComponentBuildData; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<FZoneGraphBuilderRegisteredComponent> ShapeComponents; // 0x0(0x10)
		TArray<int32_t> ShapeComponentsFreeList; // 0x10(0x10)
		TMap<UZoneShapeComponent*, int32_t> ShapeComponentToIndex; // 0x20(0x50)
		FZoneGraphBuildData BuildData; // 0x70(0x50)
		unsigned char UnknownData00_7[0xD8]; // 0xC0(0xD8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FZoneGraphBVNode> Nodes; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<FZoneLaneDesc> Lanes; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FZoneData> Zones; // 0x0(0x10)
		TArray<FZoneLaneData> Lanes; // 0x10(0x10)
		TArray<FVector> BoundaryPoints; // 0x20(0x10)
		TArray<FVector> LanePoints; // 0x30(0x10)
		TArray<FVector> LaneUpVectors; // 0x40(0x10)
		TArray<FVector> LaneTangentVectors; // 0x50(0x10)
		TArray<float> LanePointProgressions; // 0x60(0x10)
		TArray<FZoneLaneLinkData> LaneLinks; // 0x70(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x1]; // 0x6B(0x1) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr<UZoneShapeComponent*> ShapeComponent; // 0x0(0x8)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FZoneGraphTessellationSettings> SpecificTessellationTolerances; // 0x8(0x10)
		...
		TArray<FZoneGraphLaneRoutingRule> PolygonRoutingRules; // 0x28(0x10)
