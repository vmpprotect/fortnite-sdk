...
namespace SDK
{
	...
	public:
		...
		TArray<int32_t> BoneSettingToSolverBoneIndex; // 0x8(0x10)
		TArray<int32_t> SolverBoneToElementIndex; // 0x18(0x10)
	...
	public:
		...
		TArray<FPBIKEffector> Effectors; // 0x1C8(0x10)
		TArray<int32_t> EffectorSolverIndices; // 0x1D8(0x10)
		TArray<FPBIKBoneSetting> BoneSettings; // 0x1E8(0x10)
		TArray<FName> ExcludedBones; // 0x1F8(0x10)
