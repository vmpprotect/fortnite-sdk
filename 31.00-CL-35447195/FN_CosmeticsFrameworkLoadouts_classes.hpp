...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData03_3[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x6]; // 0xCA(0x6) UNKNOWN PROPERTY
