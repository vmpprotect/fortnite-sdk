...
namespace SDK
{
	...
	public:
		...
		TScriptInterface<Class> GridProvider; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x60]; // 0x68(0x60) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<AFortScriptedObjectMovement_Structure*> Structures; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0xA]; // 0xE6(0xA) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<USplineComponent*> GeneratedSplinesArray; // 0x0(0x10)
		TArray<FScriptedObjectMovement_StepMetaData> StepMetaData; // 0x10(0x10)
