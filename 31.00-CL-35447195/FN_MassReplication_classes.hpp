...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData01_1[0x960]; // 0xC0(0x960) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xFA8]; // 0xC8(0xFA8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData03_3[0x30]; // 0x38(0x30) UNKNOWN PROPERTY
		TArray BubbleInfoArray; // 0x68(0x10)
		unsigned char UnknownData04_6[0x30]; // 0x78(0x30) UNKNOWN PROPERTY
		UWorld World; // 0xA8(0x8)
		UMassLODSubsystem MassLODSubsystem; // 0xB0(0x8)
		unsigned char UnknownData05_7[0x130]; // 0xB8(0x130) UNKNOWN PROPERTY
