...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData03_7[0x54]; // 0x0(0x54) UNKNOWN PROPERTY
		int32_t ArrayReplicationKey; // 0x54(0x4)
		unsigned char UnknownData04_6[0xA8]; // 0x58(0xA8) UNKNOWN PROPERTY
		EFastArraySerializerDeltaFlags DeltaFlags; // 0x100(0x1)
		unsigned char UnknownData05_7[0x7]; // 0x101(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray AllTimePeriods; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x1]; // 0x31(0x1) UNKNOWN PROPERTY
		int16_t EscalateQuotaFaultsPerPeriod; // 0x32(0x2)
		int8_t EscalateQuotaFaultPercentPerPeriod; // 0x34(0x1)
		unsigned char UnknownData04_6[0x1]; // 0x35(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x6]; // 0x3A(0x6) UNKNOWN PROPERTY
	};
