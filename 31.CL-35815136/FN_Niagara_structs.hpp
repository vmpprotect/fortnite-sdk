...
namespace SDK
{
	...
	public:
		...
		TArray<FName> RebaseIncludeAttributes; // 0x8(0x10)
		TArray<FName> RebaseExcludeAttributes; // 0x18(0x10)
		TArray<FName> InterpolationIncludeAttributes; // 0x28(0x10)
		TArray<FName> InterpolationExcludeAttributes; // 0x38(0x10)
		TArray<FName> ExplicitCaptureAttributes; // 0x48(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EPixelFormat> Format; // 0xC(0x1)
		...
		unsigned char UnknownData01_7[0x30]; // 0x18(0x30) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x4]; // 0x4C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FNiagaraVariableBase> Variables; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FNiagaraVariable> Inputs; // 0x8(0x10)
		...
		unsigned char UnknownData01_5[0x2]; // 0x2E(0x2) UNKNOWN PROPERTY
		...
		TMap<FName, FName> FunctionSpecifiers; // 0x40(0x50)
	};
	...
	public:
		...
		TArray<FName> RegisteredParameterMapWrites; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<bool> InputParamLocations; // 0x8(0x10)
		int32_t NumOutputs; // 0x18(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x1C(0x4) UNKNOWN PROPERTY
		TArray<FVMFunctionSpecifier> FunctionSpecifiers; // 0x20(0x10)
		TArray<FNiagaraVariableBase> VariadicInputs; // 0x30(0x10)
		TArray<FNiagaraVariableBase> VariadicOutputs; // 0x40(0x10)
	};
	...
	{
	public:
		TArray<UNiagaraComponent*> ComponentsToReset; // 0x0(0x10)
		TArray<UNiagaraComponent*> ComponentsToReInit; // 0x10(0x10)
		TArray<UNiagaraComponent*> ComponentsToNotifySimDestroy; // 0x20(0x10)
		TArray<UNiagaraComponent*> ComponentsToDestroyInstance; // 0x30(0x10)
		TArray<UNiagaraSystem*> SystemSimsToDestroy; // 0x40(0x10)
		TArray<UNiagaraSystem*> SystemSimsToRecache; // 0x50(0x10)
	...
	public:
		...
		TEnumAsByte<ENiagaraBindingSource> BindingSourceMode; // 0x24(0x1)
	...
	public:
		...
		TArray<FGuid> StackGuids; // 0x30(0x10)
	...
	{
	public:
		unsigned char UnknownData00_7[0xB0]; // 0x0(0xB0) UNKNOWN PROPERTY
		TArray<FNiagaraVariable> RapidIterationParameters; // 0xB0(0x10)
		TMap<FName, UNiagaraDataInterface*> NamedDataInterfaces; // 0xC0(0x50)
	};
	...
	{
	public:
		TArray<UObject*> RootObjects; // 0x0(0x10)
		unsigned char UnknownData00_6[0x58]; // 0x10(0x58) UNKNOWN PROPERTY
		TArray<FNiagaraVariable> ExposedVariables; // 0x68(0x10)
	...
	{
	public:
		TMap<FNiagaraVariableBase, int32_t> VariableIndices; // 0x0(0x50)
		TArray<FNiagaraLwcStructConverter> LwcConverters; // 0x50(0x10)
	};
	...
	public:
		...
		TArray<FNiagaraStructConversionStep> ConversionSteps; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<UNiagaraComponent*> NiagaraSystems; // 0x40(0x10)
		unsigned char UnknownData00_7[0x20]; // 0x50(0x20) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FNiagaraVariableBase> Inputs; // 0x8(0x10)
		TArray<FNiagaraVariableBase> Outputs; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<FNiagaraVariableBase> SortedParameters; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FNDIDataChannelFunctionInfo> FunctionInfo; // 0x0(0x10)
		TMap<FNiagaraCompileHash, FNDIDataChannel_GPUScriptParameterAccessInfo> GPUScriptParameterInfos; // 0x10(0x50)
		uint32_t TotalParams; // 0x60(0x4)
		bool bUsedByCPU; // 0x64(0x1)
		bool bUsedByGPU; // 0x65(0x1)
		bool bNeedsSpawnDataTable; // 0x66(0x1)
		unsigned char UnknownData00_7[0x1]; // 0x67(0x1) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FNiagaraVariableBase> Variables; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x6(0x2) UNKNOWN PROPERTY
		TArray<uint32_t> ComponentsOffsets; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FNDIDataChannelWriteSimCacheFrameBuffer> VariableData; // 0x8(0x10)
	...
	{
	public:
		TArray<char> DefaultValue; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x8(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FText> Categories; // 0x18(0x10)
	...
	{
	public:
		TArray<FVector2f> Values; // 0x18(0x10)
		FVector2f ValuesTimeRange; // 0x28(0x8)
	};
	...
	{
	public:
		TArray<FVector3f> Values; // 0x18(0x10)
		FVector2f ValuesTimeRange; // 0x28(0x8)
	};
	...
	{
	public:
		TArray<FLinearColor> Values; // 0x18(0x10)
		FVector2f ValuesTimeRange; // 0x28(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FString> TargetValues; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x4]; // 0x24(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FWidgetNamedInputValue> InputDropdownValues; // 0x18(0x10)
		TArray<FNiagaraWidgetNamedIntegerInputValue> EnumStyleDropdownValues; // 0x28(0x10)
		int32_t MaxSegmentsPerRow; // 0x38(0x4)
		unsigned char UnknownData03_6[0x4]; // 0x3C(0x4) UNKNOWN PROPERTY
		TArray<FWidgetSegmentValueOverride> SegmentValueOverrides; // 0x40(0x10)
		bool bBroadcastValueChangesOnCommitOnly; // 0x50(0x1)
		unsigned char UnknownData04_7[0x7]; // 0x51(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x1]; // 0x23(0x1) UNKNOWN PROPERTY
		...
		TArray<FNiagaraEnumParameterMetaData> InlineParameterEnumOverrides; // 0x40(0x10)
		...
		unsigned char UnknownData06_6[0x3]; // 0x181(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<int32_t> AllowedMaterialSlots; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_5[0x3]; // 0x21(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FNCPoolElement> FreeElements; // 0x0(0x10)
	};
	...
	public:
		...
		TMap<FString, FString> PropertySetterParameterDefaults; // 0x48(0x50)
	};
	...
	{
	public:
		TArray<FVector> Positions; // 0x0(0x10)
		TArray<FVector> Scales; // 0x10(0x10)
		TArray<FQuat> Rotations; // 0x20(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x1C(0x4) UNKNOWN PROPERTY
		TArray<FNiagaraOutlinerEmitterInstanceData> Emitters; // 0x20(0x10)
		...
		TEnumAsByte<ETickingGroup> TickGroup; // 0x5C(0x1)
		TEnumAsByte<ENiagaraGpuComputeTickStage> GpuTickStage; // 0x5D(0x1)
		...
		unsigned char UnknownData04_7[0x7]; // 0x61(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FNiagaraOutlinerSystemInstanceData> SystemInstances; // 0x0(0x10)
	...
	{
	public:
		TMap<FString, FNiagaraOutlinerSystemData> Systems; // 0x0(0x50)
	...
	{
	public:
		TMap<FString, FNiagaraOutlinerWorldData> WorldData; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x1]; // 0x73(0x1) UNKNOWN PROPERTY
		...
		TArray<FNiagaraDebugHUDVariable> SystemVariables; // 0x88(0x10)
		bool bSystemShowActiveOnlyInWorld; // 0x98(0x1)
		bool bShowParticleVariables; // 0x99(0x1)
		unsigned char UnknownData07_6[0x6]; // 0x9A(0x6) UNKNOWN PROPERTY
		TArray<FNiagaraDebugHUDVariable> ParticlesVariables; // 0xA0(0x10)
		...
		unsigned char UnknownData09_6[0x3]; // 0xBD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_6[0x3]; // 0xF1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_6[0x4]; // 0x1FC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_6[0x2]; // 0x232(0x2) UNKNOWN PROPERTY
		float PlaybackRate; // 0x234(0x4)
		bool bLoopTimeEnabled; // 0x238(0x1)
		unsigned char UnknownData15_6[0x3]; // 0x239(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FString> Systems; // 0x0(0x10)
		TArray<FString> Actors; // 0x10(0x10)
		TArray<FString> Components; // 0x20(0x10)
		TArray<FString> Emitters; // 0x30(0x10)
	};
	...
	public:
		FName ComponentName; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<char> SimCacheData; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FNiagaraDeviceProfileStateEntry> DeviceProfileStates; // 0x0(0x10)
		TArray<FNiagaraPlatformSetCVarCondition> CVarConditions; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x17]; // 0x19(0x17) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FNiagaraSystemScalabilitySettings> Settings; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FNiagaraEmitterScalabilitySettings> Settings; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FNiagaraEmitterScalabilityOverride> Overrides; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FNiagaraEventReceiverProperties> EventReceivers; // 0x8(0x10)
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x3E(0x2) UNKNOWN PROPERTY
		FBox FixedBounds; // 0x40(0x38)
		bool bRequiresPersistentIDs : 1; // 0x78:0(0x1)
		unsigned char UnknownData04_5[0x7]; // 0x79(0x7) UNKNOWN PROPERTY
		TArray<FNiagaraEventScriptProperties> EventHandlerScriptProps; // 0x80(0x10)
		...
		unsigned char UnknownData05_6[0x3]; // 0xD5(0x3) UNKNOWN PROPERTY
		int32_t PreAllocationCount; // 0xD8(0x4)
		unsigned char UnknownData06_6[0x4]; // 0xDC(0x4) UNKNOWN PROPERTY
		TArray<FNiagaraDataInterfaceEmitterBinding> EmitterDependencies; // 0xE0(0x10)
		...
		TArray<FNiagaraExternalUObjectInfo> RendererBindingsExternalObjects; // 0x1C8(0x10)
		TMap<FNiagaraVariableBase, FNiagaraVariableBase> ResolvedDIBindings; // 0x1D8(0x50)
		TArray<UNiagaraRendererProperties*> RendererProperties; // 0x228(0x10)
		TArray<UNiagaraSimulationStageBase*> SimulationStages; // 0x238(0x10)
		TArray<FNiagaraSimStageExecutionLoopData> SimStageExecutionLoops; // 0x248(0x10)
		unsigned char UnknownData07_6[0x10]; // 0x258(0x10) UNKNOWN PROPERTY
		UNiagaraScript* GPUComputeScript; // 0x268(0x8)
		TArray<FName> SharedEventGeneratorIds; // 0x270(0x10)
		FNiagaraEmitterScalabilitySettings CurrentScalabilitySettings; // 0x280(0x38)
		unsigned char UnknownData08_7[0xB0]; // 0x2B8(0xB0) UNKNOWN PROPERTY
	};
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TWeakObjectPtr<UObject*> Owner; // 0x8(0x8)
		...
		TArray<FNiagaraPositionSource> OriginalPositionData; // 0x50(0x10)
	...
	{
	public:
		TArray<FNiagaraVariable> Parameters; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FNiagaraPlatformSetConflictEntry> Conflicts; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FName> ProfileNames; // 0x0(0x10)
	...
	{
	public:
		TArray<FNiagaraMaterialAttributeBinding> AttributeBindings; // 0x0(0x10)
		TArray<FNiagaraRendererMaterialScalarParameter> ScalarParameters; // 0x10(0x10)
		TArray<FNiagaraRendererMaterialVectorParameter> VectorParameters; // 0x20(0x10)
		TArray<FNiagaraRendererMaterialTextureParameter> TextureParameters; // 0x30(0x10)
		TArray<FNiagaraRendererMaterialStaticBoolParameter> StaticBoolParameters; // 0x40(0x10)
	};
	...
	public:
		...
		TArray<UNiagaraComponent*> ManagedComponents; // 0x8(0x10)
		unsigned char UnknownData00_7[0xC8]; // 0x18(0xC8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x28]; // 0x30(0x28) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_5[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x38]; // 0x30(0x38) UNKNOWN PROPERTY
		int32_t NumTempRegisters; // 0x68(0x4)
		int32_t NumUserPtrs; // 0x6C(0x4)
		TArray<FNiagaraCompilerTag> CompileTags; // 0x70(0x10)
		TArray<char> ScriptLiterals; // 0x80(0x10)
		TArray<FNiagaraVariableBase> Attributes; // 0x90(0x10)
		FNiagaraScriptDataUsageInfo DataUsage; // 0xA0(0x1)
		unsigned char UnknownData01_6[0x7]; // 0xA1(0x7) UNKNOWN PROPERTY
		TArray<FNiagaraScriptUObjectCompileInfo> UObjectInfos; // 0xA8(0x10)
		TArray<FNiagaraScriptDataInterfaceCompileInfo> DataInterfaceInfo; // 0xB8(0x10)
		TArray<FVMExternalFunctionBindingInfo> CalledVMExternalFunctions; // 0xC8(0x10)
		unsigned char UnknownData02_6[0x10]; // 0xD8(0x10) UNKNOWN PROPERTY
		TArray<FNiagaraDataSetID> ReadDataSets; // 0xE8(0x10)
		TArray<FNiagaraDataSetProperties> WriteDataSets; // 0xF8(0x10)
		TArray<FNiagaraStatScope> StatScopes; // 0x108(0x10)
		...
		unsigned char UnknownData03_6[0x7]; // 0x171(0x7) UNKNOWN PROPERTY
		TArray<FSimulationStageMetaData> SimulationStageMetaData; // 0x178(0x10)
		TArray<char> ExperimentalContextData; // 0x188(0x10)
		bool bReadsSignificanceIndex : 1; // 0x198:0(0x1)
		bool bNeedsGPUContextInit : 1; // 0x198:1(0x1)
		unsigned char UnknownData04_7[0x7]; // 0x199(0x7) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0x88(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x8C]; // 0xC(0x8C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FNiagaraSimCacheEmitterFrame> EmitterData; // 0x148(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TArray<FNiagaraSimCacheVariable> Variables; // 0x8(0x10)
		...
		TArray<FName> RebaseVariableNames; // 0x28(0x10)
		TArray<FName> InterpVariableNames; // 0x38(0x10)
		uint16_t ComponentVelocity; // 0x48(0x2)
		unsigned char UnknownData02_7[0x66]; // 0x4A(0x66) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FNiagaraSimCacheDataBuffersLayout> EmitterLayouts; // 0xB0(0x10)
	};
	...
	{
	public:
		TArray<FName> SpawnAttributes; // 0x0(0x10)
	...
	{
	public:
		TArray<FNiagaraParameterDataSetBinding> FloatOffsets; // 0x0(0x10)
	...
	public:
		...
		TArray<FNiagaraParameterDataSetBindingCollection> SpawnInstanceEmitterBindings; // 0x1A8(0x10)
		...
		TArray<FNiagaraParameterDataSetBindingCollection> UpdateInstanceEmitterBindings; // 0x218(0x10)
	};
	...
	{
	public:
		TArray<FNiagaraSystemScalabilityOverride> Overrides; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FNiagaraVariable, FNiagaraVariable> UserParameterRedirects; // 0x88(0x50)
	};
