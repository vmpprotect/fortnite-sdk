...
namespace SDK
{
	...
	{
	public:
		TEnumAsByte<ERoundingMode> RoundingMode; // 0x0(0x1)
	...
	public:
		...
		TWeakObjectPtr<UObject*> ResourceObject; // 0x18(0x20)
	...
	public:
		...
		TMap<FName, FCommonInputTypeInfo> GamepadInputOverrides; // 0x1F0(0x50)
	...
	public:
		...
		TArray<FUIActionKeyMapping> KeyMappings; // 0x18(0x10)
	};
