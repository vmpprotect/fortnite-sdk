...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_7[0x8]; // 0x150(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<float> GearRatios; // 0xC0(0x10)
	...
	{
	public:
		TArray<FMotorSimGearCurve> Gears; // 0xB0(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0xC]; // 0x14C(0xC) UNKNOWN PROPERTY
