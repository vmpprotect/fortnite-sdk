...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData05_6[0x6]; // 0x6A(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0xC]; // 0x74(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0x198]; // 0x0(0x198) UNKNOWN PROPERTY
	};
