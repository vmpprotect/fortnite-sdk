...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_3[0x8]; // 0x308(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x10]; // 0x348(0x10) UNKNOWN PROPERTY
		...
		void TestCreativeDataChannelTarget(FCreativeDataChannelEvents TestEvents); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF751613B00(relative to base address)
		void OnRep_Events(); // Flags: Final|Native|Public, Memory Exec: 0x7FF74921B8F8(relative to base address)
		void FireEvent(FName EventName); // Flags: Event|Public|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
	...
	public:
		...
		TArray<float> StormCircleLocation; // 0x358(0x10)
	...
	public:
		...
		void ReportServerStateStreamError(FString Error, FString UID, FString URL); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF75161397C(relative to base address)
		void OnRep_VersionByte(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613944(relative to base address)
		void OnRep_TeamNames(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516138DC(relative to base address)
		void OnRep_SeriesState(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516138A4(relative to base address)
		void OnRep_ScoreTotal(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613840(relative to base address)
		void OnRep_ScoreTeam(); // Flags: Final|Native|Public, Memory Exec: 0x7FF75161382C(relative to base address)
		void OnRep_ScoreboardTimeLeft(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613868(relative to base address)
		void OnRep_ScoreboardBestOf(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613854(relative to base address)
		void OnRep_PlayerNames(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613818(relative to base address)
		void OnRep_PlayerCoords(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613804(relative to base address)
		void OnRep_PlayerBoostCollected(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516137F0(relative to base address)
		void OnRep_PlayerBoost(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516137DC(relative to base address)
		void OnRep_Overtime(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516137A4(relative to base address)
		void OnRep_MediaStop(); // Flags: Final|Native|Public, Memory Exec: 0x7FF75161376C(relative to base address)
		void OnRep_MediaStart(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613758(relative to base address)
		void OnRep_MatchState(); // Flags: Final|Native|Public, Memory Exec: 0x7FF751613720(relative to base address)
		void OnRep_FinaleState(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516136E8(relative to base address)
		void OnRep_BallCoords(); // Flags: Final|Native|Public, Memory Exec: 0x7FF7516136D4(relative to base address)
	};
