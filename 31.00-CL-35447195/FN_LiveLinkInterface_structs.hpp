...
namespace SDK
{
	...
	public:
		...
		TArray PropertyValues; // 0x70(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0xB]; // 0x115(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x124(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap CurveConversionAssetMap; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData13_7[0x7]; // 0x59(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray CurveElements; // 0x10(0x10)
