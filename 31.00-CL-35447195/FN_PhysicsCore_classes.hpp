...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte PhysicsType; // 0x2C(0x1)
		TEnumAsByte CollisionTraceFlag; // 0x2D(0x1)
		TEnumAsByte CollisionReponse; // 0x2E(0x1)
	...
	public:
		float Friction; // 0x28(0x4)
		float StaticFriction; // 0x2C(0x4)
		TEnumAsByte FrictionCombineMode; // 0x30(0x1)
		...
		TEnumAsByte RestitutionCombineMode; // 0x38(0x1)
		...
		unsigned char UnknownData08_6[0x4]; // 0x54(0x4) UNKNOWN PROPERTY
		UPhysicalMaterialPropertyBase PhysicalMaterialProperty; // 0x58(0x8)
		TEnumAsByte SurfaceType; // 0x60(0x1)
		unsigned char UnknownData09_6[0x3]; // 0x61(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x2]; // 0x76(0x2) UNKNOWN PROPERTY
		float SoftCollisionThickness; // 0x78(0x4)
		float BaseFrictionImpulse; // 0x7C(0x4)
		unsigned char UnknownData11_7[0x18]; // 0x80(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x1]; // 0x4F(0x1) UNKNOWN PROPERTY
		float BounceThresholdVelocity; // 0x50(0x4)
		TEnumAsByte FrictionCombineMode; // 0x54(0x1)
		TEnumAsByte RestitutionCombineMode; // 0x55(0x1)
		unsigned char UnknownData05_6[0x2]; // 0x56(0x2) UNKNOWN PROPERTY
		...
		TEnumAsByte DefaultShapeComplexity; // 0x6D(0x1)
		unsigned char UnknownData06_6[0x2]; // 0x6E(0x2) UNKNOWN PROPERTY
		FChaosSolverConfiguration SolverOptions; // 0x70(0x6C)
		unsigned char UnknownData07_7[0x4]; // 0xDC(0x4) UNKNOWN PROPERTY
