...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData03_3[0x10]; // 0xB40(0x10) UNKNOWN PROPERTY
		FFortScoutDroneDiveTransitionData EaseInData; // 0xB50(0x30)
		FFortScoutDroneDiveTransitionData EaseOutData; // 0xB80(0x30)
		unsigned char UnknownData04_6[0x8]; // 0xBB0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x10]; // 0xCD0(0x10) UNKNOWN PROPERTY
		...
		void BP_OnDroneStoppedDiving(); // Flags: BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 0x7FF414D5D1F8
		void BP_OnDroneStartedDiving(); // Flags: BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 0x7FF414D5D118
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0xB81(0x7) UNKNOWN PROPERTY
		...
		void StopTargeting(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5D498
		void StartTargeting(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5D3B8
		void BP_OnTargetsFound(FTargetingRequestHandle& TargetingHandle); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414D5D2D8
	};
	...
	public:
		...
		TArray DoorBashCollisionTypesForPawn; // 0xC18(0x10)
		...
		void OnDoorBashed(FHitResult& HitResult, UFortBuildingWallDoorComponent BashedDoor); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414D5D658
		void OnBoostedIntoActor(FHitResult& HitResult); // Flags: Event|Protected|HasOutParms|BlueprintEvent 0x7FF414D5D578
	};
	...
	public:
		...
		TArray DBNOCarriedPlayers; // 0xE8(0x10)
	...
	public:
		...
		unsigned char UnknownData09_6[0x7]; // 0x4F1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x6]; // 0x54A(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_6[0x3]; // 0x5D5(0x3) UNKNOWN PROPERTY
		double AccelerationZ; // 0x5D8(0x8)
		bool IsLeftStrafe; // 0x5E0(0x1)
		bool WasStrafing; // 0x5E1(0x1)
		unsigned char UnknownData12_6[0x6]; // 0x5E2(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_6[0x5]; // 0x5F3(0x5) UNKNOWN PROPERTY
		double FlapTime; // 0x5F8(0x8)
		int32_t FlapRandomPick; // 0x600(0x4)
		bool IsFlapSmall; // 0x604(0x1)
		unsigned char UnknownData14_6[0x3]; // 0x605(0x3) UNKNOWN PROPERTY
		int32_t FlapRandomMaxRange; // 0x608(0x4)
		unsigned char UnknownData15_6[0x4]; // 0x60C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData16_6[0x7]; // 0x631(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData17_7[0x7]; // 0x699(0x7) UNKNOWN PROPERTY
	...
	// Size: 0x40 (0x1620 - 0x15E0)
	class AFortScoutDroneGlove : public AFortWeapon	
	{
	public:
		FScalableFloat HoldToDeployTime; // 0x15E0(0x28)
		unsigned char UnknownData01_7[0x18]; // 0x1608(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		AFortScoutDrone GetControlledDrone(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5D738
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x10]; // 0xC80(0x10) UNKNOWN PROPERTY
		...
		void OnStoppedHighlightingTarget(AActor Target); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5D8F8
		void OnStartHighlightingTarget(AActor Target); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5D818
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x10]; // 0xD70(0x10) UNKNOWN PROPERTY
		...
		void OnRep_CurrentTargetStatus(); // Flags: Final|Native|Protected 0x7FF414D5DB98
		void OnActorIndicatorExpired(AActor IndicatedActor); // Flags: Final|Native|Private 0x7FF414D5DAB8
		void BP_OnTargetStatusChanged(AActor ActiveTarget); // Flags: BlueprintAuthorityOnly|Event|Protected|BlueprintEvent 0x7FF414D5D9D8
	};
	...
	{
	public:
		unsigned char UnknownData02_3[0x8]; // 0xB88(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x10]; // 0xBE8(0x10) UNKNOWN PROPERTY
		...
		void ServerConfirmTargets(); // Flags: Final|Net|NetReliableNative|Event|Private|NetServer 0x7FF414D5DC78
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x6]; // 0xB92(0x6) UNKNOWN PROPERTY
		...
		void StopCheckingDistances(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5DFF8
		void StartCheckingDistances(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5DF18
		void Client_SetIsInWarningRange(bool bValue); // Flags: Final|Net|NetReliableNative|Event|Private|NetClient 0x7FF414D5DE38
		void Client_SetIsInSignalLossRange(bool bValue); // Flags: Final|Net|NetReliableNative|Event|Private|NetClient 0x7FF414D5DD58
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x7]; // 0x379(0x7) UNKNOWN PROPERTY
		...
		void OnViewTargetChanged(AFortPlayerController PlayerController, AActor OldViewTarget, AActor NewViewTarget); // Flags: Final|Native|Private 0x7FF414D5E0D8
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x20]; // 0xE8(0x20) UNKNOWN PROPERTY
		...
		void OnRep_Energy(FFortGameplayAttributeData& OldValue); // Flags: Final|Native|Protected|HasOutParms 0x7FF414D5E1B8
	};
	...
	{
	public:
		unsigned char UnknownData06_3[0x58]; // 0x618(0x58) UNKNOWN PROPERTY
		bool bIsDiving; // 0x670(0x1)
		unsigned char UnknownData07_6[0x7]; // 0x671(0x7) UNKNOWN PROPERTY
		FScalableFloat DivingEnabled; // 0x678(0x28)
		bool bIsSpeedBoosting; // 0x6A0(0x1)
		unsigned char UnknownData08_6[0x7]; // 0x6A1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x8]; // 0x718(0x8) UNKNOWN PROPERTY
		...
		TEnumAsByte PrimarySurfaceType; // 0x75C(0x1)
		TEnumAsByte WeaponResponseType; // 0x75D(0x1)
		bool bPlayedDeath; // 0x75E(0x1)
		unsigned char UnknownData10_6[0x1]; // 0x75F(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_7[0x10]; // 0x7C0(0x10) UNKNOWN PROPERTY
		...
		void SetupGameplayAudioParameters(); // Flags: Final|BlueprintCosmetic|Native|Protected|BlueprintCallable 0x7FF414D5EB58
		void SetTeamMatesIndicator(bool bState); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5EA78
		void SetAffiliationAudio(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414D5E998
		void OnRep_ControllingPlayerPawn(); // Flags: Final|Native|Private 0x7FF414D5E8B8
		void OnDeathPlayEffects(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, AFortPawn InstigatedBy, AActor DamageCauser, FGameplayEffectContextHandle EffectContext); // Flags: BlueprintCosmetic|Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 0x7FF414D5E7D8
		void OnDamagePlayEffects(float Damage, FGameplayTagContainer& DamageTags, FVector Momentum, FHitResult& HitInfo, AFortPawn InstigatedBy, AActor DamageCauser, FGameplayEffectContextHandle EffectContext); // Flags: BlueprintCosmetic|Event|Protected|HasOutParms|HasDefaults|BlueprintEvent 0x7FF414D5E6F8
		float GetHealthPercentage(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414D5E618
		void GetForwardAndRightDotProducts_Native(float& OutForwardDot, float& OutRightDot); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure 0x7FF414D5E538
		FRotator GetDeltaRotator(); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 0x7FF414D5E458
		AFortPawn GetControllingPlayerPawn(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414D5E378
		void GameplayCue_Damage(TEnumAsByte EventType, FGameplayCueParameters Parameters); // Flags: Native|Protected 0x7FF414D5E298
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x1F2(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		TArray InputTriggerableEvents; // 0xF8(0x10)
		...
		void ServerRequestDroneDismissal(); // Flags: Final|Net|NetReliableNative|Event|Private|NetServer 0x7FF414D5F6B8
		void OnWeaponEquipped(AFortWeapon NewWeapon, AFortWeapon PrevWeapon); // Flags: Final|Native|Private 0x7FF414D5F5D8
		void OnRep_CurrentDestructionData(); // Flags: Final|Native|Private 0x7FF414D5F4F8
		void OnRep_ControlledDrone(); // Flags: Final|Native|Private 0x7FF414D5F418
		void OnPlayerInterruptionTagsChanged(FGameplayTag tag, int32_t NewCount); // Flags: Final|Native|Private 0x7FF414D5F338
		void OnOwningPlayerStartedDBNO(); // Flags: Final|Native|Private 0x7FF414D5F258
		void OnControlledDroneDestroyed(AActor InControlledDrone); // Flags: Final|Native|Private 0x7FF414D5F178
		AFortScoutDrone GetControlledDrone(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414D5F098
		void BP_OnPlayerShortInteract(); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5EFB8
		void BP_OnPlayerInteractLongUseChanged(bool bInteracting, bool bLongUseInteractionCompleted); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5EED8
		void BP_OnDroneDestroyed(FGameplayTag& DismissalReason); // Flags: BlueprintCosmetic|Event|Protected|HasOutParms|BlueprintEvent 0x7FF414D5EDF8
		void BP_OnDismissalStarted(bool bInstantDismissal, FGameplayTag DismissalReason); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5ED18
		void BP_OnDestructionStarted(bool bInstantDestruction, FGameplayTag DismissalReason); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5EC38
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x8]; // 0x1038(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr ControlledDrone; // 0xA8(0x8)
	...
	public:
		...
		unsigned char UnknownData05_7[0x8]; // 0x1D0(0x8) UNKNOWN PROPERTY
		...
		void ServerUpdateItemAttachment(FVector CalculatedItemOffset); // Flags: Final|Net|NetReliableNative|Event|Private|NetServer|HasDefaults 0x7FF414D5FE98
		void ServerDropAttachedActors(); // Flags: Net|NetReliableNative|Event|Public|NetServer 0x7FF414D5FDB8
		void OnRep_AttachedTargets(); // Flags: Final|Native|Private 0x7FF414D5FCD8
		void OnPawnDBNOStateChanged(AFortPawn Pawn, bool bIsDBNO); // Flags: Final|Native|Private 0x7FF414D5FBF8
		void OnAttachedPawnDied(AActor DamagedActor, float Damage, AController InstigatedBy, AActor DamageCauser, FVector HitLocation, UPrimitiveComponent FHitComponent, FName BoneName, FVector Momentum); // Flags: Final|Native|Private|HasDefaults 0x7FF414D5FB18
		bool HasAPawnAtached(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414D5FA38
		bool HasAnyAttachedActors(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414D5F958
		void BP_OnActorsDetached(); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5F878
		void BP_OnActorsAttached(); // Flags: BlueprintCosmetic|Event|Protected|BlueprintEvent 0x7FF414D5F798
	};
