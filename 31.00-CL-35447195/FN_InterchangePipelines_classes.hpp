...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_6[0x1]; // 0x12F(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr Skeleton; // 0x12C(0x8)
		...
		unsigned char UnknownData03_7[0x1]; // 0x137(0x1) UNKNOWN PROPERTY
	...
	{
	public:
		TMap MaterialParents; // 0x30(0x50)
	...
	{
	public:
		TMap PredefinedSurfaceShaders; // 0x30(0x50)
		TMap PredefinedBSDF; // 0x80(0x50)
		TMap PredefinedEDF; // 0xD0(0x50)
		TMap PredefinedVDF; // 0x120(0x50)
	...
	{
	public:
		unsigned char UnknownData01_1[0x8]; // 0x128(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr CommonSkeletalMeshesAndAnimationsProperties; // 0x128(0x8)
		TWeakObjectPtr CommonMeshesProperties; // 0x130(0x8)
		...
		TArray MaterialCurveSuffixes; // 0x150(0x10)
		...
		unsigned char UnknownData06_6[0x3]; // 0x165(0x3) UNKNOWN PROPERTY
		FString SourceAnimationName; // 0x168(0x10)
		bool bSceneImport; // 0x178(0x1)
		unsigned char UnknownData07_7[0x1F]; // 0x179(0x1F) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x6]; // 0x13A(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0xDF]; // 0x1C9(0xDF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x5]; // 0x153(0x5) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x50]; // 0x180(0x50) UNKNOWN PROPERTY
	...
	{
	public:
		TWeakObjectPtr CommonMeshesProperties; // 0x128(0x8)
		TWeakObjectPtr CommonSkeletalMeshesAndAnimationsProperties; // 0x130(0x8)
		bool bImportStaticMeshes; // 0x138(0x1)
		bool bCombineStaticMeshes; // 0x139(0x1)
		unsigned char UnknownData05_6[0x2]; // 0x13A(0x2) UNKNOWN PROPERTY
		...
		TWeakObjectPtr DistanceFieldReplacementMesh; // 0x174(0x8)
		...
		unsigned char UnknownData07_6[0x3]; // 0x189(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr PhysicsAsset; // 0x18C(0x8)
		bool bUseHighPrecisionSkinWeights; // 0x194(0x1)
		unsigned char UnknownData08_6[0x3]; // 0x195(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x54]; // 0x1AC(0x54) UNKNOWN PROPERTY
		...
		void SetCombineSkeletalMeshes(bool InbCombineSkeletalMeshes); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414EFB800
		bool GetCombineSkeletalMeshes(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFB720
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xA]; // 0x13E(0xA) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_7[0x30]; // 0x160(0x30) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_1[0x100]; // 0x28(0x100) UNKNOWN PROPERTY
		...
		void SetContext(FInterchangePipelineMeshesUtilitiesContext& Context); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC600
		bool IsValidMeshInstanceUid(FString MeshInstanceUid); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC520
		bool IsValidMeshGeometryUid(FString MeshGeometryUid); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC440
		FString GetMeshInstanceSkeletonRootUid(FString MeshInstanceUid); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC360
		FInterchangeMeshInstance GetMeshInstanceByUid(FString MeshInstanceUid); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC280
		FString GetMeshGeometrySkeletonRootUid(FString MeshGeometryUid); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC1A0
		FInterchangeMeshGeometry GetMeshGeometryByUid(FString MeshGeometryUid); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414EFC0C0
		void GetAllStaticMeshInstance(TArray& MeshInstanceUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBFE0
		void GetAllStaticMeshGeometry(TArray& MeshGeometryUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBF00
		void GetAllSkinnedMeshInstance(TArray& MeshInstanceUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBE20
		void GetAllSkinnedMeshGeometry(TArray& MeshGeometryUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBD40
		void GetAllMeshInstanceUidsUsingMeshGeometryUid(FString MeshGeometryUid, TArray& MeshInstanceUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBC60
		void GetAllMeshInstanceUids(TArray& MeshInstanceUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBB80
		void GetAllMeshGeometryNotInstanced(TArray& MeshGeometryUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFBAA0
		void GetAllMeshGeometry(TArray& MeshGeometryUids); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414EFB9C0
		UInterchangePipelineMeshesUtilities CreateInterchangePipelineMeshesUtilities(UInterchangeBaseNodeContainer BaseNodeContainer); // Flags: Final|Native|Static|Public|BlueprintCallable 0x7FF414EFB8E0
	};
