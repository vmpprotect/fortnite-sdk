...
namespace SDK
{
	...
	// Enum /FortUILibrary/Systems/StatusIndicator/Data/E_UI_StatusIndicator_Size.E_UI_StatusIndicator_Size
	enum E_UI_StatusIndicator_Size
	{
	...
	// Enum /FortUILibrary/Systems/StatusIndicator/Data/E_UI_StatusIndicator_Type.E_UI_StatusIndicator_Type
	enum E_UI_StatusIndicator_Type
	{
	...
	// Enum /FortUILibrary/Systems/StatusIndicator/Data/E_UI_StatusIndicator_Configuration.E_UI_StatusIndicator_Configuration
	enum E_UI_StatusIndicator_Configuration
	{
	...
	enum E_UI_BackplateBrightness
	{
		E_UI_BackplateBrightness__NewEnumerator0 = 0,
		E_UI_BackplateBrightness__NewEnumerator1 = 1,
		E_UI_BackplateBrightness__NewEnumerator2 = 2,
		E_UI_BackplateBrightness__NewEnumerator3 = 3,
	};


	// Enum /FortUILibrary/Systems/Tabs/Data/E_UI_TabsInputActionType.E_UI_TabsInputActionType
	enum E_UI_TabsInputActionType
	{
	...
	// Enum /FortUILibrary/Systems/Throbber/Data/E_UI_ThrobberSize.E_UI_ThrobberSize
	enum E_UI_ThrobberSize
	{
	...
	// Enum /FortUILibrary/Systems/Throbber/Data/E_UI_ThrobberType.E_UI_ThrobberType
	enum E_UI_ThrobberType
	{
		E_UI_ThrobberType__NewEnumerator0 = 0,
	};


	// Enum /FortUILibrary/Systems/Tag/Data/E_UI_TagType.E_UI_TagType
	enum E_UI_TagType
	{
	...
	// Enum /FortUILibrary/Systems/Badge/Data/E_UI_BadgeIndicatorType.E_UI_BadgeIndicatorType
	enum E_UI_BadgeIndicatorType
	{
	...
	// Enum /FortUILibrary/Systems/Badge/Data/E_UI_BadgeSize.E_UI_BadgeSize
	enum E_UI_BadgeSize
	{
	...
	// Enum /FortUILibrary/Systems/Badge/Data/E_UI_BadgeType.E_UI_BadgeType
	enum E_UI_BadgeType
	{
	...
	// Enum /FortUILibrary/Systems/Items/Data/E_UIKit_ItemCardStatusIndicator.E_UIKit_ItemCardStatusIndicator
	enum E_UIKit_ItemCardStatusIndicator
	{
	...
	// Enum /FortUILibrary/Systems/Items/Data/E_UIKit_StatusIndicatorPlacement.E_UIKit_StatusIndicatorPlacement
	enum E_UIKit_StatusIndicatorPlacement
	{
	...
	// Enum /FortUILibrary/Systems/ModularButton/Data/E_UI_ToggleType.E_UI_ToggleType
	enum E_UI_ToggleType
	{
	...
	// Enum /FortUILibrary/Systems/CoachMark/Data/E_UI_DirectionLeftRightNone.E_UI_DirectionLeftRightNone
	enum E_UI_DirectionLeftRightNone
	{
	...
	// Enum /FortUILibrary/Systems/CoachMark/Data/E_UI_OutBoardPosition.E_UI_OutBoardPosition
	enum E_UI_OutBoardPosition
	{
		E_UI_OutBoardPosition__NewEnumerator3 = 0,
		E_UI_OutBoardPosition__NewEnumerator0 = 1,
		...
		E_UI_OutBoardPosition__NewEnumerator10 = A,
		E_UI_OutBoardPosition__NewEnumerator11 = B,
		E_UI_OutBoardPosition__NewEnumerator12 = C,
	};


	// Enum /FortUILibrary/Systems/Highlight/Data/E_UI_HighlightType.E_UI_HighlightType
	enum E_UI_HighlightType
	{
	...
	// Enum /FortUILibrary/Systems/Highlight/Data/E_UI_HighlightSize.E_UI_HighlightSize
	enum E_UI_HighlightSize
	{
	...
	// Enum /FortUILibrary/Systems/Items/Data/E_UIKit_ItemDescription_TextWrapType.E_UIKit_ItemDescription_TextWrapType
	enum E_UIKit_ItemDescription_TextWrapType
	{
	...
	// Enum /FortUILibrary/Systems/ItemShopTile/E_ItemShop_LoadGuardState.E_ItemShop_LoadGuardState
	enum E_ItemShop_LoadGuardState
	{
		E_ItemShop_LoadGuardState__NewEnumerator0 = 0,
		E_ItemShop_LoadGuardState__NewEnumerator1 = 1,
		E_ItemShop_LoadGuardState__NewEnumerator2 = 2,
	};


	// Enum /FortUILibrary/Systems/ItemShopTile/E_PriceSwitcherState.E_PriceSwitcherState
	enum E_PriceSwitcherState
	{
