...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr WeakFortOnlineAccount; // 0x88(0x8)
		unsigned char UnknownData03_7[0x20]; // 0x90(0x20) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData02_3[0x58]; // 0x78(0x58) UNKNOWN PROPERTY
		UFortLocalPlayerAccountHelper FortLocalPlayerAccountHelper; // 0xD0(0x8)
		TWeakObjectPtr WeakFortOnlineAccount; // 0xD8(0x8)
		unsigned char UnknownData03_6[0x8]; // 0xE0(0x8) UNKNOWN PROPERTY
		TArray GameEntryDeepLinks; // 0xE8(0x10)
