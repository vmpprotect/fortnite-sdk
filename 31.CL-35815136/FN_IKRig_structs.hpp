...
namespace SDK
{
	...
	public:
		...
		TMap<FName, FTargetChainSettings> ChainSettings; // 0x18(0x50)
	...
	public:
		...
		TArray<FIKRigGoal> Goals; // 0x70(0x10)
		...
		unsigned char UnknownData02_6[0xC0]; // 0x118(0xC0) UNKNOWN PROPERTY
		float ActualAlpha; // 0x1D8(0x4)
		unsigned char UnknownData03_7[0x4]; // 0x1DC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x98]; // 0x140(0x98) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap<FName, FQuat> BoneRotationOffsets; // 0x18(0x50)
	...
	public:
		...
		TArray<FBoneChain> BoneChains; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<int32_t> ParentIndices; // 0x10(0x10)
		TArray<FName> ExcludedBones; // 0x20(0x10)
		TArray<FTransform> CurrentPoseGlobal; // 0x30(0x10)
		TArray<FTransform> CurrentPoseLocal; // 0x40(0x10)
		TArray<FTransform> RefPoseGlobal; // 0x50(0x10)
	...
	public:
		...
		TEnumAsByte<EAxis> HingeRotationAxis; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		...
		TEnumAsByte<EAxis> EndBoneForwardAxis; // 0x21(0x1)
