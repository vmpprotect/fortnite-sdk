...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0x8]; // 0x14(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_7[0xC0]; // 0x0(0xC0) UNKNOWN PROPERTY
		UScriptStruct* EventType; // 0xC0(0x8)
		UObject* EventContext; // 0xC8(0x8)
		unsigned char UnknownData01_7[0x20]; // 0xD0(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_7[0xE0]; // 0x0(0xE0) UNKNOWN PROPERTY
