...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_7[0x7]; // 0x449(0x7) UNKNOWN PROPERTY
		...
		void SetMediaURL(FString MediaUrl); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414652498
	};
	...
	{
	public:
		TArray CarouselSlotDescriptions; // 0x2B8(0x10)
		UClass CarouselClass; // 0x2C8(0x8)
		unsigned char UnknownData01_7[0x50]; // 0x2D0(0x50) UNKNOWN PROPERTY
	...
	{
	public:
		FString TileSetFieldName; // 0x530(0x10)
		TWeakObjectPtr TileTypeToTileClassDataTable; // 0x540(0x20)
		TWeakObjectPtr LayoutErrorClass; // 0x560(0x20)
		TWeakObjectPtr LayoutTypeToLayoutClassDataTable; // 0x580(0x20)
	...
	{
	public:
		UCommonTextBlock TitleText; // 0x2E0(0x8)
		UCommonTextBlock BodyText; // 0x2E8(0x8)
		UEpicCMSImage PrimaryImage; // 0x2F0(0x8)
	...
	{
	public:
		unsigned char UnknownData04_3[0x8]; // 0x13E0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x6]; // 0x141A(0x6) UNKNOWN PROPERTY
		UTexture2D ExternalMedia; // 0x1420(0x8)
		unsigned char UnknownData06_6[0x18]; // 0x1428(0x18) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x90]; // 0x1460(0x90) UNKNOWN PROPERTY
		...
		void Launch(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414652578
	};
	...
	{
	public:
		FSlateSound PreviousButtonSound; // 0x2B8(0x18)
		FSlateSound NextButtonSound; // 0x2D0(0x18)
		UCommonWidgetCarousel Carousel; // 0x2E8(0x8)
		UWidget NextPageButton; // 0x2F0(0x8)
		UWidget PreviousPageButton; // 0x2F8(0x8)
		bool bShouldShowNavigationOnlyOnHover; // 0x300(0x1)
		bool bInputActionsForPaging; // 0x301(0x1)
		bool bIsShowingNavigation; // 0x302(0x1)
		unsigned char UnknownData01_7[0x5]; // 0x303(0x5) UNKNOWN PROPERTY
		...
		void SetCurrentPageByIndex(int32_t PageIndex); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414652C78
		void PreviousPage(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414652B98
		void NextPage(); // Flags: Final|Native|Protected|BlueprintCallable 0x7FF414652AB8
		void NavigationVisibilityChanged(bool bShowNavigation); // Flags: Event|Protected|BlueprintEvent 0x7FF4146529D8
		void HandleTilePageAdded(UWidget TileWidget); // Flags: Native|Event|Protected|BlueprintEvent 0x7FF4146528F8
		int32_t GetCurrentPageIndex(); // Flags: Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 0x7FF414652818
		void BeginAutoScrolling(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414652738
		void AddTilePage(UWidget TilePageWidget); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414652658
	};
