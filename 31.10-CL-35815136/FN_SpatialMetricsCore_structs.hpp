...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_6[0x38]; // 0x68(0x38) UNKNOWN PROPERTY
		TMap<FName, FString> MetaData; // 0xA0(0x50)
	};
	...
	{
	public:
		TArray<FSoftClassPath> Classes; // 0x38(0x10)
	};
	...
	public:
		...
		TArray<FSpatialValue> Values; // 0x40(0x10)
