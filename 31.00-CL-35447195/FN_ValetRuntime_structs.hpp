...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0x48]; // 0x218(0x48) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0xB8]; // 0xE0(0xB8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray FutureInputs; // 0x4D8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x48(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ActionDefForUI; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr FortVehicleItemDefinition; // 0x0(0x20)
