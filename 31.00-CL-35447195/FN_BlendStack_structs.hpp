...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData03_7[0x1E8]; // 0x1A0(0x1E8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData05_3[0x10]; // 0x38(0x10) UNKNOWN PROPERTY
		TArray PerSampleGraphPoseLinks; // 0x48(0x10)
		unsigned char UnknownData06_6[0x8]; // 0x58(0x8) UNKNOWN PROPERTY
		TArray AnimPlayers; // 0x60(0x10)
		...
		unsigned char UnknownData08_6[0x23]; // 0x8D(0x23) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x4]; // 0xBC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0xD2(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x7]; // 0xE9(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x1E]; // 0x112(0x1E) UNKNOWN PROPERTY
	};
