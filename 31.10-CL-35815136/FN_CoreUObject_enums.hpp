...
namespace SDK
{
	...
	{
		ETestInstanceDataObjectGrainAlternate__None = 0,
		ETestInstanceDataObjectGrainAlternate__Corn = 1,
		ETestInstanceDataObjectGrainAlternate__Rice = 2,
		ETestInstanceDataObjectGrainAlternate__Rye = 3,
		ETestInstanceDataObjectGrainAlternate__Wheat = 4,
	};
	...
	{
		ETestInstanceDataObjectFruitAlternate__None = 0,
		ETestInstanceDataObjectFruitAlternate__Apple = 1,
		ETestInstanceDataObjectFruitAlternate__Cherry = 2,
		ETestInstanceDataObjectFruitAlternate__Orange = 3,
		ETestInstanceDataObjectFruitAlternate__Pear = 4,
	};
	...
	{
		ETestInstanceDataObjectDirection__None = 0,
		ETestInstanceDataObjectDirection__North = 1,
		ETestInstanceDataObjectDirection__East = 2,
		ETestInstanceDataObjectDirection__South = 4,
		ETestInstanceDataObjectDirection__West = 8,
	};
	...
	enum ETestInstanceDataObjectDirectionAlternate
	{
		...
		ETestInstanceDataObjectDirectionAlternate__South = 10,
		ETestInstanceDataObjectDirectionAlternate__West = 20,
	};
