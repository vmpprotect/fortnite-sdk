...
namespace SDK
{
	...
	public:
		...
		double FPS; // 0x58(0x8)
		TArray Images; // 0x60(0x10)
		TArray AudioOnlyPeriods; // 0x70(0x10)
		TArray VolumeChanges; // 0x80(0x10)
	...
	public:
		...
		TArray AllowList; // 0x18(0x10)
		TArray DenyList; // 0x28(0x10)
		TMap Limits; // 0x38(0x50)
	...
	public:
		...
		TArray Pans; // 0x50(0x10)
		TArray Volumes; // 0x60(0x10)
		TArray Midi; // 0x70(0x10)
	...
	{
	public:
		TArray Playlists; // 0x0(0x10)
		TArray StateStreamPlaylists; // 0x10(0x10)
		TArray SelectedPlaylists; // 0x20(0x10)
		...
		bool Live; // 0x89(0x1)
		unsigned char UnknownData05_6[0x6]; // 0x8A(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x7]; // 0x279(0x7) UNKNOWN PROPERTY
		FEpicMediaExtraMetadataExt ExtraMetadata; // 0x280(0x68)
		unsigned char UnknownData07_7[0x10]; // 0x2E8(0x10) UNKNOWN PROPERTY
	};
