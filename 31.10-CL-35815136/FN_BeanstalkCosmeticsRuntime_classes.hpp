...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr<UTexture2D*> Body_Pattern; // 0x28(0x20)
		...
		unsigned char UnknownData05_6[0x3]; // 0x9D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x3]; // 0xC1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x3]; // 0xCD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_7[0x7]; // 0xD9(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<TWeakObjectPtr> DefaultCharacterCosmetics; // 0x48(0x10)
	...
	public:
		...
		void BP_UpdateCosmeticMaterials(UBeanCosmeticItemDefinitionBase* BeanCD, UMaterialInstanceDynamic* MaterialBody, UMaterialInstanceDynamic* MaterialCostume, UMaterialInstanceDynamic* MaterialHead); // Flags: Event|Protected|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
	...
	{
	public:
		TWeakObjectPtr<UBeanCosmeticsData*> CosmeticsData; // 0x348(0x20)
	...
	public:
		...
		void BP_UpdateCosmeticMaterials(UBeanCosmeticItemDefinitionBase* BeanCD, UMaterialInstanceDynamic* MaterialBody, UMaterialInstanceDynamic* MaterialCostume, UMaterialInstanceDynamic* MaterialHead); // Flags: Event|Public|BlueprintEvent|Const, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
