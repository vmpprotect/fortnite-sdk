...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x165(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x5F8]; // 0x70(0x5F8) UNKNOWN PROPERTY
		UFortCurieVoxelFirePropagationManagerConfig InternalManagerConfig; // 0x668(0x8)
		unsigned char UnknownData05_7[0x10]; // 0x670(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x7]; // 0x1A9(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData04_3[0x30]; // 0x40(0x30) UNKNOWN PROPERTY
		TSet PendingUpdateComponents; // 0x70(0x50)
		TSet PendingRemoveComponents; // 0xC0(0x50)
		unsigned char UnknownData05_6[0x50]; // 0x110(0x50) UNKNOWN PROPERTY
		TArray WorldFireNiagaraSystems; // 0x160(0x10)
		TArray WorldFireDebugNiagaraSystems; // 0x170(0x10)
		...
		TArray CachedFireParticleGrassData; // 0x1D8(0x10)
		TArray CachedFireParticleActorData; // 0x1E8(0x10)
		unsigned char UnknownData06_6[0x60]; // 0x1F8(0x60) UNKNOWN PROPERTY
		TSet CachedBurningGrassGridCells; // 0x258(0x50)
		TMap GrassAudioMap; // 0x2A8(0x50)
		unsigned char UnknownData07_6[0x50]; // 0x2F8(0x50) UNKNOWN PROPERTY
		TArray PreallocatedAudioComponents; // 0x348(0x10)
		...
		void OnUserSettingsEffectQualityChanged(); // Flags: Final|Native|Private 0x7FF414CFE118
	};
