...
namespace SDK
{
	...
	{
	public:
		TArray<FNeuralMorphBoneGroup> BoneGroups; // 0x68(0x10)
		TArray<FNeuralMorphCurveGroup> CurveGroups; // 0x78(0x10)
	...
	{
	public:
		TArray<UNeuralMorphMLPLayer*> Layers; // 0x28(0x10)
	...
	public:
		...
		TArray<float> InputMeans; // 0x68(0x10)
		TArray<float> InputStd; // 0x78(0x10)
	...
	{
	public:
		TArray<FNeuralMorphBoneGroup> BoneGroups; // 0x1D0(0x10)
		TArray<FNeuralMorphCurveGroup> CurveGroups; // 0x1E0(0x10)
		TMap<FName, FNeuralMorphMaskInfo> BoneMaskInfos; // 0x1F0(0x50)
		TMap<FName, FNeuralMorphMaskInfo> BoneGroupMaskInfos; // 0x240(0x50)
		TMap<FName, FMLDeformerMaskInfo> BoneMaskInfoMap; // 0x290(0x50)
		TMap<FName, FMLDeformerMaskInfo> BoneGroupMaskInfoMap; // 0x2E0(0x50)
		...
		unsigned char UnknownData02_6[0x4]; // 0x364(0x4) UNKNOWN PROPERTY
