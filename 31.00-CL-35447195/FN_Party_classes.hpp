...
namespace SDK
{
	...
	public:
		...
		TArray SocialToolkits; // 0xA8(0x10)
		USocialDebugTools SocialDebugTools; // 0xB8(0x8)
		unsigned char UnknownData03_7[0x108]; // 0xC0(0x108) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData05_3[0x40]; // 0x28(0x40) UNKNOWN PROPERTY
		USocialUser LocalUser; // 0x68(0x8)
		TArray AllUsers; // 0x70(0x10)
		unsigned char UnknownData06_6[0x50]; // 0x80(0x50) UNKNOWN PROPERTY
		bool bRemoveInvalidatedUserFromMaps; // 0xD0(0x1)
		unsigned char UnknownData07_6[0x3]; // 0xD1(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr LocalPlayerOwner; // 0xD4(0x8)
		unsigned char UnknownData08_6[0x4]; // 0xDC(0x4) UNKNOWN PROPERTY
		USocialChatManager SocialChatManager; // 0xE0(0x8)
		unsigned char UnknownData09_7[0x1E0]; // 0xE8(0x1E0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData03_3[0x50]; // 0x28(0x50) UNKNOWN PROPERTY
		TMap DirectChannelsByTargetUser; // 0x78(0x50)
		TMap ChatRoomsById; // 0xC8(0x50)
		TMap ReadOnlyChannelsByDisplayName; // 0x118(0x50)
		bool bEnableChatSlashCommands; // 0x168(0x1)
		unsigned char UnknownData04_6[0x7]; // 0x169(0x7) UNKNOWN PROPERTY
		TMap GroupChannels; // 0x170(0x50)
		unsigned char UnknownData05_7[0x60]; // 0x1C0(0x60) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData07_3[0x38]; // 0x28(0x38) UNKNOWN PROPERTY
		UClass ReservationBeaconClientClass; // 0x60(0x8)
		UClass SpectatorBeaconClientClass; // 0x68(0x8)
		unsigned char UnknownData08_6[0x10]; // 0x70(0x10) UNKNOWN PROPERTY
		FUniqueNetIdRepl OwningLocalUserId; // 0x80(0x30)
		FUniqueNetIdRepl CurrentLeaderId; // 0xB0(0x30)
		TMap PartyMembersById; // 0xE0(0x50)
		bool bEnableAutomaticPartyRejoin; // 0x130(0x1)
		unsigned char UnknownData09_6[0x57]; // 0x131(0x57) UNKNOWN PROPERTY
		double PlatformUserInviteCooldown; // 0x188(0x8)
		double PrimaryUserInviteCooldown; // 0x190(0x8)
		unsigned char UnknownData10_6[0x70]; // 0x198(0x70) UNKNOWN PROPERTY
		TWeakObjectPtr ReservationBeaconClient; // 0x208(0x8)
		unsigned char UnknownData11_6[0x4]; // 0x210(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr SpectatorBeaconClient; // 0x214(0x8)
		unsigned char UnknownData12_6[0x2C]; // 0x21C(0x2C) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_7[0x10C]; // 0x254(0x10C) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x1]; // 0x78(0x1) UNKNOWN PROPERTY
		bool bEnableDebugInitializer; // 0x79(0x1)
		unsigned char UnknownData05_7[0x9E]; // 0x7A(0x9E) UNKNOWN PROPERTY
	...
	{
	public:
		TArray OssNamesWithEnvironmentIdPrefix; // 0x28(0x10)
		...
		TArray SocialPlatformDescriptions; // 0x50(0x10)
		TArray SonyOSSNames; // 0x60(0x10)
	...
	{
	public:
		unsigned char UnknownData01_1[0x1A8]; // 0x28(0x1A8) UNKNOWN PROPERTY
