...
namespace SDK
{
	...
	public:
		TArray Nodes; // 0x0(0x10)
		TArray Transforms; // 0x10(0x10)
		TMap NodeNameToIndexMapping; // 0x20(0x50)
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0xE0]; // 0x0(0xE0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x5]; // 0xB(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0x1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0xB]; // 0x15(0xB) UNKNOWN PROPERTY
