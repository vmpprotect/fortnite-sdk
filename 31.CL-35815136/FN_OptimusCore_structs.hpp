...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UObject*> TypeObject; // 0x4(0x8)
	};
	...
	{
	public:
		TArray<FOptimusParameterBinding> InnerArray; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FOptimusConstant> InputConstants; // 0x0(0x10)
		TArray<FOptimusConstant> OutputConstants; // 0x10(0x10)
		TMap<FName, int32_t> GroupNameToBindingIndex; // 0x20(0x50)
	};
	...
	{
	public:
		TArray<FOptimusKernelConstantContainer> KernelContainers; // 0x0(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0x18(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x28]; // 0x18(0x28) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x18(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x18]; // 0x18(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x30]; // 0x18(0x30) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x90]; // 0x18(0x90) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x98]; // 0x18(0x98) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x78]; // 0x18(0x78) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x40]; // 0x18(0x40) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x88]; // 0x18(0x88) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x48]; // 0x18(0x48) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x20]; // 0x18(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x20]; // 0x38(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x50]; // 0x18(0x50) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x38]; // 0x18(0x38) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FOptimusAnimAttributeDescription> InnerArray; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> SourceObject; // 0x40(0x20)
		unsigned char UnknownData01_6[0x18]; // 0x60(0x18) UNKNOWN PROPERTY
		TArray<char> Value; // 0x78(0x10)
	};
	...
	{
	public:
		TArray<FName> InputPinPath; // 0x0(0x10)
		TArray<FName> OutputPinPath; // 0x10(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> TypeObject; // 0x28(0x8)
		...
		unsigned char UnknownData02_7[0x2]; // 0x46(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UOptimusFunctionNodeGraph*> GraphPath; // 0x0(0x20)
	...
	{
	public:
		TArray<FOptimusFunctionNodeGraphHeader> Headers; // 0x0(0x10)
	};
	...
	{
	public:
		TSet<TWeakObjectPtr> Nodes; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FSoftObjectPath, FOptimusFunctionReferenceNodeSet> FunctionReferences; // 0x0(0x50)
	};
