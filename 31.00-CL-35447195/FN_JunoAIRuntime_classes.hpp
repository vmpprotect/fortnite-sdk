...
namespace SDK
{
	...
	public:
		...
		TArray DefaultItemsToAdd; // 0x16F0(0x10)
		unsigned char UnknownData03_6[0x90]; // 0x1700(0x90) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x6]; // 0x182A(0x6) UNKNOWN PROPERTY
		FScalableFloat EffectivenessMultiplierForWeaponSelectionOnPickedOrAddedItem; // 0x1830(0x28)
		TMap ValidItemsTablePerType; // 0x1858(0x50)
		...
		unsigned char UnknownData05_7[0x4]; // 0x18DC(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData04_3[0x18]; // 0x1A0(0x18) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x3]; // 0x209(0x3) UNKNOWN PROPERTY
		FName BestTargetActorName; // 0x20C(0x4)
		unsigned char UnknownData06_6[0x4]; // 0x210(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData03_3[0x24]; // 0xA8(0x24) UNKNOWN PROPERTY
		FName TeleportDestinationKeyName; // 0xCC(0x4)
		unsigned char UnknownData04_6[0x4]; // 0xD0(0x4) UNKNOWN PROPERTY
		FName ShouldTeleportKeyName; // 0xD4(0x4)
		unsigned char UnknownData05_6[0x8]; // 0xD8(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0x18]; // 0x1A0(0x18) UNKNOWN PROPERTY
		FEQSParametrizedQueryExecutionRequest EQSRequest; // 0x1B8(0x48)
	...
	{
	public:
		unsigned char UnknownData02_3[0x30]; // 0x1A0(0x30) UNKNOWN PROPERTY
		...
		TArray ShelterQueryTypes; // 0x228(0x10)
	...
	public:
		...
		unsigned char UnknownData06_6[0x6]; // 0xAA(0x6) UNKNOWN PROPERTY
		...
		TMap MoodReactionOnFriendshipStateIncrease; // 0x130(0x50)
		TMap MoodReactionOnFriendshipStateDecrease; // 0x180(0x50)
		unsigned char UnknownData07_6[0x1B8]; // 0x1D0(0x1B8) UNKNOWN PROPERTY
		FMulticastInlineDelegate OnFriendshipValueRequestedChangeDelegate; // 0x388(0x10)
		unsigned char UnknownData08_6[0x18]; // 0x398(0x18) UNKNOWN PROPERTY
		FMulticastInlineDelegate OnFriendshipValueChangedDelegate; // 0x3B0(0x10)
		unsigned char UnknownData09_6[0x18]; // 0x3C0(0x18) UNKNOWN PROPERTY
		FMulticastInlineDelegate OnFriendshipStateChangedDelegate; // 0x3D8(0x10)
		unsigned char UnknownData10_6[0x4]; // 0x3E8(0x4) UNKNOWN PROPERTY
		float FriendshipValue; // 0x3EC(0x4)
		FGameplayTag FriendshipState; // 0x3F0(0x4)
		unsigned char UnknownData11_7[0xC]; // 0x3F4(0xC) UNKNOWN PROPERTY
		...
		void HandleUnconverted(AFortPawn UnconvertedPawn, EUnconvertReason UnconvertReason); // Flags: Final|Native|Private 0x7FF414E1AF20
		void HandleConverted(AFortPawn InstigatorPawn, AFortPawn ConvertedPawn); // Flags: Final|Native|Private 0x7FF414E1AE40
		float GetFriendshipValue(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1AD60
		FGameplayTag GetFriendshipState(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1AC80
		bool EnableFriendshipChanges(); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 0x7FF414E1ABA0
		bool DisableFriendshipChanges(); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 0x7FF414E1AAC0
		bool AreFriendshipChangesEnabled(); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1A9E0
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x50]; // 0xA8(0x50) UNKNOWN PROPERTY
	...
	public:
		...
		TArray PossibleMoodReactions; // 0x78(0x10)
	...
	{
	public:
		unsigned char UnknownData05_3[0x18]; // 0xA0(0x18) UNKNOWN PROPERTY
		FJunoCampAICachedRecruitmentData CachedAndReplicatedRecruitmentData; // 0xB8(0x30)
		unsigned char UnknownData06_6[0x68]; // 0xE8(0x68) UNKNOWN PROPERTY
		TMap UniqueAIIdentifierToSpawnedAIs; // 0x150(0x50)
		unsigned char UnknownData07_6[0xE8]; // 0x1A0(0xE8) UNKNOWN PROPERTY
		TArray NPCPointProviders; // 0x288(0x10)
		UFortAthenaLivingWorldEncounterInstance NPCEncounter; // 0x298(0x8)
		TArray CreaturePointProviders; // 0x2A0(0x10)
		...
		TArray CachedFixedNPCsConfigurationAtCurrentAwesomenessLevel; // 0x2D0(0x10)
		FJunoAICampManagementVisitorsPickingConfiguration CachedVisitorsPickingConfigurationAtCurrentAwesomenessLevel; // 0x2E0(0x28)
		TArray NonSpawnedCreaturesIdentifiersWaitingForSpawnCondition; // 0x308(0x10)
		unsigned char UnknownData08_6[0x8]; // 0x318(0x8) UNKNOWN PROPERTY
		...
		TMap AwesomenessLevelToFixedNPCsConfiguration; // 0xA90(0x50)
		TMap AwesomenessLevelToVisitorsPickingConfiguration; // 0xAE0(0x50)
		TMap AwesomenessLevelToNPCRewards; // 0xB30(0x50)
		...
		unsigned char UnknownData09_6[0x4]; // 0xC74(0x4) UNKNOWN PROPERTY
		...
		bool RequestCreatureTemporaryDespawn(FGameplayTag& UniqueAIIdentifier); // Flags: Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 0x7FF414E1B700
		void HandleAwesomeLevelReady(FJunoCampAwesomeStatsData& AwesomeData); // Flags: Final|Native|Protected|HasOutParms 0x7FF414E1B620
		void HandleAwesomeLevelChanged(FJunoAwesomeLevelChangeData& ChangeData); // Flags: Final|Native|Protected|HasOutParms 0x7FF414E1B540
		void HandleAISpawned(AActor SpawnedAIPawn, UFortAthenaLivingWorldEventData EventData); // Flags: Final|Native|Protected 0x7FF414E1B460
		void HandleAIDespawned(AActor DespawnedAIPawn, UFortAthenaLivingWorldEventData EventData); // Flags: Final|Native|Protected 0x7FF414E1B380
		void HandleAIControllerFullySpawned(AAIController Controller, AFortPawn Pawn); // Flags: Final|Native|Protected 0x7FF414E1B2A0
		void HandleAIControllerChanged(APawn Pawn, AController OldController, AController NewController); // Flags: Final|Native|Protected 0x7FF414E1B1C0
		AFortPawn GetSpawnedAIFromUniqueAIIdentifier(FGameplayTag& UniqueAIIdentifier); // Flags: Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414E1B0E0
		FJunoCampAICachedRecruitmentData GetCachedAndReplicatedRecruitmentData(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1B000
	};
	...
	{
	public:
		unsigned char UnknownData01_3[0x8]; // 0x158(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xD8]; // 0x1E8(0xD8) UNKNOWN PROPERTY
		...
		void OnRep_CachedCustomName(); // Flags: Final|Native|Private|Const 0x7FF414E1BFC0
		void NotifyPetting(AFortPawn Instigator); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 0x7FF414E1BEE0
		void NotifyFeeding(AFortPawn Instigator, UFortItemDefinition ItemBeingFed); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 0x7FF414E1BE00
		void HandleUnconverted(AFortPawn UnconvertedPawn, EUnconvertReason UnconvertReason); // Flags: Final|Native|Private 0x7FF414E1BD20
		void HandleDied(AActor DamagedActor, float Damage, AController InstigatedBy, AActor DamageCauser, FVector HitLocation, UPrimitiveComponent FHitComponent, FName BoneName, FVector Momentum); // Flags: Final|Native|Private|HasDefaults 0x7FF414E1BC40
		void HandleConverted(AFortPawn InstigatorPawn, AFortPawn ConvertedPawn); // Flags: Final|Native|Private 0x7FF414E1BB60
		FText GetCustomName(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1BA80
		FGuid GetAssignedRecruitmentObjectId(); // Flags: Final|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 0x7FF414E1B9A0
		UJunoCampRecruitmentObjectComponent GetAssignedAndSpawnedRecruitmentObject(); // Flags: Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1B8C0
		bool AssignNewCustomName(FJunoRecruitmentObjectAssignedData& AssignedData, AFortPlayerController InstigatorController); // Flags: Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable 0x7FF414E1B7E0
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x118]; // 0xB8(0x118) UNKNOWN PROPERTY
		TArray PreFTUESkillSetClasses; // 0x1D0(0x10)
		UFortAthenaAIRuntimeParameters_AIBotConvert CachedAIBotConvertParameters; // 0x1E0(0x8)
		unsigned char UnknownData03_6[0x58]; // 0x1E8(0x58) UNKNOWN PROPERTY
		TMap AIRoleToDisplayText; // 0x240(0x50)
		TArray FTUESkillSetClasses; // 0x290(0x10)
		...
		void HandleDied(AActor DamagedActor, float Damage, AController InstigatedBy, AActor DamageCauser, FVector HitLocation, UPrimitiveComponent FHitComponent, FName BoneName, FVector Momentum); // Flags: Final|Native|Private|HasDefaults 0x7FF414E1C420
		FGameplayTagContainer GetSoftRemovedReasons(); // Flags: Final|Native|Private|BlueprintCallable|BlueprintPure|Const 0x7FF414E1C340
		FText GetAIRoleDisplayText(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1C260
		FGameplayTag GetAIRole(); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 0x7FF414E1C180
		FText ConvertAIRoleToDisplayText(FGameplayTag& AIRole); // Flags: Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 0x7FF414E1C0A0
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x30]; // 0x9A8(0x30) UNKNOWN PROPERTY
		TArray ManagedFollowers; // 0x9D8(0x10)
		TScriptInterface TemporaryGlobalEncounterPointProvider; // 0x9E8(0x10)
		UFortAthenaLivingWorldEncounterInstance TemporaryGlobalEncounter; // 0x9F8(0x8)
		TMap DigestedFTUEConfigurations; // 0xA00(0x50)
		TMap FTUERuntimeDatas; // 0xA50(0x50)
		unsigned char UnknownData04_6[0x70]; // 0xAA0(0x70) UNKNOWN PROPERTY
		TMap WorldAssignedNPCs; // 0xB10(0x50)
		unsigned char UnknownData05_7[0x48]; // 0xB60(0x48) UNKNOWN PROPERTY
		...
		void HandleFTUENPCSpawned(AActor FTUENPC, UFortAthenaLivingWorldEventData EventData); // Flags: Final|Native|Private 0x7FF414E1C500
	};
	...
	{
	public:
		TArray TagsData; // 0xA0(0x10)
		FScalableFloat InGameHoursDuration; // 0xB0(0x28)
		FScalableFloat SafetyBubbleRadius; // 0xD8(0x28)
		unsigned char UnknownData01_7[0x48]; // 0x100(0x48) UNKNOWN PROPERTY
		...
		void OnTimeOfDayPhaseChanged(EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation); // Flags: Final|Native|Protected 0x7FF414E1C5E0
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x3E4(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		void JunoPauseTargetAI(bool bPause); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1CB20
		void JunoEnableRecruitedCreaturePermaDeath(bool bEnable); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1CA40
		void JunoEnableHostileCreatures(bool bEnable); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1C960
		void JunoEnableFriendlyNPCs(bool bEnable); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1C880
		void JunoEnableFriendlyCreatures(bool bEnable); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1C7A0
		void JunoEnableEliteHostileCreatures(bool bEnable); // Flags: Final|BlueprintAuthorityOnly|Exec|Native|Private 0x7FF414E1C6C0
	};
	...
	public:
		...
		TWeakObjectPtr BlockedByActor; // 0x124(0x8)
	...
	public:
		...
		unsigned char UnknownData03_5[0x7]; // 0x141(0x7) UNKNOWN PROPERTY
		...
		TEnumAsByte PathObstacleAction; // 0x1E8(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x1E9(0x3) UNKNOWN PROPERTY
		bool bApplyCostLimit : 1; // 0x1EC:0(0x1)
		unsigned char UnknownData05_5[0x3]; // 0x1ED(0x3) UNKNOWN PROPERTY
