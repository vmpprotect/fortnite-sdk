...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData02_3[0xC]; // 0xC(0xC) UNKNOWN PROPERTY
		FGameplayEffectSpec Spec; // 0x18(0x298)
		FPredictionKey PredictionKey; // 0x2B0(0x10)
		TArray GrantedAbilityHandles; // 0x2C0(0x10)
		...
		unsigned char UnknownData03_7[0x83]; // 0x2DD(0x83) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xB]; // 0x5(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray ModifiedAttributes; // 0x8(0x10)
		...
		unsigned char UnknownData07_5[0x3]; // 0x1C5(0x3) UNKNOWN PROPERTY
		TArray GrantedAbilitySpecs; // 0x1C8(0x10)
		unsigned char UnknownData08_6[0xA0]; // 0x1D8(0xA0) UNKNOWN PROPERTY
		FGameplayEffectContextHandle EffectContext; // 0x278(0x18)
		float Level; // 0x290(0x4)
		unsigned char UnknownData09_7[0x4]; // 0x294(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr SourceObject; // 0x38(0x8)
		unsigned char UnknownData04_6[0x50]; // 0x40(0x50) UNKNOWN PROPERTY
	...
	{
	public:
		TArray SourceAttributes; // 0x0(0x10)
		TArray TargetAttributes; // 0x10(0x10)
	...
	public:
		...
		TWeakObjectPtr Instigator; // 0x98(0x8)
		TWeakObjectPtr EffectCauser; // 0xA0(0x8)
		TWeakObjectPtr SourceObject; // 0xA8(0x8)
		TWeakObjectPtr PhysicalMaterial; // 0xB0(0x8)
		int32_t GameplayEffectLevel; // 0xB8(0x4)
		int32_t AbilityLevel; // 0xBC(0x4)
		TWeakObjectPtr TargetAttachComponent; // 0xC0(0x8)
	...
	{
	public:
		TEnumAsByte ActivationMode; // 0x0(0x1)
		bool bCanBeEndedByOtherInstance : 1; // 0x1:0(0x1)
		unsigned char UnknownData01_5[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData05_7[0x10]; // 0x188(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x5]; // 0x43(0x5) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray PredictionKeys; // 0x108(0x10)
	};
	...
	{
	public:
		TArray GameplayCues; // 0x108(0x10)
	...
	public:
		...
		TArray GameplayEffects_Internal; // 0x130(0x10)
		unsigned char UnknownData03_7[0x1C0]; // 0x140(0x1C0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		FPredictionKey PredictionKey; // 0x10(0x10)
		TWeakObjectPtr AnimatingAbility; // 0x20(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData02_5[0x1]; // 0x1F(0x1) UNKNOWN PROPERTY
	...
	public:
		...
		TWeakObjectPtr SourceObject; // 0x20(0x8)
		...
		unsigned char UnknownData02_5[0x16]; // 0x2A(0x16) UNKNOWN PROPERTY
		FGameplayAbilityActivationInfo ActivationInfo; // 0x40(0x18)
		FGameplayTagContainer DynamicAbilityTags; // 0x58(0x20)
		TArray NonReplicatedInstances; // 0x78(0x10)
		TArray ReplicatedInstances; // 0x88(0x10)
		FActiveGameplayEffectHandle GameplayEffectHandle; // 0x98(0x8)
		unsigned char UnknownData03_7[0x50]; // 0xA0(0x50) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr OwnerActor; // 0x8(0x8)
		TWeakObjectPtr AvatarActor; // 0x10(0x8)
		TWeakObjectPtr PlayerController; // 0x18(0x8)
		TWeakObjectPtr AbilitySystemComponent; // 0x20(0x8)
		TWeakObjectPtr SkeletalMeshComponent; // 0x28(0x8)
		TWeakObjectPtr AnimInstance; // 0x30(0x8)
		TWeakObjectPtr MovementComponent; // 0x38(0x8)
	...
	public:
		...
		TEnumAsByte LocationType; // 0x84(0x1)
		unsigned char UnknownData03_7[0xB]; // 0x85(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte TriggerSource; // 0x4(0x1)
		unsigned char UnknownData01_7[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		FGameplayAttribute Attribute; // 0x0(0x38)
		TEnumAsByte ModifierOp; // 0x38(0x1)
	...
	public:
		...
		TEnumAsByte ModifierOp; // 0x45(0x1)
		unsigned char UnknownData02_6[0x2]; // 0x46(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		TMap PreallocatedInstances; // 0x0(0x50)
		TArray ClassesNeedingPreallocation; // 0x50(0x10)
	...
	public:
		...
		TEnumAsByte SelfFilter; // 0x18(0x1)
	...
	public:
		unsigned char UnknownData01_3[0x8]; // 0x8(0x8) UNKNOWN PROPERTY
		FGameplayAbilityTargetingLocationInfo SourceLocation; // 0x10(0x90)
		TArray TargetActorArray; // 0xA0(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData02_7[0x2C0]; // 0x0(0x2C0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x4]; // 0x48(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		TArray AllowedSurfaceTypes; // 0x8(0x10)
		unsigned char UnknownData04_6[0x8]; // 0x18(0x8) UNKNOWN PROPERTY
		TArray RejectedSurfaceTypes; // 0x20(0x10)
		unsigned char UnknownData05_7[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray FxSystemComponents; // 0x0(0x10)
		TArray AudioComponents; // 0x10(0x10)
		TArray CameraShakes; // 0x20(0x10)
		TArray CameraLensEffects; // 0x30(0x10)
	...
	public:
		...
		unsigned char UnknownData03_5[0x3]; // 0x89(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_5[0x3]; // 0x81(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray DeviceProperties; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_5[0x3]; // 0x99(0x3) UNKNOWN PROPERTY
		float FadeOutStartDelay; // 0x9C(0x4)
		float FadeOutDuration; // 0xA0(0x4)
		unsigned char UnknownData03_7[0x4]; // 0xA4(0x4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray BurstParticles; // 0x0(0x10)
		TArray BurstSounds; // 0x10(0x10)
	...
	{
	public:
		TArray LoopingParticles; // 0x0(0x10)
		TArray LoopingSounds; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x54]; // 0x1C(0x54) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray TranslationLUT; // 0x0(0x10)
		TMap TranslationNameToIndexMap; // 0x10(0x50)
		UGameplayTagsManager TagManager; // 0x60(0x8)
		unsigned char UnknownData01_7[0x18]; // 0x68(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray CalculationModifiers; // 0x28(0x10)
		TArray ConditionalGameplayEffects; // 0x38(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x7]; // 0x219(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		TArray OutputModifiers; // 0x0(0x10)
	...
	public:
		...
		TWeakObjectPtr Instigator; // 0x8(0x8)
		TWeakObjectPtr EffectCauser; // 0x10(0x8)
		TWeakObjectPtr AbilityCDO; // 0x18(0x8)
		TWeakObjectPtr AbilityInstanceNotReplicated; // 0x20(0x8)
		int32_t AbilityLevel; // 0x28(0x4)
		TWeakObjectPtr SourceObject; // 0x2C(0x8)
		TWeakObjectPtr InstigatorAbilitySystemComponent; // 0x34(0x8)
		unsigned char UnknownData05_6[0x4]; // 0x3C(0x4) UNKNOWN PROPERTY
		TArray Actors; // 0x40(0x10)
		unsigned char UnknownData06_6[0x10]; // 0x50(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x24]; // 0x4(0x24) UNKNOWN PROPERTY
		FName PropertyName; // 0x28(0x4)
		FGuid PropertyGuid; // 0x2C(0x10)
		unsigned char UnknownData03_7[0xC]; // 0x3C(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray PropertyMappings; // 0x10(0x10)
	};
	...
	public:
		...
		TArray ResponseGameplayEffects; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x88]; // 0x70(0x88) UNKNOWN PROPERTY
	};
