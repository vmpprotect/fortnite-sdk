...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x1BC(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_7[0x8]; // 0x260(0x8) UNKNOWN PROPERTY
		...
		bool IsValidTarget(AActor OwningPlayer, AActor PotentialTarget, FGameplayTagContainer& ReasonForFailure); // Flags: Final|Native|Protected|HasOutParms|BlueprintCallable 0x7FF414CD9EB8
		bool FindTargetProjectile(AActor OwningPlayer, FVector& TraceStart, FVector& TraceEnd, float TargetingRadius); // Flags: Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 0x7FF414CD9DD8
		void FindTargetActor(AActor OwningPlayer, FVector& TraceStart, FVector& TraceEnd); // Flags: Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable 0x7FF414CD9CF8
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x4B1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x6]; // 0x4C2(0x6) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x10C]; // 0x524(0x10C) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0x9DC(0x4) UNKNOWN PROPERTY
		UAudioComponent LoopingAudioComponent; // 0x9E0(0x8)
		unsigned char UnknownData03_7[0x8]; // 0x9E8(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		void UpdatePropPreviewPosition(USceneComponent PropPreviewComponent, float DeltaTime, AFortPawn AttachPawn, FName AttachSocket, USkeletalMeshComponent WeaponMesh, FVector& DesiredRelativeTransform, float MinimumZOffset, FRotator& RelativeRotation, FVector& CachedScale, float InterpSpeed); // Flags: Final|Native|Static|Private|HasOutParms|HasDefaults|BlueprintCallable 0x7FF414CDA318
		void UpdatePropIndexEventState(AActor ContextActor, FPaddleGingerPropData& Payload); // Flags: Final|Native|Static|Private|HasOutParms|BlueprintCallable 0x7FF414CDA238
		void UpdatePropActivatedEventState(AActor ContextActor, FPaddleGingerPropActivatedData& Payload); // Flags: Final|Native|Static|Private|HasOutParms|BlueprintCallable 0x7FF414CDA158
		void ClearPropIndexEventState(AActor ContextActor); // Flags: Final|Native|Static|Private|BlueprintCallable 0x7FF414CDA078
		void ClearPropActivatedEventState(AActor ContextActor); // Flags: Final|Native|Static|Private|BlueprintCallable 0x7FF414CD9F98
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x4]; // 0xA28(0x4) UNKNOWN PROPERTY
		TEnumAsByte TraceChannel; // 0xA2C(0x1)
		unsigned char UnknownData03_7[0xB]; // 0xA2D(0xB) UNKNOWN PROPERTY
		...
		void UpdateAimEndPoint(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414CDA5B8
		void OnEndPointUpdated(FVector& FoundPoint); // Flags: Event|Public|HasOutParms|HasDefaults|BlueprintEvent 0x7FF414CDA4D8
		FVector GetFoundEndPoint(); // Flags: Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 0x7FF414CDA3F8
	};
