...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<ETankAimingMode> AimingMode; // 0x140(0x1)
		unsigned char UnknownData01_6[0x7]; // 0x141(0x7) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_7[0x38]; // 0x80(0x38) UNKNOWN PROPERTY
	};
