...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_3[0x48]; // 0x30(0x48) UNKNOWN PROPERTY
		UMeshTopologySelectionMechanicProperties* Properties; // 0x78(0x8)
		unsigned char UnknownData01_6[0x60]; // 0x80(0x60) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x604]; // 0xFC(0x604) UNKNOWN PROPERTY
		APreviewGeometryActor* PreviewGeometryActor; // 0x700(0x8)
		UTriangleSetComponent* DrawnTriangleSetComponent; // 0x708(0x8)
		unsigned char UnknownData03_6[0x50]; // 0x710(0x50) UNKNOWN PROPERTY
		UMaterialInterface* HighlightedFaceMaterial; // 0x760(0x8)
		unsigned char UnknownData04_7[0x3C8]; // 0x768(0x3C8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0xD]; // 0xB3(0xD) UNKNOWN PROPERTY
		...
		void SelectAll(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B45D50(relative to base address)
		void InvertSelection(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B45D14(relative to base address)
	};
	...
	{
	public:
		TWeakObjectPtr<UWorld*> TargetWorld; // 0xB0(0x8)
	...
	public:
		...
		TArray<UTransformProxy*> TransformProxies; // 0xE8(0x10)
		TArray<UCombinedTransformGizmo*> TransformGizmos; // 0xF8(0x10)
	...
	{
	public:
		TWeakObjectPtr<UWorld*> TargetWorld; // 0xA8(0x8)
		unsigned char UnknownData00_6[0x60]; // 0xB0(0x60) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x18]; // 0x120(0x18) UNKNOWN PROPERTY
		UMeshOpPreviewWithBackgroundCompute* Preview; // 0x138(0x8)
		unsigned char UnknownData01_7[0x330]; // 0x140(0x330) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x10]; // 0x110(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xB8]; // 0x5C8(0xB8) UNKNOWN PROPERTY
		...
		void SetDynamicMesh(UDynamicMesh* NewMesh); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF750B45D8C(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x47]; // 0x539(0x47) UNKNOWN PROPERTY
		...
		void SetLineMaterial(UMaterialInterface* InLineMaterial); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF750B46028(relative to base address)
		void Clear(); // Flags: Final|Native|Public|BlueprintCallable, Memory Exec: 0x7FF750B45D00(relative to base address)
		int32_t AddLines(TArray<FVector>& InStart, TArray<FVector>& InEnd, FColor& InColor, float InThickness, float InDepthBias); // Flags: Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable, Memory Exec: 0x7FF750B45A20(relative to base address)
	};
	...
	public:
		...
		TMap<FString, UTriangleSetComponent*> TriangleSets; // 0x30(0x50)
		TMap<FString, ULineSetComponent*> LineSets; // 0x80(0x50)
		TMap<FString, UPointSetComponent*> PointSets; // 0xD0(0x50)
		...
		bool SetPointSetVisibility(FString PointSetIdentifier, bool bVisible); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B80BC4(relative to base address)
		bool SetPointSetMaterial(FString PointSetIdentifier, UMaterialInterface* NewMaterial); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B80AE0(relative to base address)
		bool SetLineSetVisibility(FString LineSetIdentifier, bool bVisible); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B809F8(relative to base address)
		bool SetLineSetMaterial(FString LineSetIdentifier, UMaterialInterface* NewMaterial); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B80914(relative to base address)
		void SetAllPointSetsMaterial(UMaterialInterface* Material); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B80894(relative to base address)
		void SetAllLineSetsMaterial(UMaterialInterface* Material); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B80814(relative to base address)
		bool RemoveTriangleSet(FString TriangleSetIdentifier, bool bDestroy); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B8072C(relative to base address)
		bool RemovePointSet(FString PointSetIdentifier, bool bDestroy); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B80644(relative to base address)
		bool RemoveLineSet(FString LineSetIdentifier, bool bDestroy); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B8055C(relative to base address)
		void RemoveAllTriangleSets(bool bDestroy); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B804DC(relative to base address)
		void RemoveAllPointSets(bool bDestroy); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B8045C(relative to base address)
		void RemoveAllLineSets(bool bDestroy); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B803DC(relative to base address)
		APreviewGeometryActor GetActor(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF74DE734A8(relative to base address)
		UTriangleSetComponent FindTriangleSet(FString TriangleSetIdentifier); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B8033C(relative to base address)
		UPointSetComponent FindPointSet(FString PointSetIdentifier); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B8029C(relative to base address)
		ULineSetComponent FindLineSet(FString LineSetIdentifier); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B801FC(relative to base address)
		void Disconnect(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B801E8(relative to base address)
		void CreateInWorld(UWorld* World, FTransform& WithTransform); // Flags: Final|Native|Public|HasOutParms|HasDefaults, Memory Exec: 0x7FF750B7FD38(relative to base address)
		UTriangleSetComponent AddTriangleSet(FString TriangleSetIdentifier); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B7FC98(relative to base address)
		UPointSetComponent AddPointSet(FString PointSetIdentifier); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B7FBF8(relative to base address)
		ULineSetComponent AddLineSet(FString LineSetIdentifier); // Flags: Final|Native|Public, Memory Exec: 0x7FF750B7FB58(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x18]; // 0x130(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0xF]; // 0x41(0xF) UNKNOWN PROPERTY
		UDynamicMeshComponent* DynamicMeshComponent; // 0x50(0x8)
		unsigned char UnknownData02_7[0xE8]; // 0x58(0xE8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0xCF]; // 0x531(0xCF) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x118]; // 0x58(0x118) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x590]; // 0x30(0x590) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x210]; // 0x30(0x210) UNKNOWN PROPERTY
		UPreviewGeometry* PreviewGeometry; // 0x240(0x8)
		ULineSetComponent* DrawnPrimitiveEdges; // 0x248(0x8)
		unsigned char UnknownData01_6[0x150]; // 0x250(0x150) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x50]; // 0x3F8(0x50) UNKNOWN PROPERTY
		URectangleMarqueeMechanic* MarqueeMechanic; // 0x448(0x8)
		unsigned char UnknownData03_7[0x120]; // 0x450(0x120) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x498]; // 0x50(0x498) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0x78]; // 0x510(0x78) UNKNOWN PROPERTY
		UTransformProxy* PointTransformProxy; // 0x588(0x8)
		UCombinedTransformGizmo* PointTransformGizmo; // 0x590(0x8)
		unsigned char UnknownData03_7[0xE8]; // 0x598(0xE8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x250]; // 0x30(0x250) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x2B8]; // 0x28(0x2B8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x1F0]; // 0x30(0x1F0) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0xA8]; // 0x238(0xA8) UNKNOWN PROPERTY
		UTransformProxy* PointTransformProxy; // 0x2E0(0x8)
		UCombinedTransformGizmo* PointTransformGizmo; // 0x2E8(0x8)
		unsigned char UnknownData02_6[0x58]; // 0x2F0(0x58) UNKNOWN PROPERTY
		URectangleMarqueeMechanic* MarqueeMechanic; // 0x348(0x8)
		unsigned char UnknownData03_7[0x1C0]; // 0x350(0x1C0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x4F0]; // 0x30(0x4F0) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_7[0x108]; // 0xC8(0x108) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x46]; // 0x3A(0x46) UNKNOWN PROPERTY
		double OnDragRectangleChangedDeferredThreshold; // 0x80(0x8)
		unsigned char UnknownData02_6[0x48]; // 0x88(0x48) UNKNOWN PROPERTY
		UClickDragInputBehavior* ClickDragBehavior; // 0xD0(0x8)
		unsigned char UnknownData03_7[0x148]; // 0xD8(0x148) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x1E8]; // 0x28(0x1E8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0xF8]; // 0x70(0xF8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_6[0x38]; // 0x180(0x38) UNKNOWN PROPERTY
		UTransformProxy* PointTransformProxy; // 0x1B8(0x8)
		UCombinedTransformGizmo* PointTransformGizmo; // 0x1C0(0x8)
		unsigned char UnknownData04_7[0x108]; // 0x1C8(0x108) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x3E0]; // 0x30(0x3E0) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UMaterialInterface*> StandardMaterials; // 0x60(0x10)
		...
		TWeakObjectPtr<UWorld*> PreviewWorld; // 0x88(0x8)
	...
	public:
		...
		TEnumAsByte<ECollisionTraceFlag> CollisionMode; // 0x34(0x1)
	...
	public:
		...
		FCreateTextureObjectResult CreateTextureObject(FCreateTextureObjectParams& CreateTexParams); // Flags: Native|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF750B80114(relative to base address)
		FCreateActorResult CreateNewActor(FCreateActorParams& CreateActorParams); // Flags: Native|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF750B80034(relative to base address)
		FCreateMeshObjectResult CreateMeshObject(FCreateMeshObjectParams& CreateMeshParams); // Flags: Native|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF750B7FF38(relative to base address)
		FCreateMaterialObjectResult CreateMaterialObject(FCreateMaterialObjectParams& CreateMaterialParams); // Flags: Native|Public|HasOutParms|BlueprintCallable, Memory Exec: 0x7FF750B7FE68(relative to base address)
	};
	...
	public:
		...
		TArray<FString> OutputTypeNamesList; // 0xC0(0x10)
		...
		bool ShouldShowPropertySet(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF750BAAF24(relative to base address)
		TArray GetOutputTypeNamesFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750BAAF08(relative to base address)
		ECreateObjectTypeHint GetCurrentCreateMeshType(); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF750BAAEA8(relative to base address)
	};
	...
	public:
		...
		TArray<FString> GroupLayersList; // 0xB0(0x10)
		...
		TArray GetGroupLayersFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750BAAECC(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xAC(0x4) UNKNOWN PROPERTY
		TArray<FString> WeightMapsList; // 0xB0(0x10)
		...
		TArray GetWeightMapsFunc(); // Flags: Final|Native|Public, Memory Exec: 0x7FF750BAAECC(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0xD8]; // 0x68(0xD8) UNKNOWN PROPERTY
		UPreviewGeometry* PreviewGeometry; // 0x140(0x8)
		unsigned char UnknownData03_6[0x178]; // 0x148(0x178) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_7[0xE0]; // 0x3E0(0xE0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0xB30(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x120]; // 0x30(0x120) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_6[0x70]; // 0x90(0x70) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x98]; // 0x118(0x98) UNKNOWN PROPERTY
