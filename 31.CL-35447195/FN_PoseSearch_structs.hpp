...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr SelectedDatabase; // 0x30(0x8)
	...
	public:
		...
		TArray BoneReferences; // 0x18(0x10)
		TArray BoneIndicesWithParents; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x9C]; // 0xFC(0x9C) UNKNOWN PROPERTY
		TArray DatabasesToSearch; // 0x198(0x10)
		unsigned char UnknownData07_7[0x8]; // 0x1A8(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray CollectedBones; // 0x18(0x10)
		...
		unsigned char UnknownData06_6[0x7]; // 0x49(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x130]; // 0x198(0x130) UNKNOWN PROPERTY
	};
