...
namespace SDK
{
	...
	public:
		...
		TArray WarpPoints; // 0x30(0x10)
		TArray ExternalWarpTargets; // 0x40(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr CachedSceneActorComp; // 0x8(0x8)
		TWeakObjectPtr CachedAnimInstance; // 0x10(0x8)
		TWeakObjectPtr CachedSkeletalMesh; // 0x18(0x8)
		TWeakObjectPtr CachedMovementComp; // 0x20(0x8)
		TWeakObjectPtr CachedMotionWarpingComp; // 0x28(0x8)
		unsigned char UnknownData01_7[0xB0]; // 0x30(0xB0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray WarpPoints; // 0x18(0x10)
		TArray ExternalWarpTargets; // 0x28(0x10)
	};
	...
	public:
		...
		TArray WarpPoints; // 0x8(0x10)
		TArray ExternalWarpTargets; // 0x18(0x10)
	};
	...
	public:
		...
		TEnumAsByte MovementMode; // 0xC(0x1)
		...
		TArray SelectionCriteria; // 0x60(0x10)
	...
	public:
		...
		TArray AnimSets; // 0x8(0x10)
		TMap RoleToIKTargetDefsMap; // 0x18(0x50)
		TArray WarpPointDefinitions; // 0x68(0x10)
	...
	public:
		...
		unsigned char UnknownData01_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr PreviewSkeletalMesh; // 0x8(0x20)
		TWeakObjectPtr PreviewAnimInstance; // 0x28(0x20)
		TWeakObjectPtr PreviewStaticMesh; // 0x48(0x20)
		TWeakObjectPtr PreviewActorClass; // 0x68(0x20)
	};
