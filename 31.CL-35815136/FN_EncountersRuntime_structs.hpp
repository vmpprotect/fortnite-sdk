...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<AEncounterMobAnchor*> EncounterAnchorPoint; // 0x50(0x8)
		...
		TArray<TWeakObjectPtr> StaticPointProviders; // 0x80(0x10)
	...
	public:
		...
		TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> MobEncounterData; // 0x18(0x20)
	...
	public:
		...
		TArray<TScriptInterface> CurrentPointProviders; // 0x30(0x10)
		unsigned char UnknownData02_7[0x18]; // 0x40(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> InActor; // 0x0(0x8)
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TWeakObjectPtr<AActor*> TargetActor; // 0x8(0x8)
	...
	public:
		...
		TArray<AActor*> AIActors; // 0x68(0x10)
	...
	public:
		...
		TWeakObjectPtr<UClass*> Value; // 0x8(0x20)
	...
	public:
		FGameplayTag VariableIdentifier; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FFortAthenaLivingWorldEventDataActorSpawnDescription> Value; // 0x8(0x10)
	...
	public:
		FGameplayTag VariableIdentifier; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UEncounterFactionData*> Value; // 0x8(0x20)
		AActor* UserActor; // 0x28(0x8)
	};
	...
	public:
		FGameplayTag VariableIdentifier; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UFortWorldItemDefinition*> Value; // 0x8(0x20)
		AActor* UserActor; // 0x28(0x8)
	};
	...
	public:
		FGameplayTag VariableIdentifier; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> Value; // 0x8(0x20)
		AActor* UserActor; // 0x28(0x8)
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> CenterActor; // 0x0(0x8)
		AActor* UserActor; // 0x8(0x8)
	};
	...
	public:
		...
		TArray<FSubjectTagsPair> EncounterPlayers; // 0xB8(0x10)
	...
	public:
		...
		TWeakObjectPtr<AActor*> AnchorActor; // 0x48(0x8)
		AActor* UserActor; // 0x50(0x8)
	};
	...
	public:
		...
		TWeakObjectPtr<AActor*> ChosenActor; // 0x4C(0x8)
	...
	public:
		...
		TArray<FFortAthenaLivingWorldEventDataActorSpawnDescription> ActorDescriptions; // 0xB0(0x10)
		TArray<FFortAthenaLivingWorldTaggedSpawnActionClass> SpawnActions; // 0xC0(0x10)
	};
	...
	public:
		...
		TArray<FFortAthenaLivingWorldEventDataActorSpawnDescription> ActorDescriptions; // 0x70(0x10)
	};
	...
	public:
		...
		TArray<FDynamicEncounterEntry> DynamicEncounterEntries; // 0x170(0x10)
		TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> DynamicEmptyEncounter; // 0x180(0x20)
		TArray<FFortAthenaLivingWorldTaggedSpawnActionClass> SpawnActions; // 0x1A0(0x10)
		...
		TEnumAsByte<EEnvQueryRunMode> SpawnAroundEnvironmentQueryRunMode; // 0x1C0(0x1)
		...
		TWeakObjectPtr<ULWMEncounterInstance*> EncounterInstance; // 0x1E0(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x50]; // 0x8(0x50) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FFortAthenaLivingWorldEventDataActorSpawnDescription> DynamicActorDescriptions; // 0x8(0x10)
		TArray<FFortAthenaLivingWorldTaggedSpawnActionClass> DynamicSpawnActions; // 0x18(0x10)
	...
	public:
		...
		TWeakObjectPtr<AActor*> TargetActor; // 0x4C(0x8)
	...
	{
	public:
		TWeakObjectPtr<UFortAthenaLivingWorldEncounter*> LWMEncounter; // 0x160(0x20)
		TWeakObjectPtr<ULWMEncounterInstance*> EncounterInstance; // 0x180(0x8)
	};
	...
	public:
		...
		TWeakObjectPtr<AActor*> SpawnedActor; // 0xCC(0x8)
	...
	public:
		...
		TWeakObjectPtr<AActor*> TargetActor; // 0x20(0x8)
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> TrackedActor; // 0x0(0x8)
	...
	public:
		...
		TArray<FEncounterSendCustomVerbStateTreeTaskInstanceDataEntry> Subjects; // 0x8(0x10)
		TArray<FEncounterSendCustomVerbStateTreeTaskInstanceValueEntry> Values; // 0x18(0x10)
		AActor* UserActor; // 0x28(0x8)
	};
	...
	{
	public:
		TArray<FInstancedStruct> ObjectiveVerbs; // 0x0(0x10)
	...
	public:
		FGameplayTagQuery EncounterQuery; // 0x0(0x48)
		TArray<EAlertLevel> AlertLevels; // 0x48(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0x59(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xF]; // 0x51(0xF) UNKNOWN PROPERTY
	};
