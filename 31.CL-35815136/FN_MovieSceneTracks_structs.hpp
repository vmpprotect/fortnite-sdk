...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UMaterialInterface*> SoftPreviousMaterial; // 0x8(0x20)
	};
	...
	public:
		...
		TArray<FMovieSceneCameraShakeSourceTrigger> KeyValues; // 0x60(0x10)
	...
	public:
		TArray<FFrameNumber> KeyTimes; // 0x50(0x10)
		TArray<FMovieSceneEvent> KeyValues; // 0x60(0x10)
		FMovieSceneKeyHandleMap KeyHandles; // 0x70(0x88)
	};
	...
	public:
		...
		TArray<FString> Values; // 0x60(0x10)
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x14A(0x2) UNKNOWN PROPERTY
		bool bFollow : 1; // 0x14C:0(0x1)
		bool bReverse : 1; // 0x14C:1(0x1)
		bool bForceUpright : 1; // 0x14C:2(0x1)
		unsigned char UnknownData01_7[0x3]; // 0x14D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FMovieSceneActorReferenceKey> KeyValues; // 0x80(0x10)
	...
	public:
		TArray<FFrameNumber> Times; // 0x50(0x10)
		TArray<FEventPayload> KeyValues; // 0x60(0x10)
		FMovieSceneKeyHandleMap KeyHandles; // 0x70(0x88)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x1C]; // 0x24(0x1C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x18]; // 0x18(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<FString, FString> ValuesByCVar; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x4]; // 0x144(0x4) UNKNOWN PROPERTY
	};
