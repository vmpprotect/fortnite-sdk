...
namespace SDK
{
	...
	{
	public:
		TWeakObjectPtr<USmartObjectDefinition*> Asset; // 0x0(0x8)
	...
	{
	public:
		unsigned char UnknownData00_3[0x10]; // 0x0(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<int32_t> SmartObjectLaneLocationIndices; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<int32_t> AffectedLanes; // 0x8(0x10)
		TArray<FSmartObjectLaneLocation> SmartObjectLaneLocations; // 0x18(0x10)
		TMap<FSmartObjectHandle, int32_t> SmartObjectToLaneLocationIndexLookup; // 0x28(0x50)
		TMap<int32_t, FSmartObjectLaneLocationIndices> LaneToLaneLocationIndicesLookup; // 0x78(0x50)
