...
namespace SDK
{
	...
	{
	public:
		TArray<FJunoContextualMessageCandidate> ContextualMessages; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FFortConversationContextRequirement> ContextRequirements; // 0x8(0x10)
		TArray<FJunoConversationContextRequirement> JunoContextRequirements; // 0x18(0x10)
		FScalableFloat Priority; // 0x28(0x28)
		FScalableFloat Weight; // 0x50(0x28)
		TArray<FJunoContexualMessageContainer> Messages; // 0x78(0x10)
	};
	...
	public:
		...
		TArray<FConversationNodeParameterPair> MetadataParameters; // 0x18(0x10)
	...
	{
	public:
		TArray<FName> SaveNames; // 0x0(0x10)
		TArray<FName> SaveNamesPerPlayer; // 0x10(0x10)
		TArray<FFortItemEntry> Items; // 0x20(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UClass*> ClassToSpawn; // 0x0(0x20)
	...
	{
	public:
		TArray<FQuestPropSpawnInfo> QuestPropSpawnInfos; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<EJunoTokenReceiverType, FGameplayTagContainer> QuestTokens; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FQuestTokenMappingContainer> ObjectiveQuestTokensToGrant; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FQuestPropSpawnInfoContainer> ObjectiveQuestPropActorsToSpawn; // 0x0(0x50)
	...
	{
	public:
		TArray<FJunoChangeInventoryEventEntry> ItemRequirements; // 0x48(0x10)
		...
		TWeakObjectPtr<AFortPawn*> SavedInteractingPawn; // 0x68(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xC8]; // 0x8(0xC8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<UJunoActionConfig*> MappedJunoActions; // 0x0(0x10)
	};
