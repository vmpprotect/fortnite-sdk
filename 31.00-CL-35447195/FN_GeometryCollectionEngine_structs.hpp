...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData07_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x2]; // 0x16(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x2]; // 0x2A(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_7[0x4]; // 0x4C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray SourceMaterial; // 0x80(0x10)
		TArray InstanceCustomData; // 0x90(0x10)
		bool bAddInternalMaterials; // 0xA0(0x1)
		bool bSplitComponents; // 0xA1(0x1)
		bool bSetInternalFromMaterialIndex; // 0xA2(0x1)
		unsigned char UnknownData03_7[0xD]; // 0xA3(0xD) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray CollisionShapes; // 0x8(0x10)
