...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData01_2[0x138]; // 0x0(0x138) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData05_6[0x8]; // 0x30(0x8) UNKNOWN PROPERTY
		TWeakObjectPtr HitObject; // 0x38(0x8)
	};
