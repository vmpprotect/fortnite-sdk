...
namespace SDK
{
	...
	enum ECreativeDynamicUIAlignment
	{
		...
		ECreativeDynamicUIAlignment__LeftTall = A,
		ECreativeDynamicUIAlignment__CenteredTall = B,
		ECreativeDynamicUIAlignment__RightTall = C,
		ECreativeDynamicUIAlignment__TopWide = D,
		ECreativeDynamicUIAlignment__CenteredWide = E,
		ECreativeDynamicUIAlignment__BottomWide = F,
	};
