...
namespace SDK
{
	...
	{
	public:
		TArray<FMassMovementStyle> MovementStyles; // 0x28(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0x328]; // 0xD8(0x328) UNKNOWN PROPERTY
		float MinSpeed; // 0x400(0x4)
		float MaxSpeed; // 0x404(0x4)
		bool bSetZComponent; // 0x408(0x1)
		unsigned char UnknownData01_7[0x17]; // 0x409(0x17) UNKNOWN PROPERTY
