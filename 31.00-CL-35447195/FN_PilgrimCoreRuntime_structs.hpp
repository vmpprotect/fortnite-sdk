...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData05_6[0x2]; // 0xE(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x3]; // 0x55(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray MusicBattleStates; // 0x0(0x10)
	...
	public:
		...
		TArray ScoreUpdateHistory; // 0x30(0x10)
	...
	public:
		...
		TArray ScoreChangeRecords; // 0x10(0x10)
		TArray Multipliers; // 0x20(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr SourceActor; // 0x0(0x8)
	...
	public:
		...
		unsigned char UnknownData05_6[0x2]; // 0x3A(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x17]; // 0x59(0x17) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray InstrumentsPlayed; // 0x10(0x10)
	};
	...
	public:
		...
		TMap PlayerAccountIdToDisplayNameMap; // 0x40(0x50)
	};
	...
	public:
		...
		FString SpotlightGroup; // 0x48(0x10)
		unsigned char UnknownData05_7[0x10]; // 0x58(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray SongShortNames; // 0x0(0x10)
	...
	public:
		...
		TArray Leaderboards; // 0x68(0x10)
		TArray FriendIds; // 0x78(0x10)
	...
	public:
		...
		TArray InstrumentsPlayed; // 0x18(0x10)
	...
	public:
		FName SongShortName; // 0x0(0x4)
		TWeakObjectPtr AddedByPlayer; // 0x4(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData09_6[0x4]; // 0x1C(0x4) UNKNOWN PROPERTY
		TMap BaseGemScoreValue; // 0x20(0x50)
		int32_t SustainScorePerBeat; // 0x70(0x4)
		bool bNormalizeScores; // 0x74(0x1)
		unsigned char UnknownData10_6[0x3]; // 0x75(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_6[0x4]; // 0xCC(0x4) UNKNOWN PROPERTY
		TArray ScoreMultiplierDefinitions; // 0xD0(0x10)
		TMap PlayerHealthModifiers; // 0xE0(0x50)
		TArray PilgrimHealthCrowdResponseTiers; // 0x130(0x10)
		TMap IndividualStarPercentageThresholds; // 0x140(0x50)
		TArray BandStarPercentageThresholds; // 0x190(0x10)
		...
		TArray BandOverdriveScoreMultipliers; // 0x1A8(0x10)
		TArray BandVarietyScoreMultipliers; // 0x1B8(0x10)
		TArray AccuracyTiers; // 0x1C8(0x10)
		...
		unsigned char UnknownData13_6[0x2]; // 0x1FE(0x2) UNKNOWN PROPERTY
		float GemBreakPendingBars; // 0x200(0x4)
		bool bEnableInputSpecificGemsAndSmashers; // 0x204(0x1)
		unsigned char UnknownData14_6[0x3]; // 0x205(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData15_6[0x3]; // 0x21D(0x3) UNKNOWN PROPERTY
		TMap DifficultyCaptureFactors; // 0x220(0x50)
		TMap PerInstrumentConfigs; // 0x270(0x50)
		TArray StreakToastThresholds; // 0x2C0(0x10)
		TMap InstrumentTypeMissCues; // 0x2D0(0x50)
		USoundCue DefaultInstrumentTypeMissCue; // 0x320(0x8)
		bool CreateStandinBandmembers; // 0x328(0x1)
		unsigned char UnknownData16_6[0x7]; // 0x329(0x7) UNKNOWN PROPERTY
		TArray SupportedDifficulties; // 0x330(0x10)
		float SongIntroEmbargoMs; // 0x340(0x4)
		unsigned char UnknownData17_7[0x4]; // 0x344(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x2]; // 0x22(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xF0]; // 0x40(0xF0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray TeamAccountIds; // 0x40(0x10)
		...
		TArray SessionHistory; // 0x70(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr RequestingPlayer; // 0x98(0x8)
	};
	...
	public:
		...
		TArray SongUIDs; // 0x30(0x10)
		TArray SongShortNames; // 0x40(0x10)
	...
	public:
		...
		TArray PCBeatmatchInputMappingContexts; // 0x10(0x10)
		TArray ConsoleBeatmatchInputMappingContexts; // 0x20(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr WeakLocalPlayer; // 0x8(0x8)
	};
	...
	{
	public:
		TWeakObjectPtr ChangedSetlist; // 0x0(0x8)
	};
	...
	{
	public:
		TSet TrackTypesInState; // 0x0(0x50)
		TSet TrackTypesNotInState; // 0x50(0x50)
	};
	...
	{
	public:
		TWeakObjectPtr UserController; // 0x0(0x8)
	...
	{
	public:
		unsigned char UnknownData01_2[0x1E8]; // 0x0(0x1E8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0x290]; // 0x0(0x290) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0x108]; // 0x0(0x108) UNKNOWN PROPERTY
	};
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_Base
	// Size: 0x14 (0x14 - 0x0)
	struct FPilgrimEvent_Midi_Base	
	{
	public:
		EPilgrimTrackType TrackType; // 0x0(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		int32_t AtMidiTick; // 0x4(0x4)
		int32_t EndsAtMidiTick; // 0x8(0x4)
		TWeakObjectPtr PilgrimGameContext; // 0xC(0x8)
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteBase
	// Inherited from FPilgrimEvent_Midi_Base
	// Size: 0x4 (0x18 - 0x14)
	struct FPilgrimEvent_Midi_NoteBase : public FPilgrimEvent_Midi_Base	
	{
	public:
		int32_t EventNote; // 0x14(0x4)
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteGuitar
	// Inherited from FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteGuitar_Start
	// Inherited from FPilgrimEvent_Midi_NoteGuitar -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteGuitar_Start : public FPilgrimEvent_Midi_NoteGuitar	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteGuitar_End
	// Inherited from FPilgrimEvent_Midi_NoteGuitar -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteGuitar_End : public FPilgrimEvent_Midi_NoteGuitar	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteBass
	// Inherited from FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteBass_Start
	// Inherited from FPilgrimEvent_Midi_NoteBass -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteBass_Start : public FPilgrimEvent_Midi_NoteBass	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteBass_End
	// Inherited from FPilgrimEvent_Midi_NoteBass -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteBass_End : public FPilgrimEvent_Midi_NoteBass	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteVocals
	// Inherited from FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteVocals_Start
	// Inherited from FPilgrimEvent_Midi_NoteVocals -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteVocals_Start : public FPilgrimEvent_Midi_NoteVocals	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteVocals_End
	// Inherited from FPilgrimEvent_Midi_NoteVocals -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteVocals_End : public FPilgrimEvent_Midi_NoteVocals	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteDrum
	// Inherited from FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteDrum_Start
	// Inherited from FPilgrimEvent_Midi_NoteDrum -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteDrum_Start : public FPilgrimEvent_Midi_NoteDrum	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteDrum_End
	// Inherited from FPilgrimEvent_Midi_NoteDrum -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteDrum_End : public FPilgrimEvent_Midi_NoteDrum	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteEvents
	// Inherited from FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteEvents_Start
	// Inherited from FPilgrimEvent_Midi_NoteEvents -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteEvents_Start : public FPilgrimEvent_Midi_NoteEvents	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NoteEvents_End
	// Inherited from FPilgrimEvent_Midi_NoteEvents -> FPilgrimEvent_Midi_NoteBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_NoteEvents_End : public FPilgrimEvent_Midi_NoteEvents	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextBase
	// Inherited from FPilgrimEvent_Midi_Base
	// Size: 0x24 (0x38 - 0x14)
	struct FPilgrimEvent_Midi_TextBase : public FPilgrimEvent_Midi_Base	
	{
	public:
		unsigned char UnknownData01_3[0x4]; // 0x14(0x4) UNKNOWN PROPERTY
		FString EventString; // 0x18(0x10)
		TArray EventPayload; // 0x28(0x10)
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextGuitar
	// Inherited from FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextGuitar_Start
	// Inherited from FPilgrimEvent_Midi_TextGuitar -> FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	struct FPilgrimEvent_Midi_TextGuitar_Start : public FPilgrimEvent_Midi_TextGuitar	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextBass
	// Inherited from FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextBass_Start
	// Inherited from FPilgrimEvent_Midi_TextBass -> FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	struct FPilgrimEvent_Midi_TextBass_Start : public FPilgrimEvent_Midi_TextBass	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextVocals
	// Inherited from FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextVocals_Start
	// Inherited from FPilgrimEvent_Midi_TextVocals -> FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	struct FPilgrimEvent_Midi_TextVocals_Start : public FPilgrimEvent_Midi_TextVocals	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextDrum
	// Inherited from FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextDrum_Start
	// Inherited from FPilgrimEvent_Midi_TextDrum -> FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	struct FPilgrimEvent_Midi_TextDrum_Start : public FPilgrimEvent_Midi_TextDrum	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextEvents
	// Inherited from FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_TextEvents_Start
	// Inherited from FPilgrimEvent_Midi_TextEvents -> FPilgrimEvent_Midi_TextBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x38 - 0x38)
	struct FPilgrimEvent_Midi_TextEvents_Start : public FPilgrimEvent_Midi_TextEvents	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeBase
	// Inherited from FPilgrimEvent_Midi_Base
	// Size: 0x4 (0x18 - 0x14)
	struct FPilgrimEvent_Midi_StrikeBase : public FPilgrimEvent_Midi_Base	
	{
	public:
		bool bIsChord; // 0x14(0x1)
		unsigned char UnknownData01_7[0x3]; // 0x15(0x3) UNKNOWN PROPERTY
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeGuitar
	// Inherited from FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeGuitar_Start
	// Inherited from FPilgrimEvent_Midi_StrikeGuitar -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeGuitar_Start : public FPilgrimEvent_Midi_StrikeGuitar	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeGuitar_End
	// Inherited from FPilgrimEvent_Midi_StrikeGuitar -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeGuitar_End : public FPilgrimEvent_Midi_StrikeGuitar	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeBass
	// Inherited from FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeBass_Start
	// Inherited from FPilgrimEvent_Midi_StrikeBass -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeBass_Start : public FPilgrimEvent_Midi_StrikeBass	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeBass_End
	// Inherited from FPilgrimEvent_Midi_StrikeBass -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeBass_End : public FPilgrimEvent_Midi_StrikeBass	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeVocals
	// Inherited from FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeVocals_Start
	// Inherited from FPilgrimEvent_Midi_StrikeVocals -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeVocals_Start : public FPilgrimEvent_Midi_StrikeVocals	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeVocals_End
	// Inherited from FPilgrimEvent_Midi_StrikeVocals -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeVocals_End : public FPilgrimEvent_Midi_StrikeVocals	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeDrum
	// Inherited from FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeDrum_Start
	// Inherited from FPilgrimEvent_Midi_StrikeDrum -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeDrum_Start : public FPilgrimEvent_Midi_StrikeDrum	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeDrum_End
	// Inherited from FPilgrimEvent_Midi_StrikeDrum -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeDrum_End : public FPilgrimEvent_Midi_StrikeDrum	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeEvents
	// Inherited from FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	...
	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeEvents_Start
	// Inherited from FPilgrimEvent_Midi_StrikeEvents -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeEvents_Start : public FPilgrimEvent_Midi_StrikeEvents	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_StrikeEvents_End
	// Inherited from FPilgrimEvent_Midi_StrikeEvents -> FPilgrimEvent_Midi_StrikeBase -> FPilgrimEvent_Midi_Base
	// Size: 0x0 (0x18 - 0x18)
	struct FPilgrimEvent_Midi_StrikeEvents_End : public FPilgrimEvent_Midi_StrikeEvents	
	{
	public:
	};


	// Struct PilgrimCoreRuntime.PilgrimEvent_Midi_NotifyBeginOutro
	// Size: 0x1 (0x1 - 0x0)
	...
	{
	public:
		TArray GemsInProgress; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr MusicBattleInstance; // 0x0(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x6]; // 0x1C2(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x1E5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData02_6[0x3]; // 0x245(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x1E1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x2]; // 0x21A(0x2) UNKNOWN PROPERTY
		FFloatRange RequiredOverdriveTime; // 0x21C(0x10)
		FFloatRange RequiredPercentPerfect; // 0x22C(0x10)
		unsigned char UnknownData07_7[0x4]; // 0x23C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap HistogramSamples; // 0x40(0x50)
		TArray AccuracyTierCounts; // 0x90(0x10)
	};
	...
	public:
		AFortPlayerState OwningPlayerState; // 0x0(0x8)
		TWeakObjectPtr SourceActor; // 0x8(0x8)
	...
	public:
		...
		TArray MultiplierSources; // 0x8(0x10)
	...
	public:
		...
		TArray ScoringModifiers; // 0x8(0x10)
	...
	public:
		UPilgrimScoringModifier ScoringModifier; // 0x0(0x8)
		TArray RemainingScoringModifiers; // 0x8(0x10)
		EPilgrimScoringTarget Target; // 0x18(0x1)
		unsigned char UnknownData01_7[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_6[0x2]; // 0x12A(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x5]; // 0x133(0x5) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_2[0x208]; // 0x0(0x208) UNKNOWN PROPERTY
	};
