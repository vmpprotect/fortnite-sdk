...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte<EFormatArgumentType> ArgumentValueType; // 0x10(0x1)
	...
	public:
		...
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x58(0x8)
	...
	public:
		...
		TArray<int32_t> Children; // 0xB0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_5[0x2]; // 0xAE(0x2) UNKNOWN PROPERTY
		TWeakObjectPtr<UPhysicalMaterial*> PhysMaterial; // 0xB0(0x8)
		FActorInstanceHandle HitObjectHandle; // 0xB8(0x20)
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0xD8(0x8)
	...
	{
	public:
		TWeakObjectPtr<UObject*> ReferenceObject; // 0x0(0x8)
	...
	public:
		...
		TEnumAsByte<EPlatformInterfaceDataType> Type; // 0x4(0x1)
	...
	public:
		...
		TEnumAsByte<ETickingGroup> TickGroup; // 0x8(0x1)
		TEnumAsByte<ETickingGroup> EndTickGroup; // 0x9(0x1)
		...
		unsigned char UnknownData01_5[0x1]; // 0xB(0x1) UNKNOWN PROPERTY
		float TickInterval; // 0xC(0x4)
		unsigned char UnknownData02_7[0x18]; // 0x10(0x18) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> OtherActor; // 0x20(0x20)
	};
	...
	{
	public:
		TWeakObjectPtr<AActor*> OtherActor; // 0x20(0x8)
	};
	...
	{
	public:
		TEnumAsByte<EWalkableSlopeBehavior> WalkableSlopeBehavior; // 0x0(0x1)
	...
	{
	public:
		unsigned char UnknownData00_3[0x6]; // 0xC(0x6) UNKNOWN PROPERTY
		char PositionSolverIterationCount; // 0x12(0x1)
		char VelocitySolverIterationCount; // 0x13(0x1)
		TEnumAsByte<ECollisionChannel> ObjectType; // 0x14(0x1)
		unsigned char UnknownData01_6[0x1]; // 0x15(0x1) UNKNOWN PROPERTY
		TEnumAsByte<ECollisionEnabled> CollisionEnabled; // 0x16(0x1)
		unsigned char UnknownData02_6[0x22]; // 0x17(0x22) UNKNOWN PROPERTY
		ESleepFamily SleepFamily; // 0x39(0x1)
		TEnumAsByte<EDOFMode> DOFMode; // 0x3A(0x1)
		bool bUseCCD : 1; // 0x3B:0(0x1)
		unsigned char UnknownBit03 : 1; // 0x3B:1(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit04 : 1; // 0x3B:2(0x1) UNKNOWN PROPERTY
		bool bUseMACD : 1; // 0x3B:3(0x1)
		bool bIgnoreAnalyticCollisions : 1; // 0x3B:4(0x1)
		bool bNotifyRigidBodyCollision : 1; // 0x3B:5(0x1)
		unsigned char UnknownBit05 : 1; // 0x3B:6(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownBit06 : 1; // 0x3D:1(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit07 : 1; // 0x3D:2(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownBit08 : 1; // 0x3D:6(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_6[0x4]; // 0xDC(0x4) UNKNOWN PROPERTY
		FVector InertiaTensorScale; // 0xE0(0x18)
		unsigned char UnknownData13_6[0x10]; // 0xF8(0x10) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_7[0x40]; // 0x130(0x40) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FResponseChannel> ResponseArray; // 0x20(0x10)
	};
	...
	public:
		...
		TEnumAsByte<ECollisionResponse> Response; // 0x4(0x1)
	...
	{
	public:
		TEnumAsByte<ECollisionResponse> WorldStatic; // 0x0(0x1)
		TEnumAsByte<ECollisionResponse> WorldDynamic; // 0x1(0x1)
		TEnumAsByte<ECollisionResponse> Pawn; // 0x2(0x1)
		TEnumAsByte<ECollisionResponse> Visibility; // 0x3(0x1)
		TEnumAsByte<ECollisionResponse> Camera; // 0x4(0x1)
		TEnumAsByte<ECollisionResponse> PhysicsBody; // 0x5(0x1)
		TEnumAsByte<ECollisionResponse> Vehicle; // 0x6(0x1)
		TEnumAsByte<ECollisionResponse> Destructible; // 0x7(0x1)
		TEnumAsByte<ECollisionResponse> EngineTraceChannel1; // 0x8(0x1)
		TEnumAsByte<ECollisionResponse> EngineTraceChannel2; // 0x9(0x1)
		TEnumAsByte<ECollisionResponse> EngineTraceChannel3; // 0xA(0x1)
		TEnumAsByte<ECollisionResponse> EngineTraceChannel4; // 0xB(0x1)
		TEnumAsByte<ECollisionResponse> EngineTraceChannel5; // 0xC(0x1)
		TEnumAsByte<ECollisionResponse> EngineTraceChannel6; // 0xD(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel1; // 0xE(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel2; // 0xF(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel3; // 0x10(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel4; // 0x11(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel5; // 0x12(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel6; // 0x13(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel7; // 0x14(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel8; // 0x15(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel9; // 0x16(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel10; // 0x17(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel11; // 0x18(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel12; // 0x19(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel13; // 0x1A(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel14; // 0x1B(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel15; // 0x1C(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel16; // 0x1D(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel17; // 0x1E(0x1)
		TEnumAsByte<ECollisionResponse> GameTraceChannel18; // 0x1F(0x1)
	};
	...
	public:
		...
		TArray<char> ReplicationBytes; // 0x20(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EViewTargetBlendFunction> BlendFunction; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TSet<FInputDevicePropertyHandle> ActiveDeviceProperties; // 0x20(0x50)
	};
	...
	public:
		...
		TEnumAsByte<ERichCurveExtrapolation> PreInfinityExtrap; // 0x6C(0x1)
		TEnumAsByte<ERichCurveExtrapolation> PostInfinityExtrap; // 0x6D(0x1)
	...
	{
	public:
		TArray<FRichCurveKey> Keys; // 0x70(0x10)
	};
	...
	{
	public:
		TEnumAsByte<ERichCurveInterpMode> InterpMode; // 0x0(0x1)
		TEnumAsByte<ERichCurveTangentMode> TangentMode; // 0x1(0x1)
		TEnumAsByte<ERichCurveTangentWeightMode> TangentWeightMode; // 0x2(0x1)
	...
	public:
		...
		unsigned char UnknownData00_7[0x2]; // 0x2E(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ESplinePointType> Type; // 0x80(0x1)
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x14(0x4) UNKNOWN PROPERTY
		TMap<int32_t, int32_t> PerQuality; // 0x18(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x4]; // 0x14(0x4) UNKNOWN PROPERTY
		TMap<int32_t, float> PerQuality; // 0x18(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x18]; // 0xC(0x18) UNKNOWN PROPERTY
		EAlphaBlendOption BlendOption; // 0x24(0x1)
		unsigned char UnknownData01_7[0xB]; // 0x25(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x8]; // 0x4(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x10]; // 0x28(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FBranchFilter> BranchFilters; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FTransform> LocalTransforms; // 0x0(0x10)
	...
	{
	public:
		unsigned char UnknownData00_7[0x6D0]; // 0x0(0x6D0) UNKNOWN PROPERTY
		TMap<FName, FInertializationRequest> SlotGroupInertializationRequestDataMap; // 0x6D0(0x50)
		unsigned char UnknownData01_7[0x78]; // 0x720(0x78) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_7[0x60]; // 0x0(0x60) UNKNOWN PROPERTY
	...
	public:
		FName Name; // 0x0(0x4)
		TEnumAsByte<EMaterialParameterAssociation> Association; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TArray<char> SavedProperties; // 0x8(0x10)
		FDataCacheDuplicatedObjectData UniqueTransientPackage; // 0x18(0x10)
		TArray<FDataCacheDuplicatedObjectData> DuplicatedObjects; // 0x28(0x10)
		TArray<UObject*> ReferencedObjects; // 0x38(0x10)
		TArray<FName> ReferencedNames; // 0x48(0x10)
	};
	...
	{
	public:
		TMap<USceneComponent*, FTransform> AttachedInstanceComponents; // 0x68(0x50)
	};
	...
	{
	public:
		TArray<FKSphereElem> SphereElems; // 0x0(0x10)
		TArray<FKBoxElem> BoxElems; // 0x10(0x10)
		TArray<FKSphylElem> SphylElems; // 0x20(0x10)
		TArray<FKConvexElem> ConvexElems; // 0x30(0x10)
		TArray<FKTaperedCapsuleElem> TaperedCapsuleElems; // 0x40(0x10)
		TArray<FKLevelSetElem> LevelSetElems; // 0x50(0x10)
		TArray<FKSkinnedLevelSetElem> SkinnedLevelSetElems; // 0x60(0x10)
	...
	public:
		...
		FName Name; // 0xC(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x10(0x4) UNKNOWN PROPERTY
		bool bContributeToMass : 1; // 0x14:0(0x1)
		TEnumAsByte<ECollisionEnabled> CollisionEnabled; // 0x15(0x1)
		unsigned char UnknownData02_7[0x12]; // 0x16(0x12) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FVector> VertexData; // 0x28(0x10)
		TArray<int32_t> IndexData; // 0x38(0x10)
		FBox ElemBox; // 0x48(0x38)
		FTransform Transform; // 0x80(0x60)
		unsigned char UnknownData00_7[0x10]; // 0xE0(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FBoneReference> LinkedBones; // 0x0(0x10)
	...
	{
	public:
		TArray<FFloatCurve> FloatCurves; // 0x0(0x10)
	};
	...
	{
	public:
		TScriptInterface<Class> AnimClassInterface; // 0x0(0x10)
	...
	{
	public:
		TEnumAsByte<EAdditiveAnimationType> AdditiveType; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		float Weight; // 0x4(0x4)
		unsigned char UnknownData01_7[0x78]; // 0x8(0x78) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<UBlendSpace*> BlendSpaces; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FPerBoneBlendWeight> BoneBlendWeights; // 0x0(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EAnimLinkMethod> LinkMethod; // 0x18(0x1)
		TEnumAsByte<EAnimLinkMethod> CachedLinkMethod; // 0x19(0x1)
	...
	public:
		...
		TEnumAsByte<EMontageNotifyTickType> MontageTickType; // 0x89(0x1)
		unsigned char UnknownData01_6[0x2]; // 0x8A(0x2) UNKNOWN PROPERTY
		float NotifyTriggerChance; // 0x8C(0x4)
		TEnumAsByte<ENotifyFilterType> NotifyFilterType; // 0x90(0x1)
		...
		unsigned char UnknownData04_7[0x8]; // 0xA0(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x24]; // 0x14(0x24) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FAnimSyncMarker> AuthoredSyncMarkers; // 0x0(0x10)
	...
	{
	public:
		TArray<FVector3f> PosKeys; // 0x0(0x10)
		TArray<FQuat4f> RotKeys; // 0x10(0x10)
		TArray<FVector3f> ScaleKeys; // 0x20(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EFilterInterpolationType> InterpolationType; // 0xC(0x1)
		unsigned char UnknownData00_7[0x3]; // 0xD(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FBlendSpaceSegment> Segments; // 0x0(0x10)
		TArray<FBlendSpaceTriangle> Triangles; // 0x10(0x10)
	};
	...
	public:
		...
		TEnumAsByte<ELifetimeCondition> ReplicationCondition; // 0x8C(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x8D(0x3) UNKNOWN PROPERTY
		TArray<FBPVariableMetaDataEntry> MetaDataArray; // 0x90(0x10)
	...
	public:
		...
		TWeakObjectPtr<UObject*> PinSubCategoryObject; // 0x8(0x8)
		...
		unsigned char UnknownData00_7[0x2]; // 0x46(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> TerminalSubCategoryObject; // 0x8(0x8)
		bool bTerminalIsConst; // 0x10(0x1)
		bool bTerminalIsWeakPointer; // 0x11(0x1)
		bool bTerminalIsUObjectWrapper; // 0x12(0x1)
		unsigned char UnknownData00_7[0x1]; // 0x13(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<UEdGraph*> Graphs; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x60(0x8) UNKNOWN PROPERTY
		...
		TEnumAsByte<ECameraProjectionMode> ProjectionMode; // 0x6C(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x6D(0x3) UNKNOWN PROPERTY
		float PostProcessBlendWeight; // 0x70(0x4)
		unsigned char UnknownData05_6[0xC]; // 0x74(0xC) UNKNOWN PROPERTY
		FPostProcessSettings PostProcessSettings; // 0x80(0x6F0)
		FVector2D OffCenterProjectionOffset; // 0x770(0x10)
		unsigned char UnknownData06_7[0x90]; // 0x780(0x90) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownBit00 : 1; // 0xF:7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_3[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_3[0x1]; // 0x1B(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownBit03 : 1; // 0x1F:0(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit04 : 1; // 0x1F:1(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit05 : 1; // 0x1F:2(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit06 : 1; // 0x1F:3(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit07 : 1; // 0x1F:4(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit08 : 1; // 0x1F:5(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit09 : 1; // 0x1F:6(0x1) UNKNOWN PROPERTY
		unsigned char UnknownBit10 : 1; // 0x1F:7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_3[0x3]; // 0x21(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_3[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
		bool bOverride_LumenSurfaceCacheResolution : 1; // 0x28:0(0x1)
		unsigned char UnknownData13_3[0x3]; // 0x29(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_3[0x1]; // 0x2F(0x1) UNKNOWN PROPERTY
		bool bMobileHQGaussian : 1; // 0x30:0(0x1)
		TEnumAsByte<EBloomMethod> BloomMethod; // 0x31(0x1)
		TEnumAsByte<EAutoExposureMethod> AutoExposureMethod; // 0x32(0x1)
		TEnumAsByte<ETemperatureMethod> TemperatureType; // 0x33(0x1)
		float WhiteTemp; // 0x34(0x4)
		float WhiteTint; // 0x38(0x4)
		unsigned char UnknownData15_6[0x4]; // 0x3C(0x4) UNKNOWN PROPERTY
		...
		TEnumAsByte<EDynamicGlobalIlluminationMethod> DynamicGlobalIlluminationMethod; // 0x3D4(0x1)
		unsigned char UnknownData16_6[0x3]; // 0x3D5(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData17_6[0x3]; // 0x3ED(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData18_5[0x3]; // 0x409(0x3) UNKNOWN PROPERTY
		...
		TEnumAsByte<EReflectionMethod> ReflectionMethod; // 0x420(0x1)
		EReflectionsType ReflectionsType; // 0x421(0x1)
		unsigned char UnknownData19_6[0x2]; // 0x422(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData20_5[0x3]; // 0x429(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData21_3[0x3]; // 0x47D(0x3) UNKNOWN PROPERTY
		bool AutoExposureApplyPhysicalCameraExposure : 1; // 0x480:0(0x1)
		unsigned char UnknownData22_5[0x7]; // 0x481(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData23_6[0x4]; // 0x50C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData24_5[0x3]; // 0x5DD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData25_5[0x3]; // 0x609(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData26_6[0x4]; // 0x61C(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData27_5[0x3]; // 0x63D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData28_6[0x3]; // 0x6A9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData29_5[0x2]; // 0x6BA(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData30_5[0x2]; // 0x6CA(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData31_6[0x4]; // 0x6DC(0x4) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FWeightedBlendable> Array; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray<FName> DataLayers; // 0x8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UEdGraphNode*> OwningNode; // 0x0(0x8)
	...
	public:
		...
		TArray<FString> MenuDescriptionArray; // 0x50(0x10)
		TArray<FString> FullSearchTitlesArray; // 0x60(0x10)
		TArray<FString> FullSearchKeywordsArray; // 0x70(0x10)
		TArray<FString> FullSearchCategoryArray; // 0x80(0x10)
		TArray<FString> LocalizedMenuDescriptionArray; // 0x90(0x10)
		TArray<FString> LocalizedFullSearchTitlesArray; // 0xA0(0x10)
		TArray<FString> LocalizedFullSearchKeywordsArray; // 0xB0(0x10)
		TArray<FString> LocalizedFullSearchCategoryArray; // 0xC0(0x10)
	...
	{
	public:
		TEnumAsByte<EFullyLoadPackageType> FullyLoadType; // 0x0(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		FString Tag; // 0x8(0x10)
		TArray<FName> PackagesToLoad; // 0x18(0x10)
		TArray<UObject*> LoadedObjects; // 0x28(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FFullyLoadedPackagesInfo> PackagesToFullyLoad; // 0x190(0x10)
		unsigned char UnknownData01_6[0x10]; // 0x1A0(0x10) UNKNOWN PROPERTY
		TArray<ULevel*> LoadedLevelsForPendingMapChange; // 0x1B0(0x10)
		unsigned char UnknownData02_6[0x18]; // 0x1C0(0x18) UNKNOWN PROPERTY
		TArray<UObjectReferencer*> ObjectReferencers; // 0x1D8(0x10)
		TArray<FLevelStreamingStatus> PendingLevelStreamingStatusUpdates; // 0x1E8(0x10)
		UGameViewportClient* GameViewport; // 0x1F8(0x8)
		UGameInstance* OwningGameInstance; // 0x200(0x8)
		TArray<FNamedNetDriver> ActiveNetDrivers; // 0x208(0x10)
		unsigned char UnknownData03_7[0xA8]; // 0x218(0xA8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FStatColorMapEntry> ColorMap; // 0x10(0x10)
	...
	{
	public:
		TArray<FRigidBodyContactInfo> ContactInfos; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData01_5[0x2]; // 0xA(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_7[0x1]; // 0x0(0x1) UNKNOWN PROPERTY
		...
		TArray<float> BaseVisibleDistanceFactorThesholds; // 0x20(0x10)
		TMap<int32_t, int32_t> LODToFrameSkipMap; // 0x30(0x50)
	...
	public:
		...
		unsigned char UnknownData00_5[0x2]; // 0x2(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FMeshDisplacementMap> DisplacementMaps; // 0x30(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x3]; // 0x15(0x3) UNKNOWN PROPERTY
		TEnumAsByte<EFontImportCharacterSet> CharacterSet; // 0x18(0x1)
		...
		unsigned char UnknownData03_5[0x3]; // 0x75(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_5[0x3]; // 0x99(0x3) UNKNOWN PROPERTY
		int32_t Kerning; // 0x9C(0x4)
		bool bUseDistanceFieldAlpha : 1; // 0xA0:0(0x1)
		unsigned char UnknownData05_5[0x3]; // 0xA1(0x3) UNKNOWN PROPERTY
		int32_t DistanceFieldScaleFactor; // 0xA4(0x4)
		float DistanceFieldScanRadiusScale; // 0xA8(0x4)
		unsigned char UnknownData06_7[0x4]; // 0xAC(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAttenuationShape> AttenuationShape; // 0x9(0x1)
	...
	public:
		...
		TEnumAsByte<ECollisionChannel> TraceChannel; // 0x3D(0x1)
		unsigned char UnknownData01_6[0x2]; // 0x3E(0x2) UNKNOWN PROPERTY
		TArray<TEnumAsByte> ObjectTypes; // 0x40(0x10)
		TArray<AActor*> ActorsToIgnore; // 0x50(0x10)
		float SimFrequency; // 0x60(0x4)
		float OverrideGravityZ; // 0x64(0x4)
		TEnumAsByte<EDrawDebugTrace> DrawDebugType; // 0x68(0x1)
	...
	{
	public:
		TArray<FPredictProjectilePathPointData> PathData; // 0x0(0x10)
	...
	public:
		...
		TEnumAsByte<EComponentMobility> Mobility; // 0x18(0x1)
		...
		TEnumAsByte<EHasCustomNavigableGeometry> bHasCustomNavigableGeometry; // 0x21(0x1)
		...
		TEnumAsByte<EDetailMode> DetailMode; // 0x1BD(0x1)
		unsigned char UnknownData03_7[0x2]; // 0x1BE(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<UMaterialInterface*> OverrideMaterials; // 0x1C8(0x10)
		UMaterialInterface* OverlayMaterial; // 0x1D8(0x8)
		TArray<URuntimeVirtualTexture*> RuntimeVirtualTextures; // 0x1E0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4]; // 0x34C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_6[0x1]; // 0x2F(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_6[0x3]; // 0x4D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x2]; // 0x62(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData10_6[0x2]; // 0x6E(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_7[0x3]; // 0x125(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<ETextureSizingType> TextureSizingType; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		...
		TEnumAsByte<EMaterialMergeType> MaterialMergeType; // 0x40(0x1)
		TEnumAsByte<EBlendMode> BlendMode; // 0x41(0x1)
	...
	public:
		...
		unsigned char UnknownData02_5[0x2]; // 0xBE(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<EProxyNormalComputationMethod> NormalCalculationMethod; // 0xBC(0x1)
		TEnumAsByte<ELandscapeCullingPrecision> LandscapeCullingPrecision; // 0xBD(0x1)
	...
	public:
		TArray<FFloatCurve> FloatCurves; // 0x0(0x10)
		TArray<FTransformCurve> TransformCurves; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<FAttributeKey> Keys; // 0x68(0x10)
	...
	public:
		float Time; // 0x0(0x4)
		unsigned char UnknownData00_7[0x14]; // 0x4(0x14) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FGuid> MapBuildDataIds; // 0x60(0x10)
	};
	...
	public:
		...
		TArray<FInstancedStaticMeshInstanceData> PerInstanceSMData; // 0x130(0x10)
		unsigned char UnknownData00_6[0x20]; // 0x140(0x20) UNKNOWN PROPERTY
		int32_t InstancingRandomSeed; // 0x160(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x164(0x4) UNKNOWN PROPERTY
		TArray<FInstancedStaticMeshRandomSeed> AdditionalRandomSeeds; // 0x168(0x10)
	...
	{
	public:
		TArray<UMaterialExpression*> Expressions; // 0x0(0x10)
		TArray<UMaterialExpressionComment*> EditorComments; // 0x10(0x10)
	...
	public:
		FName OutputName; // 0x0(0x4)
		TEnumAsByte<ECustomMaterialOutputType> OutputType; // 0x4(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		FName InputName; // 0x0(0x4)
		TEnumAsByte<EDataDrivenShaderPlatformInfoCondition> PropertyCondition; // 0x4(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EBlendMode> BlendMode; // 0x3(0x1)
		TEnumAsByte<EMaterialShadingModel> ShadingModel; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<bool> LayerStates; // 0x0(0x10)
		TArray<FText> LayerNames; // 0x10(0x10)
		TArray<bool> RestrictToLayerRelatives; // 0x20(0x10)
		TArray<bool> RestrictToBlendRelatives; // 0x30(0x10)
		TArray<FGuid> LayerGuids; // 0x40(0x10)
		TArray<EMaterialLayerLinkState> LayerLinkStates; // 0x50(0x10)
		TArray<FGuid> DeletedParentLayerGuids; // 0x60(0x10)
	};
	...
	{
	public:
		TArray<UMaterialFunctionInterface*> Layers; // 0x0(0x10)
		TArray<UMaterialFunctionInterface*> Blends; // 0x10(0x10)
	...
	public:
		...
		TArray<bool> LayerStates; // 0xB8(0x10)
		TArray<FText> LayerNames; // 0xC8(0x10)
		TArray<bool> RestrictToLayerRelatives; // 0xD8(0x10)
		TArray<bool> RestrictToBlendRelatives; // 0xE8(0x10)
		TArray<FGuid> LayerGuids; // 0xF8(0x10)
		TArray<EMaterialLayerLinkState> LayerLinkStates; // 0x108(0x10)
		TArray<FGuid> DeletedParentLayerGuids; // 0x118(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FName> LinkedStatNames; // 0x8(0x10)
		int32_t PrimitiveBudget; // 0x18(0x4)
		int32_t Collection; // 0x1C(0x4)
		TArray<FName> Passes; // 0x20(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EMeshFeatureImportance> SilhouetteImportance; // 0x24(0x1)
		TEnumAsByte<EMeshFeatureImportance> TextureImportance; // 0x25(0x1)
		TEnumAsByte<EMeshFeatureImportance> ShadingImportance; // 0x26(0x1)
		...
		TEnumAsByte<EMeshFeatureImportance> VisibilityAggressiveness; // 0x29(0x1)
		TEnumAsByte<EMeshFeatureImportance> VertexColorImportance; // 0x2A(0x1)
		unsigned char UnknownData00_7[0x1]; // 0x2B(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x2]; // 0x2(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_5[0x2]; // 0x26(0x2) UNKNOWN PROPERTY
		TEnumAsByte<ENavLinkDirection> Direction; // 0x28(0x1)
		...
		unsigned char UnknownData02_5[0x5]; // 0x2B(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_5[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_5[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_5[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
		bool bCorrectConnectedBodiesFriction; // 0x1C(0x1)
		unsigned char UnknownData06_7[0x3]; // 0x1D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData16_5[0x3]; // 0x69(0x3) UNKNOWN PROPERTY
		bool bPostResimWaitForUpdate; // 0x6C(0x1)
		unsigned char UnknownData17_6[0x3]; // 0x6D(0x3) UNKNOWN PROPERTY
		bool bOverrideCorrectConnectedBodies : 1; // 0x70:0(0x1)
		unsigned char UnknownData18_5[0x3]; // 0x71(0x3) UNKNOWN PROPERTY
		bool bCorrectConnectedBodies; // 0x74(0x1)
		unsigned char UnknownData19_6[0x3]; // 0x75(0x3) UNKNOWN PROPERTY
		bool bOverrideCorrectConnectedBodiesFriction : 1; // 0x78:0(0x1)
		unsigned char UnknownData20_5[0x3]; // 0x79(0x3) UNKNOWN PROPERTY
		bool bCorrectConnectedBodiesFriction; // 0x7C(0x1)
		unsigned char UnknownData21_7[0x3]; // 0x7D(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData06_6[0x3]; // 0x1D(0x3) UNKNOWN PROPERTY
		bool bOverridePosStabilityMultiplier : 1; // 0x20:0(0x1)
		unsigned char UnknownData07_5[0x3]; // 0x21(0x3) UNKNOWN PROPERTY
		float PosStabilityMultiplier; // 0x24(0x4)
		bool bOverrideRotStabilityMultiplier : 1; // 0x28:0(0x1)
		unsigned char UnknownData08_5[0x3]; // 0x29(0x3) UNKNOWN PROPERTY
		float RotStabilityMultiplier; // 0x2C(0x4)
		bool bOverrideVelStabilityMultiplier : 1; // 0x30:0(0x1)
		unsigned char UnknownData09_5[0x3]; // 0x31(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData04_5[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_5[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
		bool bCompareInputToTriggerRewind; // 0x1C(0x1)
		unsigned char UnknownData07_6[0x3]; // 0x1D(0x3) UNKNOWN PROPERTY
		bool bOverrideEnableUnreliableFlow : 1; // 0x20:0(0x1)
		unsigned char UnknownData08_5[0x3]; // 0x21(0x3) UNKNOWN PROPERTY
		bool bEnableUnreliableFlow; // 0x24(0x1)
		unsigned char UnknownData09_6[0x3]; // 0x25(0x3) UNKNOWN PROPERTY
		bool bOverrideEnableReliableFlow : 1; // 0x28:0(0x1)
		unsigned char UnknownData10_5[0x3]; // 0x29(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData12_5[0x3]; // 0x31(0x3) UNKNOWN PROPERTY
		bool bApplyDataInsteadOfMergeData; // 0x34(0x1)
		unsigned char UnknownData13_6[0x3]; // 0x35(0x3) UNKNOWN PROPERTY
		bool bOverrideAllowInputExtrapolation : 1; // 0x38:0(0x1)
		unsigned char UnknownData14_5[0x3]; // 0x39(0x3) UNKNOWN PROPERTY
		bool bAllowInputExtrapolation; // 0x3C(0x1)
		unsigned char UnknownData15_6[0x3]; // 0x3D(0x3) UNKNOWN PROPERTY
		bool bOverrideValidateDataOnGameThread : 1; // 0x40:0(0x1)
		unsigned char UnknownData16_5[0x3]; // 0x41(0x3) UNKNOWN PROPERTY
		bool bValidateDataOnGameThread; // 0x44(0x1)
		unsigned char UnknownData17_7[0x3]; // 0x45(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UPrimitiveComponent*> Component; // 0x20(0x8)
		unsigned char UnknownData00_6[0x18]; // 0x28(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_5[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TArray<int32_t> RandomSeeds; // 0x8(0x10)
	};
	...
	{
	public:
		TEnumAsByte<EParticleEventType> Type; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_5[0x3]; // 0xD(0x3) UNKNOWN PROPERTY
		FName CustomName; // 0x10(0x4)
		unsigned char UnknownData02_6[0x4]; // 0x14(0x4) UNKNOWN PROPERTY
		TArray<UParticleModuleEventSendToGame*> ParticleModuleEventsToSendToGame; // 0x18(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TEnumAsByte<EEmitterDynamicParameterValue> ValueMethod; // 0x8(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
		bool bScaleVelocityByParamValue : 1; // 0xC:0(0x1)
		unsigned char UnknownData02_5[0x3]; // 0xD(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0xF]; // 0xC1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<UParticleModule*> SpawnModules; // 0x18(0x10)
		...
		TEnumAsByte<EParticleScreenAlignment> ScreenAlignment; // 0x204(0x1)
		TEnumAsByte<EParticleAxisLock> LockAxisFlag; // 0x205(0x1)
		unsigned char UnknownData02_6[0x2]; // 0x206(0x2) UNKNOWN PROPERTY
		bool bEnableCollision : 1; // 0x208:0(0x1)
		unsigned char UnknownData03_5[0x3]; // 0x209(0x3) UNKNOWN PROPERTY
		TEnumAsByte<EParticleCollisionMode> CollisionMode; // 0x20C(0x1)
		unsigned char UnknownData04_6[0x3]; // 0x20D(0x3) UNKNOWN PROPERTY
		bool bUseVelocityForMotionBlur : 1; // 0x210:0(0x1)
		bool bRemoveHMDRoll : 1; // 0x210:1(0x1)
		unsigned char UnknownData05_5[0x3]; // 0x211(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_7[0x10]; // 0x340(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FColor> QuantizedColorSamples; // 0x0(0x10)
		TArray<FColor> QuantizedMiscSamples; // 0x10(0x10)
		TArray<FColor> QuantizedSimulationAttrSamples; // 0x20(0x10)
		...
		TEnumAsByte<EParticleScreenAlignment> ScreenAlignment; // 0x218(0x1)
		TEnumAsByte<EParticleAxisLock> LockAxisFlag; // 0x219(0x1)
		unsigned char UnknownData00_6[0x6]; // 0x21A(0x6) UNKNOWN PROPERTY
		FVector2D PivotOffset; // 0x220(0x10)
		bool bUseVelocityForMotionBlur : 1; // 0x230:0(0x1)
		bool bRemoveHMDRoll : 1; // 0x230:1(0x1)
		unsigned char UnknownData01_5[0x3]; // 0x231(0x3) UNKNOWN PROPERTY
		float MinFacingCameraBlendDistance; // 0x234(0x4)
		float MaxFacingCameraBlendDistance; // 0x238(0x4)
		unsigned char UnknownData02_7[0x4]; // 0x23C(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		FName Name; // 0x0(0x4)
		TEnumAsByte<EParticleSysParamType> ParamType; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x88]; // 0x58(0x88) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAttachLocation> LocationType; // 0x64(0x1)
	...
	public:
		FSoftObjectPath Path; // 0x0(0x18)
		TWeakObjectPtr<AActor*> TypedPtr; // 0x18(0x20)
	};
	...
	{
	public:
		TArray<FDelegateProperty> Delegates; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x8]; // 0x828(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EBloomMethod> Method; // 0xB8(0x1)
	...
	{
	public:
		TEnumAsByte<EAutoExposureMethod> Method; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TEnumAsByte<SkeletalMeshTerminationCriterion> TerminationCriterion; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		...
		TEnumAsByte<SkeletalMeshOptimizationType> ReductionMethod; // 0x18(0x1)
		TEnumAsByte<SkeletalMeshOptimizationImportance> SilhouetteImportance; // 0x19(0x1)
		TEnumAsByte<SkeletalMeshOptimizationImportance> TextureImportance; // 0x1A(0x1)
		TEnumAsByte<SkeletalMeshOptimizationImportance> ShadingImportance; // 0x1B(0x1)
		TEnumAsByte<SkeletalMeshOptimizationImportance> SkinningImportance; // 0x1C(0x1)
		bool bRemapMorphTargets : 1; // 0x1D:0(0x1)
		bool bRecalcNormals : 1; // 0x1D:1(0x1)
		unsigned char UnknownData01_5[0x2]; // 0x1E(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData03_5[0x3]; // 0x35(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FName> CachedSkinWeightProfileNames; // 0x40(0x10)
		TArray<FName> CachedMorphTargetNames; // 0x50(0x10)
	};
	...
	{
	public:
		TArray<UMeshDeformerInstance*> DeformerInstances; // 0x0(0x10)
		unsigned char UnknownData00_7[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xA4]; // 0xDC(0xA4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UWorld*> WorldAsset; // 0x0(0x20)
	};
	...
	{
	public:
		TArray<USpatializationPluginSourceSettingsBase*> SpatializationPluginSettingsArray; // 0x0(0x10)
		TArray<UOcclusionPluginSourceSettingsBase*> OcclusionPluginSettingsArray; // 0x10(0x10)
		TArray<UReverbPluginSourceSettingsBase*> ReverbPluginSettingsArray; // 0x20(0x10)
		TArray<USourceDataOverridePluginSourceSettingsBase*> SourceDataOverridePluginSettingsArray; // 0x30(0x10)
	};
	...
	public:
		...
		TEnumAsByte<ESoundSpatializationAlgorithm> SpatializationAlgorithm; // 0xC2(0x1)
		unsigned char UnknownData00_6[0x5]; // 0xC3(0x5) UNKNOWN PROPERTY
		...
		TEnumAsByte<ECollisionChannel> OcclusionTraceChannel; // 0x1E9(0x1)
		...
		unsigned char UnknownData02_6[0x3]; // 0x1F5(0x3) UNKNOWN PROPERTY
		...
		TArray<FAttenuationSubmixSendSettings> SubmixSendSettings; // 0x2F8(0x10)
	...
	{
	public:
		TEnumAsByte<ESoundGroup> SoundGroup; // 0x0(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		FString DisplayName; // 0x8(0x10)
		bool bAlwaysDecompressOnLoad : 1; // 0x18:0(0x1)
		unsigned char UnknownData01_5[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<ModulationParamMode> ParamMode; // 0x18(0x1)
	...
	{
	public:
		TArray<FSoundWaveSpectralData> SpectralData; // 0x0(0x10)
	...
	{
	public:
		TArray<FSoundWaveSpectralDataEntry> Data; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData01_7[0x2]; // 0x2A(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FStaticSwitchParameter> StaticSwitchParameters; // 0x0(0x10)
	...
	public:
		TArray<FStaticSwitchParameter> StaticSwitchParameters; // 0x0(0x10)
		TArray<FStaticComponentMaskParameter> StaticComponentMaskParameters; // 0x10(0x10)
		TArray<FStaticTerrainLayerWeightParameter> TerrainLayerWeightParameters; // 0x20(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x94(0x4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x1C]; // 0x1C(0x1C) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<ETimelineLengthMode> LengthMode; // 0x0(0x1)
		...
		TArray<FTimelineEventEntry> Events; // 0x10(0x10)
		TArray<FTimelineVectorTrack> InterpVectors; // 0x20(0x10)
		TArray<FTimelineFloatTrack> InterpFloats; // 0x30(0x10)
		TArray<FTimelineLinearColorTrack> InterpLinearColors; // 0x40(0x10)
		FDelegateProperty TimelinePostUpdateFunc; // 0x50(0xC)
		FDelegateProperty TimelineFinishedFunc; // 0x5C(0xC)
		TWeakObjectPtr<UObject*> PropertySetObject; // 0x68(0x8)
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x54(0x4) UNKNOWN PROPERTY
		TArray<FVolumetricLightMapGridCell> Cells; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<FGuid> ContainerGuids; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<FName, FWorldPartitionRuntimeContainerInstance> ContainerInstances; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FWorldPartitionRuntimeContainer> Containers; // 0x0(0x50)
	...
	public:
		...
		TArray<UWorldPartitionRuntimeCell*> SpatiallyLoadedCells; // 0x8(0x10)
		TArray<UWorldPartitionRuntimeCell*> NonSpatiallyLoadedCells; // 0x18(0x10)
		unsigned char UnknownData00_7[0x18]; // 0x28(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EVolumeLightingMethod> VolumeLightingMethod; // 0x24(0x1)
		...
		unsigned char UnknownData00_5[0x2]; // 0x26(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0x3]; // 0x51(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		TArray<FQuartzPulseOverrideStep> OptionalPulseOverride; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x13]; // 0xD(0x13) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TWeakObjectPtr<UClass*> NavDataClass; // 0x50(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x68]; // 0x8(0x68) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAnimGroupRole> GroupRole; // 0x8(0x1)
	...
	public:
		...
		TEnumAsByte<ERichCurveInterpMode> InterpMode; // 0x11(0x1)
		TEnumAsByte<ERichCurveTangentMode> TangentMode; // 0x12(0x1)
		...
		TArray<FString> IncludeAnimationNames; // 0x20(0x10)
		TArray<FString> ExcludeAnimationNames; // 0x30(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_2[0x150]; // 0x0(0x150) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<FName> InputPoseNames; // 0x10(0x10)
		TArray<int32_t> InputPoseNodeIndices; // 0x20(0x10)
		unsigned char UnknownData01_6[0x38]; // 0x30(0x38) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<int32_t> OrderedSavedPoseNodeIndices; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<int32_t> PlayerNodeIndices; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FAnimSegment> AnimSegments; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FTransform> Bones; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<UAnimMetaData*> MetaData; // 0x38(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EAnimNotifyEventType> NotifyEventType; // 0x8(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x30]; // 0x8(0x30) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_6[0xC8]; // 0x40(0xC8) UNKNOWN PROPERTY
		TArray<int32_t> NextSections; // 0x108(0x10)
		TArray<int32_t> PrevSections; // 0x118(0x10)
		unsigned char UnknownData03_6[0x10]; // 0x128(0x10) UNKNOWN PROPERTY
		TArray<FAnimNotifyEvent> ActiveStateBranchingPoints; // 0x138(0x10)
		float Position; // 0x148(0x4)
		float PlayRate; // 0x14C(0x4)
		FAlphaBlend Blend; // 0x150(0x30)
		unsigned char UnknownData04_6[0x34]; // 0x180(0x34) UNKNOWN PROPERTY
		int32_t DisableRootMotionCount; // 0x1B4(0x4)
		unsigned char UnknownData05_7[0x20]; // 0x1B8(0x20) UNKNOWN PROPERTY
	};
	...
	public:
		TScriptInterface<Class> AnimClassInterface; // 0x0(0x10)
		TArray<uint32_t> Entries; // 0x10(0x10)
	...
	{
	public:
		TMap<FName, int32_t> NameToIndexMap; // 0x0(0x50)
	...
	public:
		...
		unsigned char UnknownData02_7[0x8]; // 0xC8(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FName> SourcePropertyNames; // 0x10(0x10)
		TArray<FName> DestPropertyNames; // 0x20(0x10)
	...
	public:
		...
		TArray<FName> FilteredCurves; // 0x50(0x10)
		TArray<FName> ExtrapolationFilteredCurves; // 0x60(0x10)
		TArray<FBoneReference> FilteredBones; // 0x70(0x10)
		...
		unsigned char UnknownData04_6[0x233]; // 0x9D(0x233) UNKNOWN PROPERTY
		TArray<FInertializationRequest> RequestQueue; // 0x2D0(0x10)
		unsigned char UnknownData05_6[0x228]; // 0x2E0(0x228) UNKNOWN PROPERTY
		UCurveFloat* InertializationCustomBlendCurve; // 0x508(0x8)
		unsigned char UnknownData06_6[0x18]; // 0x510(0x18) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FName> FilteredCurves; // 0x30(0x10)
		TArray<FBoneReference> FilteredBones; // 0x40(0x10)
		bool bResetOnBecomingRelevant; // 0x50(0x1)
		bool bForwardRequestsThroughSkippedCachedPoseNodes; // 0x51(0x1)
		unsigned char UnknownData01_6[0x1D6]; // 0x52(0x1D6) UNKNOWN PROPERTY
		TArray<FInertializationRequest> RequestQueue; // 0x228(0x10)
		unsigned char UnknownData02_6[0x1E0]; // 0x238(0x1E0) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FPoseLink> InputPoses; // 0x58(0x10)
		TArray<FName> InputPoseNames; // 0x68(0x10)
		UClass* InstanceClass; // 0x78(0x8)
		unsigned char UnknownData00_6[0x18]; // 0x80(0x18) UNKNOWN PROPERTY
		UBlendProfile* PendingBlendOutProfile; // 0x98(0x8)
		unsigned char UnknownData01_6[0x8]; // 0xA0(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData02_7[0x7]; // 0xB1(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x78]; // 0x28(0x78) UNKNOWN PROPERTY
		unsigned char UnknownBit01 : 1; // 0xA0:0(0x1) UNKNOWN PROPERTY
		bool bIsOutputLinked : 1; // 0xA0:1(0x1)
		unsigned char UnknownData02_7[0xF]; // 0xA1(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x54]; // 0x24(0x54) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAnimGroupRole> GroupRole; // 0x44(0x1)
	...
	public:
		...
		unsigned char UnknownData00_7[0xA8]; // 0x20(0xA8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_3[0x78]; // 0x10(0x78) UNKNOWN PROPERTY
		int32_t FramesToCachePose; // 0x88(0x4)
		unsigned char UnknownData01_6[0x4]; // 0x8C(0x4) UNKNOWN PROPERTY
		TEnumAsByte<EEvaluatorDataSource> DataSource; // 0x90(0x1)
		TEnumAsByte<EEvaluatorMode> EvaluatorMode; // 0x91(0x1)
		unsigned char UnknownData02_7[0x16]; // 0x92(0x16) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FAnimNotifyEventReference> Notifies; // 0x0(0x10)
	};
	...
	public:
		unsigned char UnknownData00_7[0x10]; // 0x0(0x10) UNKNOWN PROPERTY
		TArray<FAnimNotifyEventReference> AnimNotifies; // 0x10(0x10)
		TMap<FName, FAnimNotifyArray> UnfilteredMontageAnimNotifies; // 0x20(0x50)
	};
	...
	{
	public:
		TArray<FRawAnimSequenceTrack> AnimationTracks; // 0x0(0x10)
		TArray<FName> TrackNames; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<FQuat4f> RotKeys; // 0x0(0x10)
		TArray<float> Times; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<FVector3f> ScaleKeys; // 0x0(0x10)
		TArray<float> Times; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<int32_t> BoneToTrackTable; // 0x0(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x108]; // 0x798(0x108) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FAnimationTransitionRule> Transitions; // 0x8(0x10)
	...
	public:
		...
		TEnumAsByte<ETransitionLogicType> LogicType; // 0x30(0x1)
	...
	public:
		...
		TArray<int32_t> PoseEvaluatorLinks; // 0x18(0x10)
	};
	...
	public:
		FName StateName; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FBakedStateExitTransition> Transitions; // 0x8(0x10)
		int32_t StateRootNodeIndex; // 0x18(0x4)
		int32_t StartNotify; // 0x1C(0x4)
		int32_t EndNotify; // 0x20(0x4)
		int32_t FullyBlendedNotify; // 0x24(0x4)
		...
		TArray<int32_t> PlayerNodeIndices; // 0x30(0x10)
		TArray<int32_t> LayerNodeIndices; // 0x40(0x10)
	...
	public:
		...
		TArray<FBakedAnimationState> States; // 0x8(0x10)
		TArray<FAnimationTransitionBetweenStates> Transitions; // 0x18(0x10)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0xA0]; // 0x8(0xA0) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FPropertyAccessSegment> PathSegments; // 0x0(0x10)
		TArray<FPropertyAccessPath> SrcPaths; // 0x10(0x10)
		TArray<FPropertyAccessPath> DestPaths; // 0x20(0x10)
		TArray<FPropertyAccessCopyBatch> CopyBatchArray; // 0x30(0x10)
	...
	{
	public:
		TArray<FPropertyAccessCopy> Copies; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x20]; // 0x10(0x20) UNKNOWN PROPERTY
		UFunction* Function; // 0x30(0x8)
		int32_t ArrayIndex; // 0x38(0x4)
		uint16_t Flags; // 0x3C(0x2)
		unsigned char UnknownData02_7[0x2]; // 0x3E(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap<FName, TWeakObjectPtr> LinkedFunctions; // 0x8(0x50)
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TArray<FLinkedAnimLayerInstanceData> InstancesData; // 0x8(0x10)
		unsigned char UnknownData01_7[0x8]; // 0x18(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FLinkedAnimLayerClassData> ClassesData; // 0x8(0x10)
		TArray<UClass*> PersistentClasses; // 0x18(0x10)
	};
	...
	{
	public:
		TMap<FName, int32_t> NodeIndices; // 0x8(0x50)
		unsigned char UnknownData00_7[0x8]; // 0x58(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xC]; // 0x8(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FCachedAnimStateData> States; // 0x0(0x10)
		unsigned char UnknownData00_7[0x8]; // 0x10(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0xC]; // 0xC(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FExposedValueCopyRecord> CopyRecords; // 0x18(0x10)
	...
	public:
		...
		TEnumAsByte<EMirrorRowType> MirrorEntryType; // 0x10(0x1)
	...
	public:
		...
		TEnumAsByte<EMirrorFindReplaceMethod> FindReplaceMethod; // 0x8(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FTrajectorySample> Samples; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FTransform> LocalSpacePose; // 0x0(0x10)
		TArray<float> CurveData; // 0x10(0x10)
	};
	...
	{
	public:
		TArray<FPoseAssetInfluence> Influences; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FName> PoseFNames; // 0x0(0x10)
		unsigned char UnknownData00_6[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
		TArray<FName> Tracks; // 0x20(0x10)
		TArray<int32_t> TrackBoneIndices; // 0x30(0x10)
		TArray<FPoseAssetInfluences> TrackPoseInfluenceIndices; // 0x40(0x10)
		TArray<FPoseData> Poses; // 0x50(0x10)
		TArray<FAnimCurveBase> Curves; // 0x60(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UObject*> AttachedObject; // 0x0(0x20)
	...
	{
	public:
		TArray<FPreviewAttachedObjectPair> AttachedObjects; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UAnimBlueprint*> AnimBlueprint; // 0x20(0x20)
	};
	...
	{
	public:
		TArray<int32_t> SkeletonToMeshTable; // 0x0(0x10)
		TArray<int32_t> MeshToSkeletonTable; // 0x10(0x10)
	};
	...
	{
	public:
		TEnumAsByte<EBoneTranslationRetargetingMode> TranslationRetargetingMode; // 0x0(0x1)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FTransform> ReferencePose; // 0x8(0x10)
	};
	...
	{
	public:
		TArray<FName> BonesToRemove; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FName> SlotNames; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FTimeStretchCurveMarker> Markers; // 0x8(0x10)
	...
	public:
		...
		unsigned char UnknownData00_7[0x2F]; // 0x1(0x2F) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UObject*> Asset; // 0x0(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> AssetBaseClass; // 0x8(0x20)
		...
		TArray<FDirectoryPath> Directories; // 0x38(0x10)
		TArray<FSoftObjectPath> SpecificAssets; // 0x48(0x10)
		FPrimaryAssetRules Rules; // 0x58(0xC)
		unsigned char UnknownData02_6[0x4]; // 0x64(0x4) UNKNOWN PROPERTY
		TArray<FString> AssetScanPaths; // 0x68(0x10)
		bool bIsDynamicAsset; // 0x78(0x1)
		unsigned char UnknownData03_6[0x3]; // 0x79(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FString> AssetScanPaths; // 0x0(0x10)
		TArray<FString> IncludePatterns; // 0x10(0x10)
		TArray<FString> ExcludePatterns; // 0x20(0x10)
		...
		unsigned char UnknownData00_7[0x14]; // 0x3C(0x14) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x40]; // 0x8(0x40) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x6]; // 0x2(0x6) UNKNOWN PROPERTY
		TArray<FSoundSubmixSendInfo> SubmixSends; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<USoundEffectSubmixPreset*> SubmixEffectChain; // 0x8(0x10)
	...
	{
	public:
		TArray<FBlueprintComponentChangedPropertyInfo> ChangedPropertyList; // 0x0(0x10)
		unsigned char UnknownData00_6[0xD]; // 0x10(0xD) UNKNOWN PROPERTY
		bool bHasValidCookedData; // 0x1D(0x1)
		unsigned char UnknownData01_7[0x22]; // 0x1E(0x22) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<int32_t> VertexIndices; // 0x0(0x10)
	...
	{
	public:
		TArray<UCameraShakeBase*> PooledShakes; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UCameraShakeSourceComponent*> ShakeSource; // 0x8(0x8)
	...
	{
	public:
		unsigned char UnknownData00_2[0x740]; // 0x0(0x740) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x1]; // 0x3(0x1) UNKNOWN PROPERTY
		FName BoneName; // 0x4(0x4)
	...
	public:
		FName Name; // 0x0(0x4)
		TEnumAsByte<ECollisionEnabled> CollisionEnabled; // 0x4(0x1)
		unsigned char UnknownData00_6[0x1]; // 0x5(0x1) UNKNOWN PROPERTY
		bool bCanModify; // 0x6(0x1)
		unsigned char UnknownData01_6[0x21]; // 0x7(0x21) UNKNOWN PROPERTY
		FName ObjectTypeName; // 0x28(0x4)
		unsigned char UnknownData02_6[0x4]; // 0x2C(0x4) UNKNOWN PROPERTY
		TArray<FResponseChannel> CustomResponses; // 0x30(0x10)
	};
	...
	{
	public:
		TEnumAsByte<ECollisionChannel> Channel; // 0x0(0x1)
		TEnumAsByte<ECollisionResponse> DefaultResponse; // 0x1(0x1)
	...
	public:
		FName Name; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<FResponseChannel> CustomResponses; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FChildActorAttachedActorInfo> AttachedActors; // 0xC8(0x10)
		unsigned char UnknownData01_7[0x20]; // 0xD8(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UPlayerInput*> PlayerInput; // 0x0(0x8)
		unsigned char UnknownData00_7[0x68]; // 0x8(0x68) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x144(0xC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<int32_t> Mapping; // 0x0(0x10)
		TArray<int32_t> InverseMapping; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_5[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<FStaticMeshVertexColorLODData> VertexColorLODs; // 0x138(0x10)
		TArray<FGuid> CachedStaticLighting; // 0x148(0x10)
		TArray<FStreamingTextureBuildInfo> StreamingTextureData; // 0x158(0x10)
	};
	...
	{
	public:
		TArray<FPaintedVertex> PaintedVertices; // 0x0(0x10)
		TArray<FColor> VertexBufferColors; // 0x10(0x10)
	...
	{
	public:
		TArray<FIntegralKey> Keys; // 0x68(0x10)
	...
	{
	public:
		TArray<FNameCurveKey> Keys; // 0x68(0x10)
	};
	...
	{
	public:
		TEnumAsByte<ERichCurveInterpMode> InterpMode; // 0x70(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x71(0x7) UNKNOWN PROPERTY
		TArray<FSimpleCurveKey> Keys; // 0x78(0x10)
	};
	...
	public:
		...
		TArray<FStringCurveKey> Keys; // 0x78(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x2F]; // 0x31(0x2F) UNKNOWN PROPERTY
	};
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TEnumAsByte<EViewModeIndex> ViewModeIndex; // 0x8(0x1)
	...
	public:
		...
		unsigned char UnknownData01_6[0xB0]; // 0x10(0xB0) UNKNOWN PROPERTY
		TArray<UObject*> ObjReferences; // 0xC0(0x10)
	};
	...
	public:
		...
		TArray<FDPMatchingIfCondition> IfConditions; // 0x18(0x10)
	...
	{
	public:
		TArray<FDPMatchingRulestructBase> OnTrue; // 0x48(0x10)
		TArray<FDPMatchingRulestructBase> OnFalse; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<FDPMatchingRulestructA> OnTrue; // 0x48(0x10)
		TArray<FDPMatchingRulestructA> OnFalse; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<FDPMatchingRulestructB> OnTrue; // 0x48(0x10)
		TArray<FDPMatchingRulestructB> OnFalse; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<FDPMatchingRulestructC> OnTrue; // 0x48(0x10)
		TArray<FDPMatchingRulestructC> OnFalse; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<FDPMatchingRulestructD> OnTrue; // 0x48(0x10)
		TArray<FDPMatchingRulestructD> OnFalse; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<FDPMatchingRulestructE> OnTrue; // 0x48(0x10)
		TArray<FDPMatchingRulestructE> OnFalse; // 0x58(0x10)
	};
	...
	public:
		...
		TArray<UDialogueVoice*> Targets; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x50]; // 0x28(0x50) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FHitResult> ComponentHits; // 0x40(0x10)
	};
	...
	public:
		...
		char Flags; // 0x70(0x1)
		unsigned char UnknownData01_7[0xF]; // 0x71(0xF) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FForceFeedbackChannelDetails> ChannelDetails; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UInputDeviceProperty*> Property; // 0x0(0x8)
		unsigned char UnknownData00_7[0x18]; // 0x8(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x18]; // 0xF8(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		UMaterialInterface* Material; // 0x8(0x8)
		TArray<FTransform> Instances; // 0x10(0x10)
		TArray<FCustomPrimitiveData> InstancesCustomPrimitiveData; // 0x20(0x10)
	};
	...
	{
	public:
		TLazyObjectPtr<ALODActor*> LODActor; // 0x0(0x18)
	...
	public:
		...
		FBlueprintCookedComponentInstancingData CookedComponentInstancingData; // 0x30(0x40)
	};
	...
	public:
		...
		TEnumAsByte<EInputEvent> InputKeyEvent; // 0x8(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<EInputEvent> InputKeyEvent; // 0x28(0x1)
		unsigned char UnknownData01_6[0x3]; // 0x29(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TEnumAsByte<EInputEvent> InputKeyEvent; // 0x4(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
		FName FunctionNameToBind; // 0x8(0x4)
	};
	...
	public:
		...
		TArray<FCurveEdEntry> Curves; // 0x10(0x10)
	...
	{
	public:
		TArray<int32_t> ComponentIndices; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FISMClientInstance> Instances; // 0x0(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UStaticMesh*> StaticMesh; // 0x1C0(0x20)
		TArray<TWeakObjectPtr> OverrideMaterials; // 0x1E0(0x10)
		TWeakObjectPtr<UMaterialInterface*> OverlayMaterial; // 0x1F0(0x20)
		TArray<TWeakObjectPtr> RuntimeVirtualTextures; // 0x210(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TArray<float> MarginalCDF; // 0x10(0x10)
		TArray<float> ConditionalCDF; // 0x20(0x10)
		TArray<FColor> TextureData; // 0x30(0x10)
		TWeakObjectPtr<UTexture2D*> Texture; // 0x40(0x8)
		TEnumAsByte<EImportanceWeight> Weighting; // 0x48(0x1)
	...
	{
	public:
		TSet<UActorFolder*> ActorFolders; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x6]; // 0x152(0x6) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_7[0x38]; // 0x0(0x38) UNKNOWN PROPERTY
	...
	{
	public:
		TSet<FMaterialParameterInfo> ParameterInfoSet; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<FMaterialCachedParameterEditorInfo> EditorInfo; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<bool> StaticSwitchValues; // 0xF0(0x10)
		TArray<FStaticComponentMaskValue> StaticComponentMaskValues; // 0x100(0x10)
		TArray<FVector2D> ScalarMinMaxValues; // 0x110(0x10)
		TArray<TWeakObjectPtr> ScalarCurveValues; // 0x120(0x10)
		TArray<TWeakObjectPtr> ScalarCurveAtlasValues; // 0x130(0x10)
		TArray<FParameterChannelNames> VectorChannelNameValues; // 0x140(0x10)
		TArray<bool> VectorUsedAsChannelMaskValues; // 0x150(0x10)
		TArray<FParameterChannelNames> TextureChannelNameValues; // 0x160(0x10)
		FMaterialLayersFunctionsEditorOnlyData MaterialLayers; // 0x170(0x70)
		TArray<FString> AssetPaths; // 0x1E0(0x10)
		TArray<FName> LandscapeLayerNames; // 0x1F0(0x10)
		TSet<FString> ExpressionIncludeFilePaths; // 0x200(0x50)
		TSet<FName> UserSceneTextureInputs; // 0x250(0x50)
	};
	...
	public:
		...
		TArray<int32_t> ScalarPrimitiveDataIndexValues; // 0x2D0(0x10)
		TArray<int32_t> VectorPrimitiveDataIndexValues; // 0x2E0(0x10)
		TArray<float> ScalarValues; // 0x2F0(0x10)
		TArray<bool> StaticSwitchValues; // 0x300(0x10)
		TArray<bool> DynamicSwitchValues; // 0x310(0x10)
		TArray<FLinearColor> VectorValues; // 0x320(0x10)
		TArray<FVector4d> DoubleVectorValues; // 0x330(0x10)
		TArray<TWeakObjectPtr> TextureValues; // 0x340(0x10)
		TArray<TWeakObjectPtr> TextureCollectionValues; // 0x350(0x10)
		TArray<TWeakObjectPtr> FontValues; // 0x360(0x10)
		TArray<int32_t> FontPageValues; // 0x370(0x10)
		TArray<TWeakObjectPtr> RuntimeVirtualTextureValues; // 0x380(0x10)
		TArray<TWeakObjectPtr> SparseVolumeTextureValues; // 0x390(0x10)
		TArray<UObject*> ReferencedTextures; // 0x3A0(0x10)
		TArray<UTextureCollection*> ReferencedTextureCollections; // 0x3B0(0x10)
		TArray<FMaterialFunctionInfo> FunctionInfos; // 0x3C0(0x10)
		uint32_t FunctionInfosStateCRC; // 0x3D0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x3D4(0x4) UNKNOWN PROPERTY
		TArray<FMaterialParameterCollectionInfo> ParameterCollectionInfos; // 0x3D8(0x10)
		TArray<ULandscapeGrassType*> GrassTypes; // 0x3E8(0x10)
		FMaterialLayersFunctionsRuntimeData MaterialLayers; // 0x3F8(0x48)
		TArray<FName> DynamicParameterNames; // 0x440(0x10)
		TArray<bool> QualityLevelsUsed; // 0x450(0x10)
		...
		unsigned char UnknownData01_5[0x3]; // 0x461(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TWeakObjectPtr<UCurveLinearColor*> Curve; // 0x8(0x20)
		TWeakObjectPtr<UCurveLinearColorAtlas*> Atlas; // 0x28(0x20)
	};
	...
	{
	public:
		TArray<int32_t> ParentLayerIndexRemap; // 0x0(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr<UMaterialInterface*> OverrideMaterialRef; // 0x10(0x20)
	};
	...
	public:
		...
		int32_t PktFrameDelay; // 0x34(0x4)
		int32_t PktIncomingFrameDelay; // 0x38(0x4)
	};
	...
	{
	public:
		TArray<FBandwidthTestItem> ReplicatedBuffers; // 0x0(0x10)
		unsigned char UnknownData00_7[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UClass*> Class; // 0x8(0x20)
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0x1D(0x1) UNKNOWN PROPERTY
		int16_t CooloffTime; // 0x1E(0x2)
		int16_t AutoEscalateTime; // 0x20(0x2)
		unsigned char UnknownData02_7[0x26]; // 0x22(0x26) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x30]; // 0x48(0x30) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FPSCPoolElem> FreeElements; // 0x0(0x10)
	};
	...
	{
	public:
		TMap<UParticleSystem*, FPSCPool> WorldParticleSystemPools; // 0x0(0x50)
	...
	public:
		unsigned char UnknownData00_7[0x10]; // 0x0(0x10) UNKNOWN PROPERTY
		TWeakObjectPtr<UClusterUnionReplicatedProxyComponent*> ReplicatedProxyComponent; // 0x10(0x8)
		TWeakObjectPtr<AActor*> Owner; // 0x18(0x8)
	...
	{
	public:
		TSet<FClusterUnionBoneData> BonesData; // 0x0(0x50)
	};
	...
	public:
		...
		TArray<UPrimitiveComponent*> ProcessedComponents; // 0x8(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EAngularDriveMode> AngularDriveMode; // 0x60(0x1)
	...
	public:
		...
		unsigned char UnknownData00_5[0x6]; // 0x82(0x6) UNKNOWN PROPERTY
		FLinearDriveConstraint LinearDrive; // 0x88(0x68)
		FAngularDriveConstraint AngularDrive; // 0xF0(0x68)
		TEnumAsByte<EConstraintPlasticityType> LinearPlasticityType; // 0x158(0x1)
	...
	public:
		...
		TEnumAsByte<EAngularConstraintMotion> TwistMotion; // 0x18(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x19(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAngularConstraintMotion> Swing1Motion; // 0x1C(0x1)
		TEnumAsByte<EAngularConstraintMotion> Swing2Motion; // 0x1D(0x1)
		unsigned char UnknownData00_7[0x2]; // 0x1E(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<ELinearConstraintMotion> XMotion; // 0x18(0x1)
		TEnumAsByte<ELinearConstraintMotion> YMotion; // 0x19(0x1)
		TEnumAsByte<ELinearConstraintMotion> ZMotion; // 0x1A(0x1)
	...
	public:
		...
		unsigned char UnknownData01_5[0x7]; // 0xF1(0x7) UNKNOWN PROPERTY
		FConstraintProfileProperties ProfileInstance; // 0xF8(0x160)
		unsigned char UnknownData02_7[0x10]; // 0x258(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UObject*> Owner; // 0x0(0x8)
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x164(0x4) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<EPhysicalSurface> Type; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		FName Name; // 0x4(0x4)
	};
	...
	public:
		int32_t SourceIndex; // 0x0(0x4)
		TEnumAsByte<EAxis> BoneFlipAxis; // 0x4(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x5(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAxis> BoneFlipAxis; // 0x8(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x9(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UClothingAssetBase*> TargetAsset; // 0x0(0x8)
		...
		TWeakObjectPtr<UPhysicsAsset*> PhysicsAsset; // 0x30(0x20)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x9(0x7) UNKNOWN PROPERTY
		TArray<FBoneFilter> BoneList; // 0x10(0x10)
		TArray<FName> BonesToPrioritize; // 0x20(0x10)
		TArray<int32_t> SectionsToPrioritize; // 0x30(0x10)
	...
	{
	public:
		TArray<int32_t> SectionIDs; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FTransform> UVTransforms; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FSkelMeshMergeMeshUVTransforms> UVTransformsPerMesh; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FSkeletalMeshSamplingLODBuiltData> WholeMeshBuiltData; // 0x0(0x10)
		TArray<FSkeletalMeshSamplingRegionBuiltData> RegionBuiltData; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FSkeletalMeshSamplingRegionMaterialFilter> MaterialFilters; // 0x10(0x10)
		TArray<FSkeletalMeshSamplingRegionBoneFilter> BoneFilters; // 0x20(0x10)
	};
	...
	{
	public:
		TArray<FSkeletalMeshSamplingRegion> Regions; // 0x0(0x10)
	...
	public:
		FPerPlatformFloat ScreenSize; // 0x0(0x4)
		float LODHysteresis; // 0x4(0x4)
		TArray<int32_t> LODMaterialMap; // 0x8(0x10)
		...
		TArray<FBoneReference> BonesToRemove; // 0x70(0x10)
		TArray<FBoneReference> BonesToPrioritize; // 0x80(0x10)
		TArray<FSectionReference> SectionsToPrioritize; // 0x90(0x10)
		...
		unsigned char UnknownData03_5[0x7]; // 0xD1(0x7) UNKNOWN PROPERTY
		TArray<FSkeletalMeshVertexAttributeInfo> VertexAttributes; // 0xD8(0x10)
		bool bSupportUniformlyDistributedSampling : 1; // 0xE8:0(0x1)
		unsigned char UnknownData04_7[0x7]; // 0xE9(0x7) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte<EAudioOutputTarget> OutputTarget; // 0x188(0x1)
		ESoundWaveLoadingBehavior LoadingBehavior; // 0x189(0x1)
		unsigned char UnknownData01_6[0x6]; // 0x18A(0x6) UNKNOWN PROPERTY
	...
	public:
		float Value; // 0x0(0x4)
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TSet<USoundModulatorBase*> Modulators; // 0x8(0x50)
	};
	...
	public:
		...
		TEnumAsByte<EMaxConcurrentResolutionRule> ResolutionRule; // 0x5(0x1)
	...
	{
	public:
		TArray<USoundSubmixBase*> ChildSubmixes; // 0x0(0x10)
	};
	...
	public:
		...
		TEnumAsByte<EDetailMode> DetailMode; // 0x1B1(0x1)
		unsigned char UnknownData03_7[0x6]; // 0x1B2(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<UMaterialInterface*> OverrideMaterials; // 0x1C0(0x10)
		UMaterialInterface* OverlayMaterial; // 0x1D0(0x8)
		TArray<URuntimeVirtualTexture*> RuntimeVirtualTextures; // 0x1D8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UStaticMesh*> StaticMesh; // 0x1B8(0x20)
		TArray<TWeakObjectPtr> OverrideMaterials; // 0x1D8(0x10)
		TWeakObjectPtr<UMaterialInterface*> OverlayMaterial; // 0x1E8(0x20)
		TArray<TWeakObjectPtr> RuntimeVirtualTextures; // 0x208(0x10)
	};
	...
	{
	public:
		TEnumAsByte<EOptimizationType> ReductionMethod; // 0x0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x1(0x3) UNKNOWN PROPERTY
		float NumOfTrianglesPercentage; // 0x4(0x4)
		...
		unsigned char UnknownData02_7[0x1]; // 0x1B(0x1) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<uint32_t, FMeshSectionInfo> Map; // 0x0(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<int32_t> MaterialRemap; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FImportFactorySettingValues> FactorySettings; // 0x28(0x10)
	};
	...
	public:
		FFilePath ImportFilePath; // 0x0(0x10)
		TArray<FImportFactorySettingValues> FactorySettings; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FEditorImportWorkflowDefinition> OtherAssetsToImport; // 0x140(0x10)
	};
	...
	{
	public:
		TEnumAsByte<TextureCompressionSettings> CompressionSettings; // 0x0(0x1)
	...
	{
	public:
		TEnumAsByte<TextureGroup> Group; // 0x0(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		...
		TEnumAsByte<TextureMipGenSettings> MipGenSettings; // 0x1C(0x1)
		...
		unsigned char UnknownData03_6[0x1]; // 0x47(0x1) UNKNOWN PROPERTY
		...
		TEnumAsByte<ETextureLossyCompressionAmount> LossyCompressionAmount; // 0x58(0x1)
		bool CookPlatformTilingDisabled; // 0x59(0x1)
		unsigned char UnknownData05_6[0x2]; // 0x5A(0x2) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TArray<int32_t> AutoCompleteListIndices; // 0x8(0x10)
	...
	{
	public:
		TArray<TEnumAsByte> Formats; // 0x0(0x10)
	...
	{
	public:
		TArray<ULevelStreaming*> StreamingLevels; // 0x0(0x10)
		unsigned char UnknownData00_7[0x18]; // 0x10(0x18) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x76(0x2) UNKNOWN PROPERTY
		FName ActorPackage; // 0x78(0x4)
		FName ActorPath; // 0x7C(0x4)
		TArray<FSoftObjectPath> DataLayerAssets; // 0x80(0x10)
	};
	...
	{
	public:
		TArray<FName> DataLayerInstanceNames; // 0x0(0x10)
	...
	{
	public:
		TArray<FWorldPartitionDestructibleHLODDamagedActorState> DamagedActors; // 0x108(0x10)
		UWorldPartitionDestructibleHLODComponent* OwnerComponent; // 0x118(0x8)
		unsigned char UnknownData00_7[0x28]; // 0x120(0x28) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap<FTopLevelAssetPath, uint32_t> StaticMeshes; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FHLODBuildInputReferencedAssets> BuildersReferencedAssets; // 0x0(0x50)
	};
	...
	{
	public:
		TArray<UWorldPartitionRuntimeCell*> GridCells; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<FSpatialHashStreamingGridLayerCell> LayerCells; // 0x0(0x10)
		TMap<int64_t, int32_t> LayerCellsMapping; // 0x10(0x50)
	};
	...
	public:
		...
		TArray<FSpatialHashStreamingGridLevel> GridLevels; // 0x40(0x10)
		...
		unsigned char UnknownData04_6[0xE]; // 0x92(0xE) UNKNOWN PROPERTY
		TArray<FSpatialHashStreamingGridLevel> InjectedGridLevels; // 0xA0(0x10)
	};
	...
	{
	public:
		TSet<UWorldPartitionRuntimeCell*> Cells; // 0x0(0x50)
		unsigned char UnknownData00_7[0x50]; // 0x50(0x50) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<UWorldPartitionRuntimeCell*> ToLoadCells; // 0x0(0x10)
		TArray<UWorldPartitionRuntimeCell*> ToActivateCells; // 0x10(0x10)
		TArray<UWorldPartitionRuntimeCell*> ToDeactivateCells; // 0x20(0x10)
		TArray<UWorldPartitionRuntimeCell*> ToUnloadCells; // 0x30(0x10)
	...
	public:
		unsigned char UnknownData00_7[0x10]; // 0x0(0x10) UNKNOWN PROPERTY
		TSet<UWorldPartitionRuntimeCell*> LoadedCells; // 0x10(0x50)
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x1D(0x3) UNKNOWN PROPERTY
		TArray<FName> DataLayers; // 0x20(0x10)
		bool bDataLayersOnly; // 0x30(0x1)
		bool bSpatialQuery; // 0x31(0x1)
		unsigned char UnknownData01_7[0xD6]; // 0x32(0xD6) UNKNOWN PROPERTY
	};
