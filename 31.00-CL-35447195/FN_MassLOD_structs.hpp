...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0x58]; // 0x8(0x58) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x10]; // 0x0(0x10) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x2020]; // 0x0(0x2020) UNKNOWN PROPERTY
	};
	...
	{
	public:
		unsigned char UnknownData01_1[0x30]; // 0x0(0x30) UNKNOWN PROPERTY
	};
