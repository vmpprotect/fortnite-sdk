...
namespace SDK
{
	...
	{
	public:
		TArray SoundClips2D; // 0x0(0x10)
		TArray SoundClips3D; // 0x10(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr IdleAnim; // 0x0(0x20)
	...
	public:
		...
		unsigned char UnknownData01_6[0x8]; // 0x4(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData03_6[0x3]; // 0x1B9(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x2]; // 0x256(0x2) UNKNOWN PROPERTY
	...
	{
	public:
		TArray CollisionResponseData; // 0x0(0x10)
	...
	public:
		...
		unsigned char UnknownData07_6[0x7]; // 0x9(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x7]; // 0x119(0x7) UNKNOWN PROPERTY
		double SpeedForRollGetup; // 0x120(0x8)
		float GroundedCheckHalfHeightScale; // 0x128(0x4)
		unsigned char UnknownData10_6[0x4]; // 0x12C(0x4) UNKNOWN PROPERTY
		double GroundedCheckRadius; // 0x130(0x8)
		float MinimumTimeOnGround; // 0x138(0x4)
		unsigned char UnknownData11_6[0x4]; // 0x13C(0x4) UNKNOWN PROPERTY
		TArray MeshCollisionChannels; // 0x140(0x10)
		TArray MeshBonesWithCCD; // 0x150(0x10)
		int32_t MaxRemoteRagdollCharacters; // 0x160(0x4)
		unsigned char UnknownData12_6[0x4]; // 0x164(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData13_6[0x7]; // 0x179(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		TArray AcceptedCollisionChannels; // 0x0(0x10)
		TEnumAsByte HighestAcceptedComponentMobility; // 0x10(0x1)
	...
	public:
		...
		float IdleVelocitySize; // 0x4(0x4)
		float MinImmersionDepth; // 0x8(0x4)
		float MaxImmersionDepth; // 0xC(0x4)
		float TargetImmersionDepth; // 0x10(0x4)
		float JumpMinVelocityZ; // 0x14(0x4)
		float JumpMaxVelocityZ; // 0x18(0x4)
		float JumpForceZ; // 0x1C(0x4)
		float JumpForceDuration; // 0x20(0x4)
	};
	...
	{
	public:
		TArray BoneWeights; // 0x0(0x10)
		double BeingGrabbedWeightMultiplier; // 0x10(0x8)
		TArray StateWeightOverrides; // 0x18(0x10)
	...
	{
	public:
		unsigned char UnknownData01_2[0x380]; // 0x0(0x380) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray CapsuleHistory; // 0x0(0x10)
		TArray MeshHistory; // 0x10(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData04_6[0x10]; // 0x10(0x10) UNKNOWN PROPERTY
		UBeanCharStateBase NewState; // 0x20(0x8)
		unsigned char UnknownData05_7[0x8]; // 0x28(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr Character; // 0x0(0x8)
		...
		TWeakObjectPtr OptionalSourceSubobject; // 0x50(0x8)
	};
