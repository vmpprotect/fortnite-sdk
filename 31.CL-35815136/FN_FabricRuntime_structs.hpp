...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<AFortCreativeDeviceProp*> InteractableOwnerDevice; // 0x4(0x8)
	};
	...
	public:
		...
		TArray<float> Signals; // 0x30(0x10)
		bool bBoundToWatchEvents; // 0x40(0x1)
		unsigned char UnknownData01_7[0xF]; // 0x41(0xF) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x64]; // 0x14(0x64) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x4C]; // 0xC(0x4C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<FFabricMeshProviderMeshReferenceParamInfo_Scalar> ScalarParams; // 0x8(0x10)
		TArray<FFabricMeshProviderMeshReferenceParamInfo_Color> ColorParams; // 0x18(0x10)
	};
	...
	public:
		...
		TArray<FTransform> InstanceTransforms; // 0x38(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x8]; // 0x150(0x8) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TMap<FName, FMetaSoundBuilderNodeOutputHandle> InputNodeNamesToHandles; // 0x38(0x50)
		...
		TArray<FName> AnalyzerOutputNames; // 0xD0(0x10)
	...
	public:
		...
		TArray<FFabricMetaSoundMergeNode> MergeList; // 0xB0(0x10)
	};
	...
	public:
		...
		TArray<FFabricMetaSoundNodeInfo> FreeNodes; // 0x8(0x10)
	...
	{
	public:
		TWeakObjectPtr<UMetaSoundPatch*> CombinerNode; // 0x0(0x20)
		TWeakObjectPtr<UMetaSoundPatch*> SwitcherNode; // 0x20(0x20)
		TWeakObjectPtr<UMetaSoundPatch*> SelectNode; // 0x40(0x20)
		TWeakObjectPtr<UMetaSoundPatch*> AnalyzerNode; // 0x60(0x20)
	...
	public:
		...
		unsigned char UnknownData00_6[0x2]; // 0x2(0x2) UNKNOWN PROPERTY
		TWeakObjectPtr<ABuildingActor*> LockingDevice; // 0x4(0x8)
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x5C]; // 0x24(0x5C) UNKNOWN PROPERTY
	...
	public:
		...
		TMap<FName, bool> PerPlatformTuning; // 0x10(0x50)
	};
	...
	public:
		...
		TMap<FName, int32_t> PerPlatformTuning; // 0x10(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0xC(0x4) UNKNOWN PROPERTY
		TMap<FName, float> PerPlatformTuning; // 0x10(0x50)
	};
	...
	public:
		unsigned char UnknownData00_7[0x8]; // 0x0(0x8) UNKNOWN PROPERTY
		TArray<TWeakObjectPtr> ObjectsInGroup; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<FFabricSignificanceBasedUpdateBucketRuntimeGroup> UpdateGroups; // 0x18(0x10)
	};
	...
	{
	public:
		TArray<int32_t> PackedEnabledSquares; // 0x0(0x10)
		TArray<int32_t> PackedContinuationSquares; // 0x10(0x10)
	...
	{
	public:
		TArray<FFabricStepTrackPacked> PackedTracks; // 0x0(0x10)
	...
	{
	public:
		TArray<FFabricStepPagePacked> PackedPages; // 0x0(0x10)
		TArray<FStepSequenceNote> Notes; // 0x10(0x10)
	...
	{
	public:
		TArray<UFabricStepSequencerGridSquareComponent*> GridSquares; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<UMaterialInstance*> MaterialInstance; // 0x8(0x10)
