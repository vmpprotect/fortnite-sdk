...
namespace SDK
{
	...
	public:
		...
		TArray BranchFilters; // 0x8(0x10)
		TArray SkeletonPoseBoneWeights; // 0x18(0x10)
		TArray SkeletonPoseChildBoneIndices; // 0x28(0x10)
	};
	...
	{
	public:
		TArray BodyPartDefinitions; // 0x0(0x10)
	};
	...
	public:
		...
		TEnumAsByte ControlSpace; // 0x100(0x1)
		...
		unsigned char UnknownData03_7[0x16]; // 0x112(0x16) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TEnumAsByte TargetCurveRotationAxis; // 0x17D(0x1)
		unsigned char UnknownData07_6[0x2]; // 0x17E(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_7[0x18]; // 0x1C8(0x18) UNKNOWN PROPERTY
	};
