...
namespace SDK
{
	...
	enum EFortUIFeature
	{
		...
		EFortUIFeature__ShowStore = A,
		EFortUIFeature__ShowQuests = B,
		EFortUIFeature__ShowMainStore = C,
		EFortUIFeature__ShowContextHelpMenu = D,
		EFortUIFeature__ShowCampaign = E,
		EFortUIFeature__ShowActiveBoost = F,
		EFortUIFeature__ShowJournal = 10,
		EFortUIFeature__ShowPartyBar = 11,
		EFortUIFeature__ShowChatWindow = 12,
		EFortUIFeature__ShowFriendsMenu = 13,
		EFortUIFeature__ShowObjectives = 14,
		EFortUIFeature__ShowRatingIconsInTopbar = 15,
		EFortUIFeature__ShowAntiAddictionMessage = 16,
		EFortUIFeature__ShowMinorShutdownMessage = 17,
		EFortUIFeature__ShowHealthWarningScreen = 18,
		EFortUIFeature__ShowSimplifiedHUD = 19,
		EFortUIFeature__LargeHeaderFooterButtons = 1A,
		EFortUIFeature__ShowAthenaFavoriting = 1B,
		EFortUIFeature__ShowAthenaItemRandomization = 1C,
		EFortUIFeature__ShowAthenaQuests = 1D,
		EFortUIFeature__ShowBattlePass = 1E,
		EFortUIFeature__ShowNewBattlePass = 1F,
		EFortUIFeature__ShowDynamicBattlePass = 20,
		EFortUIFeature__ShowBattlePassFAQ = 21,
		EFortUIFeature__ShowPoblano = 22,
		EFortUIFeature__ShowReplays = 23,
		EFortUIFeature__ShowProfileStatsUI = 24,
		EFortUIFeature__ShowAthenaItemShop = 25,
		EFortUIFeature__ShowMultiProductItemShop = 26,
		EFortUIFeature__ShowShowdown = 27,
		EFortUIFeature__SpecialEventsStart = 28,
		EFortUIFeature__ShowSpecialEvent = 29,
		EFortUIFeature__ShowSpecialEventTeaser = 2A,
		EFortUIFeature__ShowSparksSpecialEvent = 2B,
		EFortUIFeature__ShowJunoSpecialEvent = 2C,
		EFortUIFeature__ShowDelMarSpecialEvent = 2D,
		EFortUIFeature__ShowWinterfest = 2E,
		EFortUIFeature__SpecialEventsEnd = 2F,
		EFortUIFeature__ShowSpatialUI = 30,
		EFortUIFeature__ShowSocial = 31,
		EFortUIFeature__ShowAccountBoosts = 32,
		EFortUIFeature__ShowCustomerSupport = 33,
		EFortUIFeature__ShowGlobalChat = 34,
		EFortUIFeature__ShowEULA = 35,
		EFortUIFeature__ShowEndOfZoneCinematic = 36,
		EFortUIFeature__ShowOnboardingCinematics = 37,
		EFortUIFeature__ShowFounderBannerIcons = 38,
		EFortUIFeature__ShowCurrentRegionInLobby = 39,
		EFortUIFeature__ShowPrerollLlamas = 3A,
		EFortUIFeature__EnableFoundersDailyRewards = 3B,
		EFortUIFeature__EnableMatchmakingRegionSetting = 3C,
		EFortUIFeature__EnableLanguageSetting = 3D,
		EFortUIFeature__EnableFriendCodeSetting = 3E,
		EFortUIFeature__EnableEarlyAccessLoadingScreenBanner = 3F,
		EFortUIFeature__EnableAlterationModifications = 40,
		EFortUIFeature__EnableSchematicRarityUpgrade = 41,
		EFortUIFeature__EnableMissionActivationVote = 42,
		EFortUIFeature__EnableLtmRetrieveTheData = 43,
		EFortUIFeature__EnableUpgradesVideos = 44,
		EFortUIFeature__ShowPreviewTestTab = 45,
		EFortUIFeature__EnableSearchTabInTopNavigationBar = 46,
		EFortUIFeature__EnableDiscoverTabInTopNavigationBar = 47,
		EFortUIFeature__EnableLibraryTabInTopNavigationBar = 48,
		EFortUIFeature__PlaceholderUIFeature1 = 49,
		EFortUIFeature__PlaceholderUIFeature2 = 4A,
		EFortUIFeature__PlaceholderUIFeature3 = 4B,
		EFortUIFeature__PlaceholderUIFeature4 = 4C,
		EFortUIFeature__PlaceholderUIFeature5 = 4D,
		EFortUIFeature__Max_None = 4E,
	};
	...
	enum EFortSidebarButtonType
	{
		...
		EFortSidebarButtonType__Cilantro = 8,
	};
	...
	enum ESocialTutorialType
	{
		...
		ESocialTutorialType__LibraryInHomebar = F,
	};
	...
	// Enum /Script/FortniteUI.EActorUnderReticleType
