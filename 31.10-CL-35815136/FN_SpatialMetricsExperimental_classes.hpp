...
namespace SDK
{
	...
	{
	public:
		unsigned char UnknownData00_1[0x2D8]; // 0x50(0x2D8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x2D0]; // 0x50(0x2D0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x2D8]; // 0x50(0x2D8) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_3[0x390]; // 0x50(0x390) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0x4]; // 0x3EC(0x4) UNKNOWN PROPERTY
