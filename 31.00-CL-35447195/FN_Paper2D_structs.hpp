...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_6[0x30]; // 0x20(0x30) UNKNOWN PROPERTY
		FColor Color; // 0x50(0x4)
		unsigned char UnknownData03_7[0xEC]; // 0x54(0xEC) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray Shapes; // 0x0(0x10)
		TEnumAsByte GeometryType; // 0x10(0x1)
	...
	{
	public:
		TWeakObjectPtr SpriteRef; // 0x0(0x20)
