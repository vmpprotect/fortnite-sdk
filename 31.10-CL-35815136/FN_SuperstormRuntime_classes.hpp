...
namespace SDK
{
	...
	public:
		...
		TArray<FTempestLightningBoltEffectContainer> LightningBoltTargetEffectContainers; // 0xA8(0x10)
		...
		TArray<FTempestLightningBoltData> LightningBoltData; // 0x338(0x10)
		unsigned char UnknownData00_7[0xD0]; // 0x348(0xD0) UNKNOWN PROPERTY
		...
		float GetLightningRadius(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF751576B7C(relative to base address)
		float GetCloudHeight(); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF751576B48(relative to base address)
	};
	...
	public:
		...
		TArray<FGameplayTag> PhysicsPresetTagsAngularDampingToOverride; // 0xD0(0x10)
		FScalableFloat AngularDampingOverride; // 0xE0(0x28)
		UClass* PawnInGE; // 0x108(0x8)
		TMap<EFortPhysicsObjectType, FScalableFloat> ObjectTypeToMaxCapCount; // 0x110(0x50)
		...
		unsigned char UnknownData02_6[0x118]; // 0x318(0x118) UNKNOWN PROPERTY
		FTargetingRequestHandle AsyncTargetingHandle; // 0x430(0x4)
		unsigned char UnknownData03_6[0x4]; // 0x434(0x4) UNKNOWN PROPERTY
		TSet<AFortPlayerPawn*> PreviouslyNearPlayers; // 0x438(0x50)
		unsigned char UnknownData04_7[0xA8]; // 0x488(0xA8) UNKNOWN PROPERTY
		...
		void OnVehicleInTornadoPlayerExit(AFortPlayerControllerAthena* PlayerController, AFortAthenaVehicle* Vehicle); // Flags: Final|Native|Private, Memory Exec: 0x7FF751576C40(relative to base address)
		bool IsActorInTornado(AActor* Actor); // Flags: Final|Native|Public|BlueprintCallable|BlueprintPure|Const, Memory Exec: 0x7FF751576BB0(relative to base address)
	};
