...
namespace SDK
{
	...
	{
	public:
		TArray<FName> PackageNames; // 0x0(0x10)
		TArray<FName> PackagePaths; // 0x10(0x10)
		TArray<FSoftObjectPath> SoftObjectPaths; // 0x20(0x10)
		TArray<FName> ClassNames; // 0x30(0x10)
		TArray<FTopLevelAssetPath> ClassPaths; // 0x40(0x10)
		unsigned char UnknownData00_6[0x50]; // 0x50(0x50) UNKNOWN PROPERTY
		TSet<FName> RecursiveClassesExclusionSet; // 0xA0(0x50)
		TSet<FTopLevelAssetPath> RecursiveClassPathsExclusionSet; // 0xF0(0x50)
		bool bRecursivePaths; // 0x140(0x1)
		bool bRecursiveClasses; // 0x141(0x1)
		bool bIncludeOnlyOnDiskAssets; // 0x142(0x1)
		unsigned char UnknownData01_7[0xD]; // 0x143(0xD) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FAssetBundleEntry> Bundles; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FTopLevelAssetPath> AssetPaths; // 0x8(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_7[0x20]; // 0x18(0x20) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TEnumAsByte<ERangeBoundTypes> Type; // 0x0(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FInterpCurvePointFloat> Points; // 0x0(0x10)
	...
	public:
		...
		TEnumAsByte<EInterpCurveMode> InterpMode; // 0x10(0x1)
		unsigned char UnknownData00_7[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FInterpCurvePointLinearColor> Points; // 0x0(0x10)
		bool bIsLooped; // 0x10(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		float LoopKeyOffset; // 0x14(0x4)
	};
	...
	public:
		...
		TEnumAsByte<EInterpCurveMode> InterpMode; // 0x34(0x1)
	...
	public:
		...
		TEnumAsByte<EInterpCurveMode> InterpMode; // 0x70(0x1)
	...
	public:
		...
		TEnumAsByte<EInterpCurveMode> InterpMode; // 0x98(0x1)
	...
	public:
		...
		TEnumAsByte<EInterpCurveMode> InterpMode; // 0x50(0x1)
	...
	public:
		...
		TEnumAsByte<EInterpCurveMode> InterpMode; // 0x38(0x1)
	...
	{
	public:
		TArray<FInterpCurvePointQuat> Points; // 0x0(0x10)
		bool bIsLooped; // 0x10(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		float LoopKeyOffset; // 0x14(0x4)
	};
	...
	{
	public:
		TArray<FInterpCurvePointTwoVectors> Points; // 0x0(0x10)
		bool bIsLooped; // 0x10(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		float LoopKeyOffset; // 0x14(0x4)
	};
	...
	{
	public:
		TArray<FInterpCurvePointVector> Points; // 0x0(0x10)
		bool bIsLooped; // 0x10(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		float LoopKeyOffset; // 0x14(0x4)
	};
	...
	{
	public:
		TArray<FInterpCurvePointVector2D> Points; // 0x0(0x10)
		bool bIsLooped; // 0x10(0x1)
		unsigned char UnknownData00_6[0x3]; // 0x11(0x3) UNKNOWN PROPERTY
		float LoopKeyOffset; // 0x14(0x4)
	};
	...
	public:
		...
		TWeakObjectPtr<UObject*> SoftObjectPointer; // 0x8(0x20)
		FSoftObjectPath SoftObjectPath; // 0x28(0x18)
		TWeakObjectPtr<UObject*> WeakObjectPointer; // 0x40(0x8)
	};
	...
	// Struct CoreUObject.TestInstanceDataObjectPoint
	// Size: 0x10 (0x10 - 0x0)
	...
	// Struct CoreUObject.TestInstanceDataObjectPointAlternate
	// Size: 0xC (0xC - 0x0)
	...
	public:
		...
		int32_t C; // 0x8(0x4)
		int32_t D; // 0xC(0x4)
		TEnumAsByte<ETestInstanceDataObjectBird> Bird; // 0x10(0x1)
		TEnumAsByte<ETestInstanceDataObjectGrain> Grain; // 0x11(0x1)
		ETestInstanceDataObjectFruit Fruit; // 0x12(0x1)
		unsigned char UnknownData00_6[0x1]; // 0x13(0x1) UNKNOWN PROPERTY
		ETestInstanceDataObjectDirection Direction; // 0x14(0x2)
		unsigned char UnknownData01_6[0x2]; // 0x16(0x2) UNKNOWN PROPERTY
		FTestInstanceDataObjectPoint Point; // 0x18(0x10)
	};
	...
	public:
		...
		int32_t D; // 0x10(0x4)
		int32_t E; // 0x14(0x4)
		TEnumAsByte<ETestInstanceDataObjectBird> Bird; // 0x18(0x1)
		TEnumAsByte<ETestInstanceDataObjectGrainAlternate> Grain; // 0x19(0x1)
		ETestInstanceDataObjectFruitAlternate Fruit; // 0x1A(0x1)
		unsigned char UnknownData01_6[0x1]; // 0x1B(0x1) UNKNOWN PROPERTY
		ETestInstanceDataObjectDirectionAlternate Direction; // 0x1C(0x2)
		unsigned char UnknownData02_6[0x2]; // 0x1E(0x2) UNKNOWN PROPERTY
		FTestInstanceDataObjectPointAlternate Point; // 0x20(0xC)
	...
	public:
		...
		TMap<FOverriddenPropertyNodeID, FOverriddenPropertyNodeID> SubPropertyNodeKeys; // 0x18(0x50)
	};
	...
	public:
		...
		TSet<FOverriddenPropertyNode> OverriddenPropertyNodes; // 0x8(0x50)
	...
	{
	public:
		TMap<FName, FString> ObjectMetaData; // 0x0(0x50)
	};
	...
	{
	public:
		TMap<FName, FString> FieldMetaData; // 0x0(0x50)
	};
	...
	public:
		...
		TMap<FName, FFieldCookedMetaDataStore> PropertiesMetaData; // 0x50(0x50)
	};
