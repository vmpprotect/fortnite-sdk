...
namespace SDK
{
	...
	public:
		...
		void ExecuteUbergraph(int32_t EntryPoint); // Flags: Event|Public|BlueprintEvent, Memory Exec: 0x7FF7471BBE78(relative to base address)
	};
	...
	public:
		...
		FTestInstanceDataObjectStruct Struct; // 0x2C(0x28)
	...
	public:
		...
		unsigned char UnknownData00_7[0x70]; // 0x40(0x70) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0xB0(0x10) UNKNOWN PROPERTY
	...
	{
	public:
		TEnumAsByte<EUserDefinedStructureStatus> Status; // 0xC0(0x1)
		unsigned char UnknownData00_6[0x3]; // 0xC1(0x3) UNKNOWN PROPERTY
		FGuid Guid; // 0xC4(0x10)
		unsigned char UnknownData01_7[0x34]; // 0xD4(0x34) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x150]; // 0xB0(0x150) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FPropertyBagPropertyDesc> PropertyDescs; // 0xC0(0x10)
	...
	{
	public:
		unsigned char UnknownData00_1[0x30]; // 0xB0(0x30) UNKNOWN PROPERTY
	...
	public:
		...
		TMap<FName, FStructCookedMetaDataStore> FunctionsMetaData; // 0xC8(0x50)
	...
	{
	public:
		unsigned char UnknownData00_1[0x1C0]; // 0x200(0x1C0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x1C0]; // 0xE0(0x1C0) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x78(0x8) UNKNOWN PROPERTY
