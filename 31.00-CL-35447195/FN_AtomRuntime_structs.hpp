...
namespace SDK
{
	...
	{
	public:
		TArray Meshes; // 0x0(0x10)
		TArray Materials; // 0x10(0x10)
		TArray UUIDs; // 0x20(0x10)
		TArray Instances; // 0x30(0x10)
		TArray InstanceTransforms; // 0x40(0x10)
	};
	...
	public:
		...
		TWeakObjectPtr Material; // 0x8(0x20)
	...
	{
	public:
		TArray MaterialAssignments; // 0x0(0x10)
		TWeakObjectPtr MeshOverride; // 0x10(0x20)
	};
	...
	public:
		...
		TArray GeometryStyles; // 0x70(0x10)
	};
	...
	public:
		...
		TArray Decorations; // 0x38(0x10)
		TArray Colors; // 0x48(0x10)
		TArray SelectionSets; // 0x58(0x10)
		FString Group; // 0x68(0x10)
		FString ParentGroup; // 0x78(0x10)
		TArray CommonParts; // 0x88(0x10)
		bool bIsUndersideVisible; // 0x98(0x1)
		unsigned char UnknownData05_7[0x17]; // 0x99(0x17) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray Boxes; // 0x0(0x10)
		TArray Spheres; // 0x10(0x10)
		TArray Capsules; // 0x20(0x10)
		TArray Cylinders; // 0x30(0x10)
		TArray Tubes; // 0x40(0x10)
	};
	...
	{
	public:
		TArray PlanarFields; // 0x0(0x10)
		TArray LineFields; // 0x10(0x10)
		TArray PointFields; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x6]; // 0x42(0x6) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData01_3[0x7]; // 0x1(0x7) UNKNOWN PROPERTY
		TArray PointConnections; // 0x8(0x10)
	...
	{
	public:
		TArray Fields; // 0x0(0x10)
		TArray PlanarConnections; // 0x10(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr AtomPrimitive; // 0x0(0x20)
		TWeakObjectPtr MaterialInstance; // 0x20(0x20)
		TWeakObjectPtr MaterialWithPayload; // 0x40(0x20)
		TArray Transforms; // 0x60(0x10)
		uint32_t PartId; // 0x70(0x4)
		unsigned char UnknownData02_6[0x4]; // 0x74(0x4) UNKNOWN PROPERTY
		FString PartRevision; // 0x78(0x10)
		TArray ColorSurfaces; // 0x88(0x10)
		TArray Decorations; // 0x98(0x10)
	...
	public:
		FGuid ID; // 0x0(0x10)
		FName Name; // 0x10(0x4)
		unsigned char UnknownData01_6[0xC]; // 0x14(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		TArray PrimitiveConnections; // 0x68(0x10)
	...
	{
	public:
		TArray BoneReferences; // 0x0(0x10)
		TArray Connections; // 0x10(0x10)
		FName Name; // 0x20(0x4)
	...
	public:
		...
		TSet PrimitiveIds; // 0x28(0x50)
		TArray Sockets; // 0x78(0x10)
	...
	{
	public:
		TArray Primitives; // 0x0(0x10)
		TArray Elements; // 0x10(0x10)
		TArray SelectionSets; // 0x20(0x10)
		TArray GlueSets; // 0x30(0x10)
		TArray Groups; // 0x40(0x10)
	...
	{
	public:
		TWeakObjectPtr Component; // 0x0(0x20)
	...
	public:
		...
		TArray ProcessedObjects; // 0x8(0x10)
		TArray SharedAssets; // 0x18(0x10)
	};
	...
	public:
		...
		TArray ProcessedObjects; // 0x18(0x10)
	};
	...
	public:
		...
		TArray GeometryStyles; // 0x38(0x10)
	...
	{
	public:
		TArray UnscaledInstances; // 0x0(0x10)
	};
