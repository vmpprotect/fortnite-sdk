...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData01_7[0xC]; // 0x814(0xC) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0xC]; // 0x1CB4(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x8]; // 0xE98(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_6[0xC]; // 0x1014(0xC) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0xC]; // 0x8774(0xC) UNKNOWN PROPERTY
		FChatMarkupStyle ChatMarkupStyle; // 0x8780(0x820)
		FSocialSoundSchema SoundSchema; // 0x8FA0(0x48)
		unsigned char UnknownData01_7[0x8]; // 0x8FE8(0x8) UNKNOWN PROPERTY
	};
