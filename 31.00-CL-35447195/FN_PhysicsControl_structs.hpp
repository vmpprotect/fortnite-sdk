...
namespace SDK
{
	...
	{
	public:
		TArray ControlSetUpdates; // 0x0(0x10)
		TArray ModifierSetUpdates; // 0x10(0x10)
	};
	...
	public:
		...
		TEnumAsByte CollisionType; // 0x1(0x1)
	...
	public:
		...
		unsigned char UnknownData03_7[0x5]; // 0x4B(0x5) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray ControlParameters; // 0x0(0x10)
		TArray ControlMultiplierParameters; // 0x10(0x10)
		TArray ModifierParameters; // 0x20(0x10)
	};
	...
	{
	public:
		TArray ControlUpdates; // 0x0(0x10)
		TArray ControlMultiplierUpdates; // 0x10(0x10)
		TArray ModifierUpdates; // 0x20(0x10)
	};
	...
	{
	public:
		TMap Controls; // 0x0(0x50)
		TMap Modifiers; // 0x50(0x50)
	};
	...
	public:
		...
		unsigned char UnknownData08_6[0x137]; // 0xD1(0x137) UNKNOWN PROPERTY
		...
		unsigned char UnknownData09_6[0x3]; // 0x2E5(0x3) UNKNOWN PROPERTY
		FBoneReference BaseBoneRef; // 0x2E8(0xC)
		TEnumAsByte OverlapChannel; // 0x2F4(0x1)
		...
		unsigned char UnknownData10_3[0x1]; // 0x2F7(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData14_6[0x1]; // 0x628(0x1) UNKNOWN PROPERTY
		ESimulationTiming SimulationTiming; // 0x629(0x1)
		unsigned char UnknownData15_7[0x816]; // 0x62A(0x816) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr ParentActor; // 0x0(0x8)
		FName ParentMeshComponentName; // 0x8(0x4)
		FName ParentBoneName; // 0xC(0x4)
		TWeakObjectPtr ChildActor; // 0x10(0x8)
