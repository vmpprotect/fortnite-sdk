...
namespace SDK
{
	...
	{
	public:
		TArray<FDataStreamDefinition> DataStreamDefinitions; // 0x28(0x10)
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0x60(0x8) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FNetBlobHandlerDefinition> NetBlobHandlerDefinitions; // 0x28(0x10)
	...
	{
	public:
		unsigned char UnknownData00_1[0x50]; // 0x58(0x50) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FNetObjectFilterDefinition> NetObjectFilterDefinitions; // 0x28(0x10)
	...
	public:
		...
		TArray<FNetObjectGridFilterProfile> FilterProfiles; // 0x48(0x10)
	...
	{
	public:
		unsigned char UnknownData00_1[0x110]; // 0x58(0x110) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FNetObjectPrioritizerDefinition> NetObjectPrioritizerDefinitions; // 0x28(0x10)
	...
	// Size: 0x480 (0x590 - 0x110)
	class UObjectReplicationBridge : public UReplicationBridge	
	{
	public:
		unsigned char UnknownData00_1[0x480]; // 0x110(0x480) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FObjectReplicationBridgePollConfig> PollConfigs; // 0x28(0x10)
		TArray<FObjectReplicationBridgeFilterConfig> FilterConfigs; // 0x38(0x10)
		TArray<FObjectReplicationBridgePrioritizerConfig> PrioritizerConfigs; // 0x48(0x10)
		TArray<FObjectReplicationBridgeDeltaCompressionConfig> DeltaCompressionConfigs; // 0x58(0x10)
		TArray<FObjectReplicatedBridgeCriticalClassConfig> CriticalClassConfigs; // 0x68(0x10)
		bool bAllClassesCritical; // 0x78(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x79(0x7) UNKNOWN PROPERTY
		TArray<FObjectReplicationBridgeTypeStatsConfig> TypeStatsConfigs; // 0x80(0x10)
		FName DefaultSpatialFilterName; // 0x90(0x4)
		FName RequiredNetDriverChannelClassName; // 0x94(0x4)
		TArray<FName> CriticalActorClasses; // 0x98(0x10)
	...
	public:
		...
		TArray<FObjectScopeHysteresisProfile> HysteresisProfiles; // 0x30(0x10)
	...
	{
	public:
		unsigned char UnknownData00_1[0x38]; // 0x68(0x38) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<FSupportsStructNetSerializerConfig> SupportsStructNetSerializerList; // 0x28(0x10)
