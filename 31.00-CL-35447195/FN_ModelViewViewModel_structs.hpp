...
namespace SDK
{
	...
	public:
		...
		char Type; // 0xC(0x1)
		unsigned char UnknownData01_7[0x1]; // 0xD(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x1]; // 0x3(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray FieldPaths; // 0x20(0x10)
		TArray CompiledFields; // 0x30(0x10)
		TArray CompiledFieldNames; // 0x40(0x10)
	};
	...
	{
	public:
		TArray ViewModelInstances; // 0x0(0x10)
	...
	public:
		...
		FMVVMVCompiledFieldPath FieldPath; // 0x20(0x4)
		FName PropertyName; // 0x24(0x4)
		TArray FieldToRegisterTo; // 0x28(0x10)
