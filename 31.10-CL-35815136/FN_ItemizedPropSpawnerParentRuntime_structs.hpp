...
namespace SDK
{
	...
	public:
		...
		TArray<AActor*> SupportingActors; // 0x80(0x10)
		...
		unsigned char UnknownData00_7[0xB]; // 0x105(0xB) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<AFortPlayerPawnAthena*> Player; // 0x0(0x8)
		TWeakObjectPtr<AFortWeaponRanged*> Weapon; // 0x8(0x8)
		...
		TArray<UClass*> ClassesToIgnoreWhenTracing; // 0x40(0x10)
		TArray<UClass*> ClassesToIgnoreWhenTracingIfTooSmall; // 0x50(0x10)
		float DebugDrawTime; // 0x60(0x4)
		unsigned char UnknownData03_6[0x4]; // 0x64(0x4) UNKNOWN PROPERTY
		TArray<FTransform> ChunkRelativeTransforms; // 0x68(0x10)
		TMap<EItemizedPropSpawnerChunkLocation, int32_t> ChunkLocationToChunkIndexMap; // 0x78(0x50)
		...
		TArray<UStaticMeshComponent*> PreviewMeshesTEMP; // 0xE0(0x10)
		...
		unsigned char UnknownData06_6[0x3]; // 0x131(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		TArray<TEnumAsByte> CapsuleOverlapObjectTypes; // 0x0(0x10)
		TWeakObjectPtr<UClass*> CapsuleOverlapActorClassFilter; // 0x10(0x20)
		...
		unsigned char UnknownData01_7[0x1]; // 0x97(0x1) UNKNOWN PROPERTY
	};
