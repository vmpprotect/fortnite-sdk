...
namespace SDK
{
	...
	enum ECreativeModalDialogAlignmentOption
	{
		...
		ECreativeModalDialogAlignmentOption__LeftTall = A,
		ECreativeModalDialogAlignmentOption__CenteredTall = B,
		ECreativeModalDialogAlignmentOption__RightTall = C,
		ECreativeModalDialogAlignmentOption__TopWide = D,
		ECreativeModalDialogAlignmentOption__CenteredWide = E,
		ECreativeModalDialogAlignmentOption__BottomWide = F,
	};
