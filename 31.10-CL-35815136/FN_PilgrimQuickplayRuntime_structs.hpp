...
namespace SDK
{
	...
	public:
		...
		TArray<FPilgrimQuickplaySongResultBandData> BandData; // 0x38(0x10)
		TArray<FPilgrimQuickplaySongResultPlayerData> PlayerData; // 0x48(0x10)
		char Team; // 0x58(0x1)
	...
	public:
		...
		TWeakObjectPtr<APlayerState*> PlayerState; // 0x40(0x8)
	...
	public:
		...
		TArray<FPilgrimHistogramSample> HistogramSamples; // 0x28(0x10)
		TArray<int32_t> AccuracyTierCounts; // 0x38(0x10)
	};
