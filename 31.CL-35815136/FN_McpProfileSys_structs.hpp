...
namespace SDK
{
	...
	public:
		...
		TArray<FJsonObjectWrapper> ProfileChanges; // 0x20(0x10)
		FDateTime LockExpiration; // 0x30(0x8)
		TArray<FJsonObjectWrapper> Notifications; // 0x38(0x10)
	...
	public:
		...
		TArray<FProfileUpdateSingle> MultiUpdate; // 0x60(0x10)
	};
	...
	public:
		...
		TArray<FMcpAddItemRequest> AddRequests; // 0x8(0x10)
		TArray<FMcpRemoveItemRequest> RemoveRequests; // 0x18(0x10)
		TArray<FMcpChangeQuantityRequest> ChangeQuantityRequests; // 0x28(0x10)
		TArray<FMcpChangeAttributesRequest> ChangeAttributesRequests; // 0x38(0x10)
		TArray<FJsonObjectWrapper> ChangeStatRequests; // 0x48(0x10)
	};
	...
	{
	public:
		TArray<FJsonObjectWrapper> Changes; // 0x0(0x10)
	...
	{
	public:
		TWeakObjectPtr<UMcpProfile*> ProfileWeakPtr; // 0x0(0x8)
	...
	public:
		...
		TArray<FMcpLootEntry> Items; // 0x10(0x10)
	};
	...
	public:
		...
		TArray<FMcpLootEntry> LootList; // 0x18(0x10)
