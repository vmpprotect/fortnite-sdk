...
namespace SDK
{
	...
	{
	public:
		TEnumAsByte<EHorizontalAlignment> HorizontalAlignment_4_A94CBD4C4E96C298CF51F6B49895AE3D; // 0x0(0x1)
		TEnumAsByte<EVerticalAlignment> VerticalAlignment_5_BC3E4CD143DBC026850F4BAE098F6937; // 0x1(0x1)
	...
	public:
		...
		TEnumAsByte<E_UI_BackplateBrightness> Brightness_85_A94CBD4C4E96C298CF51F6B49895AE3D; // 0x40(0x1)
		TEnumAsByte<E_UI_BackplateCornerRadius> CornerRadius_86_3E7C183E49CE6543B65BBEB8E5C3DEF9; // 0x41(0x1)
	...
	public:
		...
		TEnumAsByte<ETextJustify> Justification_52_5897D4F946C704E9C5D67E9DD207EF16; // 0xAD(0x1)
	...
	public:
		...
		TEnumAsByte<E_UI_ButtonSize> EachButtonSize_90_7A1E34E243F1F10533E9EA910463B328; // 0x48(0x1)
		...
		TArray<TEnumAsByte> CTAButtonsTypes_89_963DA1ED40E4193862297D976DA12A11; // 0x58(0x10)
	...
	{
	public:
		TEnumAsByte<E_UI_StatusIndicator_Configuration> Configuration_2_4F95EDE441841EAA721CCEBD1EB55CB0; // 0x0(0x1)
		TEnumAsByte<E_UI_StatusIndicator_Size> Size_9_6A845B25414BCD4AD542299A80B2861A; // 0x1(0x1)
		TEnumAsByte<E_UI_StatusIndicator_Type> Type_11_9B3629794F4B75331E8B2187EF326C83; // 0x2(0x1)
		unsigned char UnknownData00_6[0x5]; // 0x3(0x5) UNKNOWN PROPERTY
		TWeakObjectPtr<UMaterialInstance*> Icon_28_BD4DFFFF4E313FBF9321FB8F8B6F065E; // 0x8(0x20)
		TEnumAsByte<E_UIKit_StatusIndicatorPlacement> Placement_36_7BAF349C4AD25576F7599B9659D4F8B5; // 0x28(0x1)
	...
	public:
		...
		TArray<FUIKitTabData> InnerTabs_7_80595BFD459B00A700F6ACAB5B15D171; // 0x10(0x10)
	};
