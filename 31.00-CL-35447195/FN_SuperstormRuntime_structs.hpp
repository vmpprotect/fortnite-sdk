...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_6[0x40]; // 0x8(0x40) UNKNOWN PROPERTY
		AFortGameplayEffectDeliveryActor LightningBolt; // 0x48(0x8)
		TArray TargetActors; // 0x50(0x10)
		TArray TargetPawns; // 0x60(0x10)
	...
	public:
		...
		unsigned char UnknownData06_6[0x4]; // 0x6C(0x4) UNKNOWN PROPERTY
		TMap SizeForceModifiers; // 0x70(0x50)
		TMap ObjectTypeForceModifiers; // 0xC0(0x50)
		...
		unsigned char UnknownData07_7[0x5]; // 0x133(0x5) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TMap NumActorsEnteredByType; // 0x0(0x50)
		TSet EnteredPlayerAccountIds; // 0x50(0x50)
	...
	{
	public:
		TArray ActorsToSimulateArray; // 0x108(0x10)
	};
