...
namespace SDK
{
	...
	{
	public:
		TArray<UJunoActiveMusicElementController_Base*> ElementControllerArray; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<UClass*> JunoMusicDataCollectors; // 0x0(0x10)
	};
	...
	public:
		...
		TArray<FSoftObjectPath> MusicCues; // 0xA0(0x10)
	...
	public:
		...
		TEnumAsByte<EMusicScheduleMode> MusicScheduleMode; // 0x28(0x1)
		...
		TArray<UClass*> CustomPlaybackConditions; // 0x70(0x10)
		...
		unsigned char UnknownData04_6[0x3]; // 0x8D(0x3) UNKNOWN PROPERTY
		FVector2D PlaybackCooldownInSeconds; // 0x90(0x10)
		bool bResetCooldownOnFalseConditions; // 0xA0(0x1)
		unsigned char UnknownData05_6[0x7]; // 0xA1(0x7) UNKNOWN PROPERTY
		TArray<FName> CooldownGroupNames; // 0xA8(0x10)
	};
	...
	public:
		...
		TArray<FJunoMusicPlaylistElement> MusicPlaylist; // 0x8(0x10)
		TMap<FName, FVector2D> CooldownGroups; // 0x18(0x50)
	...
	{
	public:
		TArray<UClass*> JunoMusicPlayspaceProbes; // 0x0(0x10)
	};
