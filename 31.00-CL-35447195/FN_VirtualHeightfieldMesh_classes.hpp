...
namespace SDK
{
	...
	public:
		...
		TArray TextureData; // 0x48(0x10)
		FIntPoint TextureDataSize; // 0x58(0x8)
		TArray TextureDataMips; // 0x60(0x10)
	...
	{
	public:
		TWeakObjectPtr VirtualTexture; // 0x4C8(0x20)
		...
		unsigned char UnknownData03_6[0x7]; // 0x4F9(0x7) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_6[0x3]; // 0x50D(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0xE]; // 0x532(0xE) UNKNOWN PROPERTY
		...
		void GatherHideFlags(bool& InOutHidePrimitivesInEditor, bool& InOutHidePrimitivesInGame); // Flags: Final|Native|Protected|HasOutParms|Const 0x7FF414EC0460
	};
