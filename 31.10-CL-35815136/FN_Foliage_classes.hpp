...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0xA99(0x3) UNKNOWN PROPERTY
		FGuid GenerationGuid; // 0xA9C(0x10)
		unsigned char UnknownData01_7[0x4]; // 0xAAC(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		TEnumAsByte<FoliageVertexColorMask> VertexColorMask; // 0x98(0x1)
		...
		unsigned char UnknownData03_5[0x3]; // 0xA1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData04_5[0x3]; // 0xAD(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData07_6[0x4]; // 0xE4(0x4) UNKNOWN PROPERTY
		...
		unsigned char UnknownData08_5[0x7]; // 0x101(0x7) UNKNOWN PROPERTY
		FVector CollisionScale; // 0x108(0x18)
		int32_t AverageNormalSampleCount; // 0x120(0x4)
		unsigned char UnknownData09_6[0x4]; // 0x124(0x4) UNKNOWN PROPERTY
		FBoxSphereBounds MeshBounds; // 0x128(0x38)
		FVector LowBoundOriginRadius; // 0x160(0x18)
		TEnumAsByte<EComponentMobility> Mobility; // 0x178(0x1)
		unsigned char UnknownData10_6[0x3]; // 0x179(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_3[0x3]; // 0x185(0x3) UNKNOWN PROPERTY
		bool bCastContactShadow : 1; // 0x188:0(0x1)
		unsigned char UnknownData12_3[0x3]; // 0x189(0x3) UNKNOWN PROPERTY
		bool bCastShadowAsTwoSided : 1; // 0x18C:0(0x1)
		bool bReceivesDecals : 1; // 0x18C:1(0x1)
		bool bOverrideLightMapRes : 1; // 0x18C:2(0x1)
		unsigned char UnknownData13_5[0x3]; // 0x18D(0x3) UNKNOWN PROPERTY
		EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior; // 0x190(0x1)
		unsigned char UnknownData14_6[0x3]; // 0x191(0x3) UNKNOWN PROPERTY
		int32_t OverriddenLightMapRes; // 0x194(0x4)
		ELightmapType LightmapType; // 0x198(0x1)
		unsigned char UnknownData15_6[0x3]; // 0x199(0x3) UNKNOWN PROPERTY
		bool bUseAsOccluder : 1; // 0x19C:0(0x1)
		unsigned char UnknownData16_3[0x3]; // 0x19D(0x3) UNKNOWN PROPERTY
		bool bVisibleInRayTracing : 1; // 0x1A0:0(0x1)
		bool bEvaluateWorldPositionOffset : 1; // 0x1A0:1(0x1)
		unsigned char UnknownData17_5[0x3]; // 0x1A1(0x3) UNKNOWN PROPERTY
		int32_t WorldPositionOffsetDisableDistance; // 0x1A4(0x4)
		FBodyInstance BodyInstance; // 0x1A8(0x170)
		TEnumAsByte<EHasCustomNavigableGeometry> CustomNavigableGeometry; // 0x318(0x1)
		FLightingChannels LightingChannels; // 0x319(0x1)
		unsigned char UnknownData18_6[0x2]; // 0x31A(0x2) UNKNOWN PROPERTY
		bool bRenderCustomDepth : 1; // 0x31C:0(0x1)
		unsigned char UnknownData19_5[0x3]; // 0x31D(0x3) UNKNOWN PROPERTY
		ERendererStencilMask CustomDepthStencilWriteMask; // 0x320(0x1)
		unsigned char UnknownData20_6[0x3]; // 0x321(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData21_6[0x2]; // 0x352(0x2) UNKNOWN PROPERTY
		...
		unsigned char UnknownData22_5[0x1]; // 0x487(0x1) UNKNOWN PROPERTY
		TArray<URuntimeVirtualTexture*> RuntimeVirtualTextures; // 0x488(0x10)
		int32_t VirtualTextureCullMips; // 0x498(0x4)
		ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType; // 0x49C(0x1)
		unsigned char UnknownData23_7[0x3]; // 0x49D(0x3) UNKNOWN PROPERTY
	...
	public:
		...
		TArray<UMaterialInterface*> OverrideMaterials; // 0x4A8(0x10)
		TArray<UMaterialInterface*> NaniteOverrideMaterials; // 0x4B8(0x10)
	...
	{
	public:
		unsigned char UnknownData00_1[0x50]; // 0x2A0(0x50) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData00_1[0x10]; // 0x590(0x10) UNKNOWN PROPERTY
	...
	public:
		...
		int32_t FoliageOverlappingSphereCount(UObject* WorldContextObject, UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // Flags: Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable, Memory Exec: 0x7FF74C06A8A4(relative to base address)
		void FoliageOverlappingBoxTransforms(UObject* WorldContextObject, UStaticMesh* StaticMesh, FBox Box, TArray<FTransform>& OutTransforms); // Flags: Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable, Memory Exec: 0x7FF74C06A690(relative to base address)
		int32_t FoliageOverlappingBoxCount(UObject* WorldContextObject, UStaticMesh* StaticMesh, FBox Box); // Flags: Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable, Memory Exec: 0x7FF74C06A4E4(relative to base address)
	};
	...
	{
	public:
		unsigned char UnknownData00_1[0x8]; // 0xA78(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_7[0x4]; // 0x32C(0x4) UNKNOWN PROPERTY
		...
		void CapsuleTouched(UPrimitiveComponent* OverlappedComp, AActor* Other, UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // Flags: Final|Native|Protected|HasOutParms, Memory Exec: 0x7FF74C06A180(relative to base address)
	};
	...
	public:
		...
		TArray<TWeakObjectPtr> OverrideFoliageTerrainMaterials; // 0x58(0x10)
		...
		void Simulate(int32_t NumSteps); // Flags: Final|RequiredAPI|Native|Public|BlueprintCallable, Memory Exec: 0x7FF74C06AAE8(relative to base address)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0xA0]; // 0x30(0xA0) UNKNOWN PROPERTY
		TArray<FProceduralFoliageInstance> InstancesArray; // 0xD0(0x10)
		unsigned char UnknownData01_7[0x90]; // 0xE0(0x90) UNKNOWN PROPERTY
