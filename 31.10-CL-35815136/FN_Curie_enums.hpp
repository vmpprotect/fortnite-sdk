...
namespace SDK
{
	...
	enum ECurieHandlerPriority
	{
		...
		ECurieHandlerPriority__Priority = A,
		ECurieHandlerPriority__Priority_Default = B,
	};
	...
	enum ECurieManagerComponentPriority
	{
		...
		ECurieManagerComponentPriority__Priority = A,
		ECurieManagerComponentPriority__Priority_Default = B,
	};
