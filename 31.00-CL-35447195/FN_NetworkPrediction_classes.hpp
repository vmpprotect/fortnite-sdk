...
namespace SDK
{
	...
	public:
		...
		void ServerReceiveClientInput(FServerReplicationRPCParameter ProxyParameter); // Flags: Net|Native|Event|Protected|NetServer|NetValidate 0x7FF414628D58
	};
	...
	public:
		...
		unsigned char UnknownData02_6[0x8]; // 0x158(0x8) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x638]; // 0x38(0x638) UNKNOWN PROPERTY
