...
namespace SDK
{
	...
	public:
		...
		TArray<FFortSubmixPair> SubmixSends; // 0x50(0x10)
		TArray<FFortBusPair> PreEffectBusSends; // 0x60(0x10)
		TArray<FFortBusPair> PostEffectBusSends; // 0x70(0x10)
	...
	{
	public:
		TMap<UClass*, UFortSoundCueTemplateDefaults*> TemplateDefaults; // 0x30(0x50)
		...
		UFortSoundCueTemplateDefaults GetSettingsForTemplateType(UClass* TemplateType); // Flags: Final|Native|Public, Memory Exec: 0x7FF750641550(relative to base address)
	};
	...
	{
	public:
		TWeakObjectPtr<UFortSoundCueTemplateDefaultSettings*> DefaultTemplateSettings; // 0x30(0x20)
		...
		UFortSoundCueTemplateDefaults GetDefaultSettingsForTemplateType(UClass* TemplateType); // Flags: Final|Native|Public|Const, Memory Exec: 0x7FF750641490(relative to base address)
	};
	...
	public:
		...
		TArray<USoundWave*> DistantVariations; // 0xA0(0x10)
	...
	public:
		...
		TArray<FDistanceDatum> ElevationCrossfadeDistances; // 0xC8(0x10)
