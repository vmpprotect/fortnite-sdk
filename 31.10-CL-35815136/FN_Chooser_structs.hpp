...
namespace SDK
{
	...
	{
	public:
		TArray<FName> PropertyBindingChain; // 0x8(0x10)
	...
	{
	public:
		TArray<FName> PropertyBindingChain; // 0x0(0x10)
		int32_t ContextIndex; // 0x10(0x4)
		bool IsBoundToRoot; // 0x14(0x1)
		unsigned char UnknownData00_7[0x13]; // 0x15(0x13) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray<EBoolColumnCellValue> RowValuesWithAny; // 0x18(0x10)
	};
	...
	public:
		FInstancedStruct InputValue; // 0x8(0x10)
		TArray<FChooserEnumRowData> RowValues; // 0x18(0x10)
	};
	...
	public:
		...
		TArray<FChooserFloatDistanceRowData> RowValues; // 0x38(0x10)
	};
	...
	public:
		...
		TArray<FChooserFloatRangeRowData> RowValues; // 0x30(0x10)
	};
	...
	public:
		...
		TArray<FGameplayTagContainer> RowValues; // 0x20(0x10)
	};
	...
	public:
		FInstancedStruct InputValue; // 0x8(0x10)
		TArray<FChooserMultiEnumRowData> RowValues; // 0x18(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UObject*> Asset; // 0x8(0x20)
	};
	...
	public:
		FInstancedStruct InputValue; // 0x8(0x10)
		TArray<FChooserObjectClassRowData> RowValues; // 0x18(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
		TWeakObjectPtr<UObject*> Value; // 0x8(0x20)
	};
	...
	public:
		FInstancedStruct InputValue; // 0x8(0x10)
		TArray<FChooserObjectRowData> RowValues; // 0x18(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		TArray<bool> RowValues; // 0x20(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData00_6[0x7]; // 0x19(0x7) UNKNOWN PROPERTY
		TArray<FChooserOutputEnumRowData> RowValues; // 0x20(0x10)
	};
	...
	public:
		...
		TArray<double> RowValues; // 0x20(0x10)
	};
	...
	public:
		FInstancedStruct InputValue; // 0x8(0x10)
		TArray<FChooserOutputObjectRowData> RowValues; // 0x18(0x10)
	...
	public:
		...
		TArray<FInstancedStruct> RowValues; // 0x28(0x10)
	};
	...
	public:
		...
		TArray<float> RowValues; // 0x20(0x10)
	};
	...
	{
	public:
		TArray<FAnimCurveOverride> Values; // 0x0(0x10)
	...
	{
	public:
		unsigned char UnknownData00_3[0x20]; // 0xC0(0x20) UNKNOWN PROPERTY
		...
		TArray<FInstancedStruct> ChooserContextDefinition; // 0x150(0x10)
		bool bStartFromMatchingPose; // 0x160(0x1)
		unsigned char UnknownData03_7[0xE7]; // 0x161(0xE7) UNKNOWN PROPERTY
	};
