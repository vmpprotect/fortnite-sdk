...
namespace SDK
{
	...
	public:
		...
		TWeakObjectPtr<UTexture2D*> ArrowIcon; // 0x58(0x20)
		TWeakObjectPtr<UMaterialInstance*> FaceIcon; // 0x78(0x20)
	...
	public:
		...
		FText Title; // 0x10(0x10)
		FText Description; // 0x20(0x10)
		TWeakObjectPtr<UTexture2D*> Icon; // 0x30(0x20)
	};
	...
	public:
		...
		TArray<FJunoVillageTamingLevelRewardsEntryInfo> EntryInfo; // 0x8(0x10)
	};
	...
	public:
		...
		TArray<UJunoKnowledgeBundle*> KnowledgeBundles; // 0x58(0x10)
	};
	...
	{
	public:
		TArray<UJunoKnowledgeBundle*> KnowledgeBundles; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x5]; // 0x133(0x5) UNKNOWN PROPERTY
	};
