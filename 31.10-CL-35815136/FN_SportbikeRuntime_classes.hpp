...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData00_7[0x9]; // 0x6F7(0x9) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData00_6[0x3]; // 0x9A1(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData01_7[0xF]; // 0x9B1(0xF) UNKNOWN PROPERTY
