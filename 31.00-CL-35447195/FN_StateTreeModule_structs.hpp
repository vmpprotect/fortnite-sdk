...
namespace SDK
{
	...
	public:
		...
		TArray PropertyOverrides; // 0x18(0x10)
	};
	...
	{
	public:
		TArray NextActiveFrames; // 0x0(0x10)
		TArray NextActiveFrameEvents; // 0x10(0x10)
		...
		unsigned char UnknownData03_7[0x6]; // 0x32(0x6) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xB]; // 0x1D(0xB) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0x1]; // 0x11(0x1) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_6[0x1]; // 0x2E(0x1) UNKNOWN PROPERTY
	...
	{
	public:
		TArray ActiveFrames; // 0x0(0x10)
		TArray DelayedTransitions; // 0x10(0x10)
	...
	public:
		...
		unsigned char UnknownData05_6[0x1]; // 0x21(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData06_6[0x6]; // 0x2A(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_5[0x4]; // 0x4(0x4) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x5]; // 0x23(0x5) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray TemporaryInstances; // 0x48(0x10)
		unsigned char UnknownData01_6[0x18]; // 0x58(0x18) UNKNOWN PROPERTY
		TArray TransitionRequests; // 0x70(0x10)
	...
	public:
		...
		unsigned char UnknownData05_7[0x2]; // 0x56(0x2) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray SourceStructs; // 0x0(0x10)
		TArray CopyBatches; // 0x10(0x10)
		TArray PropertyPathBindings; // 0x20(0x10)
		TArray PropertyCopies; // 0x30(0x10)
		TArray PropertyReferencePaths; // 0x40(0x10)
		TArray PropertyAccesses; // 0x50(0x10)
		TArray PropertyIndirections; // 0x60(0x10)
