...
namespace SDK
{
	...
	public:
		...
		unsigned char UnknownData02_7[0x6]; // 0xDA(0x6) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x5]; // 0xCB(0x5) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x108]; // 0x38(0x108) UNKNOWN PROPERTY
	...
	public:
		...
		unsigned char UnknownData01_7[0x168]; // 0x38(0x168) UNKNOWN PROPERTY
