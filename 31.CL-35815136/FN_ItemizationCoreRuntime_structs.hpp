...
namespace SDK
{
	...
	public:
		...
		TArray<TWeakObjectPtr> ItemDefinitions; // 0x8(0x10)
	};
	...
	{
	public:
		TWeakObjectPtr<UItemDefinitionBase*> ItemDefinition; // 0x0(0x20)
	...
	public:
		...
		TArray<UItemType*> ItemRequirements; // 0x10(0x10)
	...
	{
	public:
		TWeakObjectPtr<UClass*> InventoryClass; // 0x30(0x20)
	};
	...
	public:
		int64_t Slot; // 0x0(0x8)
		TWeakObjectPtr<UInputAction*> InputAction; // 0x8(0x20)
	};
	...
	public:
		TWeakObjectPtr<UClass*> InventoryClass; // 0x30(0x20)
		TArray<FEquippableInventorySlotBindingDefinition> SlotBindings; // 0x50(0x10)
	};
	...
	{
	public:
		TArray<FInstancedStruct> DataList; // 0x0(0x10)
		unsigned char UnknownData00_7[0xF8]; // 0x10(0xF8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TWeakObjectPtr<UItemInputAction*> InputAction; // 0x0(0x20)
		EItemStateFilter ActiveState; // 0x20(0x1)
		unsigned char UnknownData00_6[0x7]; // 0x21(0x7) UNKNOWN PROPERTY
		TArray<UItemAbilityCost*> Costs; // 0x28(0x10)
		TArray<UItemAbilityCooldown*> Cooldowns; // 0x38(0x10)
	...
	{
	public:
		TArray<FItemAbilityBinding> AbilityList; // 0x0(0x10)
	};
	...
	{
	public:
		TArray<UItemAttachmentDefinition*> Attachments; // 0x0(0x10)
	};
	...
	public:
		...
		unsigned char UnknownData02_7[0x8]; // 0x138(0x8) UNKNOWN PROPERTY
	};
	...
	{
	public:
		TArray<FItemEntry> ItemList; // 0x108(0x10)
		unsigned char UnknownData00_7[0x1F0]; // 0x118(0x1F0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		FVerseGameplayTagContainer ForbiddenTags; // 0x10(0x10)
		FVerseGameplayTagContainer AnyTags; // 0x20(0x10)
	};
