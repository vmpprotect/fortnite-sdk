...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte ComplexTraceChannel; // 0xD(0x1)
		...
		TEnumAsByte SimpleTraceChannel; // 0x18(0x1)
		bool bEnabled; // 0x19(0x1)
		unsigned char UnknownData03_7[0x2]; // 0x1A(0x2) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData03_7[0x3]; // 0x31(0x3) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray LegDefinitions; // 0x108(0x10)
		...
		unsigned char UnknownData05_7[0x28C]; // 0x194(0x28C) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData01_7[0xE0]; // 0x20(0xE0) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData08_6[0x4]; // 0xD4(0x4) UNKNOWN PROPERTY
		...
		TArray SpineBones; // 0xF8(0x10)
		FBoneReference IKFootRootBone; // 0x108(0xC)
		unsigned char UnknownData09_6[0x4]; // 0x114(0x4) UNKNOWN PROPERTY
		TArray IKFootBones; // 0x118(0x10)
		TEnumAsByte RotationAxis; // 0x128(0x1)
		unsigned char UnknownData10_6[0x3]; // 0x129(0x3) UNKNOWN PROPERTY
		...
		unsigned char UnknownData11_6[0x1]; // 0x13F(0x1) UNKNOWN PROPERTY
		FVector ManualRootMotionVelocity; // 0x140(0x18)
		EOrientationWarpingSpace WarpingSpace; // 0x158(0x1)
		unsigned char UnknownData12_6[0x7]; // 0x159(0x7) UNKNOWN PROPERTY
		FTransform WarpingSpaceTransform; // 0x160(0x60)
		unsigned char UnknownData13_7[0x60]; // 0x1C0(0x60) UNKNOWN PROPERTY
	};
	...
	public:
		...
		unsigned char UnknownData11_5[0x3]; // 0x2A5(0x3) UNKNOWN PROPERTY
	...
	{
	public:
		unsigned char UnknownData03_3[0x8]; // 0xC8(0x8) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0xC4]; // 0x11C(0xC4) UNKNOWN PROPERTY
	};
	...
	public:
		...
		TArray FootDefinitions; // 0x110(0x10)
		...
		unsigned char UnknownData07_7[0x44]; // 0x1FC(0x44) UNKNOWN PROPERTY
	};
