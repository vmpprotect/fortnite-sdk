...
namespace SDK
{
	...
	public:
		...
		TArray OwnedEntities; // 0x38(0x10)
	...
	public:
		...
		TWeakObjectPtr EntityPtr; // 0x298(0x20)
		unsigned char UnknownData04_6[0x8]; // 0x2B8(0x8) UNKNOWN PROPERTY
		TWeakObjectPtr EntityOwnerPtr; // 0x2C0(0x20)
		...
		TArray EntityComponentsPendingInitialization; // 0x430(0x10)
	...
	public:
		...
		unsigned char UnknownData03_7[0x210]; // 0x40(0x210) UNKNOWN PROPERTY
