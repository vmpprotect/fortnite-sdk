...
namespace SDK
{
	...
	public:
		...
		TEnumAsByte DefaultMaterialBakeFilter; // 0x44(0x1)
		TEnumAsByte DefaultMaterialBakeTiling; // 0x45(0x1)
		unsigned char UnknownData03_6[0x2]; // 0x46(0x2) UNKNOWN PROPERTY
		TMap DefaultInputBakeSettings; // 0x48(0x50)
		...
		unsigned char UnknownData04_6[0x1]; // 0xA3(0x1) UNKNOWN PROPERTY
		...
		unsigned char UnknownData05_7[0x2]; // 0xAE(0x2) UNKNOWN PROPERTY
		...
		void ResetToDefault(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414EC9E60
	};
	...
	public:
		...
		bool ExportToGLTF(UObject Object, FString FilePath, UGLTFExportOptions Options, TSet& SelectedActors, FGLTFExportMessages& OutMessages); // Flags: Final|Native|Static|Public|HasOutParms|BlueprintCallable 0x7FF414EC9F40
	};
	...
	public:
		...
		TEnumAsByte DefaultMaterialBakeFilter; // 0x38(0x1)
		TEnumAsByte DefaultMaterialBakeTiling; // 0x39(0x1)
		unsigned char UnknownData03_6[0x6]; // 0x3A(0x6) UNKNOWN PROPERTY
		TMap DefaultInputBakeSettings; // 0x40(0x50)
		...
		void ResetToDefault(); // Flags: Final|Native|Public|BlueprintCallable 0x7FF414ECA020
	};
